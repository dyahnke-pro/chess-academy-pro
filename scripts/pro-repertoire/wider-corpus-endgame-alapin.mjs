...
// Alapin corpus (all 2,752 games), not just the 3-4 games at deep
// terminus. Bucket the endgame structure at the final position of
// every game matching each variation prefix.
