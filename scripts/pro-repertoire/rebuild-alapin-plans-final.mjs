...
const PLANS = [
  ...
  },
  {
    ...
    moves: ['Bh6','exd4','cxd4','e5','dxe5','Nc4'],
    annotations: [
      "Bh6 — the bishop infiltrates to h6 pressuring the king's defensive squares. The dark-squared bishop coordinates with Black's awkward pieces.",
      "Black plays …exd4 trying to open central lines and create tactics. The pawn structure shifts in our favour because our pieces are better coordinated.",
      "cxd4 — recapture with the c-pawn opening the c-file for our rook and consolidating the central pawn duo (d4 + e5).",
      "Black plays …e5 trying to undermine our centre. The break looks principled but actually accelerates our attack — the e-file opens for our rook.",
      "dxe5! — capture toward the centre. The pawn on e5 now threatens to push to e6 next, opening lines toward Black's king on g8.",
      "Black plays …Nc4 trying to harass our queen and create counter-threats. We push e6 next opening the seventh rank — the Zanyglobal game ended at move 31 with Bd5 winning a piece via discovered tactics on the kingside.",
    ],
    learnCues: ['Bh6 — bishop infiltrates','…exd4 — Black opens lines','cxd4 — recapture, open c-file','…e5 — Black\'s desperate break','dxe5 — push toward king','…Nc4 — harass the queen'],
    pawnBreaks: ['cxd4 — opens the c-file','dxe5 — push toward the king'],
    pieceManeuvers: ['Bh6 — dark-square pressure','Pawn advance e5-e6 opens lines','Queen + rook battery'],
    strategicThemes: ['Structural conversion via central push','Pawn shield cracks under pressure'],
    endgameTransitions: ['Tactics decide before deep endgame — material wins'],
    sources: SRC,
  },
  ...
  },
  {
    ...
    setupFen: 'r7/pp2Rr1k/3P2bp/2P3p1/5q2/8/PP3QPP/R5K1 w - - 2 31',
    moves: ['Rxf7+','Bxf7','Re7','Kf6','Rxb7','Bd5'],
    annotations: [
      "Rxf7+! — capture the rook with check. After …Bxf7 we're up material AND Black's king is even MORE exposed on h7 with no defenders.",
      "Black plays …Bxf7 forced. The recapture brings the bishop to f7 — temporarily defending the king but uncoordinated.",
      "Re7 — the rook on e7 invades the 7th rank attacking Black's bishop on f7 AND the king on h7. Slow-motion winning move.",
      "Black plays …Kf6 trying to escape and centralise the king. The king walk is desperate; we have all the time.",
      "Rxb7 — grab the b7-pawn opening the queenside. Black has nothing to defend.",
      "Black plays …Bd5 trying to centralise the bishop. Too little — the d6-pawn + the b-pawn passer + active pieces all combine to win. The Salem-AR game went another 100 moves before resignation; the endgame technique stayed consistent throughout.",
    ],
    learnCues: ['Rxf7+ — rook sacrifice for invasion','…Bxf7 — forced recapture','Re7 — invade the 7th','…Kf6 — desperate king walk','Rxb7 — grab the queenside','…Bd5 — late centralisation'],
    pawnBreaks: ['cxd6 — passer creates winning chances','b-file open for the rook'],
    pieceManeuvers: ['Rxf7+ — invasive rook sac','Re7 + Rxb7 — 7th rank dominance','d-pawn passer marches'],
    strategicThemes: ['Long technical conversion','King fix on g8/h7 never resolves'],
    endgameTransitions: ['Pawn promotions finish the game'],
    sources: SRC,
  },
