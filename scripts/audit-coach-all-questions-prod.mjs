...
const ACCEPT = {
  ...
  'move-rating': /good|fine|solid|book|inaccuracy|mistake|blunder|best|reasonable|no move|haven'?t (played|made)/i,
  ...
  concept: /fork.{0,80}(two|attack|same time|both|more than one)/i,
...
const SECTIONS = [
  ...
  ['knowledge', ['concept', 'teaching-method', 'settings-query', 'app-help']],
