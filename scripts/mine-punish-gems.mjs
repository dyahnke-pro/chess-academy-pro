...
(async () => {
  ...
  let proReps = [];
  try { proReps = JSON.parse(readFileSync('src/data/pro-repertoires.json', 'utf-8')).openings || []; } catch { /* none */ }
  ...
  for (const id of ids) {
    const opening = repertoire.find((o) => o.id === id) || gambits.find((o) => o.id === id) || proReps.find((o) => o.id === id);
