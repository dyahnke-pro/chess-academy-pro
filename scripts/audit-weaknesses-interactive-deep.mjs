 ...
 *
 * Run:
 *   AUDIT_PASS=1 node scripts/audit-weaknesses-interactive-deep.mjs
 *   AUDIT_PASS=2 node scripts/audit-weaknesses-interactive-deep.mjs
 *   AUDIT_PASS=3 node scripts/audit-weaknesses-interactive-deep.mjs
 *
 * Env:
