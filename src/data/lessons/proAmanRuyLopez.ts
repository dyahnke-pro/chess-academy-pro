...
export const PRO_AMAN_RUY_LOPEZ_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'be7', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3', arrows: [A('a4', 'b3')], highlights: [H('b3')],
    ...
    b({ id: 'na5', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O h3 d6 c3 Na5 Bc2', arrows: [A('b3', 'c2')], highlights: [H('c2')],
