...
export const PRO_ERICROSEN_QGD_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'qgd', moves: 'd4 d5 c4 e6',
      ...
      say: "The Queen's Gambit Declined — the most solid answer to d4 there is. You support d5 with e6, declining the gambit pawn and building a granite centre. It is reliable, principled, and almost impossible to break down.",
    ...
    b({ id: 'exchange', moves: 'd4 d5 c4 e6 Nc3 Nf6 cxd5 exd5',
      ...
      say: "White releases the tension with cxd5; you recapture …exd5, entering the Carlsbad structure. The pawn on d5 gives you a free, half-open e-file and active piece play — the trade-off for the slightly fixed centre.",
    ...
    b({ id: 'c6', moves: 'd4 d5 c4 e6 Nc3 Nf6 cxd5 exd5 Bg5 c6',
      ...
      say: "After Bg5 pins your knight, you play …c6 — the backbone of the Carlsbad defense. It braces d5 forever and prepares the standard regrouping. White will try a minority attack with b4-b5; you will counter on the kingside.",
      sayShort: '…c6 — brace d5, prep the defense.' }),
    b({ id: 'bd6', moves: 'd4 d5 c4 e6 Nc3 Nf6 cxd5 exd5 Bg5 c6 e3 Bd6 Bd3 h6 Bh4',
      arrows: [], highlights: [{ square: 'd6', color: KEY }, { square: 'h2', color: SOFT }],
      say: "…Bd6 develops the bishop actively toward h2 (not the passive …Be7), and after …h6 White keeps the pin with Bh4. The bishop on d6 is the key to your kingside counterplay — it eyes White's king the moment lines open.",
      sayShort: '…Bd6 — active bishop toward h2.' }),
    b({ id: 'oo', moves: 'd4 d5 c4 e6 Nc3 Nf6 cxd5 exd5 Bg5 c6 e3 Bd6 Bd3 h6 Bh4 O-O Nge2 Re8',
      arrows: [], highlights: [{ square: 'e8', color: KEY }, { square: 'e3', color: SOFT }],
      say: "You castle and bring the rook to e8, seizing the half-open e-file and pressuring White's e3-pawn. The position is balanced and rich: White will push b4-b5 on the queenside, and you answer with …Ne4 and a kingside pawn storm.",
    ...
    b({ id: 'plan', moves: 'd4 d5 c4 e6 Nc3 Nf6 cxd5 exd5 Bg5 c6 e3 Bd6 Bd3 h6 Bh4 O-O Nge2 Re8',
      ...
      say: "The Carlsbad blueprint for Black: meet White's minority attack on the queenside by counter-attacking on the kingside — …Ne4 jumping into the hole, …Bxh4 or …f5-f4 prying open lines at White's king. While White grinds slowly on the queenside, you play for the knockout. This repertoire handles this structure against 3000-rated opposition.",
