...
export const DUTCH_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "dutch-defence::Anti-Dutch 2.Bg5 Response": {
    ...
    beats: [
      ...
      { id: "db4", moves: ["d4", "f5", "Bg5", "g6", "Nc3", "Bg7", "e3", "Nf6", "Bd3", "d5", "Nge2", "O-O", "Nf4", "c6", "h4", "Ne4", "Bxe4", "fxe4", "h5", "h6", "hxg6"], say: "…Ne4! — the central counter, the Dutch player's eternal answer to a wing attack. White trades and pushes anyway: h5, and when …h6 tries to close the door, hxg6 rips it open. Honest assessment: the engine favours White here by most of a pawn — this is the Anti-Dutch's best version, and Black survives on precision, the e4-wedge, and counterplay down the f-file. Know this storm before you sit down; improvising against it loses.", sayShort: "…Ne4 — counter in the centre, hold on.", highlights: [{ square: "e4", color: "rgba(255,214,0,0.88)" }, { square: "g6", color: "rgba(80,140,255,0.32)" }] },
    ],
  },
};
