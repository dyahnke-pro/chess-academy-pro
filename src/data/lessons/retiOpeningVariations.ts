...
export const RETI_OPENING_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "reti-opening::Reti: KIA Setup g3 Bg2 d3 e4": {
    ...
    beats: [
      ...
      b({ id: 'ks2', moves: 'Nf3 d5 g3 c6 Bg2 Bg4 O-O Nd7 d3 Ngf6 Nbd2 e5 e4', say: "Black takes the centre with …e5, and White strikes the thematic blow: e4! This is the whole reason to play the system. White challenges d5 on their own terms, and the g2-bishop, until now biting on granite, is about to spring to life along the long diagonal once the centre opens.", sayShort: 'e4 — the thematic central strike.', highlights: [H('e4'), H('e5', SOFT)] }),
  ...
  orientation: "white",
  beats: [
    b({ id: "as1", moves: "Nf3 d5 c4 c6 g3 Nf6 Bg2 Bf5", say: "Against a Slav-like ...c6, Black develops their light-squared bishop actively to f5 before ...e6 can shut it in — the Anti-Slav Réti. White's plan is clear: challenge the centre with cxd5 and lean on the d5-pawn and the queenside with a quick Qb3 and the g2-bishop.", sayShort: "…Bf5 — the active Anti-Slav bishop.", highlights: [H("f5", KEY), H("d5", SOFT)] }),
  ...
  "reti-opening::Reti: Reti Gambit": {
    ...
    beats: [
      { id: "rg1", moves: ["Nf3", "d5", "c4", "d4", "e3"], say: "…d4 grabs space and e3! undermines it immediately — the Réti Gambit. White isn't sacrificing for material; they're buying the thing the whole opening trades in: time.", sayShort: "e3 — undermine; buy time.", highlights: [{ square: "d4", color: "rgba(255,214,0,0.88)" }, { square: "e3", color: "rgba(80,140,255,0.32)" }] },
