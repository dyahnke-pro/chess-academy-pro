...
const ROSSOLIMO: LessonScript = {
  ...
  beats: [
    b({ id: 'bb5', moves: 'e4 c5 Nf3 Nc6 Bb5', arrows: [A('b5', 'c6')], highlights: [H('c6')], say: "When Black develops the knight to c6, this repertoire often sidesteps the heavy theory and plays the Rossolimo — Bb5, pinning the knight to nothing in particular but threatening to take it. The whole idea is structural: trade the bishop for the knight and damage Black's pawns.", sayShort: 'Bb5 — the Rossolimo squeeze.' }),
    ...
    b({ id: 'mid', moves: 'e4 c5 Nf3 Nc6 Bb5 e6 O-O Nge7 Re1 a6 Bf1 d5 d3', highlights: [H('d3'), H('e4')], say: "Black strikes with d5; White holds the centre with d3 and a small, durable space edge. This is pure this repertoire — no fireworks, just a sound structure and the better pieces, the kind of position he grinds for eighty moves until you crack.", sayShort: 'd3 — the slow this repertoire squeeze.' }),
  ],
};
...
const TAIMANOV: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'e4 c5 Nf3 e6 d4 cxd4 Nxd4 Nc6 Nc3', arrows: [A('d4', 'c6')], highlights: [H('d4')], say: "Against the flexible ...e6 Taimanov, this repertoire opens the centre and grabs the d4 outpost for the knight. The knight on d4 is the dream Sicilian piece — central, untouchable, and eyeing both wings.", sayShort: 'Open it — the d4 knight.' }),
