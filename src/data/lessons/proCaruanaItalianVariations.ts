...
const TWO_KNIGHTS: LessonScript = {
  ...
  beats: [
    b({ id: 'd3', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 d3', say: "Against the Two Knights move-order, this repertoire sidesteps the sharp lines with the quiet d3 — transposing toward the same Pianissimo structure he loves. No early sacrifices, just a deep strategic battle.", sayShort: 'd3 — the quiet Pianissimo.', highlights: [H('d3')] }),
    ...
    b({ id: 'a4', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 d3 Bc5 c3 d6 O-O O-O Re1 a6 a4', say: "This repertoire centralises the rook on e1 and grabs queenside space with a4, restraining Black's ...b5. Patient improving moves — the modern Italian is a maneuvering game.", sayShort: 'Re1, a4 — centralise, gain space.', arrows: [A('a2', 'a4')], highlights: [H('a4')] }),
    b({ id: 'nbd2', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 d3 Bc5 c3 d6 O-O O-O Re1 a6 a4 Ba7 Nbd2 Be6', say: "Black tucks the bishop to a7; this repertoire reroutes the knight via d2 toward f1 and g3, and Black offers a trade with Be6. A fully-developed Pianissimo middlegame where White's small space edge tells.", sayShort: 'Nbd2 — reroute, press the edge.', arrows: [A('b1', 'd2')], highlights: [H('d2')] }),
  ],
};
