...
export const PRO_GOTHAMCHESS_QGD_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say:
        "The Queen's Gambit Declined. White offers the c4-pawn; you simply decline it with e6, propping up your d5-pawn with a rock. White isn't really giving anything away — and you're not interested in grabbing. You want a solid, fight-from-a-fortress position, and the QGD is the most respected way to get one.",
    ...
    b({
      ...
      say:
        "Both sides develop naturally — knights out, and your dark-squared bishop to e7, a modest but flexible square. Nothing fancy, nothing loose. The QGD is about getting every piece to a sensible home and refusing to create a single weakness.",
    ...
    b({
      ...
      say:
        "White develops the bishop to f4 — the modern main line, keeping it outside the pawn chain. You castle, getting the king safe. So far it's a textbook QGD: White has a space edge, you have a fortress and a plan to chip away at the centre.",
    ...
    b({
      ...
      say:
        "White solidifies with e3; you strike with the move that defines this whole opening — c5! This is the QGD's freeing break, hitting White's d4-pawn and finally giving your pieces room to breathe. Without …c5, Black just sits cramped; WITH it, the position opens on your terms.",
    ...
    b({
      ...
      say:
        "White takes on c5; you recapture with the bishop. Look how that piece transformed — a minute ago it sat passively on e7, now it rakes the a7-g1 diagonal toward White's king. The break didn't just free you, it activated your worst piece.",
    ...
    b({
      ...
      say:
        "White lifts the queen to c2; you develop the last knight to c6, finishing your development and adding a defender to your centre. Every piece is now in the game — and unlike a lot of Black openings, you got here without a single awkward move.",
    ...
    b({
      ...
      say:
        "White centralises a rook on d1; you tuck the bishop back to e7, sidestepping any b4 tricks and keeping your flexible setup. Here's the middlegame: fully developed, king safe, no weaknesses, the queen active and the c3-knight pinned. From here you double on the d-file, eye the d4-square for a knight, and prepare …e5. Dead equal, totally comfortable — the QGD did its job. You're never worse, and you're always solid.",
