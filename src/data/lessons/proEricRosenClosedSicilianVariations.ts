...
const VS_E6: LessonScript = {
  ...
  beats: [
    b({ id: 'e6', moves: 'e4 c5 Nc3 e6 f4 d5',
      ...
      say: "Against an …e6/…d5 French-style setup, you keep your f4 stake in the centre. Black challenges e4 with …d5; you are happy to clarify because your f-pawn and kingside development give you the attacking chances.",
    ...
    b({ id: 'bb5', moves: 'e4 c5 Nc3 e6 f4 d5 Nf3 Nf6 Bb5+ Bd7 Bxd7 Nbxd7',
      ...
      say: "Nf3 develops and Bb5+ is a useful check: you trade off Black's light-squared bishop — often Black's best piece in these French structures — and after …Nbxd7 White has an easy game with a clear kingside plan and no bad pieces.",
...
const VS_G6: LessonScript = {
  ...
  beats: [
    b({ id: 'g6', moves: 'e4 c5 Nc3 g6 d4',
      ...
      say: "When Black fianchettoes early with …g6 before developing the queenside, you change gears and grab the centre with d4 — an Open Sicilian on your terms, since Black has committed to the fianchetto and can't fight for the centre with …Nc6 and …e5 as flexibly.",
    ...
    b({ id: 'qxd4', moves: 'e4 c5 Nc3 g6 d4 cxd4 Qxd4 Nf6 Bb5',
      ...
      say: "After cxd4 you recapture with the queen — and crucially, when Black hits it with …Nf6, you do not retreat but play Bb5+, so the check covers the queen and develops with tempo. A neat point that keeps White a step ahead.",
