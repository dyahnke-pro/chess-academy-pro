...
const VS_E6: LessonScript = {
  ...
  beats: [
    b({ id: 'e6', moves: 'e4 c5 Nc3 e6 f4 d5',
      arrows: [A('d5', 'e4')], highlights: [{ square: 'd5', color: KEY }, { square: 'f4', color: SOFT }],
    ...
    b({ id: 'bb5', moves: 'e4 c5 Nc3 e6 f4 d5 Nf3 Nf6 Bb5+ Bd7 Bxd7 Nbxd7',
      arrows: [A('f1', 'b5')], highlights: [{ square: 'b5', color: KEY }, { square: 'd7', color: SOFT }],
    ...
    b({ id: 'plan', moves: 'e4 c5 Nc3 e6 f4 d5 Nf3 Nf6 Bb5+ Bd7 Bxd7 Nbxd7',
      arrows: [A('e4', 'e5'), A('f4', 'f5')], highlights: [{ square: 'e5', color: KEY }, { square: 'f5', color: SOFT }],
...
const VS_G6: LessonScript = {
  ...
  beats: [
    b({ id: 'g6', moves: 'e4 c5 Nc3 g6 d4',
      arrows: [A('d2', 'd4')], highlights: [{ square: 'd4', color: KEY }],
    ...
    b({ id: 'qxd4', moves: 'e4 c5 Nc3 g6 d4 cxd4 Qxd4 Nf6 Bb5',
      arrows: [A('d1', 'd4'), A('f1', 'b5')], highlights: [{ square: 'd4', color: KEY }, { square: 'b5', color: SOFT }],
    ...
    b({ id: 'plan', moves: 'e4 c5 Nc3 g6 d4 cxd4 Qxd4 Nf6 Bb5 a6 Bd3 Bg7 Be3 O-O O-O-O',
      arrows: [A('b5', 'd3'), A('d1', 'd8')], highlights: [{ square: 'd3', color: KEY }, { square: 'c1', color: SOFT }],
