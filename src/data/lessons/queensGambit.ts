...
export const QUEENS_GAMBIT_LESSON: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      say: "Here is the gambit: c4. White attacks the d5-pawn from the side and dares Black to take. Edward Lasker explained the whole point in one sentence — White offers a pawn to induce Black to give up their centre-pawn. It is NOT a real sacrifice. If Black grabs on c4, White regains the pawn easily and Black has simply traded their proud central pawn for one on the wing. So the gambit is really a question put to Black: will you give up the centre, or fight for it?",
    ...
    },
    {
      ...
      say: "Black breaks the pin with Be7 and tucks their king away. White answers e3 — modest, almost apologetic, but exactly right. It opens the f1-bishop's path and keeps the pawn chain solid. This is the Queen's Gambit's character: White is not hunting for a knockout, they are accumulating tiny, permanent advantages — a freer game, the better bishop, more central space. Capablanca won game after game from positions that looked like nothing.",
    ...
    },
    {
      ...
      say: "Nf3 finishes the kingside, Nbd7 develops behind the pawns, and then a quietly strategic move: Rc1. The rook slides onto the c-file before a single pawn has been traded there. This is foresight — White expects the c-file to open, and they want their rook already aimed down it. Black plays c6, the rock-solid Orthodox set-up, bracing d5 a third time. Every piece on both sides is doing centre-work; the tension has not broken yet.",
    ...
    },
    {
      ...
      highlights: [{ square: 'd5', color: KEY }],
      say: "Now Black tries the famous antidote — Capablanca's freeing manoeuvre, Nd5. The knight jumps to the centre and offers a swarm of trades; the cramped side wants to swap pieces to get room to breathe. White obliges where it helps them: Bxe7 removes Black's good bishop, Qxe7 recaptures. Trading is fine for White as long as they keep the structural plus. The d5-knight now eyes White's c3-knight, inviting the exchange that decides where White's rook lands.",
    ...
    },
    {
      ...
      say: "Remember the plan that defines this structure, because it is the engine of half of all Queen's Gambit wins: the minority attack. White has fewer pawns on the queenside, yet they Attack there — pushing b2 to b4 and on to b5, deliberately offering to trade their b-pawn for Black's c6-pawn. When the dust clears Black is left with a backward pawn on an open file and a hole in front of it, and White's rooks pour down the c-file onto it. It is one of the most elegant ideas in chess: you attack with the minority precisely to create a target you then besiege. Learn this, and you understand why the Queen's Gambit has won more world-championship games than any other opening.",
    ...
    },
    {
      id: 'close',
      moves: M,
      say: "That is the Queen's Gambit. Not a real sacrifice — a question. Offer the c-pawn, and either Black gives up the centre and you seize space, or they decline and you out-develop them toward a structural edge: the half-open c-file your rook already patrols from c3, the central majority, the bad bishop rotting on c8 that they can never quite free. There are no cheap traps here and no need for them. You win the Queen's Gambit the way Capablanca did — by understanding the pawns better than your opponent and squeezing until the position falls apart on its own. The tabs that follow teach each road: the Exchange and its minority attack, the Tartakower, the Accepted, the Slav and Semi-Slav, the Catalan, and the quick Bf4 set-up. Learn them, and you have a weapon for a lifetime.",
