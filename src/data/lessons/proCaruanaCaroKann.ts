...
export const PRO_CARUANA_CARO_KANN_LESSON: LessonScript = {
  ...
  sources: SRC,
  beats: [
    b({ id: 'bg4', moves: 'e4 c6 Nf3 d5 Nc3 Bg4', say: "The Caro-Kann — the soundest defence to e4. After c6 and d5 Black challenges the centre, and against the Two Knights they play the classical Bg4, pinning the f3-knight before White can trap the light bishop inside the pawn chain.", sayShort: '…Bg4 — pin the knight.', arrows: [A('c8', 'g4')], highlights: [H('g4')] }),
    b({ id: 'bxf3', moves: 'e4 c6 Nf3 d5 Nc3 Bg4 h3 Bxf3 Qxf3 e6', say: "White breaks the pin with h3; Black trades on f3, damaging nothing of their own, and builds the solid wall with e6. The light bishop has done its job and left — no bad bishop in this Caro.", sayShort: '…Bxf3, …e6 — trade and build.', arrows: [A('g4', 'f3')], highlights: [H('e6')] }),
