...
export const PRO_CARUANA_CARO_KANN_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'e5', moves: 'e4 c6 Nf3 d5 Nc3 Bg4 h3 Bxf3 Qxf3 e6 d3 Nd7 g3 Ngf6 Bg2 Bb4 O-O O-O Qe2 e5', say: "Both sides castle, White connects with Qe2, and Black strikes with e5 — seizing the centre and equalising fully. Black has the sounder structure, no bad bishop, and an easy game where understanding outweighs memory. The Caro at its best.", sayShort: '…e5 — seize the centre, equal.', arrows: [A('e6', 'e5')], highlights: [H('e5')] }),
  ],
};
