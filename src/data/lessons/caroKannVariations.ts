...
const ADVANCE: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'adv4', moves: 'e4 c6 d4 d5 e5 Bf5 Nf3 e6 Be2 c5 Be3 cxd4 Nxd4 Ne7 Nd2 Nbc6 N2f3 Be4',
      say: "Both knights come out, and the bishop steps to e4 — dead-centre, the single best home it could find. You don't put it here just to 'rake a diagonal'; you put it here because e4 commands the b1-h7 diagonal, the exact artery any attack on White's king will travel down once they castle short. And White can't chase it off without loosening their own position. This is the bishop the French player only dreams of — Black got it OUTSIDE the pawn chain back on move three, and now the whole game is built around it.",
