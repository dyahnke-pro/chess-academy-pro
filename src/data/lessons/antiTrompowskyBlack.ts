...
export const ANTI_TROMPOWSKY_BLACK_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'trp1', moves: 'd4 Nf6 Bg5 Ne4 Bf4 d5 e3 c5',
      say: "The Trompowsky's whole idea is Bg5, wanting to trade for your knight and give you doubled pawns. You refuse at the root: …Ne4! The knight leaps into the centre and hits the bishop, so instead of pinning you it must scurry to f4. Now you plant your own big centre with …d5 and …c5, and you already have easy, comfortable development.",
    ...
    b({ id: 'trp2', moves: 'd4 Nf6 Bg5 Ne4 Bf4 d5 e3 c5 Nd2 Nxd2 Qxd2 Nc6 Nf3 cxd4 exd4',
      say: "White challenges the outpost with Nd2; you trade it off, and after Qxd2 you develop naturally with …Nc6. Then …cxd4 exd4 clarifies the centre, leaving White with a lone d4-pawn to look after. You have no weaknesses, easy piece play, and a clear target — the game is dead level and pleasant to play.",
    ...
    b({ id: 'trp3', moves: 'd4 Nf6 Bg5 Ne4 Bf4 d5 e3 c5 Nd2 Nxd2 Qxd2 Nc6 Nf3 cxd4 exd4 Bf5 Bd3 Bxd3 Qxd3',
      say: "Here is the key move: …Bf5, developing your light-squared bishop OUTSIDE the pawn chain before …e6 ever locks it in — the same good-bishop principle that makes the Caro-Kann so solid. White offers a trade with Bd3; you take, …Bxd3 Qxd3, and your worst potential piece is gone from the board. Nothing bad can happen to you now.",
    ...
    b({ id: 'trp4', moves: 'd4 Nf6 Bg5 Ne4 Bf4 d5 e3 c5 Nd2 Nxd2 Qxd2 Nc6 Nf3 cxd4 exd4 Bf5 Bd3 Bxd3 Qxd3 e6 O-O Bd6',
      say: "…e6 completes a rock-solid structure, and after White castles you challenge the last active enemy piece with …Bd6, offering to trade the dark-squared bishops. When they come off, the position is symmetrical and completely equal — you have met the Trompowsky's surprise value with pure principle and stand shoulder to shoulder. A calm, confident equaliser.",
