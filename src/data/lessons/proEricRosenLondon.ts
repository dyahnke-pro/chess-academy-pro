...
export const PRO_ERICROSEN_LONDON_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "The London System. You play d4 and develop the dark-squared bishop OUT to f4 before locking it in with e3 — that one move is the whole point. The bishop eyes the b8-h2 diagonal and the c7/e5 squares, and you will build the same harmonious setup no matter what Black does. It is the opening this repertoire reaches for more than any other.",
    ...
    b({
      ...
      say: "Black fianchettoes with g6, heading for a King's-Indian setup, and stakes a claim in the centre with d5. You develop the knight to c3, pressuring d5 and keeping your options open between a quiet game and a kingside pawn storm.",
    ...
    b({
      ...
      say: "You finish developing with Nf3 and Be2 and castle is met. Black strikes at your centre with c5 — the standard break against the London. You do not have to release the tension; instead you are about to plant a knight on the square the whole system is built around.",
    ...
    b({
      ...
      say: "Ne5 — the London knight's dream square. From e5 it stares at f7, c6 and g6, it cannot be chased by a pawn, and it backs up every kingside attacking idea you have. Memorise this leap: in the London, the knight belongs on e5.",
    ...
    b({
      ...
      say: "From here the plan writes itself: reroute the bishop to d3 to aim at h7, bring the queen toward the kingside, and use the e5-knight as the spearhead of an attack on Black's king. When Black is solid you just keep your edge; when Black weakens, you strike at f7 and h7. This is this repertoire's bread and butter.",
