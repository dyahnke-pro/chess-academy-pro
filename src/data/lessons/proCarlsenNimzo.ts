...
const CATALAN: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'dxc4', moves: 'd4 Nf6 c4 e6 g3 d5 Bg2 Be7 Nf3 O-O O-O dxc4', highlights: [H('c4')], say: "Black develops and then takes the pawn — ...dxc4, the Open Catalan. Grabbing the c4-pawn isn't about winning material; it's about gaining time. While White spends moves regaining it, Black completes development and frees their position with ...a6 and ...b5 or a quick ...c5.", sayShort: 'dxc4 — grab it, gain time.' }),
