...
const CATALAN: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'a6', moves: 'd4 Nf6 c4 e6 g3 d5 Bg2 Be7 Nf3 O-O O-O dxc4 Qc2 a6', highlights: [H('a6'), H('b5')], say: "The clever ...a6 prepares ...b5, holding the extra pawn for one more move and grabbing queenside space. Black either keeps the pawn with tempo or returns it for a comfortable, free game. The Open Catalan is one of Black's safest, most respected equalisers — and Carlsen plays it both colours.", sayShort: 'a6 — prep b5, hold or free.' }),
  ],
};
...
const BOGO: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'nbd7', moves: 'd4 Nf6 c4 e6 Nf3 Bb4+ Nbd2 O-O a3 Be7 e4 d6 Be2 Nbd7', highlights: [H('d7'), H('e5')], say: "Black completes with ...Nbd7, ready to play ...e5 and challenge White's big centre. The position resembles a comfortable King's Indian where Black has saved time by provoking a3 and Nbd2. A sound, manoeuvring middlegame with chances for both — Carlsen's preferred battleground.", sayShort: 'Nbd7 — ready for e5.' }),
  ],
};
