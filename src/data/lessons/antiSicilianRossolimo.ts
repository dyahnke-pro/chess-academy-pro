...
export const ANTI_SICILIAN_ROSSOLIMO_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'ros4', moves: 'e4 c5 Nf3 Nc6 Bb5 g6 O-O Bg7 Re1 Nf6 e5 Nd5 Nc3 Nc7 Bxc6 dxc6 Ne4 Ne6 d3 O-O',
      say: "Now the knight swings to e4 — a gorgeous central outpost Black can never kick with a pawn. You brace it with d3, absolutely solid, and Black castles. Your e5-pawn cramps them, the e4-knight eyes d6 and f6, and those doubled c-pawns have nothing — no counterplay at all to show for the bishop pair they won.",
    ...
    b({ id: 'ros5', moves: 'e4 c5 Nf3 Nc6 Bb5 g6 O-O Bg7 Re1 Nf6 e5 Nd5 Nc3 Nc7 Bxc6 dxc6 Ne4 Ne6 d3 O-O Be3 b6 Qd2 Nd4 Nxd4 cxd4',
      say: "Be3 develops with a purpose — it and the queen on d2 are lining up on the dark squares around Black's king. Black tries to break free with …Nd4; you simply trade it off, and after …cxd4 they're left with a weak, over-advanced d4-pawn that your pieces will swarm and pick off in the endgame.",
