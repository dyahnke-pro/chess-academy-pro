...
const ALAPIN: LessonScript = {
  ...
  beats: [
    b({ id: 'd5', moves: 'e4 c5 c3 d5', arrows: [A('d5', 'e4')], highlights: [H('d5')], say: "Against the Alapin's c3, this repertoire hits the centre at once with d5 — the most principled antidote. White's c3 blocks his own knight from c3, so Black gets free, equal development by challenging the e4-pawn immediately. No passivity allowed.", sayShort: 'd5 — challenge the centre.' }),
