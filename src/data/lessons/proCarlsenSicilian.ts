...
export const PRO_CARLSEN_SICILIAN_LESSON: LessonScript = {
  ...
  title: "This repertoire's Sicilian — the Najdorf Main Line",
  minutes: 12,
  orientation: 'black',
  kind: 'variation',
  sources: SRC,
  beats: [
    b({ id: 'najdorf', moves: 'e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 a6', highlights: [H('a6'), H('c5')], say: "The Sicilian is Black's most ambitious answer to e4 — they unbalance the game from move one and plays for a win, not a draw. The Najdorf's a6 is the most famous move in the opening: prophylaxis and preparation in one, ruling out b5 ideas and readying Black's own queenside counterplay.", sayShort: 'a6 — the Najdorf, play to win.' }),
    b({ id: 'bg5', moves: 'e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 a6 Bg5', arrows: [A('g5', 'f6')], highlights: [H('g5')], say: "White chooses the sharpest weapon — Bg5, pinning the f6-knight and threatening to wreck Black's kingside. This is the Main Line, a tabiya soaked in theory and danger. This repertoire welcomes it: the more concrete the position, the more his calculation tells.", sayShort: 'vs Bg5 — the sharpest Najdorf.' }),
    ...
    b({ id: 'qc7', moves: 'e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 a6 Bg5 e6 f4 Qc7', arrows: [A('c7', 'c3')], highlights: [H('c7')], say: "Qc7 is the modern, flexible choice — the queen eyes the c-file and the e5-square, supporting Black's counterplay against White's centre. Black keeps every option open: castle either side, push the queenside pawns, or strike in the centre. Maximum flexibility, classic this repertoire.", sayShort: 'Qc7 — flexible, eye the centre.' }),
...
const ROSSOLIMO: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'qc7', moves: 'e4 c5 Nf3 Nc6 Bb5 g6 O-O Bg7 Re1 e5 Bxc6 dxc6 d3 Qc7', highlights: [H('c7'), H('e5')], say: "After d3, Black completes with Qc7, defending e5 and preparing to develop and castle. This is a fully sound, equal middlegame where Black's bishop pair gives genuine winning chances — exactly the kind of rich, balanced fight this repertoire outplays people in.", sayShort: 'Qc7 — solid, two-bishop chances.' }),
  ],
};
...
const TAIMANOV: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'be7', moves: 'e4 c5 Nf3 e6 d4 cxd4 Nxd4 a6 Nc3 Qc7 Bd3 Nf6 O-O', highlights: [H('f6')], say: "Black develops calmly — ...Nf6 and the pieces follow. The Taimanov gives Black a hugely sound, flexible game where one inaccuracy by White can be punished by the ...b5-b4 advance. This repertoire loves these slow Sicilians where understanding beats memorisation.", sayShort: 'Nf6 — sound, spring-loaded.' }),
  ],
};
...
const OPEN_NC6: LessonScript = {
  ...
  beats: [
    b({ id: 'e5', moves: 'e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 Nf6 Nc3 e5', arrows: [A('e5', 'd4')], highlights: [H('e5')], say: "The Sveshnikov-flavoured e5 — Black strikes at the centre immediately, kicking the d4-knight and seizing space. It concedes the d5-square but grabs the initiative and active piece play. This is one of the most respected lines at the very top, and a this repertoire World-Championship weapon.", sayShort: 'e5 — strike the centre.' }),
...
const ALAPIN: LessonScript = {
  ...
  beats: [
    b({ id: 'd5', moves: 'e4 c5 c3 d5', arrows: [A('d5', 'e4')], highlights: [H('d5')], say: "Against the Alapin's c3, this repertoire hits the centre at once with d5 — the most principled antidote. White's c3 blocks their own knight from c3, so Black gets free, equal development by challenging the e4-pawn immediately. No passivity allowed.", sayShort: 'd5 — challenge the centre.' }),
    ...
    b({ id: 'nc6', moves: 'e4 c5 c3 d5 exd5 Qxd5 d4 Nf6 Nf3 Bg4 Be2 e6 O-O Nc6', highlights: [H('c6'), H('c5')], say: "Black completes development with ...e6 and ...Nc6, piling pressure on White's d4-pawn. The position is a comfortable IQP-style fight where Black is fully equal and can even play for more. The Alapin promises White nothing against precise play — and this repertoire is always precise.", sayShort: 'Nc6 — pressure d4, fully equal.' }),
  ],
};
...
const SMITH_MORRA: LessonScript = {
  ...
  beats: [
    b({ id: 'accept', moves: 'e4 c5 d4 cxd4 c3 dxc3 Nxc3', highlights: [H('c3')], say: "The Smith-Morra Gambit — White sacrifices a pawn for fast development and open lines. This repertoire's approach is the calm, classical one: accept the pawn, then give it back at the right moment to defuse the attack and emerge a clean tempo or a healthy structure ahead.", sayShort: 'Accept — then give it back safely.' }),
    ...
    b({ id: 'develop', moves: 'e4 c5 d4 cxd4 c3 dxc3 Nxc3 Nc6 Nf3 e6 Bc4 a6 O-O Nge7', highlights: [H('e7')], say: "The clever ...Nge7 keeps the knight off f6, where White's pieces would pressure it, and prepares ...Ng6 and a smooth completion of development. Black is simply up a pawn with a sound position. Against accurate defence, the Smith-Morra is just a pawn down — and this repertoire defends accurately.", sayShort: 'Nge7 — a clean extra pawn.' }),
  ],
};
