  ...
  "birds-opening::Bird's: Leningrad Formation": {
    ...
    beats: [
      ...
      },
      {
        ...
        say: "Black expands with b5; White completes their harmonious set-up with Be3, eyeing the c5-pawn and the dark squares, while the queen and rooks await the central break. The Leningrad Bird is the positional face of the opening — no early attack, just a sound, flexible structure where White's fianchettoed bishop and central control give them a comfortable, easy-to-play game.",
    ...
    beats: [
      {
        ...
        say: "From's Gambit is Black's sharpest try against the Bird: 1...e5, throwing a pawn at f4 to rip open lines toward White's king before they are developed. White ACCEPTS — fxe5 — and after exd6 Bxd6 Black has the bishop pointed menacingly at h2. The whole line is a test of nerve: hold the extra pawn, weather the attack, and win the endgame.",
      ...
      },
      {
        ...
        say: "Black trades queens with Qxd1+ — but that is exactly what White wants. After Kxd1 there is no attack left without queens, and White simply remains a clean pawn up with the extra e5-pawn and the better structure. They finish developing with Bf4 and Nc3; Black checks with O-O-O+ but it is harmless. The lesson of From's Gambit is calm: accept the pawn, trade the attackers, reach the endgame, and convert the extra material.",
    ...
    beats: [
      {
        ...
        say: "The Stonewall Bird builds a wall of pawns on d4, e3 and f4 — rigid, but it grips e5 with iron and clamps the centre shut. The bishop comes to d3, pointing down the b1-h7 diagonal toward Black's king. White's structure tells them exactly what to do: occupy e5, attack the kingside.",
    ...
    beats: [
      {
        ...
        say: "In the Williams, Black hurries their light bishop out to f5 before locking it in behind ...e6 — sensible development against a b3 Bird. White continues with the b2-bishop on the long diagonal and the f4-grip on e5. The position is quiet and manoeuvring; White's edge is small but real, built on the e5-square and the harmonious piece placement.",
