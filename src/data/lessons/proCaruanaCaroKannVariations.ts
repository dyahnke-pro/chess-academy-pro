...
const ADVANCE: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'castled', moves: 'e4 c6 d4 d5 e5 Bf5 Nf3 e6 Be2 c5 Be3 Qb6 Nc3 Nc6 O-O', say: "White castles. Black already has the freed light bishop on f5 — the piece buried in the French — a solid e6-wall, and active pressure on the d4-base with the queen on b6 and the knight on c6. The Caro's bishop problem is solved; Black has a comfortable, sound Advance.", sayShort: 'Bishop free, pressure on d4.', arrows: [A('c6', 'd4')], highlights: [H('c5')] }),
  ],
};
