...
const AUSTRIAN: LessonScript = {
  ...
  beats: [
    b({ id: 'a1', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4',
      ...
      sayShort: "f4 — the Austrian's huge centre: ram or target.",
      highlights: [H('f4', KEY), H('e4', KEY), H('d4', KEY)] }),
    b({ id: 'a2', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 O-O Bd3 Na6',
      say: "Black develops unhurried — Bg7, castle — and then the quiet star move: Na6. It looks offside, and that's the point: the knight is waiting for the position to tell it where it belongs, and in this line its dream square is c5. One more thing to register before anything happens: White's bishop went to d3. That bishop is the engine of the whole Austrian attack — every kingside idea White has runs through it. Remember that.",
      sayShort: "Calm dev, then …Na6 — waiting for c5.",
      highlights: [H('a6', KEY), H('d3', SOFT), H('c5', SOFT)] }),
    b({ id: 'a3', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 O-O Bd3 Na6 O-O c5',
      ...
      sayShort: "…c5 — hits the centre's base, the standard plan.",
      highlights: [H('c5', ATK), H('d4', KEY)] }),
    b({ id: 'a4', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 O-O Bd3 Na6 O-O c5 d5 c4',
      say: "White declines the capture and clamps the centre shut with d5 — and now the move that separates the prepared from the hopeful: c4!, offering the pawn straight at that d3-bishop. Here's the logic: you cannot out-wait the Austrian. White's plan is a kingside avalanche, and every tempo you spend shuffling is a tempo it rolls closer. So you don't shuffle — you drag the attack's best piece off its diagonal and MAKE White answer you on the queenside instead.",
      sayShort: "…c4! — drag the bishop, buy the initiative.",
      highlights: [H('c4', KEY), H('d3', ATK)] }),
    b({ id: 'a5', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 O-O Bd3 Na6 O-O c5 d5 c4 Bxc4 b5 Nxb5 Nxe4 Qe1 Nac5',
      say: "The point unfolds by force: after Bxc4, b5! regains the tempo on the bishop's new home, and when the knight grabs the pawn, Nxe4 takes White's centre pawn right back. White's queen slides to e1 to win that knight — and the offside a6-knight answers by landing on c5, its dream square, defending its partner on e4. Count what changed: the attacking bishop is off its diagonal, the e4-ram is gone, and both Black knights stand in the centre of the board. Be clear-eyed about the verdict: the engine still prefers White by well under a pawn, so this is a sharp practical fight, not equality — for a sound, comfortable Pirc, prefer the Classical System. But the days of Black getting rolled in this line are over: you traded a wing pawn for White's whole attacking setup.",
      sayShort: "…b5, …Nxe4, …Nac5 — the attack is defused.",
      arrows: [{ from: 'c5', to: 'e4', color: ATK }],
      highlights: [H('c5', KEY), H('e4', SOFT)] }),
  ],
};
...
const CLASSICAL: LessonScript = {
  ...
  beats: [
    b({ id: 'c1', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O',
      say: "The Classical System: White develops naturally with Nf3 and the modest Be2, with no early pawn storm. This is the solid, principled main line — White simply finishes development and keeps the centre. Black is comfortable here, the Bg7 on its long diagonal and the king castled behind it.",
      sayShort: "Nf3, Be2 — White's calm, no-storm main line.",
    ...
    b({ id: 'c2', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O O-O c6 a4 Nbd7',
      ...
      sayShort: "…c6, …Nbd7 — readying the …e5 break.",
    ...
    b({ id: 'c4', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O O-O c6 a4 Nbd7 h3 e5 dxe5 dxe5 Be3 Qe7',
      say: "White releases with dxe5 dxe5, the d-file opens up to d8, and Black holds a solid pawn on e5. The queen steps to e7 — connecting the rooks, guarding e5, and eyeing the open file. The position is symmetrical in spirit and dead equal; Black has solved every opening problem.",
      sayShort: "…dxe5, …Qe7 — opens d-file, backs e5; equal.",
    ...
    b({ id: 'c5', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O O-O c6 a4 Nbd7 h3 e5 dxe5 dxe5 Be3 Qe7 Qd3 Nh5',
      ...
      sayShort: "…Nh5 — eyes the f4 outpost; easy equality.",
...
const BYRNE: LessonScript = {
  ...
  beats: [
    b({ id: 'y1', moves: 'e4 d6 d4 Nf6 Nc3 g6 Bg5',
      ...
      sayShort: "Bg5 — the Byrne: opposite castling, pawn-storm race.",
    ...
    b({ id: 'y2', moves: 'e4 d6 d4 Nf6 Nc3 g6 Bg5 Bg7 Qd2 O-O O-O-O c6',
      ...
      sayShort: "White castles long; …c6 begins the b5-b4 storm.",
    ...
    b({ id: 'y3', moves: 'e4 d6 d4 Nf6 Nc3 g6 Bg5 Bg7 Qd2 O-O O-O-O c6 f4 b5 e5 b4',
      ...
      sayShort: "f4-e5 vs …b5-b4 — both storms crash in.",
    ...
    b({ id: 'y4', moves: 'e4 d6 d4 Nf6 Nc3 g6 Bg5 Bg7 Qd2 O-O O-O-O c6 f4 b5 e5 b4 exf6 bxc3 Qxc3 exf6',
      ...
      sayShort: "Knights off, White's king cover cracked — wild.",
    ...
    b({ id: 'y5', moves: 'e4 d6 d4 Nf6 Nc3 g6 Bg5 Bg7 Qd2 O-O O-O-O c6 f4 b5 e5 b4 exf6 bxc3 Qxc3 exf6 Bh4 d5',
      ...
      sayShort: "…d5 — rips the centre toward White's king.",
...
const LION: LessonScript = {
  ...
  beats: [
    b({ id: 'l1', moves: 'e4 d6 d4 Nf6 Nc3 e5',
      ...
      sayShort: "…e5 — the Lion, a solid Philidor-like setup.",
    ...
    b({ id: 'l2', moves: 'e4 d6 d4 Nf6 Nc3 e5 Nf3 Nbd7 Bc4 Be7 O-O O-O',
      ...
      sayShort: "…Nbd7, …Be7, castle — the flexible Lion.",
    ...
    b({ id: 'l3', moves: 'e4 d6 d4 Nf6 Nc3 e5 Nf3 Nbd7 Bc4 Be7 O-O O-O a4 c6 Re1 Qc7 h3 b6',
      ...
      sayShort: "…c6, …b6, …Qc7 — coiling for expansion.",
    ...
    b({ id: 'l4', moves: 'e4 d6 d4 Nf6 Nc3 e5 Nf3 Nbd7 Bc4 Be7 O-O O-O a4 c6 Re1 Qc7 h3 b6 Bg5 Bb7 dxe5 Nxe5',
      ...
      sayShort: "…Bb7, …Nxe5 — comfortable and active.",
...
const FIANCHETTO: LessonScript = {
  ...
  beats: [
    b({ id: 'f1', moves: 'e4 d6 d4 Nf6 Nc3 g6 g3 Bg7 Bg2 O-O',
      say: "White meets the Pirc with a fianchetto of their own — g3 and Bg2 — the quietest, most positional try. With no pawn storm coming, Black is free to play for the centre and for space. Two bishops staring down two long diagonals — White's Bg2 and Black's Bg7 mirror each other: this will be a slow, strategic battle.",
      sayShort: "g3, Bg2 — White's fianchetto, mirrored by …Bg7.",
    ...
    b({ id: 'f2', moves: 'e4 d6 d4 Nf6 Nc3 g6 g3 Bg7 Bg2 O-O Nge2 e5 O-O Nc6 d5 Ne7',
      ...
      sayShort: "…e5, …Nc6 hit d4; then …Ne7 toward f5.",
    ...
    b({ id: 'f3', moves: 'e4 d6 d4 Nf6 Nc3 g6 g3 Bg7 Bg2 O-O Nge2 e5 O-O Nc6 d5 Ne7 a4 Nd7 Be3 f5',
      say: "With the centre bolted shut by d5, Black knows exactly where to play: the kingside. The break is f5, gaining space and prying open lines for the g7-bishop and the rooks on the f-file — while Black's e5-pawn anchors the entire structure. The knights reroute behind it — one toward f5, the other supporting from d7. In a locked Fianchetto position this thrust is Black's whole plan, and it gives fully equal, double-edged play.",
      sayShort: "…f5 — the kingside break behind e5.",
...
const CZECH: LessonScript = {
  ...
  beats: [
    b({ id: 'z1', moves: 'e4 d6 d4 Nf6 Nc3 c6',
      ...
      sayShort: "…c6 — the Czech: compact, aiming for …e5.",
      highlights: [H('c6', KEY)] }),
    b({ id: 'z2', moves: 'e4 d6 d4 Nf6 Nc3 c6 f4 Qa5',
      ...
      sayShort: "…Qa5 — pins c3, freezes the centre, preps …e5.",
...
const AUSTRIAN_E5C5: LessonScript = {
  ...
  beats: [
    b({ id: 'e1', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 O-O e5',
      ...
      sayShort: "An early e5 hits f6 — frightening, but answerable.",
    ...
    b({ id: 'e2', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 O-O e5 Nfd7',
      ...
      highlights: [H('d7', KEY), H('e5', SOFT)] }),
    b({ id: 'e3', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 O-O e5 Nfd7 Be2 c5 exd6 exd6 O-O Nc6 Be3 Nf6',
      ...
      sayShort: "…c5 — hits the chain's base; the centre wobbles.",
      highlights: [H('c5', ATK), H('d4', KEY)] }),
  ],
};
