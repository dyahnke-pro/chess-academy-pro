...
export const PRO_CARLSEN_KID_LESSON: LessonScript = {
  ...
  title: "Carlsen's King's Indian — the Mar del Plata Race",
  minutes: 11,
  orientation: 'black',
  kind: 'variation',
  sources: SRC,
...
const GRUNFELD: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'c5', moves: 'd4 Nf6 c4 g6 Nc3 d5 cxd5 Nxd5 e4 Nxc3 bxc3 Bg7 Bc4 c5 Ne2 Nc6 Be3 O-O', arrows: [A('c5', 'd4')], highlights: [H('c5')], say: "Black strikes with ...c5, the thematic Grünfeld lever, hammering at the base of White's centre, then develops and castles. The d4-pawn becomes the target of Black's whole army. If White can't hold and use his centre, it falls and Black stands better — and Carlsen excels at proving exactly that.", sayShort: 'c5 — hammer the centre\'s base.' }),
  ],
};
