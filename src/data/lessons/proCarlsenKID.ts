...
export const PRO_CARLSEN_KID_LESSON: LessonScript = {
  ...
  sources: SRC,
  beats: [
    b({ id: 'setup', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6', arrows: [A('g7', 'a1')], highlights: [H('g7'), H('d6')], say: "The King's Indian — Black's most aggressive answer to d4. Black deliberately lets White build a big pawn centre, then fianchettoes the bishop on g7 to snipe at it from the long diagonal. The plan is bold: invite the centre forward, then blow it up with ...e5 and a kingside storm.", sayShort: 'Bg7 — cede the centre, then strike.' }),
    b({ id: 'e5', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 Be2 O-O Nf3 e5', arrows: [A('e5', 'd4')], highlights: [H('e5')], say: "Black castles and strikes with ...e5 — the soul of the King's Indian. They challenge White's centre directly. White can trade, hold the tension, or push past with d5; each choice leads to a completely different battle, and Black is booked and dangerous in all of them.", sayShort: 'e5 — the King\'s Indian strike.' }),
    b({ id: 'd5', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 Be2 O-O Nf3 e5 O-O Nc6 d5', highlights: [H('d5'), H('e5')], say: "White plays d5, locking the centre and gaining queenside space — the Mar del Plata main line. Now the famous race is on: White attacks on the queenside where their space is, Black storms the kingside toward White's king. Whoever's attack lands first wins. Pure, thrilling chess.", sayShort: 'd5 — the locked-centre race begins.' }),
...
const FIANCHETTO: LessonScript = {
  ...
  beats: [
    b({ id: 'g3', moves: 'd4 Nf6 c4 g6 g3 Bg7 Bg2 O-O Nc3 d6', highlights: [H('d6')], say: "The Fianchetto Variation is White's most solid anti-King's-Indian: they fianchetto too, blunting Black's g7-bishop along the long diagonal. Black doesn't panic — they set up the same ...d6 and ...e5 structure and looks for a slower, more positional version of their usual plans.", sayShort: 'd6 — meet the calm fianchetto.' }),
...
const GRUNFELD: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'c5', moves: 'd4 Nf6 c4 g6 Nc3 d5 cxd5 Nxd5 e4 Nxc3 bxc3 Bg7 Bc4 c5 Ne2 Nc6 Be3 O-O', arrows: [A('c5', 'd4')], highlights: [H('c5')], say: "Black strikes with ...c5, the thematic Grünfeld lever, hammering at the base of White's centre, then develops and castles. The d4-pawn becomes the target of Black's whole army. If White can't hold and use their centre, it falls and Black stands better — and this repertoire excels at proving exactly that.", sayShort: 'c5 — hammer the centre\'s base.' }),
  ],
};
