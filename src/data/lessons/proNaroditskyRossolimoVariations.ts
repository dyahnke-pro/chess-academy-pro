...
const NC6_ROSSOLIMO: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "After …Nc6, you play Bb5 — the Rossolimo proper. The bishop pins the knight against the e5-square (where Black would want to push the e-pawn), and immediately sidesteps every Open Sicilian theory book Black has prepared.",
      sayShort: 'Bb5 — Rossolimo pin.',
    }),
    b({
      id: 'nc6-e6', moves: 'e4 c5 Nf3 Nc6 Bb5 e6 O-O',
      highlights: [{ square: 'e6', color: KEY }, { square: 'g1', color: SOFT }],
      say: "…e6 prepares …Nge7 and …d5, the standard Black setup. You castle and develop classically. The position is still anti-Sicilian — no d4 from you, just system development matching whatever Black does.",
    ...
    b({
      ...
      say: "…Nge7 develops the second knight to its KIA-like square. You play Re1 — supporting e4 AND preparing the f1-bishop's later return. This is the Rossolimo's signature move: the rook lift comes BEFORE pawn moves.",
      sayShort: 'Re1 — support e4.',
    }),
    b({
      id: 'nc6-bf1', moves: 'e4 c5 Nf3 Nc6 Bb5 e6 O-O Nge7 Re1 a6 Bf1',
      highlights: [{ square: 'f1', color: KEY }],
      say: "Black plays …a6 chasing the bishop, and you retreat Bf1! The bishop's signature route: Bb5 → Bf1 (and later Bd3 or Be2 depending on setup). The bishop is back home but has cost Black a tempo.",
    ...
    b({
      ...
      say: "exd5 Nxd5 d3 — central trade simplifies, then d3 supports your setup AND prepares c4 or Nbd2-e4 later. The Maroczy-style structure favours you: better piece coordination, easier development, knowledge of every middlegame pattern.",
...
// Black plays 2...e6 trying to transpose. You play d4 — Open Sicilian
// Taimanov, where you're well-prepared.
// ============================================================
const E6_TAIMANOV: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "…e6 — Black tries to transpose to a Kan or Taimanov. You play d4! Against this move order, the Open Sicilian is the right answer. You're well-prepared in Taimanov structures and Black gets a real fight instead of the easy Rossolimo trade.",
    ...
    b({
      ...
      say: "…Nf6 develops, you castle. The Taimanov has reached its mainline position. From here Black has options (…Qc7, …Bc5, …d6) and each leads to a different known structure.",
    ...
    b({
      ...
      say: "Black plays …Qc7 (the most common move), you answer with c4! The c-pawn push grabs space, locks the queenside, and prepares the Maroczy Bind. The Taimanov has resolved into a structure favoring your central control.",
...
// Black plays the easy ...Bd7 trade after Bb5+. You trade immediately,
...
const BD7_TRADE: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "After Bb5+, Black plays …Bd7 — the easy trade. Black's idea: simplify, develop, and play a normal Sicilian. The problem is you don't agree to play a normal Sicilian — you take the trade and convert the bishop pair edge.",
      sayShort: '…Bd7 — easy trade.',
    }),
    b({
      id: 'bd7-trade', moves: 'e4 c5 Nf3 d6 Bb5+ Bd7 Bxd7+ Qxd7',
      highlights: [{ square: 'd7', color: KEY }],
      say: "Bxd7+ Qxd7 — bishops trade. Black's queen ends up on d7 (forced — the alternative …Nxd7 is too passive). You've simplified AND won the bishop pair. The middlegame plan is straightforward: castle, develop, convert structurally.",
    ...
    b({
      ...
      say: "O-O …Nf6 Re1 — both kings safe, you lift the rook to e1 supporting e4. Standard Rossolimo development. The bishop pair you kept on the board is the structural edge that compounds for the rest of the game.",
    ...
    b({
      ...
      say: "…Nc6 c4 — Black develops the second knight, you push c4 setting up the Maroczy Bind structure. From here White's setup is: c4 + Nc3 + d3 (or d4) + bishop on the long diagonal eventually.",
      sayShort: 'c4 — Maroczy bind.',
    }),
    b({
      ...
      say: "…g6 Nc3 — Black fianchettos for safety, you develop the queen knight. The position is now a closed Maroczy where Black's only plan is …Bg7 + …O-O and waiting. You have the active plan.",
      sayShort: 'Nc3 — develop.',
    }),
    b({
      id: 'bd7-convert', moves: 'e4 c5 Nf3 d6 Bb5+ Bd7 Bxd7+ Qxd7 O-O Nf6 Re1 Nc6 c4 g6 Nc3 Bg7 d3',
      highlights: [{ square: 'd3', color: KEY }],
      say: "…Bg7 d3 — Black completes the fianchetto, you play d3 to keep the structure flexible. The middlegame plan from here is Nd5 outpost ideas + queenside expansion with a4 + slow conversion of the bishop pair.",
...
// Instead of Bb5+ you play c3 quietly, transposing into a Maroczy-
...
const C3_SIDELINE: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "c3 — instead of the Bb5+ Moscow line, you play the quiet c3 sideline preparing d4. This is the Alapin-style structure where you accept slower piece play in exchange for a small structural edge.",
      sayShort: 'c3 — quiet setup.',
    }),
    b({
      id: 'c3-nf6', moves: 'e4 c5 Nf3 d6 c3 Nf6 Bd3',
      highlights: [{ square: 'd3', color: SOFT }],
      say: "...Nf6 Bd3 — Black develops the knight, you play Bd3 covering the kingside attack diagonal. The Bd3 supports e4 AND prepares a future kingside expansion.",
      sayShort: 'Bd3 — kingside attacker.',
    }),
    b({
      id: 'c3-nc6', moves: 'e4 c5 Nf3 d6 c3 Nf6 Bd3 Nc6 Bc2',
      highlights: [{ square: 'c2', color: KEY }],
      say: "...Nc6 Bc2 — Black develops the queen knight, you retreat the bishop to c2 — the classical Spanish bishop dance. The Bc2 keeps the diagonal pointing at h7 AND avoids being exchanged.",
      sayShort: 'Bc2 — Spanish dance.',
    }),
    b({
      id: 'c3-bg4', moves: 'e4 c5 Nf3 d6 c3 Nf6 Bd3 Nc6 Bc2 Bg4 d3',
      highlights: [{ square: 'd3', color: SOFT }],
      say: "...Bg4 d3 — Black tries the pin on your knight, you play d3 supporting the centre. The position now resembles a Closed Spanish with one extra tempo for you.",
    ...
    b({
      ...
      say: "Nbd2 ...O-O Re1 — White develops the queen knight to d2 (preparing Nf1-Ng3 reroute), Black castles, you lift the rook to e1. The middlegame structure is now defined: White's kingside attack plan vs Black's queenside ...b5 expansion. Closed Spanish-style squeeze.",
...
const BC4_VS_D6: LessonScript = {
  ...
  beats: [
    b({
      ...
      highlights: [{ square: 'c4', color: KEY }],
      say: "Bc4 — instead of Bb5+ checking, you play the Italian-style Bc4 aiming directly at f7. The bishop on c4 is more aggressive than Bb5+ but slower; Black gets time to develop AND you avoid the early trade.",
      sayShort: 'Bc4 — Italian setup.',
    }),
    b({
      id: 'bc4-nf6', moves: 'e4 c5 Nf3 d6 Bc4 Nf6 d3',
      highlights: [{ square: 'd3', color: SOFT }],
      say: "...Nf6 d3 — Black develops, you play d3 keeping the centre solid. The d3 also prepares Nbd2 + e4 expansion later.",
      sayShort: 'd3 — solid setup.',
    }),
    b({
      id: 'bc4-nc6', moves: 'e4 c5 Nf3 d6 Bc4 Nf6 d3 Nc6 c3',
      highlights: [{ square: 'c3', color: KEY }],
      say: "...Nc6 c3 — both develop, you play c3 preparing d4 expansion. The setup looks like an Italian Game but with c5 instead of e5 by Black — slightly worse structure for Black.",
      sayShort: 'c3 — prep d4.',
    }),
    b({
      id: 'bc4-bb3', moves: 'e4 c5 Nf3 d6 Bc4 Nf6 d3 Nc6 c3 e6 Bb3',
      highlights: [{ square: 'b3', color: KEY }],
      say: "...e6 Bb3 — Black plays the French-like ...e6, you retreat the bishop to b3 keeping the diagonal alive. The Bb3 also avoids the future ...Bxc4 trade.",
    ...
    b({
      ...
      say: "Re1 ...b5 Nbd2 — White's rook supports the central squares, Black plays the queenside expansion ...b5, you develop the queen knight to d2 (ready for the Nf1-Ng3 reroute). Standard Italian-Spanish middlegame: White's kingside attack vs Black's queenside push.",
...
// Black plays Dragon-style ...g6 early. You answer with c3 + d4
...
const VS_G6_DRAGON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "...g6 — Black plays Dragon-style fianchetto early. You answer with c3 preparing d4 — this is the Smith-Morra-style setup against the Hyper-Accelerated Dragon.",
      sayShort: 'c3 — vs Hyper Dragon.',
    }),
    b({
      id: 'g6-d5', moves: 'e4 c5 Nf3 g6 c3 d5',
      highlights: [{ square: 'd5', color: KEY }],
      say: "...d5 — Black challenges the centre. The d5 is the principled reply preventing your d4 expansion.",
      sayShort: '...d5 — central try.',
    }),
    b({
      id: 'g6-exd5', moves: 'e4 c5 Nf3 g6 c3 d5 exd5 Qxd5',
      highlights: [{ square: 'd5', color: ATK }],
      say: "exd5 ...Qxd5 — central trades, Black recaptures with the queen. The queen on d5 is centralised but exposed — you now play d4 with tempo.",
    ...
    b({
      ...
      say: "...Bg7 — Black completes the Dragon fianchetto. The position is now a Maroczy Bind with one extra tempo for you.",
    ...
    b({
      ...
      say: "Nbd2 ...Nf6 dxc5 — you develop the queen knight to d2 (the c3-pawn blocks Nc3), Black develops the king knight, you trade off the c-pawn opening the centre.",
