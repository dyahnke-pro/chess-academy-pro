...
export const VIENNA_GAMBIT_VARIATION_LESSONS: Record<string, LessonScript> = {
  'vienna-gambit::Gambit Accepted (…exf4)': {
    ...
    beats: [
      ...
      b({ id: 'a2', moves: 'e4 e5 Nc3 Nf6 f4 exf4 e5 Ng8', say: "e5! is the refutation — the pawn slams forward and the f6-knight has nowhere to go but all the way back to g8. Black has spent two moves to win a pawn and undeveloped their only piece.", sayShort: 'e5 — kick the knight back to g8.', highlights: [H('e5'), H('g8')] }),
