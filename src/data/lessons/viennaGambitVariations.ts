...
export const VIENNA_GAMBIT_VARIATION_LESSONS: Record<string, LessonScript> = {
  'vienna-gambit::Gambit Accepted (…exf4)': {
    ...
    beats: [
      ...
      b({ id: 'a2', moves: 'e4 e5 Nc3 Nf6 f4 exf4 e5 Ng8', say: "e5! is the refutation — the pawn slams forward and the f6-knight has nowhere to go but all the way back to g8. Black has spent two moves to win a pawn and undeveloped his only piece.", sayShort: 'e5 — kick the knight back to g8.', arrows: [A('e5', 'f6')], highlights: [H('e5'), H('g8')] }),
  ...
  'vienna-gambit::Qf3 Setup (vs …d5)': {
    ...
    beats: [
      ...
      b({ id: 'q2', moves: 'e4 e5 Nc3 Nf6 f4 d5 fxe5 Nxe4 Qf3 Nxc3 dxc3', say: "…Nxc3 dxc3 — Black trades the knight, but White recaptures toward the centre, opening the d-file for the rook and keeping the e5-pawn as a cramping wedge.", sayShort: 'dxc3 — open the d-file, keep e5.', highlights: [H('e5'), H('d1')] }),
      b({ id: 'q3', moves: 'e4 e5 Nc3 Nf6 f4 d5 fxe5 Nxe4 Qf3 Nxc3 dxc3 Be6 Bf4 Be7 O-O-O', say: "Bf4 supports the e5-pawn, and O-O-O! — the queenside-castling race again. White's rook hits the open d-file and the kingside pawns are ready to storm.", sayShort: 'O-O-O — castle into the attack.', highlights: [H('c1'), H('e5')] }),
      b({ id: 'q4', moves: 'e4 e5 Nc3 Nf6 f4 d5 fxe5 Nxe4 Qf3 Nxc3 dxc3 Be6 Bf4 Be7 O-O-O c6 Qg3 g6 Nf3 Qa5', say: "Qg3 swings the queen toward the kingside, Nf3 develops, and the engine likes White — the e5-wedge, the open d-file, and the attacking chances outweigh the gambit pawn. A pleasant, aggressive edge.", sayShort: 'Qg3 — swing the queen kingside.', highlights: [H('e5'), H('c1')] }),
    ],
  },
};
