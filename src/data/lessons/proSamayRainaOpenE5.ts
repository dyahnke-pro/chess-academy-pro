...
export const PRO_SAMAYRAINA_OPEN_E5_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'pianissimo', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d3',
      ...
      say: "You develop Nf6, hitting e4, and after c3 and d3 the game settles into a Giuoco Pianissimo — the slow maneuvering struggle where understanding beats memorisation and Black is never worse.",
    ...
    b({ id: 'ba7', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d3 d6 O-O O-O Re1 a6 a4 Ba7',
      ...
      say: "You castle and tuck the bishop to a7 — keeping the powerful a7-g1 diagonal while sidestepping b4 ideas. The position is symmetrical and rich; Black has every resource White does.",
