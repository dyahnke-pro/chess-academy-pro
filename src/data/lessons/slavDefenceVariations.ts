...
export const SLAV_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'slav-defence::Quiet Variation (4.e3)': {
    ...
    beats: [
      ...
      b({ id: 'q3', moves: 'd4 d5 c4 c6 Nf3 Nf6 e3 Bf5 Nc3 e6 Nh4 Bg6 Nxg6 hxg6', say: "Nxg6 hxg6 — now count what each side bought. White owns the bishop pair. Black owns a half-open h-file — the rook on h8 already works — a recapture toward the centre, and a structure without a single weakness. Two tempi plus the file for the bishops: many strong players prefer Black's side of that trade.", sayShort: 'hxg6 — the h-file for the bishops.', highlights: [H('h8', SOFT), H('g6')] }),
      b({ id: 'q4', moves: 'd4 d5 c4 c6 Nf3 Nf6 e3 Bf5 Nc3 e6 Nh4 Bg6 Nxg6 hxg6 Bd3 Nbd7 O-O Bd6 h3 O-O Qc2 dxc4', say: "Both sides finish: …Bd6 takes the strong diagonal, …O-O tucks the king, and then …dxc4 — Black resolves the centre at the moment of their choosing, forcing the d3-bishop to spend a move recapturing. The engine calls it level, and Black's plans — …e5 or …c5 at the right moment, pressure down the h-file in any kingside race — are the easier ones to play. Quiet lines reward the player who knows what the structure wants.", sayShort: '…dxc4 — resolve on your own clock.', highlights: [H('c4'), H('e5', SOFT)] }),
    ],
  },

  "slav-defence::Winawer Countergambit (...e5!?)": {
    openingId: "slav-defence", title: "Slav — the Winawer Countergambit (…e5!?)", minutes: 9, orientation: "black",
    sources: ["concept:pos-initiative", "concept:pos-tempo", "https://en.wikipedia.org/wiki/Slav_Defense"],
    beats: [
      { id: "wc1", moves: ["d4", "d5", "c4", "c6", "Nc3", "e5"], say: "…e5!? — the Winawer Countergambit: instead of defending d5, Black counter-strikes in the centre on move three. It looks like a pawn sacrifice; in the main line it isn't one — the pawn comes straight back, and White has to know exactly how to keep the balance.", sayShort: "…e5 — strike, don't defend.", highlights: [{ square: "e5", color: "rgba(255,214,0,0.88)" }, { square: "d5", color: "rgba(80,140,255,0.32)" }] },
      { id: "wc2", moves: ["d4", "d5", "c4", "c6", "Nc3", "e5", "dxe5", "d4", "Ne4", "Qa5+"], say: "dxe5 …d4! — the point: the pawn lunges at the c3-knight, and after Ne4 comes …Qa5+!, the double-purpose check — it forces a block AND attacks the e5-pawn along the fifth rank at the same time. Every Black move so far has come with a threat attached.", sayShort: "…Qa5 — check, and e5 falls.", arrows: [{ from: "a5", to: "e5", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "e5", color: "rgba(255,214,0,0.88)" }, { square: "d4", color: "rgba(80,140,255,0.32)" }] },
      { id: "wc3", moves: ["d4", "d5", "c4", "c6", "Nc3", "e5", "dxe5", "d4", "Ne4", "Qa5+", "Bd2", "Qxe5", "Ng3", "Nf6", "Nf3", "Qd6"], say: "Bd2 blocks, …Qxe5 restores the material, and the queen dance begins: Ng3 tucks the knight, …Nf6 develops, and when Nf3 hits the queen she settles on d6 — done travelling, having carried the whole opening's initiative on her back. Material is level and Black's game plays naturally.", sayShort: "…Qd6 — material level, initiative spent well.", highlights: [{ square: "d6", color: "rgba(255,214,0,0.88)" }, { square: "e5", color: "rgba(80,140,255,0.32)" }] },
      { id: "wc4", moves: ["d4", "d5", "c4", "c6", "Nc3", "e5", "dxe5", "d4", "Ne4", "Qa5+", "Bd2", "Qxe5", "Ng3", "Nf6", "Nf3", "Qd6", "Qc2", "Be7", "O-O-O", "O-O", "e3", "dxe3", "fxe3", "Qc7"], say: "Qc2 and O-O-O — White commits their king to the queenside; …Be7 and …O-O answer on the other wing: opposite castling, mutual attacks coming. When e3 finally challenges the d4-wedge, …dxe3 fxe3 concedes the pawn but hands White a weakness on e3 to besiege, and …Qc7 takes the long dark diagonal, spearing the knight on g3 — while White's king on c1 braces for the …b5 pawn storm. The engine tilts it slightly to BLACK — the countergambit that never really gambled, and one of the most fun lines in the Slav player's bag.", sayShort: "…Qc7 — opposite wings, Black attacks first.", arrows: [{ from: "c7", to: "g3", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "e3", color: "rgba(255,214,0,0.88)" }, { square: "c1", color: "rgba(80,140,255,0.32)" }] },
    ],
  },
};
