...
export const QGD_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "qgd::Cambridge Springs": {
    openingId: "qgd", title: "QGD — the Cambridge Springs (the pin and the trap)", minutes: 9, orientation: "black",
    sources: ["concept:tac-pin", "concept:tac-trap", "https://en.wikipedia.org/wiki/Queen%27s_Gambit_Declined"],
    beats: [
      { id: "cs1", moves: ["d4", "d5", "c4", "e6", "Nc3", "Nf6", "Bg5", "Nbd7", "Nf3", "c6", "e3", "Qa5"], say: "…Qa5 — the Cambridge Springs. The queen pins the c3-knight against the king and loads three ideas at once: …Ne4 hitting the pinned piece, …Bb4 piling on, and …dxc4 undermining. From this exact move, White has to know their theory or lose material.", sayShort: "…Qa5 — pin the knight, load the tricks.", arrows: [{ from: "a5", to: "c3", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "c3", color: "rgba(255,214,0,0.88)" }] },
      { id: "cs2", moves: ["d4", "d5", "c4", "e6", "Nc3", "Nf6", "Bg5", "Nbd7", "Nf3", "c6", "e3", "Qa5", "Nd2", "Bb4", "Qc2", "O-O"], say: "Nd2 rushes back to hold c3 and cover e4; …Bb4 piles onto the pin anyway, and after Qc2, Black calmly castles. Notice the division of labour: every Black move develops with a threat, every White move defends something. That imbalance is the whole opening.", sayShort: "…Bb4 — pile on; castle while he defends.", arrows: [{ from: "b4", to: "c3", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "c3", color: "rgba(80,140,255,0.32)" }] },
      { id: "cs3", moves: ["d4", "d5", "c4", "e6", "Nc3", "Nf6", "Bg5", "Nbd7", "Nf3", "c6", "e3", "Qa5", "Nd2", "Bb4", "Qc2", "O-O", "Bd3", "dxc4"], say: "Bd3 looks completely natural — develop, prepare e4 — and …dxc4! springs the net. The bishop must recapture, because the d2-knight cannot leave: it is the only thing standing between the g5-bishop and Black's queen. Nxc4 even comes with tempo on her — which is precisely the bait.", sayShort: "…dxc4 — the net is set; only Bxc4 holds.", highlights: [{ square: "c4", color: "rgba(255,214,0,0.88)" }, { square: "g5", color: "rgba(80,140,255,0.32)" }] },
      { id: "cs4", moves: ["d4", "d5", "c4", "e6", "Nc3", "Nf6", "Bg5", "Nbd7", "Nf3", "c6", "e3", "Qa5", "Nd2", "Bb4", "Qc2", "O-O", "Bd3", "dxc4", "Nxc4", "Qxg5", "O-O", "Bxc3"], say: "Nxc4 — played in thousands of games — and …Qxg5 answers, collecting the bishop the knight abandoned. White castles to limit the damage and …Bxc3 even harvests the c3-knight; however White recaptures, Black is a clean piece up, +3.5 says the engine. Learn the mechanism, not the moves: in the Cambridge Springs the g5-bishop is always one careless knight-move from hanging, and …dxc4 is the trigger that makes White choose.", sayShort: "…Qxg5 — the trap closes; a piece up.", highlights: [{ square: "g5", color: "rgba(255,214,0,0.88)" }] },
    ],
  },
};
