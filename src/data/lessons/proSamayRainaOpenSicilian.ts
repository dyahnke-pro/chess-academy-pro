...
export const PRO_SAMAYRAINA_OPEN_SICILIAN_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "The Open Sicilian — the most principled, most ambitious answer to the Sicilian. You play Nf3 and then strike with d4, opening the centre. You refuse the quiet anti-Sicilians; you want the full theoretical main lines where White fights for a real edge. This is this repertoire's most-played opening by a mile.",
    ...
    b({
      ...
      say: "After cxd4 you recapture with the knight, reaching the classic Open Sicilian structure: a beautiful knight on d4, the e4-pawn, and rapid development. Nf6 hits e4 and you defend it naturally with Nc3. White has a lead in development and central space — the two assets the Open Sicilian is built on.",
    ...
    b({
      ...
      say: "Black plays the Najdorf with a6 — controlling b5 and preparing queenside expansion. Against it you choose the solid, classical Be2 setup rather than the razor-sharp Bg5 or Be3 lines: develop, castle, and play a long positional game where your space tells. Low theory, high reliability.",
    ...
    b({
      ...
      say: "Black grabs the centre with e5, kicking the knight, which retreats to b3. This is the great Najdorf trade-off: Black gets central space but concedes the d5-square permanently. Your whole plan now revolves around that hole — a knight will land on d5 and never be dislodged.",
    ...
    b({
      ...
      say: "Both sides castle and you develop the bishop to e3, eyeing the queenside and controlling d4. The position is a textbook Najdorf middlegame: White will play Nd5 or maneuver a knight there, push on the queenside with a4, and use the d5-outpost as the anchor of a lasting positional edge.",
