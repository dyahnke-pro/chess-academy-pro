...
// ── 5.Nc3 — White develops the knight; you trade into an open h-file ──
...
const FIVE_KNIGHTS: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Instead of d3, White develops the knight to c3. It is a sensible move, but it does nothing about your two open lines — the d-file and the c8-to-h3 diagonal. You carry on with the same plan: bishop to c5, then storm the kingside.",
    ...
    b({
      ...
      say: "Bishop to c5 aims at f2, and h5 again prepares the knight jump while opening the rook's file. White tucks the bishop on e2, but the h-pawn is already telling you where the game will be decided.",
    ...
    b({
      ...
      say: "Knight to g4, and this time White trades it off with Bxg4. You recapture with the h-pawn — and that is exactly what you wanted. The h-file is now wide open with your rook already sitting on it, and the pawn on g4 cramps White's kingside. The bishop trade did White no favours.",
    ...
    b({
      ...
      say: "White offers a bishop trade with Be3; you take it, and after fxe3 White's kingside pawns are a shattered mess on e3 and g3 with the king still in the middle. The queen comes to d6, ready to lift to the h-file or h2, and Black is doing all the attacking despite being a pawn down.",
...
const SPACE_GRAB: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "White plays the most ambitious move, e5, kicking your knight and grabbing space. But the pawn that advances is also a pawn that can be surrounded — and the square it leaves behind, e4, becomes a perfect home for your knight.",
    ...
    b({
      ...
      say: "The knight jumps into e4 — a dream outpost in the centre, where it cannot be hit by a pawn and eyes f2 and g3. From here it supports every kingside idea you have.",
    ...
    b({
      ...
      say: "White defends with Qf3, so you strike at the head of the advanced pawn with f6. The e5-pawn was White's pride; now it is a target, and prying it loose opens the f-file and the centre right next to White's stranded king.",
...
// ── 4.Nf3 retreat — the equalizing decline; you just regain the pawn ──
...
const KNIGHT_RETREAT: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Sometimes White takes on e5 and then, seeing the Stafford coming, simply retreats the knight to f3 rather than grabbing a second time on c6. This is the safe choice — and it lets you calmly take back the pawn.",
      sayShort: '…vs Nf3 — the safe retreat.',
    }),
    b({
      id: 'nxe4', moves: 'e4 e5 Nf3 Nf6 Nxe5 Nc6 Nf3 Nxe4',
      highlights: [{ square: 'e4', color: KEY }],
      say: "You recapture on e4. Material is level again, both sides have a knight in the centre, and you have the easy, harmonious development that the Petroff is famous for. No gambit, no risk — just a comfortable, equal game where your pieces come out naturally.",
    ...
    b({
      ...
      say: "When White challenges with Nc3, you support the strong knight with d5 — a wall of central pawns and a knight White cannot easily dislodge. This is textbook, solid, and exactly how to neutralise a White player who refuses the gambit.",
    ...
    b({
      ...
      say: "You pin with Bb4, both sides castle, and the position is dead level with chances for both. The lesson here is restraint: when White declines the gambit correctly, do not force the attack — just develop, equalise, and outplay them later. This repertoire beat a 2796 from exactly this calm structure.",
...
// Spine from his win vs wonderfultime (3165). White never takes on e5; you go
...
const FOUR_KNIGHTS: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "The cleanest way for White to dodge the gambit is to never take on e5 at all — Nc3, the Four Knights. You do not copy with the symmetric knight move; you play in Stafford spirit and develop the bishop straight toward f2. This is this repertoire's highest-scoring line of the whole complex.",
    ...
    b({
      ...
      say: "Bishop to c5 — pointed at f2, exactly as in the gambit. White mirrors with Bc4 aiming at your f7, and you shore it up with d6, opening a path for your own light bishop. The position is balanced and rich, an Italian-style middlegame where you know the f2 ideas and your opponent often does not.",
    ...
    b({
      ...
      say: "White plays the prophylactic h3 to deny your knight the g4-square, so you develop normally — knight to c6, a6 to keep the white bishop out of b5. Both sides are fully developed and the game is even; from here it is a fight, not a forced attack.",
    ...
    b({
      ...
      say: "When White offers the dark-squared bishops with Be3, you trade — and after fxe3 it is WHITE's pawns that end up doubled and weak on e3 and the kingside, while Black's structure stays clean. This repertoire ground this structure down against a 3165. The Four Knights is sound, equal, and his most reliable scorer.",
...
const PAWN_RETURNED: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Here White grabs on e5 but, instead of trading on c6, props the knight with d4. White is trying to keep the extra pawn and stay solid — but the knight on e5 is now loose, and you hit it at once.",
    ...
    b({
      ...
      highlights: [{ square: 'e4', color: KEY }],
      say: "You take the knight, White recaptures with the pawn, and then you snap up the e4-pawn with your own knight. Material is level, and your knight sits proudly in the centre on e4 — active, central, and impossible to chase with a pawn.",
    ...
    b({
      ...
      say: "White develops the bishop to d3 to challenge your knight, so the knight hops to c5, attacking it. Wherever White's bishop goes you are happy — you have equalised effortlessly and your pieces are the more active.",
