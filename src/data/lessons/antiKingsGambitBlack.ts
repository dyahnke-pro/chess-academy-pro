...
export const ANTI_KINGS_GAMBIT_BLACK_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'kgb1', moves: 'e4 e5 f4 exf4 Nf3 d5',
      say: "The King's Gambit offers a pawn to blow open the f-file and attack. It is a real, sound opening — not refuted — so the goal isn't to 'punish' it, it's to neutralise it cleanly. Rather than cling to the extra pawn and get mated, you hit back in the centre with d5, striking at e4 and opening lines for YOUR pieces. This is the Modern Defence: the simplest road to a safe, comfortable game.",
    ...
    b({ id: 'kgb4', moves: 'e4 e5 f4 exf4 Nf3 d5 exd5 Nf6 Bc4 Nxd5 O-O Be6 Qe2 Nc6 d4 Qd6 Nc3 O-O-O Nxd5 Bxd5 Bxd5 Qxd5',
      say: "You castle queenside — king safe, rooks connected — and the trades on d5 leave your queen centralised. Count it up: comfortably developed, safe king, and no weaknesses. Be honest about the verdict: with best play the King's Gambit is not busted, but you have taken all its fire away and reached an easy, pleasant game where only Black can really press. Exactly what a sound defence should deliver.",
