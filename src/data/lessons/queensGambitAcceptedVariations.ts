...
export const QGA_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'qga::Sadler Variation ...Bg4': {
    ...
    beats: [
      ...
      b({ id: 'd3', moves: 'd4 d5 c4 dxc4 Nf3 Nf6 e3 Bg4 Bxc4 e6 h3 Bh5 Nc3 Nbd7 g4 Bg6', say: "Nc3 and …Nbd7 develop; when White lunges g4 to trap the bishop, …Bg6 calmly steps to safety. White has gained space but loosened their own king — and that g4-pawn will be a target.", sayShort: '…Bg6 — retreat safely; g4 loosens White.', highlights: [H('g6'), H('g4', SOFT)] }),
