...
export const BENKO_GAMBIT_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'benko-gambit::King Walk Variation': {
    ...
    beats: [
      ...
      b({ id: 'kw2', moves: 'd4 Nf6 c4 c5 d5 b5 cxb5 a6 bxa6 Bxa6 Nc3 d6 e4 Bxf1 Kxf1 g6 Nf3 Bg7 g3 O-O Kg2', say: "Black plays …g6, …Bg7 and …O-O while White's king finishes its awkward trek to g2. Don't think of that g7-bishop as merely 'raking a diagonal' — it is the SOUL of the whole Benko. It points down the a1-h8 highway straight at d4 and b2, and married to the rooks that swing onto the open a- and b-files, it turns White's entire queenside indefensible. That was the deal Black struck: one pawn, for permanent self-running pressure on the side of the board where White keeps everything they own.", sayShort: '…Bg7, …O-O — the soul of the Benko awakens.', highlights: [H('g7'), H('d4', SOFT), H('b2', SOFT)] }),
  ...
  'benko-gambit::Zaitsev Variation': {
    ...
    beats: [
      ...
      b({ id: 'z4', moves: 'd4 Nf6 c4 c5 d5 b5 cxb5 a6 Nc3 axb5 e4 b4 Nb5 d6 Bc4 g6 Nf3 Bg7 O-O O-O', say: "…Bg7 fianchettoes onto the long diagonal and Black castles. There is the Zaitsev tabiya: White nominally has the extra pawn, but the b4-pawn cramps their queenside, the a-file is Black's, and the g7-bishop rakes the centre toward d4. Black has full compensation and an easy, pressing game.", sayShort: '…Bg7, O-O — full Benko compensation.', highlights: [H('d4')] }),
    ],
  },
