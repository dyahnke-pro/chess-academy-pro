...
// compensation is pure initiative; you teach attack, not equality. Both registers
...
export const PRO_ERICROSEN_STAFFORD_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "You start like the Petroff — e5, then Nf6, attacking the e4-pawn. It looks like a quiet, symmetrical game. It is bait. You are inviting White to grab on e5, because the whole Stafford is built on what happens next.",
    ...
    b({
      ...
      say: "White takes the pawn, and instead of recapturing you play Nc6 — the Stafford Gambit. You offer the e5-pawn for free. White will trade it off, but every tempo White spends collecting material is a tempo you spend developing toward their king. The pawn is the price of the initiative.",
    ...
    b({
      ...
      say: "White trades on c6 and you recapture toward the centre with the d-pawn — never the b-pawn. This is the key choice: dxc6 opens the d-file for your queen and the c8-to-h3 diagonal for your light bishop. You are down a pawn, but both bishops and the queen suddenly have open roads.",
    ...
    b({
      ...
      say: "White props up the centre with d3, and your bishop goes straight to c5 — pointing at f2. Memorise this square: f2 is the soft spot in almost every Stafford line. The whole attack is going to crash into it. This repertoire has reached this exact position hundreds of times.",
    ...
    b({
      ...
      say: "White touches the centre with c3, and the knight leaps to g4. Now look at the pressure: the g4-knight and the c5-bishop both hammer f2, and the knight also eyes h2. Because you played h5 first, White cannot kick the knight with the bishop. The attack is live.",
    ...
    b({
      ...
      say: "From here the plan is simple and violent: push the h-pawn to h4 to rip open the h-file, castle queenside to bring the other rook into the attack, and keep every piece pointed at the white king. You do not try to win the pawn back — you try to win the king.",
