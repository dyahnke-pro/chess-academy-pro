...
export const PRO_HIKARU_CLOSED_SICILIAN_LESSON: LessonScript = {
  ...
  sources: SRC,
  beats: [
    b({ id: 'nc3', moves: 'e4 c5 Nc3', highlights: [H('c3')], say: "The Grand Prix — widely regarded as legendary. Against the Sicilian, Nc3 comes first for a reason: it stops Black's freeing ...d5 before you throw the f-pawn forward. No deep Open-Sicilian theory, just a direct attack.", sayShort: 'Nc3 — stop ...d5 first.' }),
