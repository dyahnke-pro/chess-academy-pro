...
export const PRO_ERICROSEN_SCANDINAVIAN_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'd5', moves: 'e4 d5 exd5 Nf6',
      ...
      say: "The modern Scandinavian. Instead of recapturing with the queen (and getting it chased around), you play …Nf6 — preparing to win the d5-pawn back with a piece and keeping your queen safely at home. Fast, clean development is the whole idea.",
      sayShort: '…Nf6 — regain d5 with a piece.' }),
    b({ id: 'bg4', moves: 'e4 d5 exd5 Nf6 d4 Bg4',
      arrows: [], highlights: [{ square: 'g4', color: KEY }],
      say: "When White holds the pawn with d4, you develop …Bg4 — pinning a future Nf3 and, crucially, solving the Scandinavian's eternal problem of the light-squared bishop by getting it OUTSIDE the pawn chain before …e6 ever locks it in.",
    ...
    b({ id: 'trade', moves: 'e4 d5 exd5 Nf6 d4 Bg4 Be2 Bxe2 Qxe2 Qxd5',
      ...
      say: "You trade the light bishops with …Bxe2 — happily giving up the 'bad' bishop for White's good one — and only NOW recapture the pawn with …Qxd5. The queen comes out when it is safe, not when it can be harassed. Material is level and Black is fully developed.",
