...
export const TWO_KNIGHTS_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'two-knights-defence::Two Knights: Max Lange Attack': {
    ...
    beats: [
      ...
      b({ id: 'ml3', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 d4 exd4 O-O Nxe4 Re1 d5 Bxd5 Qxd5 Nc3 Qd8', say: "White grabs on d5 and Black recaptures with the queen, which then has to step lively: Nc3 forks the queen and the e4-knight, so the queen retreats calmly to d8. The dust settles with Black still holding the extra pawn and White scrambling to justify the gambit.", sayShort: '…Qd8 — sidestep the fork, keep the pawn.', highlights: [H('c3'), H('d8', SOFT), H('e4', SOFT)] }),
