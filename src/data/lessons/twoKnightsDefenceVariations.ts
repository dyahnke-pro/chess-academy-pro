...
export const TWO_KNIGHTS_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'two-knights-defence::Two Knights: Quiet Italian d3 with ...Be7': {
    ...
    beats: [
      ...
      b({ id: 'qi4', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 d3 Be7 O-O O-O Re1 d6 a4 Na5 Ba2 c5 c3 Nc6 Nbd2 Be6 Bxe6 fxe6 Nf1', say: "Bxe6 …fxe6 — and the recapture points TOWARD the centre: the f-file opens for the f8-rook and the e6/e5/d6 pawns grip every central square. Nf1 begins White's long knight walk to g3. The engine says dead equal — and Black's plans, the …d5 break and the f-file, are at least as easy to play. The quiet Italian holds no fear for the prepared.", sayShort: '…fxe6 — the f-file and the centre.', highlights: [H('f8', SOFT), H('e6')] }),
    ],
  },
  ...
  'two-knights-defence::Two Knights: Fritz Variation 5...Nd4': {
    ...
    beats: [
      ...
      b({ id: 'fz2', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 Ng5 d5 exd5 Nd4 c3 b5', say: "c3 attacks the d4-knight, and …b5! counter-attacks the bishop — two Black pieces hang at once, and that is exactly the point: White cannot profitably take either. The single cold-blooded test is the retreat Bf1, and almost nobody finds it over the board.", sayShort: '…b5 — two pieces hang; neither can fall.', highlights: [H('b5'), H('d4', SOFT)] }),
      b({ id: 'fz3', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 Ng5 d5 exd5 Nd4 c3 b5 cxd4 bxc4 dxe5 Qxd5 exf6 Qxg5', say: "White grabs everything in sight — the d4-knight, the e5-pawn, the f6-knight — and Black collects back with tempo every time: …bxc4 took the bishop, …Qxd5 scooped the pawn while centralising, and …Qxg5 removes the stranded knight. Stop counting captures and look at the board: Black's queen commands the whole kingside and White hasn't developed a piece.", sayShort: '…Qxg5 — collect the strays.', highlights: [H('g5')] }),
      b({ id: 'fz4', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 Ng5 d5 exd5 Nd4 c3 b5 cxd4 bxc4 dxe5 Qxd5 exf6 Qxg5 fxg7 Bxg7 O-O Bb7', say: "The last greedy grab, fxg7, meets …Bxg7 — Black recaptures and the bishop lands on the long diagonal White just cleared for it. …Bb7 aims the second bishop at g2, and the engine's verdict on the whole grab-fest is decisive: Black is winning, up clean material with both bishops raking the kingside. That is the Fritz — one quiet knight hop on move five that turns natural-looking greed into a lost position.", sayShort: '…Bb7 — both bishops rake; Black is winning.', arrows: [A('b7', 'g2')], highlights: [H('g2', SOFT)] }),
    ],
  },
};
