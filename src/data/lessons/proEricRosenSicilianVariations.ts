...
const TAIMANOV: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'oppo', moves: 'e4 c5 Nf3 e6 d4 cxd4 Nxd4 Nc6 Nc3 Qc7 Be3 a6 Qd2 Nf6 O-O-O Bb4',
      ...
      say: "When White castles long for an attack, …Nf6 develops and …Bb4 pins the c3-knight — the standard counter. You damage White's queenside pawns or win the bishop pair, and your own …b5-…b4 storm comes fast in the opposite-castling race.",
...
const ROSSOLIMO: LessonScript = {
  ...
  beats: [
    b({ id: 'bb5', moves: 'e4 c5 Nf3 Nc6 Bb5 d6',
      ...
      say: "The Rossolimo: White pins and threatens to trade on c6, doubling your pawns. You answer …d6 — a flexible move that prepares …Bd7 to break the pin and keeps your structure healthy. No need to fear the bishop.",
...
const ALAPIN: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'qxd5', moves: 'e4 c5 c3 d5 exd5 Qxd5 d4 Nf6 Nf3 e6',
      ...
      say: "You recapture with the queen on d5, and unlike the Scandinavian the queen is safe here — c3 means there is no Nc3 to chase it. After …Nf6 and …e6 Black develops smoothly with an open, comfortable position.",
...
const CLOSED: LessonScript = {
  ...
  beats: [
    b({ id: 'e6', moves: 'e4 c5 Nc3 e6',
      ...
      say: "When White plays Nc3 first (threatening a Closed Sicilian or a transposition), you keep it flexible with …e6, ready to meet an Open Sicilian with your Taimanov setup or a Closed one with a quick …d5 or …g6.",
    ...
    b({ id: 'open', moves: 'e4 c5 Nc3 e6 Nf3 Nc6 d4 cxd4 Nxd4',
      ...
      say: "If White goes for the open game with Nf3 and d4, you transpose straight into your familiar Taimanov structure — …Nc6 and a flexible shell. You are simply on home turf, having forced White to reveal their hand.",
