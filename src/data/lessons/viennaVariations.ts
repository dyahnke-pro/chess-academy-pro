...
const VS_NC6: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'nc6-5', moves: 'e4 e5 Nc3 Nc6 f4 exf4 Nf3 g5',
      say: "g5 — Black tries to hold the f4-pawn with their g-pawn. This is the move that creates immortal chess. Edward Lasker noted that lines like this 'lead to the most brilliant complications,' and history bears him out: every important Vienna sacrifice of the nineteenth century launches from approximately this position. The g4-square is about to become a weapon Black thinks is their and isn't.",
...
const FRANKENSTEIN_DRACULA: LessonScript = {
  ...
  beats: [
    b({ id: 'fd-1', moves: 'e4 e5 Nc3 Nf6 Bc4',
      say: "The Frankenstein-Dracula begins quietly enough: Bc4, the Italian-Vienna bishop pointing at f7, exactly as in the Classical lesson. But what follows is the wildest known line in the entire Vienna repertoire, born when Black makes one ambitious choice on their third move.",
...
const PAULSEN: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'p3', moves: 'e4 e5 Nc3 Nf6 g3 Bc5 Bg2 d6 Nge2',
      say: "The Vienna knight-maneuver returns, exactly as in the Classical: Nge2! White re-routes their king-knight via e2 toward g3 or f4, keeping every option open. Same Nc3-Ne2 dance you saw in the Classical lesson, but now with a fianchettoed bishop already supporting the centre from below. The Paulsen IS the Classical Vienna with the g2-bishop swapped in for the Bc4.",
    ...
    b({ id: 'p5', moves: 'e4 e5 Nc3 Nf6 g3 Bc5 Bg2 d6 Nge2 Nc6 O-O a6 a4 O-O d3',
      say: "White's setup completes: …a4 to gain queenside space and stop a future …Na5, d3 to solidify, and the position has reached its canonical Paulsen middlegame structure. White's plan: Nd5 at the right moment (the long-diagonal bishop supports it), and slow expansion on either wing depending on where Black commits. Black's plan: develop solidly, contest the d5 outpost, and pray for an opening of the long diagonals where their own bishop-pair might shine.",
