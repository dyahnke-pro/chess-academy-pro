...
export const PRO_ERICROSEN_BUDAPEST_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'e5', moves: 'd4 Nf6 c4 e5',
      arrows: [A('e5', 'd4')], highlights: [{ square: 'e5', color: KEY }, { square: 'd4', color: KEY }],
    ...
    b({ id: 'bf4', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Bf4 Bb4+',
      arrows: [A('f8', 'b4')], highlights: [{ square: 'b4', color: KEY }, { square: 'f4', color: SOFT }],
    ...
    b({ id: 'nd2', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Bf4 Bb4+ Nd2 Nc6 Ngf3 Qe7',
      arrows: [A('c6', 'e5'), A('d8', 'e7')], highlights: [{ square: 'e5', color: KEY }, { square: 'e7', color: KEY }],
