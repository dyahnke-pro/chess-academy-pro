...
export const PRO_ERICROSEN_BUDAPEST_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'e5', moves: 'd4 Nf6 c4 e5',
      ...
      say: "The Budapest Gambit — e5! Against d4 and c4 you strike in the centre and offer the pawn. It is a this repertoire kind of opening: a little dubious, hugely fun, and packed with traps that punish a White player who grabs material and relaxes.",
    ...
    b({ id: 'ng4', moves: 'd4 Nf6 c4 e5 dxe5 Ng4',
      ...
      say: "White takes on e5; you hop the knight to g4, hitting the e5-pawn and eyeing f2 and h2. This is the heart of the gambit — the g4-knight will either win the pawn back or spearhead a kingside attack. Black is never passive here.",
    ...
    b({ id: 'bf4', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Bf4 Bb4+',
      ...
      say: "White defends the pawn with Bf4; you develop with check — Bb4+. The bishop gets out actively, forces White to block, and gains a tempo. Every Black piece comes flying out while White is busy hanging onto the extra pawn.",
    ...
    b({ id: 'nd2', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Bf4 Bb4+ Nd2 Nc6 Ngf3 Qe7',
      ...
      say: "After Nd2 blocks the check, you pile on the e5-pawn: …Nc6 adds a second attacker and …Qe7 a third, also pinning ideas down the e-file. White cannot comfortably hold the pawn AND finish developing — something has to give.",
    ...
    b({ id: 'regain', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Bf4 Bb4+ Nd2 Nc6 Ngf3 Qe7 a3 Ngxe5 Nxe5 Nxe5',
      ...
      say: "You regain the pawn with …Ngxe5, and after the trades a knight lands on the great central e5-square. Material is level, your pieces are far more active than White's, and the bishop on b4 and knight on e5 already cramp White. The gambit has paid off.",
