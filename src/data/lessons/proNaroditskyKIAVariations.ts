...
// Mirror fianchetto: Black plays the same setup you do, becoming a
...
const VS_SYMMETRIC: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Nf3 …g6 — Black mirrors your fianchetto. The position becomes a positional fight with both bishops on the long diagonal. The key insight: with mirror development, the first side to break the symmetry productively wins the middlegame.",
    ...
    b({
      ...
      say: "Both kings castled, both fianchettos developed. d3 starts the KIA's central plan — you're going to follow up with Nbd2, e4, and a kingside attack. The d3 is modest but supports both e4 and the c1-bishop's later development.",
    ...
    b({
      ...
      say: "Nbd2 develops the second knight to its prep square. Black plays …e5 trying to claim the centre. Note: this is the same e5 break you use as Black in the KID — now you're on the other side, with a tempo less, but you know the structures cold.",
    ...
    b({
      ...
      say: "e4 claims the centre, …Nc6 develops, c3 prepares the d4 push. The position is symmetric in development but you have the move advantage to break first. Patience is everything in the KIA — the right break wins.",
    ...
    b({
      ...
      say: "After …Re8 develops the rook, a4 starts the queenside expansion. The a-pawn push gains space and prepares the b-pawn deployment. You're attacking on the side where Black's pieces are less coordinated.",
    ...
    b({
      ...
      say: "After Black's blocking …a5, the knight goes to h4 preparing Nf5 — the prize square for your knight in the KIA. From f5 it attacks the d6-pawn, hits the e7 pawn, and supports a kingside attack. The Nh4 detour pays off.",
...
// centre immediately with ...d5. You answer with the KIA's classical
...
const VS_RETI_D5: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Nf3 …d5 — Black claims the centre right away. You fianchetto regardless: g3, Bg2. After …c5 Black has the classical centre, but your system development is unbothered. The KIA works against ANY Black setup; that's the whole point.",
    ...
    b({
      ...
      say: "Black plays …e6 supporting the d5-pawn and preparing development. You respond with Nbd2 — the queen's knight to its KIA square, ready to support the e4 break.",
    ...
    b({
      ...
      say: "…Bd6 develops the bishop actively, and you play e4 challenging the centre. After e4, Black has to decide: trade with …dxe4 (opens the position), push …d4 (lock the centre), or maintain tension. Each leads to a different KIA middlegame.",
    ...
    b({
      ...
      say: "…dxe4 dxe4 — the standard exchange opens the position. Now the Bg2 has a clear diagonal toward the queenside, the d-file is half-open for your rook, and Black's …Bd6 is awkwardly placed without the central pawn support.",
    ...
    b({
      ...
      say: "…O-O Re1 — Black castles, you lift the rook to the e-file. The Re1 supports e4 AND prepares the central pressure that defines KIA middlegames. From here Nc4 or e5 are the key breakthrough ideas.",
...
// Black plays a quiet setup with ...d6 keeping options open. You
...
const VS_PIRC_D6: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Nf3 …d6 — Black plays a Pirc-style quiet setup. You continue your system development: g3, Bg2. The d6 is solid but doesn't challenge your centre yet, so you get to set up the broadest possible KIA structure.",
      sayShort: '…d6 — Pirc setup.',
    }),
    b({
      id: 'd6-castle', moves: 'Nf3 d6 g3 g6 Bg2 Bg7 O-O Nf6 d4',
      highlights: [{ square: 'd4', color: KEY }],
      say: "O-O …Nf6 d4! — and you play d4 instead of d3. The Pirc structure invites this transposition: Black can't easily strike at the centre, so you claim the full centre with c4 + d4 + e4 coming.",
      sayShort: 'd4 — claim the centre.',
    }),
    b({
      id: 'd6-c4', moves: 'Nf3 d6 g3 g6 Bg2 Bg7 O-O Nf6 d4 O-O c4',
      highlights: [{ square: 'c4', color: KEY }],
      say: "O-O c4 — both kings safe, you expand with c4. The position has transposed into a King's Indian Reversed structure where You play Black's side with an extra tempo. The KID's natural plans (e4 + queenside expansion) all work for you here.",
    ...
    b({
      ...
      say: "Black plays …e5 challenging the d4-pawn. You develop Nc3 supporting your centre and preparing d5 to lock the position. The Nc3 also adds pressure on the d5 outpost square.",
    ...
    b({
      ...
      say: "…Nbd7 develops the knight, then d5! locks the centre. The position is now a King's Indian Reversed with locked centre — kingside attack territory for whoever has the king on the queenside. You have the extra tempo to organise first.",
      sayShort: 'd5 — lock centre.',
    }),
    b({
      id: 'd6-middlegame', moves: 'Nf3 d6 g3 g6 Bg2 Bg7 O-O Nf6 d4 O-O c4 e5 Nc3 Nbd7 d5 a5 e4',
      highlights: [{ square: 'e4', color: KEY }],
      say: "Black plays …a5 trying to claim queenside space, and you push e4 finally. Now the centre is fully formed: c4-d5-e4 — and the long-diagonal Bg2 has a clear path. The KIA's structural plan converts.",
...
const VS_E5_OPEN: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Nf3 ...e5 — Black plays the most aggressive response, treating your Nf3 as if it were a regular e4 opening. The pawn on e5 attacks your knight, but you grab it: Nxe5 starts the Reti gambit-accepted line.",
      sayShort: '...e5 — Black overcommits.',
    }),
    b({
      id: 'e5-nxe5', moves: 'Nf3 e5 Nxe5',
      highlights: [{ square: 'e5', color: ATK }],
      say: "Nxe5 — you accept the pawn. Black's choices now are limited: ...d6 chasing the knight, or ...Nc6 attacking the knight. The most common reply is ...Nc6 attacking with tempo.",
      sayShort: 'Nxe5 — accept the pawn.',
    }),
    b({
      id: 'e5-nc6', moves: 'Nf3 e5 Nxe5 Nc6',
      highlights: [{ square: 'c6', color: SOFT }],
      say: "...Nc6 — Black develops with attack on the knight. You must move it back.",
      sayShort: '...Nc6 — attacks Nxe5.',
    }),
    b({
      id: 'e5-nf3', moves: 'Nf3 e5 Nxe5 Nc6 Nf3',
      highlights: [{ square: 'f3', color: KEY }],
      say: "Nf3 — knight retreats. You've won a clean pawn AND Black has to spend tempo proving compensation. The classical follow-up: d4 + e3 + Be2 + O-O, defending the extra pawn through the middlegame.",
    ...
    b({
      ...
      say: "d4 ...Bd6 — you play your own central pawn blunting Black's compensation, Black develops the bishop actively. The d4 fixes the centre, and Black has limited targets for the pawn deficit.",
    ...
    b({
      ...
      say: "e3 ...Nf6 Be2 — you play e3 supporting d4, Black develops the king knight, you develop the bishop to e2. The classical KIA-Reti structure is set up with the extra pawn AND piece coordination.",
...
// Black plays ...c6 supporting a future ...d5. You respond with the
...
const VS_C6_SLAV: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Nf3 ...c6 — Black plays the Slav-like setup, supporting a future ...d5 push. The c6 is solid but slow; you develop your KIA system with full freedom.",
      sayShort: '...c6 — Slav-like.',
    }),
    b({
      id: 'c6-g3', moves: 'Nf3 c6 g3',
      highlights: [{ square: 'g3', color: SOFT }],
      say: "g3 — your standard KIA fianchetto setup. The Bg2 will dominate the long diagonal pointing at Black's queenside.",
    ...
    b({
      ...
      say: "Bg2 ...Nf6 O-O — you complete development with the fianchetto + castle. Black mirrors with knight development. So far symmetric, but you have the move advantage AND clearer KIA plans.",
      sayShort: 'O-O — KIA setup done.',
    }),
    b({
      id: 'c6-d3', moves: 'Nf3 c6 g3 d5 Bg2 Nf6 O-O Bg4 d3',
      highlights: [{ square: 'd3', color: KEY }],
      say: "...Bg4 d3 — Black tries the active ...Bg4 pin, you play the small d3 keeping flexibility. The d3 supports e4 later AND avoids the central trade that would help Black.",
      sayShort: 'd3 — flexible setup.',
    }),
    b({
      id: 'c6-middlegame', moves: 'Nf3 c6 g3 d5 Bg2 Nf6 O-O Bg4 d3 Nbd7 Nbd2 e6 e4',
      highlights: [{ square: 'e4', color: KEY }],
      say: "...Nbd7 Nbd2 ...e6 e4 — both sides finish development AND you push e4 immediately. The e4 break is the climax: it challenges Black's d5-pawn AND opens lines for the Bg2.",
    ...
    b({
      ...
      say: "...Be7 Re1 ...O-O — Black completes development with Be7 + O-O, you lift the rook to e1 supporting the central pawn. Both kings safe, structure defined: White's central pressure vs Black's passive c6-Nbd7-Be7 setup. The middlegame plan from here: Qe2 + Nf1-Ng3 reroute toward kingside attack.",
...
const VS_B6_OWEN: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "...Bb7 — Black completes the queen-bishop fianchetto. The bishop aims at the centre + your kingside. Now you develop your own fianchetto AND claim the centre.",
    ...
    b({
      ...
      highlights: [{ square: 'd4', color: KEY }],
      say: "O-O ...e6 d4! — you castle, Black plays solidly with ...e6, and now you GRAB the centre with d4. The d4 push is justified because Black has no central counter-strike available. White's space advantage converts in 75.8% of the games.",
      sayShort: 'd4 — claim the centre.',
    }),
    b({
      id: 'b6-c4', moves: 'Nf3 b6 g3 Bb7 Bg2 Nf6 O-O e6 d4 Be7 c4',
      highlights: [{ square: 'c4', color: KEY }],
      say: "...Be7 c4 — Black develops, you expand with c4. The c4 + d4 + Bg2 + Nf3 setup is a Reversed-Slav structure where White has all the active plans.",
    ...
    b({
      ...
      say: "...O-O Nc3 — Black castles, you develop the queen knight to c3 completing the queenside setup. Both kings safe, full central structure.",
    ...
    b({
      ...
      say: "...d5 cxd5 — Black tries the central counter, you trade pawns opening the c-file for your rook AND keeping the central pressure. The Reversed-Slav middlegame favors White's space + active piece play. 75.8% score confirms.",
...
// Black plays ...e6 setting up a French Defense structure. You
...
const VS_E6_FRENCH: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Nf3 ...e6 — Black plays a French-style setup, supporting a future ...d5. The e6 commits Black to a slow positional fight. You transpose into the KIA-vs-French structure where White's plans are well-known.",
    ...
    b({
      ...
      say: "Bg2 ...Nf6 O-O — you complete the fianchetto + castle. Black develops the knight. The position resembles a Catalan in structure but from a different move order.",
      sayShort: 'O-O — Catalan-like.',
    }),
    b({
      id: 'e6-be7', moves: 'Nf3 e6 g3 d5 Bg2 Nf6 O-O Be7 d3',
      highlights: [{ square: 'd3', color: KEY }],
      say: "...Be7 d3 — Black continues classical development, you play the small d3 keeping options open. The d3 supports e4 later AND avoids committing to d4 (which would block your Bg2's diagonal).",
      sayShort: 'd3 — flexibility.',
    }),
    b({
      id: 'e6-nbd2', moves: 'Nf3 e6 g3 d5 Bg2 Nf6 O-O Be7 d3 O-O Nbd2',
      highlights: [{ square: 'd2', color: KEY }],
      say: "...O-O Nbd2 — Black castles, you develop the queen knight to its KIA-square. From d2, the knight prepares e4 push AND can reroute via Nf1-Ng3 toward the kingside attack.",
      sayShort: 'Nbd2 — KIA reroute square.',
    }),
    b({
      id: 'e6-e4-break', moves: 'Nf3 e6 g3 d5 Bg2 Nf6 O-O Be7 d3 O-O Nbd2 c5 e4',
      highlights: [{ square: 'e4', color: KEY }],
      say: "...c5 e4 — Black plays the central counter, you strike with e4! The e4 challenges Black's centre AND opens lines for your Bg2 + future kingside attack. This is the standard KIA-vs-French middlegame where White's attack is faster than Black's.",
      sayShort: 'e4 — central break.',
    }),
  ],
};
