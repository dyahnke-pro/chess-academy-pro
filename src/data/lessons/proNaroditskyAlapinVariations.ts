...
const E6_FRENCH: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "…e6 — Black plays a French-style setup, preparing …d5 to challenge the centre next move. The trade we're getting here is exactly what the Alapin promises: Black voluntarily walks into French-Advance territory, and we trade Sicilian theory we don't want for French theory we know cold. Logical piece development, central control, practical positions — the consensus description of the Alapin lands beat for beat in this line.",
    ...
    b({
      ...
      say: "d4 d5 e5 — the French Advance structure, only now with the c3-c4 lever still available to us later. Black's kingside is cramped because the e5-pawn kills the f6-square for a knight, so Black's natural defender can never reach the kingside. This is the position the c3 setup was building toward.",
    ...
    b({
      ...
      say: "After …Bc5 Black tries to coordinate his pieces, but Ng5 lands first. The knight threatens Nxf7 with the bishop hitting h7 behind it — Black has to give up the bishop pair with …Bxg5 or weaken the kingside with …h6, and either choice hands us a permanent structural edge to convert in the middlegame.",
...
const D6_MAINLINE: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Bd3 and we castle short. The setup is complete: pawns on c3-d4-e4, knights and bishops out, rooks ready for the c-file and d-file. From here the plan is to wait — let Black find a weakness for us. Once he overcommits the kingside or queenside, e4-e5 or d4-d5 opens lines wherever his king ended up.",
...
const NC6_LINE: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Bd3 / Nf6 / O-O / Be7 / a3 — we develop classically and prepare b4 expansion. The d4-pawn looks isolated but Black's c8-bishop is locked in by his own e6-pawn, so he can't pressure it. White converts the structural edge in the endgame, where the bishop pair and the queenside space carry the rest of the way.",
...
const NF6_E6_SUB: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      highlights: [{ square: 'c3', color: KEY }, { square: 'd5', color: ATK }],
      say: "…Bc6 / Nc3 — Black redirects the bishop to c6, we develop the queen knight finally hitting the d5-knight. The whole position rests on the d5 exchange that's now coming: whoever wins that trade controls the central squares for the rest of the middlegame.",
    ...
    b({
      ...
      say: "…Nxc3 / bxc3 — the knight trade gives us doubled c-pawns, but they aren't a real weakness here. We get the open b-file for the rook AND the bishop pair AND a reinforced d4 centre. Black trades his best piece for a structural concession he can't punish, and the endgame steers cleanly in White's favour.",
