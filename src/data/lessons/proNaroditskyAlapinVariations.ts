...
const E6_FRENCH: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "After …Bc5 Black tries to coordinate their pieces, but Ng5 lands first. The knight threatens Nxf7 with the bishop hitting h7 behind it — Black has to give up the bishop pair with …Bxg5 or weaken the kingside with …h6, and either choice hands you a permanent structural edge to convert in the middlegame.",
...
const G6_DRAGON: LessonScript = {
  ...
  beats: [
    b({
      ...
      moves: 'e4 c5 c3 g6',
      highlights: [{ square: 'g6', color: KEY }, { square: 'g7', color: SOFT }],
      say: "…g6 — the Hyper-Accelerated Dragon. Black wants the fianchetto setup without committing to …d6 first, hoping to keep their Dragon theory available later. The Alapin's whole point is that you don't need to know their theory: c3 supports d4, the pieces find their squares the same way regardless of move order, and you head for practical positions instead of memorisation. The flexibility they're preserving doesn't matter against a system.",
...
const NC6_LINE: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "d4 / …cxd4 / cxd4 / …d5 / exd5 / …Qxd5 — Black tries the same Scandinavian-style simplification as in the d5-open line, but via a different move order. You end up in a similar structure, except now Black has committed the Nc6 — which limits their options later.",
...
const NF6_D6_SUB: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Qxc4+ — material recovered, king exposed, two attacking files open. White has lost zero material in the tactical sequence and Black has lost the right to castle. From here Black has to find precise defence; their rating bucket usually doesn't.",
...
const NF6_E6_SUB: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Qe2 — the queen activates supporting the e-file rook (next move) and aiming at e6. From this position the central pawn break Qe2 + Rd1 + d5! is the long-term winning idea — Black can't stop it without weakening their king.",
