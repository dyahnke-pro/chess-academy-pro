...
export const PRO_SAMAYRAINA_ITALIAN_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'bc4', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5',
      ...
      say: "The Italian Game — the oldest opening in chess and a perfect club weapon. The bishop develops actively to c4, eyeing the f7-square, the weakest point in Black's camp. Black mirrors with …Bc5. You are heading for a slow, rich middlegame.",
    ...
    b({ id: 'c3', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d3',
      ...
      say: "c3 and d3 — the Giuoco Pianissimo, the 'very quiet game'. You build a small, sturdy centre and prepare a slow expansion. No early fireworks; you want a position rich in plans where understanding beats memorisation.",
    ...
    b({ id: 'oo', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d3 d6 O-O O-O Re1 a6 a4',
      ...
      say: "Both sides castle and complete development. You play Re1 and a4 — gaining queenside space and stopping Black's …b5. The position is balanced and maneuvering; White's plan is to expand and probe on both wings.",
