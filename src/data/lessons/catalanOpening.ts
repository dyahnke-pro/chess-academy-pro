...
export const CATALAN_OPENING_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: "develop", moves: "d4 Nf6 c4 e6 g3 d5 Bg2 dxc4 Nf3 a6 O-O Nc6 e3 Bd7 Qe2", say: "O-O Nc6 e3 Bd7 Qe2 — White simply develops and bides their time, the queen on e2 lining up behind the centre and preparing the pawn-recovery break. There is no panic and no chase: the Catalan player trusts the position, not the material count.", sayShort: "Qe2 — develop calmly, prepare to recover c4.", highlights: [H("e3", KEY), H("c4", SOFT)] }),
    ...
    b({ id: "close", moves: "d4 Nf6 c4 e6 g3 d5 Bg2 dxc4 Nf3 a6 O-O Nc6 e3 Bd7 Qe2 b5 b3 cxb3 axb3 Be7 Bb2 O-O Rc1", say: "O-O Rc1 and you reach the Open Catalan tabiya: White has fully regained the pawn and emerged with the bishop pair, pressure down the c- and a-files, and the famous g2-bishop bearing on the queenside. This is the Catalan in one breath — fianchetto, let Black take c4, undermine and recover it, then squeeze with the two bishops. The other tabs show the solid Closed Catalan and the Slav move-order.", sayShort: "Rc1 — the Open Catalan squeeze.", highlights: [H("c1", KEY)] }),
  ],
};
