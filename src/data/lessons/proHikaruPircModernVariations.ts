...
const BE3: LessonScript = {
  ...
  beats: [
    b({ id: 'a6', moves: 'e4 g6 d4 Bg7 Nc3 a6', arrows: [A('f8', 'g7')], highlights: [H('g7')], say: "Black fianchettoes and plays the flexible ...a6 — preparing the queenside expansion. You hand White the big centre on purpose; a big centre is a big target.", sayShort: '…a6 — prepare ...b5.' }),
