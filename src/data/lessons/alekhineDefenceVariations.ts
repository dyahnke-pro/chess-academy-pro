...
export const ALEKHINE_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'alekhine-defence::Four Pawns Attack': {
    ...
    beats: [
      ...
      b({ id: 'fp4', moves: 'e4 Nf6 e5 Nd5 d4 d6 c4 Nb6 f4 dxe5 fxe5 Nc6 Be3 Bf5 Nc3 e6 Nf3 Bb4 Rc1 O-O', say: "…Bb4 pins the c3-knight and Black castles to safety, every piece trained on the big white centre. Be honest about the balance here — the Four Pawns is critical for a reason: White's space still gives a real pull and Black is a shade worse, so this is a sharp, double-edged fight where Black leans on piece activity, not an equaliser. Save the …f6 break for when White can't answer exf6 — played too early it just hands White the point.", sayShort: '…Bb4, castle — active but a shade worse.', arrows: [A('b4', 'c3')], highlights: [H('c3')] }),
    ],
  },
