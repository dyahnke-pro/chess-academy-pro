...
export const VIENNA_GAME_LESSON: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      sayShort: 'Three weapons — f4, Bc4, g3 — one knight.',
    },
    {
      id: 'classical-bishop',
    ...
    },
    {
      ...
      say: "d3 — quiet, modest, fundamental. It does three jobs at once: it overprotects e4, it frees the c1-bishop to come out via Bg5 or Be3, and crucially it KEEPS the option of d3-d4 alive for later, when the pieces are coordinated. The Vienna's Classical is the patient brother of the Italian — White builds first, fights second.",
      sayShort: 'd3 — guards e4, frees the bishop, saves d4.',
    },
    {
      id: 'castle-and-stabilize',
      moves: ['e4', 'e5', 'Nc3', 'Nf6', 'Bc4', 'Bc5', 'd3', 'O-O', 'Nf3', 'd6', 'O-O'],
      arrows: [{ from: 'f3', to: 'e5', color: VIS }],
      say: "Now the king-knight finally comes out — Nf3 — and lands where it would have stood on move two in any other opening. Both sides castle. Black plays d6 to underprop e5. The position is stable, the kings are safe, and the real game — the middlegame fight — is about to begin. This is exactly the structure Blackburne reached when he played the Vienna at the great nineteenth-century events; Bird records his games with Mason in this position as 'enterprising and full of interest.'",
      sayShort: 'O-O — kings safe, …d6 props e5, fight begins.',
    },
    {
      id: 'preparation',
    ...
    },
    {
      ...
      sayShort: 'Nf5 — the Lasker outpost the plan aimed at.',
    },
    {
      id: 'branch-gambit',
    ...
    },
    {
      ...
      say: "Or White can refuse fireworks altogether and play g3 — the Paulsen Variation. The bishop fianchettoes to g2, raking the long light diagonal from a corner of the board, and White builds a slow squeeze from a distance — the Bg2 will eventually press through the centre once the structure opens. The Paulsen is the modern grandmaster's choice — Carlsen and Caruana play it at the very top level — even though at amateur ranks it's rarely seen. Same Nc3 spine, third completely different personality. The Vienna's whole pitch is right here: one move, three weapons, depending on what Black gives you.",
      sayShort: 'g3 — the Paulsen, the modern elite squeeze.',
    },
    {
      id: 'branch-nc6',
      moves: ['e4', 'e5', 'Nc3', 'Nc6'],
