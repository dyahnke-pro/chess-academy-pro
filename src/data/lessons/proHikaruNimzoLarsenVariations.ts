...
const D5 = lesson("Nimzo-Larsen vs 1...d5 — the Reversed London", [
  b({ id: 'd5-fianch', moves: 'b3 d5 Bb2 Nf6 Nf3 g6', arrows: [A('b2', 'g7')], highlights: [H('b2')], say: "Against the solid d5, this repertoire fianchettoes and develops naturally — Bb2 and Nf3. Black mirrors with a kingside fianchetto, but the b2-bishop already owns the long diagonal toward g7.", sayShort: 'Bb2, Nf3 — claim the diagonal.' }),
  ...
  b({ id: 'd5-c4', moves: 'b3 d5 Bb2 Nf6 Nf3 g6 e3 Bg7 d4 O-O c4', arrows: [A('c2', 'c4')], highlights: [H('c4')], say: "Black castles and this repertoire strikes with c4 — challenging d5 and grabbing queenside space. The position is a comfortable space-edge where White's pieces flow naturally.", sayShort: 'c4 — challenge d5, take space.' }),
...
const NF6 = lesson("Nimzo-Larsen vs 1...Nf6 — Contest the Long Diagonal", [
  b({ id: 'nf6-fianch', moves: 'b3 Nf6 Bb2 g6 e3 Bg7 Nf3 O-O', arrows: [A('b2', 'g7')], highlights: [H('b2')], say: "Black develops flexibly and fianchettoes; this repertoire does the same. Both dark-squared bishops eye the long diagonal — the whole game will be a fight over who controls it.", sayShort: 'Bb2 — contest the diagonal.' }),
...
const C5 = lesson("Nimzo-Larsen vs 1...c5 — Reversed Sicilian", [
  ...
  b({ id: 'c5-d4', moves: 'b3 c5 Bb2 Nc6 e3 Nf6 Nf3 g6 d4', arrows: [A('d2', 'd4')], highlights: [H('d4')], say: "Black fianchettoes and this repertoire breaks with d4 — opening the centre while ahead in development. The position cracks open in White's favour.", sayShort: 'd4 — open it, ahead in development.' }),
...
const E6 = lesson("Nimzo-Larsen vs 1...e6 — Open Lines After the Trades", [
  ...
  b({ id: 'e6-d4', moves: 'b3 e6 Bb2 d5 e3 Nf6 Nf3 Be7 d4 O-O Bd3', arrows: [A('f1', 'd3')], highlights: [H('d4'), H('d3')], say: "This repertoire builds with d4 and swings the bishop to d3 — the b1-h7 diagonal now points at Black's castled king. White has a harmonious, classical attacking setup.", sayShort: 'd4, Bd3 — aim at the king.' }),
  b({ id: 'e6-open', moves: 'b3 e6 Bb2 d5 e3 Nf6 Nf3 Be7 d4 O-O Bd3 c5 O-O Nc6 c4 cxd4 Nxd4', highlights: [H('d4')], say: "Black strikes with c5 and the centre trades; White recaptures with the knight on d4. The lines open, both bishops rake the board, and White has the more active pieces — the best-scoring line for good reason.", sayShort: 'Nxd4 — open lines, active pieces.' }),
]);
