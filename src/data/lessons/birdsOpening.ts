...
export const BIRDS_OPENING_LESSON: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      highlights: [{ square: 'e5', color: KEY }, { square: 'e4', color: KEY }],
    ...
    },
    {
      ...
      say: "Black's soundest reply is to defuse the plan: trade queens on d1 and strike with ...e5, contesting the centre before a White knight can settle. But White is still the one pressing — the d-file is open and White's rook already sits on d1, the centre stays tense between e4 and e5, and White keeps a small, durable edge with the freer game. No fireworks required. That is the honest pitch of the modern Bird: an offbeat first move that hands White a sound, slightly better position, with the easier play and almost no theory to memorise.",
