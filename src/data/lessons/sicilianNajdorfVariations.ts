...
export const SICILIAN_NAJDORF_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  beats: [
    ...
    b({ id: "bishop", moves: "e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 a6 Be3 Ng4 Bg5 h6 Bh4 g5 Bg3 Bg7 Qd2 Nc6", say: "Black completes the fianchetto with Bg7 — the bishop now rakes the long diagonal — and Nc6 develops, pressing the d4-knight. The Ng4 plan has handed Black space and the freedom of the two bishops: an aggressive, double-edged Najdorf.", sayShort: "Bg7 rakes the long diagonal.", arrows: [A("c6", "d4", ATK)], highlights: [H("g7", KEY)] }),
  ],
},
