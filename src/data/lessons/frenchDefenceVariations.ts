...
export const FRENCH_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'french-defence::Winawer Variation': {
    ...
    beats: [
      ...
      b({ id: 'win3', moves: 'e4 e6 d4 d5 Nc3 Bb4 e5 c5 a3 Bxc3+ bxc3', say: "a3 questions the bishop, and Black takes — …Bxc3+ bxc3. This is the Winawer bargain: Black trades their good bishop to shatter White's queenside into doubled, immobile c-pawns. Black accepts a long-term dark-square concession in return for a permanent structural target. The whole variation lives on this trade.", sayShort: '…Bxc3+ — wreck the doubled c-pawns.', highlights: [H('c3')] }),
      ...
      b({ id: 'win5', moves: 'e4 e6 d4 d5 Nc3 Bb4 e5 c5 a3 Bxc3+ bxc3 Ne7 Qg4 Qc7 Qxg7 Rg8 Qxh7', say: "…Qc7 ignores the threat and eyes the c3-weakling; White gorges with Qxg7 and after …Rg8 grabs again — Qxh7. These are the famous poisoned pawns. White is two pawns up but their queen is marooned on h7, miles from their king, while Black's rook stands on the open g-file pointing at g2 with deadly intent.", sayShort: '…Rg8 — open the g-file at g2; queen marooned.', arrows: [A('g8', 'g2')], highlights: [H('g2'), H('h7', SOFT)] }),
      b({ id: 'win6', moves: 'e4 e6 d4 d5 Nc3 Bb4 e5 c5 a3 Bxc3+ bxc3 Ne7 Qg4 Qc7 Qxg7 Rg8 Qxh7 cxd4 Ne2 Nbc6', say: "…cxd4 rips open the centre while White's queen is offside, and …Nbc6 throws the last piece into the attack. Every black move comes with tempo and threat; White is busy untangling their queen and king while Black's army floods toward the centre. The two-pawn deficit means nothing if the initiative never stops.", sayShort: '…cxd4, …Nbc6 — open the centre, pile in.', arrows: [A('c6', 'd4')], highlights: [H('d4')] }),
  ...
  'french-defence::Burn Variation': {
    ...
    beats: [
      ...
      b({ id: 'bur5', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 dxe4 Nxe4 Be7 Bxf6 Bxf6 Nf3 Nd7 Qd2 O-O O-O-O Be7 Bd3 b6 Kb1 Bb7', say: "Kb1 tucks the king away and …Bb7 completes Black's dream. Remember where this bishop began — boxed in behind the e6-pawn, the despair of every French player. Now it's reborn on the a8-h1 diagonal as Black's BEST piece, x-raying through the centre onto the e4-knight and the long light squares White can no longer cover. That single transformation — the bad bishop made good — is the whole reason you answer 3.Nc3 with …dxe4. Bishop pair, a sound structure, and a position bursting with trumps.", sayShort: '…Bb7 — the bad bishop, reborn as the best.', arrows: [A('b7', 'e4')], highlights: [H('b7'), H('e4', SOFT)] }),
    ],
  },
  ...
  'french-defence::Fort Knox Variation': {
    ...
    beats: [
      ...
      b({ id: 'fk3', moves: 'e4 e6 d4 d5 Nd2 dxe4 Nxe4 Bd7 Nf3 Bc6 Bd3 Nd7 c3 Ngf6 Nxf6+ Nxf6', say: "Bd3, …Nd7 and c3 develop quietly, and Black meets Nxf6+ with …Nxf6, trading a pair of knights. Each trade suits Black — fewer pieces means White's slight space edge matters less and Black's solid structure becomes ever easier to hold. The name fits: this position is built like a vault.", sayShort: '…Nxf6 — trade down, keep it solid.', highlights: [H('f6')] }),
      b({ id: 'fk4', moves: 'e4 e6 d4 d5 Nd2 dxe4 Nxe4 Bd7 Nf3 Bc6 Bd3 Nd7 c3 Ngf6 Nxf6+ Nxf6 O-O Bxf3 Qxf3', say: "Black castles and then plays …Bxf3, trading the prized c6-bishop for the f3-knight. Why give up the good bishop? Because it removes White's best minor piece and, crucially, drags the white queen to f3 — off the centre — so Black can seize it themselves. This is the active Fort Knox, not a passive crouch.", sayShort: "…Bxf3 — trade to pull White's queen off-centre.", highlights: [H('f3')] }),
      b({ id: 'fk5', moves: 'e4 e6 d4 d5 Nd2 dxe4 Nxe4 Bd7 Nf3 Bc6 Bd3 Nd7 c3 Ngf6 Nxf6+ Nxf6 O-O Bxf3 Qxf3 Qd5', say: "…Qd5! — the key improvement. Black centralises the queen on the best square on the board, offering a trade that further simplifies and eyeing both a2 and the kingside. After the queen retreats, …Bd6 develops with gain of tempo. There is the active Fort Knox tabiya: completely sound, no weaknesses, but now with the more active pieces — Black scores comfortably above fifty percent here, a clear upgrade on the old passive …c6 set-up.", sayShort: '…Qd5 — centralise, active and equal-plus.', highlights: [H('d5')] }),
    ],
  },
  ...
  'french-defence::Advance: Milner-Barry Gambit': {
    ...
    orientation: 'black',
    beats: [
      b({ id: 'mb1', moves: 'e4 e6 d4 d5 e5 c5 c3 Nc6', say: "You're in an Advance, and White is about to gambit. First the normal moves — e5, …c5 hitting the base, c3 propping it, …Nc6 pressing d4. White's next will offer the d4-pawn for fast development and an attack. Black's task is the eternal gambit question: accept, then prove the pawn is worth more than the activity.", sayShort: '…Nc6 — pressure d4 before the gambit.', arrows: [A('c6', 'd4')], highlights: [H('d4')] }),
  ...
  'french-defence::McCutcheon Variation': {
    ...
    beats: [
      ...
      b({ id: 'mcc5', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 Bb4 e5 h6 Bd2 Bxc3 bxc3 Ne4 Qg4 g6 Bd3 Nxd2 Kxd2', say: "Bd3 challenges the knight and …Nxd2 Kxd2 forces the white king into the open — it cannot castle and must shuffle on d2. Black has traded off into a position where White's king is exposed in the centre and their pawns are wrecked. The bishop trade cost Black nothing they weren't happy to give.", sayShort: '…Nxd2 — drag the white king out to d2.', highlights: [H('d2')] }),
  ...
  'french-defence::Rubinstein Variation': {
    ...
    beats: [
      ...
      b({ id: 'rub5', moves: 'e4 e6 d4 d5 Nc3 dxe4 Nxe4 Nd7 Nf3 Ngf6 Nxf6+ Nxf6 Bd3 c5 dxc5 Bxc5 O-O O-O Bg5 b6 Qe2 Bb7', say: "Qe2 centralises and …Bb7 completes the job. Here's why this bishop is worth so much: from b7 it stares the length of the a8-h1 diagonal at the f3-knight and the g2-pawn — the front door of White's castled king. The old 'bad' French bishop is now the one piece both sides keep watching. There's the Rubinstein tabiya: sound, harmonious, the bishop pair, no weaknesses. It's a shade passive and Black must respect White's space — but Black is never worse than a sliver, and that bulletproof reliability is exactly why you play it.", sayShort: "…Bb7 — eyes the king's front door.", arrows: [A('b7', 'f3')], highlights: [H('b7'), H('f3', SOFT)] }),
    ],
  },
};
