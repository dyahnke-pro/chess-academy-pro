...
export const FRENCH_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'french-defence::Classical Variation': {
    ...
    beats: [
      ...
      b({ id: 'cla3', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 Be7 e5 Nfd7 Bxe7 Qxe7 f4 O-O Nf3 c5', say: "f4 braces the e5-spearhead; Black castles and strikes the base with …c5. The structure is the familiar French chain, and Black's job is clear — pressure d4, prepare the …f6 lever, and get the pieces pointing at White's centre and king.", sayShort: '…c5 — hit the base of the chain.', highlights: [H('c5'), H('d4')] }),
      b({ id: 'cla4', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 Be7 e5 Nfd7 Bxe7 Qxe7 f4 O-O Nf3 c5 Qd2 Nc6 O-O-O', say: "…Nc6 adds the second hit on d4, and White commits to O-O-O — castling queenside. Now the game becomes a pure race: the kings sit on opposite wings, so whoever's pawn storm lands first wins. Black already has …c5 rolling toward White's king; the attack writes itself.", sayShort: '…Nc6 — opposite-side race begins.', arrows: [A('c6', 'd4')], highlights: [H('d4'), H('c5', SOFT)] }),
      b({ id: 'cla5', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 Be7 e5 Nfd7 Bxe7 Qxe7 f4 O-O Nf3 c5 Qd2 Nc6 O-O-O f6', say: "…f6 — the second French lever, prising open the centre and the f-file right when White's king has fled to the queenside. Black opens lines toward the enemy centre while the …c5–c4 pawn storm gathers against c1. The position crackles with mutual attack.", sayShort: '…f6 — crack the centre, open the f-file.', highlights: [H('f6')] }),
      b({ id: 'cla6', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 Be7 e5 Nfd7 Bxe7 Qxe7 f4 O-O Nf3 c5 Qd2 Nc6 O-O-O f6 exf6 Qxf6', say: "exf6 Qxf6 — and the queen swings to f6, suddenly active, bearing down on d4 and f4 and the open files. There's the Classical tabiya: opposite-side castling, Black's pawns and pieces aimed at the white king on c1, the chain dissolved into open, dynamic play. From the quiet 4…Be7 has grown a full-blooded attacking position — exactly what the French is built to deliver.", sayShort: '…Qxf6 — the queen springs to life, eyeing d4.', arrows: [A('f6', 'd4'), A('f6', 'f4', SOFT)], highlights: [H('d4'), H('f4')] }),
    ],
  },
