...
const VS_D5: LessonScript = {
  ...
  beats: [
    b({ id: 'd5', moves: 'd4 d5 Bf4 Nf6 e3 c5',
      ...
      say: "When Black meets you with a classical d5 and then hits the centre with c5, you are on the main road of the London. The position is symmetrical and solid; your edge comes from being first to the good squares.",
    ...
    b({ id: 'tension', moves: 'd4 d5 Bf4 Nf6 e3 c5 Nf3 Nc6 Nbd2 cxd4 exd4 Bf5 c3',
      ...
      say: "Black releases the tension and develops the bishop to f5. You recapture toward the centre and play c3, building the little pawn triangle c3-d4 that is the backbone of the whole system — the d4-pawn is now bomb-proof.",
    ...
    b({ id: 'trade', moves: 'd4 d5 Bf4 Nf6 e3 c5 Nf3 Nc6 Nbd2 cxd4 exd4 Bf5 c3 e6 Be2 Bd6 Bxd6 Qxd6',
      ...
      say: "When Black offers to trade the dark-squared bishops with Bd6, you take — Bxd6. Trading off Black's good bishop leaves you with the slightly better minor pieces and a clean structure to play against. The queen recaptures on d6.",
    ...
    b({ id: 'castle', moves: 'd4 d5 Bf4 Nf6 e3 c5 Nf3 Nc6 Nbd2 cxd4 exd4 Bf5 c3 e6 Be2 Bd6 Bxd6 Qxd6 O-O',
      ...
      say: "You castle into a comfortable, risk-free middlegame: the c3-d4 wall, the half-open e-file, and the standard plan of Ne5 and a minority push on the queenside. Nothing flashy — just a pleasant edge this repertoire converts against very strong opposition.",
      sayShort: 'O-O — risk-free edge, aim Ne5.' }),
  ],
};

// ── vs …e6 setup: Black offers the bishop trade; you keep Ne5 + Bd3 ──
const VS_E6: LessonScript = {
  ...
  beats: [
    b({ id: 'e6', moves: 'd4 Nf6 Bf4 e6 e3 d5',
      ...
      say: "Black plays a restrained e6 and d5 — a Queen's-Gambit-Declined-style wall. It is solid, but it shuts in Black's own light-squared bishop on c8, the classic problem piece. You keep building.",
    ...
    b({ id: 'ne5', moves: 'd4 Nf6 Bf4 e6 e3 d5 Nf3 Bd6 Ne5',
      ...
      say: "Black challenges your bishop with Bd6; instead of trading, you leap into e5. The knight there is worth more than the bishop trade — it cannot be kicked and it cements your grip on the centre and the kingside.",
    ...
    b({ id: 'support', moves: 'd4 Nf6 Bf4 e6 e3 d5 Nf3 Bd6 Ne5 O-O Nd2 c5 c3 Nc6 Bd3',
      ...
      say: "You back the e5-knight with the d2-knight, brace the centre with c3, and swing the bishop to d3 — pointing straight at h7. Now the e5-knight and the d3-bishop form a battery aimed at Black's castled king. This is the attacking version of the London.",
...
const VS_C5: LessonScript = {
  ...
  beats: [
    b({ id: 'qb6', moves: 'd4 Nf6 Bf4 c5 e3 Qb6',
      ...
      say: "The critical test of the London: Black hits the centre with c5 and immediately jumps the queen to b6, attacking both the d4-pawn and the loose b2-pawn. Many White players panic here. You have a clean solution.",
      sayShort: '…Qb6 — double-hit on b2 and d4.' }),
    b({ id: 'na3', moves: 'd4 Nf6 Bf4 c5 e3 Qb6 Na3',
      arrows: [A('a3', 'c4')], highlights: [{ square: 'a3', color: KEY }],
      say: "Na3 — the modern antidote. It looks ugly on the rim, but the knight is heading to c4, where it hits the b6-queen with tempo and defends everything. You refuse to weaken your queenside with b3 or Qc1.",
    ...
    b({ id: 'nc4', moves: 'd4 Nf6 Bf4 c5 e3 Qb6 Na3 d6 Nc4 Qc7',
      ...
      say: "After d6, the knight lands on c4 hitting the queen, which retreats to c7. You have gained a tempo, kept your structure intact, and the knight on c4 is a monster — eyeing d6, b6 and e5.",
    ...
    b({ id: 'develop', moves: 'd4 Nf6 Bf4 c5 e3 Qb6 Na3 d6 Nc4 Qc7 Nf3 g6 h3 Bg7 Be2',
      ...
      say: "You finish with Nf3, h3 to deny Black's pieces g4, and Be2. White is fully developed with the better-placed pieces and a rock-solid centre, having calmly defused Black's most aggressive try. This repertoire scores heavily from here.",
...
const VS_D6: LessonScript = {
  ...
  beats: [
    b({ id: 'd6', moves: 'd4 Nf6 Bf4 d6 Nc3 g6',
      ...
      say: "When Black plays a King's-Indian setup with d6 and g6 but holds back from d5, you are handed the centre — so you take all of it. Nc3 prepares the big push.",
    ...
    b({ id: 'e4', moves: 'd4 Nf6 Bf4 d6 Nc3 g6 e4 Bg7',
      ...
      say: "e4! This is the aggressive face of the London — a full pawn centre on d4 and e4 with the bishop already developed to f4. You have a Pirc-style position but with your problem bishop already outside the pawn chain.",
    ...
    b({ id: 'qd2', moves: 'd4 Nf6 Bf4 d6 Nc3 g6 e4 Bg7 Qd2 O-O O-O-O',
      ...
      say: "Qd2 connects with the f4-bishop, eyeing the h6-square for a bishop trade and a kingside hack, and you castle queenside. Now the two kings sit on opposite wings — and that means a pawn-storm race you are set up to win.",
    ...
    b({ id: 'h4', moves: 'd4 Nf6 Bf4 d6 Nc3 g6 e4 Bg7 Qd2 O-O O-O-O c6 h4',
      ...
      say: "h4! The storm begins. With opposite castling you throw the h-pawn at Black's fianchetto: h4-h5 will pry open the h-file straight onto the king. Bxh6 and a rook-lift follow. This is the most dangerous weapon in this repertoire's London — calm setup, violent finish.",
