...
export const ANTI_MODERN_150_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'm150-5', moves: 'e4 g6 d4 Bg7 Nc3 d6 Be3 a6 Qd2 Nf6 f3 O-O O-O-O Nc6 Nd5 a5 Nxf6+ exf6 h4 f5 h5 fxe4',
      say: "And now the avalanche. h4-h5 smashes into g6, prising open the h-file straight at Black's king — while their queenside counterplay is hopelessly, laughably slow. They flail with …f5, but it's already over: you're winning by a clear margin. THIS is why the 150 terrorises the Modern — pure, direct, and brutally effective.",
