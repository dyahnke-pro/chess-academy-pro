...
export const PHILIDOR_DEFENCE_LESSON: LessonScript = {
  ...
  orientation: 'black',
  beats: [
    b({ id: 'open', moves: 'e4 e5 Nf3 d6', say: "The Philidor — Black's rock-solid answer to 1.e4. Rather than defend the e5-pawn with a piece, Black props it with the pawn …d6. The structure is humble but unbreakable: no weaknesses, no early tactics, and a clear plan to follow. Philidor themselves called the pawns 'the soul of chess', and here they are the foundation.", sayShort: '…d6 — prop e5, build a solid base.', highlights: [H('e5'), H('d6')] }),
