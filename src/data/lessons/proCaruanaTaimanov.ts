...
export const PRO_CARUANA_TAIMANOV_LESSON: LessonScript = {
  ...
  title: "This repertoire's Taimanov Sicilian",
  minutes: 9,
  orientation: 'black',
  kind: 'variation',
  sources: SRC,
  beats: [
    b({ id: 'e6', moves: 'e4 c5 Nf3 e6', say: "The Taimanov Sicilian — This repertoire's flexible, less-forcing answer to e4. The early e6 keeps every option open, letting Black choose their structure based on what White reveals. Sound and rich in plans.", sayShort: '…e6 — the flexible Sicilian.', highlights: [H('e6')] }),
    ...
    b({ id: 'oo', moves: 'e4 c5 Nf3 e6 d4 cxd4 Nxd4 Nc6 Nc3 a6 Nxc6 bxc6 Bd3 d5 O-O Nf6', say: "White castles and Black develops the knight to f6, reinforcing the d5-pawn and pressuring e4. Black's centre is broad and their pieces come out naturally — comfortable, active development.", sayShort: '…Nf6 — reinforce d5, hit e4.', arrows: [A('g8', 'f6')], highlights: [H('f6')] }),
