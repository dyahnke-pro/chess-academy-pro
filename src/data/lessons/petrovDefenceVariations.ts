...
export const PETROV_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  'petrov-defence::Steinitz Variation': {
    ...
    beats: [
      ...
      b({ id: 's5', moves: 'e4 e5 Nf3 Nf6 d4 Nxe4 Bd3 d5 Nxe5 Nd7 Nxd7 Bxd7 O-O Bd6 c4 c6 Nc3 Nxc3 bxc3 O-O Qh5 g6 Qh6 f6 Rb1 Bc7 Re1', say: "White lunges with Qh5–h6 to provoke …g6 and …f6, but the attack has no support — Black calmly retreats …Bc7 keeping the bishop, and the queen on h6 is left biting on granite. After Rb1 and …f6 the kingside is sealed. There is the Steinitz tabiya: Black solid, the extra c-pawn weakness still White's to nurse.", sayShort: '…Bc7 — repel the lone queen, hold firm.', highlights: [H('h6'), H('c7'), H('f6', SOFT)] }),
    ],
  },
