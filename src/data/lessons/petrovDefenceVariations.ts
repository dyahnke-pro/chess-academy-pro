...
export const PETROV_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'petrov-defence::Kaufmann Attack': {
    ...
    beats: [
      ...
      b({ id: 'kf2', moves: 'e4 e5 Nf3 Nf6 Nxe5 d6 Nf3 Nxe4 Nc3 Nxc3 dxc3 Be7 Bf4 Nc6 Qd2 Be6 O-O-O', say: "Black trades on c3 and develops with the most natural moves in chess — …Be7, …Nc6, …Be6 — every piece going to its best square. White throws the queen to d2 and castles queenside; but Black will castle the SAME side, taking the sting out of any attack before it starts.", sayShort: '…Be7, …Nc6, …Be6 — natural development.', highlights: [H('e6', KEY), H('e7', SOFT)] }),
      b({ id: 'kf3', moves: 'e4 e5 Nf3 Nf6 Nxe5 d6 Nf3 Nxe4 Nc3 Nxc3 dxc3 Be7 Bf4 Nc6 Qd2 Be6 O-O-O Qd7 Kb1 O-O-O Ng5 Bxg5 Bxg5 f6', say: "Black castles queenside too — the key defensive idea: with both kings on the same wing, White has no pawn-storm to throw. White probes with Ng5, but Black simply trades it with …Bxg5 and then plays …f6, kicking the bishop back and shoring up the centre. There is the Kaufmann tabiya: both kings safe, the structure symmetric and solid — comfortable, principled equality, the Petrov's promise.", sayShort: '…Bxg5, …f6 — trade and solidify, equal.', highlights: [H('f6', KEY), H('g5', SOFT)] }),
    ],
  },
