...
export const GLEK_SYSTEM_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: "bc5bg2", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 Bc5 Bg2", say: "Black's most popular reply is Bc5, developing actively and eyeing f2, and White completes the fianchetto with Bg2. That bishop on g2 is the soul of the system. For now its own knight on f3 stands in front of it, but the moment that knight reroutes, the bishop will glare straight down the long diagonal at Black's centre and queenside. White's structure is solid and their plans stay flexible.", sayShort: "Bg2 — the fianchettoed bishop's home.", highlights: [H("g2", KEY), H("f3", SOFT)] }),
    b({ id: "tabiya", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 Bc5 Bg2 d6 d3 a6 O-O O-O", say: "Both sides build calmly — d6 and d3 prop the centre pawns, and both castle into safety. Two details carry real teaching. First, a6 is not a waiting move: without it, White plays the knight to a4 and forces the dark-squared bishop — Black's key defender — into a trade, banking the bishop pair for the whole game. The pawn on a6 gives that bishop its escape hatch on a7. And if you ever do land Na4 against a careless opponent, don't hurry the capture; the bishop is going nowhere, so improve first and take when it suits you. Second, Black plays …d6 before castling for a concrete reason — castling first walks straight into the fork trick Nxe5 and d4, which you punish elsewhere. This is the Glek tabiya: a closed centre, White's king snug behind the fianchetto, a system where White knows the plan and Black often does not.", sayShort: "O-O — the tabiya; a6 stops Na4.", arrows: [A("c3", "a4", INTENT)], highlights: [H("a6", KEY), H("c5", SOFT)] }),
    b({ id: "be3", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 Bc5 Bg2 d6 d3 a6 O-O O-O h3 h6 Be3 Bxe3 fxe3", say: "From the tabiya White stands at a fork with two good roads. The traditional plan tucks the king on h2, drops the knight to d2 and storms with f4 — that whole attack is its own lesson in the middlegame plans below. Here you walk the other road. First h3, a genuinely useful move that denies g4 to Black's pieces; Black answers h6, a common reflex that just costs time — White was never coming to g5. Then Be3 offers the trade of dark-squared bishops, and after Bxe3 White recaptures toward the centre — fxe3. The point hides in that recapture: it opens the f-file for the rook and builds a broad pawn front on e3 and e4. The symmetrical calm has quietly become a small space edge and an open file to attack down.", sayShort: "fxe3 — open the f-file, build the centre.", highlights: [H("e3", KEY), H("h3", SOFT)] }),
