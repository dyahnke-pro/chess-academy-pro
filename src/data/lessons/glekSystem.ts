...
export const GLEK_SYSTEM_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: "tabiya", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 Bc5 Bg2 d6 d3 a6 O-O O-O", say: "Both sides build calmly — d6 and d3 prop the centre pawns, a6 gives the bishop a retreat, and both castle into safety. This is the Glek tabiya: a closed, manoeuvring centre on e4 and e5, White's king snug behind the fianchetto. There is no contact yet, no forcing line. This is a positional system, and the whole point is that White knows the plan and Black often does not.", sayShort: "O-O — the calm Glek tabiya.", highlights: [H("e4", KEY), H("e5", SOFT)] }),
