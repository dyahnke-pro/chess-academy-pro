...
export const PRO_SAMAYRAINA_CARO_WHITE_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'c4', moves: 'e4 c6 c4 d5 exd5 cxd5 d4',
      ...
      say: "Against the Caro, this repertoire's choice is c4 — the Accelerated Panov. You immediately challenge d5 and, after the trades, build a d4 centre. Instead of the slow Classical Caro, you get an open, dynamic game where White's development lead and central pressure do the talking.",
    ...
    b({ id: 'cxd5', moves: 'e4 c6 c4 d5 exd5 cxd5 d4 Nf6 Nc3 Nc6 Bg5 e6 Nf3 Be7 cxd5 Nxd5',
      ...
      say: "After both sides develop, you clarify with cxd5 — Black recaptures with the knight and you reach the classic IQP position: an isolated d-pawn for White, but in return a beautiful free game with active pieces, the d5 and e5 outposts, and attacking chances against Black's king.",
    ...
    b({ id: 'plan', moves: 'e4 c6 c4 d5 exd5 cxd5 d4 Nf6 Nc3 Nc6 Bg5 e6 Nf3 Be7 cxd5 Nxd5',
      ...
      say: "The IQP plan: develop Bd3 and Re1, jump a knight into e5, and use the d-pawn as a springboard for a kingside attack with ideas like Bxh7 or a knight sacrifice. The isolated pawn is dynamic, not weak — as long as you attack. If Black trades everything off, only then does the endgame favour Black, so you keep the pieces on and press.",
