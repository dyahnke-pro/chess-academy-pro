...
const VS_E6: LessonScript = {
  ...
  beats: [
    b({ id: 'e6', moves: 'e4 c6 c4 e6 Nc3 d5 e5',
      ...
      say: "When Black plays …e6 and …d5, you get a French structure but with your c-pawn already on c4. You advance e5, grabbing space and locking the centre — and Black's light-squared bishop is buried behind the e6-pawn, the chronic French problem.",
    ...
    b({ id: 'space', moves: 'e4 c6 c4 e6 Nc3 d5 e5 d4 Nce2 c5 Ng3 Nc6 Nf3',
      ...
      say: "Black tries to clamp with …d4, so you reroute the knight via e2 to g3, eyeing the f5 and h5 squares for a kingside attack. The e5-pawn cramps Black and your pieces flow to the kingside — a classic space-and-attack setup.",
