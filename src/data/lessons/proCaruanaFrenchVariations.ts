...
const ADVANCE: LessonScript = {
  ...
  beats: [
    b({ id: 'c5', moves: 'e4 e6 d4 d5 e5 c5', say: "White grabs space and locks the centre with e5. This repertoire hits the base of the pawn chain at once with c5 — the thematic French strike at the d4-pawn that props the whole structure.", sayShort: '…c5 — hit the chain’s base.', highlights: [H('c5'), H('d4')] }),
...
const TARRASCH: LessonScript = {
  ...
  beats: [
    b({ id: 'be7', moves: 'e4 e6 d4 d5 Nd2 Be7', say: "Against the Tarrasch knight to d2, this repertoire chooses the flexible bishop to e7 — keeping the structure fluid rather than committing early to the sharp c5 lines.", sayShort: '…Be7 — keep it flexible.', highlights: [H('e7')] }),
...
const EXCHANGE: LessonScript = {
  ...
  beats: [
    b({ id: 'exd5', moves: 'e4 e6 d4 d5 exd5 exd5', say: "White trades on d5 — the Exchange French. It looks symmetrical and drawish, but this repertoire plays the resulting open position for a win with the more active pieces.", sayShort: '…exd5 — open and symmetric.', highlights: [H('d5')] }),
    ...
    b({ id: 'oo', moves: 'e4 e6 d4 d5 exd5 exd5 Nf3 Nf6 Bd3 Bd6 O-O O-O', say: "Both castle and the symmetry is intact — but whoever grabs the open e-file or lands the first c-pawn break takes over. This repertoire plays this tabiya for the long technical squeeze, not the draw.", sayShort: '…O-O — play for the squeeze.', highlights: [H('g8')] }),
  ],
};
