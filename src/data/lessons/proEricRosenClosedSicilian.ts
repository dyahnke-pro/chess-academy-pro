...
export const PRO_ERICROSEN_CLOSED_SICILIAN_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'nc3', moves: 'e4 c5 Nc3 d6 f4',
      arrows: [A('f4', 'f5')], highlights: [{ square: 'f4', color: KEY }, { square: 'c3', color: SOFT }],
    ...
    b({ id: 'develop', moves: 'e4 c5 Nc3 d6 f4 Nc6 Nf3 g6 Bc4',
      arrows: [A('f1', 'c4')], highlights: [{ square: 'c4', color: KEY }, { square: 'f7', color: SOFT }],
    ...
    b({ id: 'center', moves: 'e4 c5 Nc3 d6 f4 Nc6 Nf3 g6 Bc4 Bg7 O-O e6 d4 Nxd4 Be3',
      arrows: [A('d2', 'd4'), A('c1', 'e3')], highlights: [{ square: 'd4', color: KEY }, { square: 'e3', color: KEY }],
    ...
    b({ id: 'plan', moves: 'e4 c5 Nc3 d6 f4 Nc6 Nf3 g6 Bc4 Bg7 O-O e6 d4 Nxd4 Be3',
      arrows: [A('f4', 'f5'), A('d1', 'e1')], highlights: [{ square: 'f5', color: KEY }, { square: 'h6', color: SOFT }],
