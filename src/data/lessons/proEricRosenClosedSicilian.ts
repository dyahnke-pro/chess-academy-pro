...
export const PRO_ERICROSEN_CLOSED_SICILIAN_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'nc3', moves: 'e4 c5 Nc3 d6 f4',
      ...
      say: "The Grand Prix Attack. Against the Sicilian you sidestep all the open theory: Nc3 and then f4, signalling a kingside pawn storm. No memorising twenty moves of Najdorf — just a clear, aggressive plan that scores heavily at club level.",
    ...
    b({ id: 'develop', moves: 'e4 c5 Nc3 d6 f4 Nc6 Nf3 g6 Bc4',
      ...
      say: "You develop naturally — Nf3 and the bishop to c4, aiming at f7. Black fianchettoes with g6 for a Dragon-style setup. The bishop on c4 and the f-pawn already telegraph where you are going: straight at Black's king.",
    ...
    b({ id: 'castle', moves: 'e4 c5 Nc3 d6 f4 Nc6 Nf3 g6 Bc4 Bg7 O-O e6',
      ...
      say: "You castle and Black plays …e6 to blunt the c4-bishop and prepare …d5. That is fine — it costs Black time and weakens the kingside dark squares. Your attacking scheme rolls on regardless.",
    ...
    b({ id: 'center', moves: 'e4 c5 Nc3 d6 f4 Nc6 Nf3 g6 Bc4 Bg7 O-O e6 d4 Nxd4 Be3',
      ...
      say: "d4! Now that Black has committed, you strike in the centre too. After the knight trade, Be3 develops with tempo and supports a big centre. You have the classic Grand Prix dream: a space edge, the bishop pair eyeing the kingside, and f4-f5 coming.",
