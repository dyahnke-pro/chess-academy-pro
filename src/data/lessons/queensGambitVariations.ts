  ...
  'queens-gambit::Exchange Variation': {
    ...
    beats: [
      ...
      },
      {
        ...
        say: "Both sides finish developing and Black shows their defensive idea: the knight reroutes from d7 to f8 and on toward g6, where it guards the kingside and the e-file. Black plays c6 — the rock of the Carlsbad — bracing d5 and bolstering the very square White intends to attack. The battle lines are drawn: White against the c6-pawn, Black covering their king.",
      ...
      },
      {
        ...
        highlights: [{ square: 'b4', color: KEY }],
        say: "b4 breaks. Black trades on b4, White recaptures axb4, and now the b-pawn is one square from its goal. Black redeploys the bishop to d6, eyeing the kingside in search of counterplay, because they know what is coming on the other wing. Everything White has done for fifteen moves was to reach this single pawn lever.",
      ...
      },
      {
        ...
        say: "b5! The spearhead lands, supported by the rook behind it on the b-file. Black has two bad choices. If they take on b5, White recaptures and the c6-pawn is gone — the c-file opens onto Black's position. If they allow b5xc6, the recapture leaves them a backward pawn on c6 sitting on a half-open file, exactly the target White wanted. Either way White gets the lasting weakness, and the rooks pour onto it. That is the minority attack: you push the minority precisely to manufacture the weakness you then besiege.",
    ...
    beats: [
      {
        ...
        say: "The Tartakower is Black's most respected solution to the whole Queen's Gambit problem: how to free the bad light-squared bishop locked behind e6. They insert h6 to question the pin, then plays b6 — fianchetto preparation. The problem bishop will come to b7 and finally breathe on the long diagonal. White must prove that they get something in return for letting it out.",
      ...
      },
      {
        ...
        say: "White strikes in the centre while the bishop is still on its launch pad: cxd5. Black recaptures with the knight, Nxd5 — and now the h4-bishop stares the length of the diagonal at the e7-bishop, ready to trade off a defender. White's plan is to simplify into a position where Black's freed bishop has less to bite on and their central pawn becomes a target.",
      ...
      },
      {
        ...
        say: "Black breaks with c5 to free their game, and the isolated pawn becomes a pair of hanging pawns on c5 and d5. They look strong — they control key central squares — but they are a pair of targets, advanced and unguarded by other pawns. White answers Qa3, piling onto the c5-pawn, and Bb5 develops with tempo down the diagonal toward Black's back rank on e8. The Tartakower's lesson is exactly this: Black solves their bad bishop, but the price is a long defence of weak central pawns. White's edge is small and permanent — the hallmark of the whole Queen's Gambit.",
    ...
    beats: [
      {
        ...
        say: "When Black plays dxc4 they Accept the gambit — and gives up the centre to do it. Edward Lasker's verdict is the key to the whole line: Black cannot actually hold the pawn, and there is no good reason to give up the centre for it. So White does not rush to win the c4-pawn back. They develop, builds a big pawn centre with d4 and a coming e4, and trusts that the pawn returns on its own terms.",
      ...
      },
      {
        ...
        say: "Both sides expand. White castles and plays Qe2, quietly preparing the central break e3-e4 and connecting the rooks. Black grabs queenside space with a6 and b5, chasing the bishop to b3, and develops their own light bishop to b7 where it rakes the long diagonal toward White's king. This is the QGA's character: White's centre versus Black's queenside space and active bishop. Tempo decides it.",
  ...
  'queens-gambit::Slav Defence Response': {
    ...
    beats: [
      ...
      },
      {
        ...
        say: "a4! The key move. It stops Black's …b5 in its tracks — Black can no longer hold the extra pawn with a pawn chain. The cost is the b4-square, slightly loosened, but that is a small price. Black gets their bishop out first with Bf5, onto the b1-h7 diagonal, exactly the developing move the Slav is built around. White will simply recapture the c4-pawn next and stand better in the centre.",
    ...
    beats: [
      {
        ...
        say: "The Semi-Slav is Black's most ambitious defence: they play BOTH c6 and e6, building a triangle of pawns that holds the centre like a fortress and keeps the option of grabbing on c4 and holding with …b5. It is rock-solid and double-edged. White's most principled answer is the Meran set-up — develop quickly, let Black take the pawn, then blow the centre open while Black is still untangling their queenside.",
      ...
      },
      {
        ...
        say: "The Meran. White develops naturally — e3, Bd3, and when Black takes dxc4, White recaptures Bxc4. Then Black plays b5, gaining queenside space and hitting the bishop. This is the tabiya of the whole variation: Black expands on the wing, but every tempo they spend on …b5 and …a6 and …c5 is a tempo White spends preparing to detonate the centre. It is a race.",
      ...
      },
      {
        ...
        arrows: [{ from: 'd3', to: 'h7', color: VIS }],
        highlights: [{ square: 'h7', color: KEY }],
        say: "The bishop drops back to d3, NOT to e2 — because on d3 it points down the b1-h7 diagonal at Black's king, and that diagonal is the whole point. Black develops their freed bishop to b7 and plays a6 to brace b5. Everything is poised. White is castled, their pieces aimed at the kingside; Black has space but a king that has not yet found cover.",
      ...
      },
      {
        ...
        say: "e4! The centre erupts. Black counters with c5 to hit d4, but White does not capture — they charge past with d5!, locking the centre and gaining a protected passed pawn that cramps Black for the rest of the game. Black bolts the door with e5. Now the position is a knife fight: White's central wedge and the coming kingside push against Black's queenside majority. The Semi-Slav lesson is nerve — meet Black's solidity by storming the centre with e4 and d5 the moment your pieces are ready, and play for the attack the wedge sets up.",
    ...
    beats: [
      {
        ...
        say: "With g3, White steers the Queen's Gambit into the Catalan — instead of developing the bishop to d3, they fianchetto it to g2. From the corner the bishop will rake the entire long light diagonal, a1 to h8, straight through the centre and at Black's queenside. It is the most positional weapon in the whole repertoire: White accepts a slower game in exchange for the most powerful bishop on the board.",
      ...
      },
      {
        ...
        say: "Black develops and grabs the c4-pawn — the typical Catalan try, betting that White will struggle to win it back. White doesn't chase with a piece; they play Qc2. Now TWO White forces aim at the loose pawn and the long diagonal at once: the queen on c2 eyes c4 directly, and the g2-bishop waits behind its knight on the long diagonal. The pawn cannot be held for long, and the diagonal springs to life the moment the knight steps aside.",
  ...
  'queens-gambit::Anti-QGD: Early Bf4 System': {
    ...
    beats: [
      ...
      },
      {
        ...
        say: "Black challenges the bishop with Bd6, offering a trade. White sidesteps with Bg3 — keeping the bishop and keeping the tension on the diagonal, still looking at the d6-bishop and the kingside. If Black ever trades on g3, White recaptures toward the centre and opens the h-file for their rook. The little bishop dance keeps White's structure flawless.",
