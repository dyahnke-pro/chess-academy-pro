...
export const PRO_NAR_ALAPIN_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "exd6 en passant! Then Qxd6 and we castle short. Black's queen is exposed in the centre, our king is safe, our bishop on b3 stares at f7, and we're ahead in development by a tempo. From here Naroditsky's plan is a4-a5 cramping Black's queenside.",
      sayShort: 'exd6 + O-O — open the centre, king safe.',
    }),
    b({
      id: 'expand', moves: 'e4 c5 c3 Nf6 e5 Nd5 Nf3 Nc6 Bc4 Nb6 Bb3 d5 exd6 Qxd6 O-O Be6 Bxe6 Qxe6 a4',
      arrows: [{ from: 'a4', to: 'a5', color: VIS }],
      highlights: [{ square: 'a4', color: KEY }, { square: 'a5', color: SOFT }],
      say: "Trade bishops on e6 to remove Black's best piece, then a4 starting the queenside crawl. a5 next, then a6 cramping Black's pawn structure. We score 73.8% in this exact line for a reason — Black's pieces never get coordinated while we just methodically expand.",
...
export const PRO_NAR_NAJDORF_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Bxf6 trade, we recapture with the bishop (keeping our pawn structure intact), and now Nb6 — the knight reroutes to c4 or a4, joining the queenside attack. The c-file is OURS, the queen on c7 has a clear shot at the white king, and we're attacking faster than White is. Score: 65% in his actual games.",
...
export const PRO_NAR_KID_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Nh5 reroutes, Nf4 lands on the prize square — hitting both the Be2 AND the g2 pawn. From here the kingside attack is real, the queen will come to h4 or g5, and the …f5 break opens lines toward the white king. 65% score across his 4,432 KID games for this exact treatment.",
...
export const PRO_NAR_ALEKHINE_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Be2 / Bf5 / O-O / Nd7 — the Modern Alekhine mainline. Our Bf5 develops actively (no Caro problem-bishop here), Nd7 prepares e6, and the position is structurally healthy in every measure. Score: 68.7% across 2,830 games for him as Black.",
...
export const PRO_NAR_KIA_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      highlights: [{ square: 'c3', color: KEY }, { square: 'd4', color: SOFT }],
      say: "Nc6 from Black, then our c3 supports an eventual d4 push. White's plan: d3-d4 cracking the centre, queenside expansion with a4, and kingside attack with Nh4 / f4. Score across 18,000 games: 69.7%. The system works.",
...
export const PRO_NAR_ROSSOLIMO_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "c4 + Nc3 — the maroczy bind structure. White has the broad centre, more space, easier development. Black's pieces are coordinated but cramped. From here our plan is queenside expansion (b4) or a4-a5 cramping further. 65.5% across 4,000+ games.",
...
export const PRO_NAR_JOBAVA_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Nc6 from Black hits our queen, we slide to d3 — bringing the queen to a beautiful diagonal aiming at h7. From here e4 opens lines, the kingside attack is real, and our 70.3% score across 2,000+ games reflects exactly this kind of advantage.",
...
export const PRO_NAR_RUY_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Nxd4 trade, our e5 pushes, Black's knight retreats to e8 (no other squares), and c3 supports our centre. From here we have space, the bishop pair, and a positional advantage that converts patiently. 62.5% score across nearly 3,000 games for this exact treatment.",
