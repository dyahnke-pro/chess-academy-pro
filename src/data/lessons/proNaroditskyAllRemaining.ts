...
export const PRO_NAR_ALAPIN_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "After …Nxe5 / dxe5 trades, Black plays …Be7 and we swing the queen out: Qg4 eyeing g7 + h7 + g7-pawn weakness. The endgame of the opening: cramped queenside + open kingside + active queen + structural advantage. 73.8% score in 2,752 games tells you this works.",
      sayShort: 'Qg4 — queen to the attack.',
    }),
  ],
};
