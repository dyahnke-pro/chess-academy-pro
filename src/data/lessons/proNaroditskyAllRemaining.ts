...
export const PRO_NAR_ALAPIN_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "This repertoire's anti-Sicilian. c3 isn't theory — it's a setup move. The whole point is move three: d4, with the pawn supported. You sidestep heavy Sicilian theory entirely and head for a position where practical chances to outplay matter more than memorisation. Solid, flexible, and surprisingly aggressive once the pieces find their squares.",
    ...
    b({
      ...
      say: "Black's main answer is Nf6 attacking e4. You push e5, kicking the knight to d5 where it sits awkwardly — no support, no good retreat squares. Black has bought one tempo for the next ten moves of awkwardness.",
    ...
    b({
      ...
      say: "Nf3 + Bc4. The bishop attacks the knight on d5 directly — once Black moves the knight, the diagonal opens up toward f7 for the long-term attacking plan. Black has to react; you keep the initiative throughout the opening.",
    ...
    b({
      ...
      say: "Nb6 chases the bishop, Bb3 keeps the diagonal. Now …d5 looks active for Black but it's exactly the response you wanted. The e5-pawn gets a target, and your next move opens the position favorably.",
    ...
    b({
      ...
      say: "exd6 en passant! Then Qxd6 and you castle short. Black's queen is exposed in the centre, your king is safe, your bishop on b3 stares at f7, and you're ahead in development by a tempo. From here this repertoire's plan is a4-a5-a6 cramping Black's queenside.",
    ...
    b({
      ...
      say: "Black develops with Be6 offering the bishop trade. You take it — Bxe6 Qxe6 — because Black's light-squared bishop was their best piece, and the queen now sits awkwardly on e6 blocking the e-file for the rook. Trade your good piece for theirs whenever it removes their best defender.",
    ...
    b({
      ...
      say: "Black retreats Qd7 trying to reorganise. You push a5 attacking the Nb6, forcing it back. The knight has nowhere good — Nd5 is fine but blockable; Nc8 is passive. Every move you make is a question Black can't answer cleanly.",
    ...
    b({
      ...
      say: "a6 — the crawl reaches its peak. You attack b7, fix Black's queenside pawns permanently, and create a long-term passed-pawn threat the moment Black has to deal with the …b6 weakness. The knight on d5 looks centralised but it can't help on the queenside.",
    ...
    b({
      ...
      say: "Black plays …b6 forced to stop a7, and NOW you open with d4 — the move c3 was setting up since move two. The centre opens with your king safe, your pieces developed, and Black's queenside cramped. Patience pays off.",
...
export const PRO_NAR_NAJDORF_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "The Najdorf begins the way every Sicilian does — White claims the centre with e4, and you answer on the wing with c5. That refusal to mirror is the whole point: instead of a symmetrical e5, the c-pawn fights for the d4-square from the side and hands you an unbalanced game where Black plays for the full point, not a draw.",
      sayShort: 'c5 — the Sicilian imbalance.',
    }),
    b({
      id: 'd6', moves: 'e4 c5 Nf3 d6',
      highlights: [{ square: 'd6', color: KEY }, { square: 'e5', color: SOFT }],
      say: "White develops the knight to f3 and you play d6 — small, but it does two jobs at once. It takes the e5-square away from White's pieces so nothing can land there and cramp you, and it opens the diagonal for your light-squared bishop later. Flexible and solid, the Najdorf keeps every plan alive.",
    ...
    b({
      ...
      say: "White breaks with d4, you trade, and the knight recaptures on d4 — the Open Sicilian. That knight is White's pride, sitting in the centre eyeing e6 and f5. But you have the half-open c-file to work with and a healthy queenside majority. Both sides have their trumps; this is the sharpest battleground in chess.",
    ...
    b({
      ...
      say: "White plays f4, grabbing kingside space and preparing the pawn storm — and you calmly develop Be7. That bishop does the quiet, essential work: it defends the pinned knight and stands ready to break the pin entirely. You're not slowing down; you're building the springboard for your own counterattack.",
    ...
    b({
      ...
      say: "White pushes h4 to keep storming; you reroute with Nb6, heading for the c4- and a4-squares where the knight bites into White's queenside. Now count the attackers: the queen on the c-file, the bishop on the long diagonal, the knight swinging to c4, and your own a- and b-pawns ready to roll. Black is a tempo up in the race — engine-level near-equal, but at human speed this is the attacker's dream, and you're the attacker.",
...
export const PRO_NAR_KID_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "The King's Indian Defence. Against d4 you develop Nf6 and then play g6, clearing the way for the bishop to come to g7. That fianchettoed bishop is going to be the soul of the whole opening — it points down the long dark diagonal at White's centre and queenside, it shelters your king, and it underwrites the kingside attack you're aiming for. Everything you do is built around it.",
      sayShort: 'g6 — clear the way for Bg7.',
    }),
    b({
      id: 'bg7', moves: 'd4 Nf6 c4 g6 Nc3 Bg7',
      highlights: [{ square: 'g7', color: KEY }],
      say: "White develops Nc3 and you complete the fianchetto with Bg7. For now the bishop's diagonal is masked by your own f6-knight, but that's temporary — the King's Indian is a coiled spring. You deliberately let White build a big pawn centre, planning to strike back at it later and unleash the bishop when the centre cracks open.",
    ...
    b({
      ...
      say: "White grabs the full classical centre with e4 — pawns on c4, d4 and e4, an imposing wall. You answer with d6, the modest move that defines the King's Indian: it supports the coming e5 break and keeps your structure flexible. You're not going to meet that centre head-on; you're going to undermine it from the flank.",
    ...
    b({
      ...
      say: "White develops Nf3 and you castle, tucking the king safely behind the fianchetto. Both sides finish mobilising; the calm before the storm. The whole King's Indian plan hinges on the next few moves, where you throw the gauntlet down in the centre.",
    ...
    b({
      ...
      say: "White develops Be2 — the solid Classical setup — and you play e5, the defining strike of the whole opening. You challenge the d4-pawn head-on and force White to make a decision that shapes the entire game: push d5 and lock the centre (which hands you a kingside pawn-storm), or resolve the tension in the centre. Either way, you've committed to the King's Indian's fighting soul.",
    ...
    b({
      ...
      say: "White castles, and you release the central tension with exd4 — the modern, flexible treatment. Rather than let White fix the structure with d5, you open the e-file for your rook and hand yourself fast, active piece play. This is the up-to-date King's Indian: dynamic piece activity over the old locked-centre grind.",
    ...
    b({
      ...
      say: "White braces the centre with f3, propping up e4 — but that move quietly weakens the dark squares around the king, which is grist for your mill. You develop Nc6, hitting the d4-knight and gaining time. Every piece you bring out comes with a threat; White is kept busy while you build.",
    ...
    b({
      ...
      say: "White develops Be3, and you begin the knight's journey to glory with Nh5 — heading for the f4-square. It looks like the knight is drifting to the rim, but it's aiming at a magnificent outpost. In the King's Indian, a knight on f4 is worth its weight in gold.",
    ...
    b({
      ...
      say: "Qd2 develops the queen, and Nf4 lands on the prize square — a monster knight hitting the Be2 and the g2-pawn right next to White's king. From here the attack plays itself: the queen swings to h4 or g5, an f5 break tears the kingside open, and the Bg7 you sheltered all opening finally roars down the long diagonal. The engine calls it near-level, but this is the King's Indian attacker's dream, and the initiative is yours.",
...
export const PRO_NAR_ALEKHINE_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "The Alekhine, and it breaks the rules on move one. Instead of meeting e4 in the centre, you attack it with Nf6 and invite White to chase you. The whole opening rests on one contrarian idea: let the opponent grab space and push pawns, because every pawn that advances is a pawn that can be undermined and a square left behind it. You provoke on purpose.",
      sayShort: 'Nf6 — provoke, invite the chase.',
    }),
    b({
      id: 'e5', moves: 'e4 Nf6 e5',
      highlights: [{ square: 'e5', color: KEY }, { square: 'd5', color: SOFT }],
      say: "White takes the bait with e5, kicking your knight and grabbing the big central space. This is exactly what you wanted to see. That advanced e5-pawn looks proud, but it is also a target you will chip at, and the square in front of it can never be defended by a pawn again.",
    ...
    b({
      ...
      say: "Your knight hops to d5, White expands with d4, and now you strike at the chain with d6. White's pawns look like a wall — d4 and e5 side by side — but you hit them at once. The moment you open the centre, all that space White invested becomes over-extension you can exploit.",
    ...
    b({
      ...
      say: "White develops Nf3, you trade the e5-wedge off with dxe5, and White recaptures with the knight. The imposing pawn centre is already gone, swapped for piece play, and White's edge in space has shrunk to almost nothing. The knight sits on e5 for now, but you can challenge it whenever you like.",
    ...
    b({
      ...
      say: "c6 — a small move doing big jobs. It gives your d5-knight a rock-solid home by covering the b5- and e4-squares an enemy piece might use to evict it, and it opens the door for your queen and prepares the whole queenside. Quiet, prophylactic, and typically Alekhine: no weaknesses, just steady improvement.",
    ...
    b({
      ...
      say: "White develops Be2, and you play the key move Bf5 — getting the light-squared bishop OUTSIDE the pawn chain before you ever play e6. This is the whole point that makes the Alekhine pleasant to play: unlike the Caro-Kann, your light bishop never gets buried behind its own pawns. It stands active on f5, eyeing the b1-c2 corner.",
    ...
    b({
      ...
      say: "White castles, and you play Nd7 — immediately questioning that knight on e5 and preparing the e6 move that will complete your fortress. Every piece now has a job, the structure is rock-solid, and you have reached a full, healthy middlegame from an opening the textbooks still politely call a provocation. That is the Alekhine's quiet triumph.",
    ...
    b({
      ...
      say: "So what is the plan from here? Everything points at White's remaining central pawn on d4. You challenge the e5-knight with Nd7, complete development with e6 and Be7, and then chip at d4 with pieces and, when it helps, a c5 or f6 break. Your active f5-bishop and sound structure mean the engine reads this as near-level — a comfortable game where White's early space has quietly become nothing special.",
...
export const PRO_NAR_KIA_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Nf3 — and here is the whole philosophy of this weapon: it is a SYSTEM, not a body of theory to memorise. Whatever Black does, you build the same King's Indian Attack setup — g3, Bg2, castle, d3, Nbd2, e4 — every single game. You learn the ideas once and play them forever; Black is the one who has to solve a fresh problem each time.",
      sayShort: 'Nf3 — a system, not theory.',
    }),
    b({
      id: 'fianchetto-start', moves: 'Nf3 Nf6 g3',
      highlights: [{ square: 'g3', color: KEY }, { square: 'g2', color: SOFT }],
      say: "Black mirrors with Nf6, and you start the fianchetto with g3. The bishop is headed for g2, where it will sit on the long light diagonal and become the quiet hero of the whole setup — pressuring Black's centre and queenside from a safe distance for the entire game.",
    ...
    b({
      ...
      say: "g6, Bg2, Bg7 — both sides fianchetto and the bishops eye each other down the long diagonal. It looks symmetric, but it isn't a dead draw in waiting: you get to choose the central plan, and that first-move initiative is exactly the small, durable edge the system is built to nurse.",
    ...
    b({
      ...
      say: "d3 — the KIA's signature restraint. You keep the pawn modest, refusing to commit the centre, and let Black over-extend with d5 grabbing more space. That space can become a target: the more Black commits, the more levers you get to strike at it later with your own e4 break.",
    ...
    b({
      ...
      say: "Nbd2 develops the knight where it belongs in this system — not blocking the c-pawn, but ready to reroute to c4 or f1-e3 depending on where the action is. Black grabs still more space with c5. You're inviting the big centre precisely so you can undermine it.",
    ...
    b({
      ...
      say: "e4 — the thematic break that gives the King's Indian Attack its bite. You strike at Black's d5-pawn and open lines for the Bg2. From here the position pivots into the classic KIA plans: e4-e5 to gain a kingside space-grip, or a central resolution that hands your long-diagonal bishop open lines.",
      sayShort: 'e4 — the thematic KIA break.',
    }),
    b({
      id: 'plans', moves: 'Nf3 Nf6 g3 g6 Bg2 Bg7 O-O O-O d3 d5 Nbd2 c5 e4 Nc6 c3',
      highlights: [{ square: 'c3', color: KEY }, { square: 'd4', color: SOFT }],
      say: "Black develops Nc6 and you play c3, bracing the centre and preparing d4. Now the three classic KIA plans all run at once off the same setup: d4 to crack the centre, a4 to expand on the queenside, and Nh4 with f4 to storm the kingside. Black has to guard everywhere because you've committed to nothing. The engine calls it roughly level — a flexible, one-sided game to play where your understanding does the work.",
...
export const PRO_NAR_ROSSOLIMO_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      highlights: [{ square: 'f3', color: KEY }],
      say: "Against the Sicilian you sidestep the ocean of Open-Sicilian theory. Nf3 develops naturally, and depending on how Black continues you deploy the same bishop-check idea: against d6 you have Bb5+, the Moscow, and against Nc6 the Bb5 Rossolimo. One coherent plan that dodges the sharpest preparation Black owns.",
    ...
    b({
      ...
      say: "Black interposes the knight on d7 — solid but a touch passive — and you castle to safety. Black nudges the bishop with a6. The key decision is coming: most players would trade on d7, but that hands Black easy development, so you do the opposite and keep your good bishop.",
      sayShort: 'Nd7 O-O — solid but passive for Black.',
    }),
    b({
      id: 'bd3', moves: 'e4 c5 Nf3 d6 Bb5+ Nd7 O-O a6 Bd3',
      highlights: [{ square: 'd3', color: KEY }],
      say: "Bd3 — retreat, but keep the bishop. This is the whole finesse: instead of trading on d7 and relieving Black's cramped position, you tuck the bishop back where it still eyes the kingside and stays a long-term asset. Denying the opponent the trade they want is a strategic weapon in its own right.",
    ...
    b({
      ...
      say: "Black develops the second knight to f6, and you lift the rook to e1 — backing the e4-pawn and quietly claiming the e-file for the future. Every move is low-commitment and improving; you are in no hurry, because Black's cramped setup will not fix itself.",
    ...
    b({
      ...
      say: "Black plays e6 to shore up the centre and free a bishop; you regroup with Bf1 — the modern maneuver. The bishop steps back to its starting square, but with the knight already off b1 it now guards the light squares flexibly and clears the d-file. Patience and re-routing over forcing play: that is the Rossolimo way.",
      sayShort: 'Bf1 — the modern regroup.',
    }),
    b({
      id: 'maroczy', moves: 'e4 c5 Nf3 d6 Bb5+ Nd7 O-O a6 Bd3 Ngf6 Re1 e6 Bf1 b6 c4',
      highlights: [{ square: 'c4', color: KEY }, { square: 'd5', color: SOFT }],
      say: "Black fianchettos with b6, and you clamp down with c4 — the Maroczy Bind. This is the structural prize: the c4- and e4-pawns together lock a vice on the d5-square, so Black can never free the position with the thematic d5 break. A bind Black cannot break is a bind that decides the game slowly.",
    ...
    b({
      ...
      say: "Bb7 and Nc3 complete the picture: the Maroczy Bind is locked in. You own more space, the d5-square is yours forever, and Black's pieces are coordinated but permanently cramped. The plan from here writes itself — expand on the queenside with b4 and a4-a5, and improve your pieces at leisure while Black struggles for a break that never comes. Objectively near-level, but a one-sided position to play.",
      sayShort: 'Nc3 — the bind is locked, you squeeze.',
    }),
  ],
};
...
export const PRO_NAR_JOBAVA_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "The Jobava London — and the whole attitude is in this third move. Instead of the quiet Nf3 of the ordinary London, you throw the knight to c3. It's a declaration: you want a tactical fight, not a slow positional grind. The knight eyes e4 and b5, and against an under-prepared opponent this offbeat aggression pays off fast.",
    ...
    b({
      ...
      highlights: [{ square: 'f4', color: KEY }],
      say: "Black develops Nf6 and you bring the bishop to f4 — the London bishop, but with teeth here. From f4 it rakes down toward c7, a square that often becomes tender in Black's camp. Paired with the knight on c3, you're not just developing; you're already leaning on Black's position with real threats.",
    ...
    b({
      ...
      say: "Nc6 develops and nudges your queen, and you slide her to d3 — onto a gorgeous attacking diagonal that stares all the way down at h7, the doorstep of Black's king. This is the position nearly every Jobava funnels into: the queen and bishop trained on the kingside, ready for e4 to blast the centre open.",
    ...
    b({
      ...
      say: "Black plays e6, buttressing the d5-pawn and opening a path for the dark-squared bishop to come to d6 and offer a trade of your strong f4-bishop. Solid and sensible from Black — but it commits the pawn structure and leaves the h7-square just as tender as before.",
      sayShort: 'e6 — Black shores up d5.',
    }),
    b({
      id: 'e3', moves: 'd4 d5 Nc3 Nf6 Bf4 c5 Nf3 cxd4 Qxd4 Nc6 Qd3 e6 e3',
      highlights: [{ square: 'e3', color: KEY }],
      say: "You solidify with e3, giving the position a firm base and keeping your options flexible — the centre stays ready for a later e4 break. There's no rush: your pieces are already better placed for the coming middlegame, and a sound structure lets you pick your moment to strike.",
    ...
    b({
      ...
      say: "Black offers the bishop trade with Bd6 and you accept, swapping the dark-squared bishops. That's fine for you: the trade pulls Black's queen to d6 where you can gain time hitting it later, and it clears the way for your own plan. You've traded a piece but kept the initiative and the more purposeful setup.",
...
export const PRO_NAR_RUY_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "You open the game the classical way — e4, and Black meets you head-on with e5. This is the Open Game, the oldest argument in chess: both sides stake a claim in the centre and fight for it directly. The Ruy Lopez is your weapon here, the deepest and most respected way to squeeze an edge out of this symmetrical start.",
    ...
    b({
      ...
      say: "Bb5 — the Ruy Lopez. Notice the idea: the bishop attacks the c6-knight, and that knight is the defender of Black's e5-pawn. You're not winning a pawn yet, but you're leaning on the whole point of Black's centre. This indirect pressure on e5, kept up move after move, is the soul of the Spanish.",
    ...
    b({
      ...
      arrows: [{ from: 'f6', to: 'e4', color: VIS }],
      highlights: [{ square: 'f6', color: KEY }, { square: 'e4', color: SOFT }],
      say: "Black develops Nf6, striking at your e4-pawn. It looks like you must defend — but the Ruy's cool secret is that e4 is not really hanging: if Black grabs it, you get the initiative back with interest. So instead of a fearful defence, you just keep developing and castle.",
      sayShort: 'Nf6 — Black hits e4, you stay calm.',
    }),
    b({
      id: 'castle', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7',
      highlights: [{ square: 'g1', color: SOFT }, { square: 'e7', color: KEY }],
      say: "You castle, tucking the king away, and Black develops the bishop to e7 and prepares to castle too. Both sides are building the classical Closed Spanish structure — no early fireworks, just sound development and a long, rich middlegame ahead where small edges decide.",
    ...
    b({
      ...
      arrows: [{ from: 'e1', to: 'e4', color: VIS }],
      highlights: [{ square: 'e1', color: KEY }],
      say: "Re1 — quiet but essential. The rook backs up the e4-pawn so any …Nxe4 ideas lose their sting, and it clears the way for the plan you're really after: c3 and then d4, the big central break. Everything in the Ruy points toward that break; this is you loading the spring.",
    ...
    b({
      ...
      say: "Black plays b5 to shove the bishop, and you drop it back to b3 — its best home. Look where it points now: straight down the a2-g8 diagonal at f7, the softest square in Black's camp. The bishop that started on b5 pressuring c6 has quietly become an attacker aimed at the king.",
    ...
    b({
      ...
      say: "Black castles, and you've reached the great tabiya of the Closed Ruy — the position more grandmaster games have started from than almost any other. Everything is developed, both kings are safe, and now the real fight begins in the centre. Your move has been prepared since Re1.",
    ...
    b({
      ...
      say: "d4 — the central break lands at last. You strike at e5 with a supported pawn, opening the centre now that your pieces are ready for it. The tension between d4 and e5 is the heart of the position; how it resolves shapes the whole middlegame, and you're the ones who chose the moment.",
    ...
    b({
      ...
      say: "Black releases the tension with Nxd4, you recapture, and Black takes back with the e-pawn. The dust settles: Black has a pawn on d4, but it's isolated and will become a target, while your e4-pawn stands proud and ready to advance. You've traded a pair of knights and come out with the more comfortable structure.",
    ...
    b({
      ...
      say: "e5 grabs space and kicks the f6-knight back to e8, cramping Black's kingside, and c3 turns to undermine that isolated d4-pawn. This is the Ruy in a nutshell: no single knockout blow, but space, the bishop pair aimed at Black's king, and a structural target to work against. The engine calls it near-level — which for White out of the opening is a healthy, pressing pull, and it's the kind of position you're happy to grind for a long time.",
