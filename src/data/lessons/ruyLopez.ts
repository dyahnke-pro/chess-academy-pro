...
export const RUY_LOPEZ_LESSON: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      sayShort: "…Nc6 — the only defender of e5. Remember it.",
    },
    {
      id: 'attack-defender',
      moves: ['e4', 'e5', 'Nf3', 'Nc6', 'Bb5'],
      arrows: [{ from: 'b5', to: 'c6', color: ATK }],
      say: "White does not attack the pawn. White attacks its defender — the c6-knight. That is the soul of the Spanish: patient, indirect pressure. White will never win e5 by force — White will simply make it exhausting for Black to hold.",
      sayShort: "Bb5 — attack the c6-defender, not the pawn.",
    },
    {
      id: 'demo-exchange',
      moves: ['e4', 'e5', 'Nf3', 'Nc6', 'Bb5', 'a6', 'Bxc6', 'dxc6'],
      highlights: [{ square: 'c6', color: KEY }, { square: 'c7', color: KEY }],
      say: "What if White just takes the knight? Watch. After the trade, Black's queenside pawns double on the c-file — c6 and c7 stack up. That structural weakness lasts into the endgame. That's a real plan, the Exchange Variation, a lesson of its own. But usually White is greedier than that.",
      sayShort: "Bxc6 — doubles Black's pawns; the Exchange Variation.",
    },
    {
      id: 'keep-pin',
      ...
      sayShort: "Ba4 — retreats but keeps the c6 pressure.",
    },
    {
      id: 'e4-bait',
    ...
    },
    {
      ...
      say: "Both sides develop calmly — knights and bishops out, kings tucked away. No fireworks. And White's rook slides to e1, lining up behind the e4-pawn. This is the rhythm of the Ruy: every piece points at the center before it points anywhere else.",
      sayShort: "O-O — calm; Re1 aims at e4, centre first.",
    },
    {
      id: 'bishop-home',
      ...
      sayShort: "Bb3 — the bishop finds its diagonal at f7.",
    },
    {
      id: 'quiet-prep',
      ...
      sayShort: "c3 — readies d4, opens c2 for the bishop.",
    },
    {
      id: 'prophylaxis',
    ...
    },
    {
      ...
      sayShort: "Nb8 — the Breyer reroute via d7.",
    },
    {
      id: 'the-break',
      ...
      say: "Finally — after nine moves of preparation — the central break lands. The whole opening has circled d4 and e5, and now those two squares collide. This is the moment the slow build pays off.",
      sayShort: "d4 — after nine prep moves, the centre breaks.",
    },
    {
    ...
    },
    {
      ...
      sayShort: "Bc2 — loaded toward h7, primed for the break.",
    },
    {
      id: 'f5-outpost',
      moves: M,
    ...
    },
    {
      ...
      sayShort: "…Nf6 — the Berlin wall, hitting e4 at once.",
    },
    {
      id: 'branch-marshall',
      moves: ['e4', 'e5', 'Nf3', 'Nc6', 'Bb5', 'a6', 'Ba4', 'Nf6', 'O-O', 'Be7', 'Re1', 'b5', 'Bb3', 'O-O', 'c3', 'd5'],
      highlights: [{ square: 'd5', color: KEY }, { square: 'e5', color: SOFT }],
      say: "Or Black can do something audacious: castle, then strike with …d5 in the center and offer the e5-pawn for a furious attack. This is the Marshall Attack — a prepared sacrifice that has terrified White players for over a century. Another chapter entirely. But again, the same root question: who controls the center, and at what price?",
      sayShort: "…d5 — the Marshall, sacrificing e5 for attack.",
    },
    {
      id: 'close',
      moves: M,
      highlights: [{ square: 'f5', color: SOFT }, { square: 'f7', color: SOFT }],
      say: "And that is the Ruy Lopez. Not a trap, not a knockout — a four-century argument about a single pawn and the squares around it. White builds slowly, presses the defender, aims the Bb3-bishop at f7 and a knight at f5. Black holds, reroutes, and waits to counterpunch. Learn this one idea — pressure the defender, not the pawn — and you don't just know the Ruy Lopez. You understand chess a little more deeply than you did fifteen minutes ago.",
      sayShort: "Pressure the defender — Bb3 on f7, Nf5.",
    },
  ],
};
