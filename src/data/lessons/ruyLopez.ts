...
export const RUY_LOPEZ_LESSON: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      sayShort: "The soul of the Ruy: attack the c6-defender, not the e5-pawn.",
    },
    {
      id: 'demo-exchange',
      ...
      sayShort: "Trading on c6 doubles Black's c6 and c7 pawns — the Exchange Variation.",
    },
    {
      id: 'keep-pin',
    ...
    },
    {
      ...
      sayShort: 'Calm development — the Re1 rook aims at e4. Every Spanish piece points at the center first.',
    },
    {
      id: 'bishop-home',
    ...
    },
    {
      ...
      sayShort: 'After nine moves of preparation, d4 strikes e5 — the center breaks open.',
    },
    {
    ...
    },
    {
      ...
      sayShort: 'The Marshall — …d5 sacrifices the e5-pawn for a roaring attack.',
    },
    {
      id: 'close',
      moves: M,
      ...
      sayShort: 'Pressure the defender, not the pawn — Bb3 at f7, knight at f5. That is the Ruy Lopez.',
    },
  ],
};
