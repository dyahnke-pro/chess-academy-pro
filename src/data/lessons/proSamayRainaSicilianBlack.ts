...
export const PRO_SAMAYRAINA_SICILIAN_BLACK_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'bxc6', moves: 'e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 e5 Nxc6 bxc6',
      ...
      say: "White usually trades with Nxc6 and you recapture toward the centre with bxc6. Look at what Black gets: a broad pawn front on c6 and e5, the two bishops, and a half-open b-file pointing straight at White's queenside.",
    ...
    b({ id: 'nf6', moves: 'e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 e5 Nxc6 bxc6 Nc3 Nf6',
      ...
      say: "You develop with Nf6, attacking the e4-pawn immediately and forcing White to spend energy defending it. Every Black move asks a question.",
    ...
    b({ id: 'bb4', moves: 'e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 e5 Nxc6 bxc6 Nc3 Nf6 Bg5 Bb4',
      ...
      say: "White pins with Bg5; you answer with Bb4, pinning the c3-knight — the defender of e4. Now the pressure on e4 is real, and the bishop pair gives Black the long-term trumps in an open position.",
