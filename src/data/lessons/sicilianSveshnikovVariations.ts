...
export const SICILIAN_SVESHNIKOV_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  beats: [
    ...
    b({ id: "nv2", moves: "e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 Nf6 Nc3 e5 Ndb5 d6 Bg5 a6 Na3 b5 Nd5 Be7 Bxf6 Bxf6 c3", say: "The standard route to the d5-outpost: …a6 and …b5 grab queenside space, and after the trade on f6 Black recaptures with the bishop to keep their dark-squared bishop intact. White supports d5 with c3.", sayShort: "…b5, …Bxf6 — space and the dark bishop kept.", highlights: [H("b5", KEY), H("f6", SOFT)] }),
  ...
  orientation: "black",
  beats: [
    b({ id: "rb1", moves: "e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 Nf6 Nc3 e5", say: "The Sveshnikov begins with …e5, trading a structural concession on d5 for dynamic piece play. This particular plan is all about the queenside, where Black's space advantage gives them a concrete pawn-lever to work with.", sayShort: "…e5 — the Sveshnikov, queenside in mind.", highlights: [H("e5", KEY)] }),
  ...
  "sicilian-sveshnikov::Sveshnikov: 11.c4 Queenside Grip": {
    openingId: "sicilian-sveshnikov", title: "Sveshnikov — meeting the 11.c4 grip", minutes: 9, orientation: "black",
    sources: ["concept:pos-outpost", "concept:pos-bishop-pair", "https://en.wikipedia.org/wiki/Sicilian_Defence"],
    beats: [
      { id: "cg1", moves: ["e4", "c5", "Nf3", "Nc6", "d4", "cxd4", "Nxd4", "Nf6", "Nc3", "e5", "Ndb5", "d6", "Bg5", "a6", "Na3", "b5", "Nd5", "Be7", "Bxf6", "Bxf6"], say: "The Sveshnikov tabiya: Black accepted the d5-octopus and the backward d6-pawn as the price of the bishop pair and the living centre. Bxf6 …Bxf6 seals the deal — White owns d5, Black owns the dark squares.", sayShort: "…Bxf6 — the deal is sealed.", highlights: [{ square: "d5", color: "rgba(255,214,0,0.88)" }, { square: "f6", color: "rgba(80,140,255,0.32)" }] },
      { id: "cg2", moves: ["e4", "c5", "Nf3", "Nc6", "d4", "cxd4", "Nxd4", "Nf6", "Nc3", "e5", "Ndb5", "d6", "Bg5", "a6", "Na3", "b5", "Nd5", "Be7", "Bxf6", "Bxf6", "c4", "b4", "Nc2", "O-O"], say: "c4 — White reaches for the full queenside grip. …b4! answers immediately: the pawn fixes the structure and shuts the a3-knight out of c2's natural partner squares — it has to crawl back through c2 just to breathe. Black castles while White reorganises.", sayShort: "…b4 — fix the pawn, exile the knight.", highlights: [{ square: "b4", color: "rgba(255,214,0,0.88)" }, { square: "a3", color: "rgba(80,140,255,0.32)" }] },
      { id: "cg3", moves: ["e4", "c5", "Nf3", "Nc6", "d4", "cxd4", "Nxd4", "Nf6", "Nc3", "e5", "Ndb5", "d6", "Bg5", "a6", "Na3", "b5", "Nd5", "Be7", "Bxf6", "Bxf6", "c4", "b4", "Nc2", "O-O", "g3", "a5", "Bg2", "Bg5"], say: "…a5 backs the b4-pawn for the long haul, and …Bg5! brings the dark-squared bishop back to its best diagonal — eyeing d2 and c1, and sitting on the squares White's kingside pawns would love to use. The bishop pair starts earning its keep.", sayShort: "…Bg5 — the dark squares are Black's.", arrows: [{ from: "g5", to: "c1", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "g5", color: "rgba(255,214,0,0.88)" }] },
      { id: "cg4", moves: ["e4", "c5", "Nf3", "Nc6", "d4", "cxd4", "Nxd4", "Nf6", "Nc3", "e5", "Ndb5", "d6", "Bg5", "a6", "Na3", "b5", "Nd5", "Be7", "Bxf6", "Bxf6", "c4", "b4", "Nc2", "O-O", "g3", "a5", "Bg2", "Bg5", "O-O", "Be6", "Qd3"], say: "…Be6 walks up and puts the question directly to the d5-octopus — trade it or reinforce it, but the squatting is no longer free. Qd3 holds everything together, and the engine reads the standoff as near-level: White's knight versus Black's bishops, the c4-grip versus the …a5-b4 counter-grip. The Sveshnikov bargain, alive and well fifteen moves in.", sayShort: "…Be6 — question the octopus.", arrows: [{ from: "e6", to: "d5", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "d5", color: "rgba(255,214,0,0.88)" }] },
    ],
  },
};
