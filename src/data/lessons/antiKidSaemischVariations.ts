...
const NC6_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'kid-nc6-2', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 f3 O-O Be3 Nc6 Nge2 a6 Qd2 Rb8',
      say: "You develop with Nge2 and Qd2 — the standard Sämisch build, the queen eyeing the kingside for a future Bh6 and pawn storm. Black prepares their flank play with a6 and Rb8. The battle lines are drawn: your central bind against their queenside expansion, and you're comfortably on top.",
...
const A6_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'kid-a6-2', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 f3 O-O Be3 a6 Qd2 c5 dxc5 dxc5',
      say: "You develop Qd2 and Black strikes with c5; you take dxc5 and after dxc5 the d-file swings open. This exchange has cost Black their central foothold — their d-pawn is gone, and your pieces are ready to pour down the newly-opened d-file into their position.",
...
const NBD7_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'kid-n7-2', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 f3 O-O Be3 Nbd7 Qd2 a6 O-O-O Rb8',
      say: "Qd2 completes the battery and you castle long — king tucked safe on the queenside, rooks connected, and the g- and h-pawns freed to storm. Black readies their own counter-attack with a6 and Rb8. It's a race of opposite-wing assaults, and you are the one aiming straight at the enemy king.",
