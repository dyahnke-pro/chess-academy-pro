...
const BF5_NE4_BISHOP_PAIR: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "b3 ...Ne4! — White develops the b-pawn and you plant the knight on e4. The Ne4 attacks the Nc3 and the bishop pair becomes vulnerable. If White retreats, Black continues with Nxc3 destroying the structure; if White trades, the dark-square bishop has to recapture on c3.",
    ...
    b({
      ...
      say: "Bb2 ...Nxc3 Bxc3 — you trade the knight, forcing the bishop onto c3. White has surrendered the bishop pair AND the b2-bishop is now blocked by its own queenside pawns. Black has won the structural fight from move 6 of the Fianchetto.",
...
const QXD8_BETTER_ENDGAME: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Bg5 ...Re8 — White's bishop pins your f6-knight, but you calmly redirect the rook to e8 protecting the e5-pawn and pointing at the e-file. The pin doesn't help White because you control the d-file AND the e-file.",
    ...
    b({
      ...
      say: "Nd5 ...Nxd5 cxd5 — knights trade and now White has DOUBLED c-pawns AND the d5-pawn is isolated. Black's structural edge is permanent. From here your knight reroutes to c5/d6, the c-file becomes a target, and the endgame converts on the queenside. Nihal Sarin at 2949 also lost this exact endgame.",
...
const BG4_PIN_FOUR_PAWNS: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Be2 ...Bxf3! — White develops the bishop trying to break the pin, but you don't wait. ...Bxf3 trades the bishop AND forces White's bishop to recapture on f3, doubling White's f-pawns. The doubled pawns are a permanent weakness AND you keep the bishop pair.",
