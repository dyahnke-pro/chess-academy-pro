...
export const GLEK_SYSTEM_VARIATION_LESSONS: Record<string, LessonScript> = {
  "glek-system::Central Break: 4...d5": {
    ...
    beats: [
      b({ id: "cb1", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 d5", say: "The instant White plays g3, the most principled reply is to strike the centre at once with d5. Rather than allow the slow fianchetto game, Black challenges the e4-pawn immediately and tries to open the position while White's king-bishop is still at home. This is the main line at the higher levels — the one line you really must know if you are serious about the Glek — so it is worth learning the resulting structure cold.", sayShort: "d5 — the immediate central strike.", highlights: [H("d5", KEY), H("e4", SOFT)] }),
      ...
      b({ id: "cb6", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 d5 exd5 Nxd5 Bg2 Nxc3 bxc3 Bc5 O-O O-O Re1 Qf6 d3 Bb6", say: "d3 props the centre and frees the c1-bishop; Black tucks the bishop back to b6. There is the typical Glek pawn structure you get from the d5 exchange — the half-open b-file, the broad c3-d3-e-none front, and the long-range g2-bishop. It is a lively, roughly level middlegame, but White's structure hands them the easier, more natural plans, while Black's soundness holds the balance. Learn this position and you will feel at home every time a strong opponent meets you with …d5.", sayShort: "d3, Bb6 — the typical Glek structure.", highlights: [H("b6", SOFT), H("g2", KEY)] }),
    ],
  },
  ...
  "glek-system::Symmetrical: 4...g6": {
    ...
    beats: [
      b({ id: "sy1", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 g6", say: "Black answers the fianchetto with a fianchetto of their own — g6, preparing to place the bishop on g7 along the long dark diagonal and mirror White's whole setup. Symmetry looks safe, but it hands the initiative to the side that breaks it first, and here White moves first.", sayShort: "g6 — Black mirrors the fianchetto.", highlights: [H("g7", SOFT)] }),
      b({ id: "sy2", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 g6 Bg2 Bg7 O-O O-O", say: "Both bishops take their long diagonals and both kings castle. It is a clean mirror — but White is a full move ahead in that mirror, and the extra tempo is exactly what they will use to strike in the centre before Black can arrange the same break.", sayShort: "Bg7, O-O — a mirror, White a tempo up.", highlights: [H("g2", KEY), H("g7", SOFT)] }),
