...
export const SCANDINAVIAN_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'scandinavian-defence::Gubinsky-Melts (3...Qd8)': {
    ...
    beats: [
      ...
      b({ id: 'g4', moves: 'e4 d5 exd5 Qxd5 Nc3 Qd8 d4 Nf6 Nf3 Bg4 Bc4 e6 h3 Bh5 O-O c6 g4 Bg6 Ne5', say: "Black castles by hand later and plays …c6 for solidity; White lashes out with g4 to grab the bishop, but …Bg6 calmly retreats it to the great diagonal. White's g4 has loosened his own king — a long-term weakness Black will target.", sayShort: '…Bg6 — retreat to the long diagonal.', highlights: [H('g6'), H('g4', SOFT)] }),
      b({ id: 'g5', moves: 'e4 d5 exd5 Qxd5 Nc3 Qd8 d4 Nf6 Nf3 Bg4 Bc4 e6 h3 Bh5 O-O c6 g4 Bg6 Ne5 Nbd7 Qe2 Be7', say: "Ne5 occupies the centre; Black develops …Nbd7 to challenge it and …Be7, completing a harmonious setup. There is the Gubinsky tabiya: Black utterly solid, no weaknesses, the bishop humming on g6, and White's loosened kingside as a long-term target. Patience rewarded.", sayShort: '…Be7 — complete the rock-solid setup.', highlights: [H('g6'), H('e7', SOFT)] }),
    ],
  },
};
