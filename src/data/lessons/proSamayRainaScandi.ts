...
export const PRO_SAMAYRAINA_SCANDI_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'qxd5', moves: 'e4 d5 exd5 Qxd5 Nc3 Qd8',
      ...
      say: "The Scandinavian — you hit the centre with …d5, recapture with the queen, and after Nc3 retreat all the way to d8. It looks passive, but it is the modern, super-solid choice: the queen is completely safe, and Black builds a rock-solid Caro-Kann-like structure with no weaknesses.",
    ...
    b({ id: 'nf6', moves: 'e4 d5 exd5 Qxd5 Nc3 Qd8 d4 Nf6 Nf3 Nc6',
      ...
      say: "You develop naturally — …Nf6 and …Nc6 hitting d4. Black's setup is simple and sound: develop every piece to a good square, castle, and play a solid middlegame where White's extra centre pawn is balanced by Black's easy, harmonious development.",
    ...
    b({ id: 'bf5', moves: 'e4 d5 exd5 Qxd5 Nc3 Qd8 d4 Nf6 Nf3 Nc6 Bc4 Bf5',
      ...
      say: "…Bf5! The key move — you develop the light-squared bishop OUTSIDE the pawn chain before …e6 ever locks it in. This solves the same problem the Caro and Scandinavian both have, and the bishop is beautifully active eyeing the b1-h7 diagonal.",
