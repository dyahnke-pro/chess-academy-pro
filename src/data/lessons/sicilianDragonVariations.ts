...
export const SICILIAN_DRAGON_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  beats: [
    ...
    b({ id: "mobilize", moves: "e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 g6 Be3 Bg7 f3 O-O Qd2 Nc6 Bc4 Bd7 O-O-O Rc8", say: "Black's army funnels toward White's king: Nc6 presses the d4-knight, Bd7 connects the rooks, and Rc8 swings onto the c-file — the highway to White's king now that they have castled long.", sayShort: "Nc6, Bd7, Rc8 — Black aims down the c-file.", arrows: [A("c6", "d4", ATK)], highlights: [H("c8", KEY)] }),
  ...
  beats: [
    ...
    b({ id: "b5", moves: "e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 g6 Be3 Bg7 f3 O-O Qd2 Nc6 Bc4 Bd7 O-O-O Rb8 Bb3 b5", say: "Bb3 tucks the bishop away, and Black fires the first shot: b5, threatening b4 to kick the c3-knight and prise open the b-file at White's king. Be honest about the price, though — this is a pawn sacrifice: White can grab on b5, and the engine rates the position clearly better for White objectively. The Chinese Dragon is a practical attacking weapon, banked on White's king being harder to defend than Black's over the board — a sharp gamble for the initiative, not an equaliser.", sayShort: "b5 — a pawn-sac charge; objectively worse but dangerous.", highlights: [H("b5", KEY), H("c3", SOFT)] }),
