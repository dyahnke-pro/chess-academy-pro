...
export const ENGLISH_OPENING_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "english-opening::English: Hedgehog System": {
    ...
    sources: ["concept:pos-space", "concept:pos-open-file", "https://en.wikipedia.org/wiki/English_Opening"],
    beats: [
      { id: "eh1", moves: ["c4", "c5", "Nc3", "Nc6", "g3", "g6", "Bg2", "Bg7", "Nf3", "Nf6", "O-O", "O-O"], say: "Pure symmetry — five identical developing moves each, both kings castled. In a mirror position the mover's advantage is the whole game: White will break the symmetry first, and on the wing of his choosing.", sayShort: "O-O — symmetry; the mover breaks it." },
