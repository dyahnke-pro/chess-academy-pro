...
export const ENGLISH_OPENING_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "english-opening::English: Botvinnik System": {
    ...
    beats: [
      ...
      b({ id: 'bv3', moves: 'c4 e5 Nc3 Nc6 g3 g6 Bg2 Bg7 e4 d6 Nge2 f5 d3 Nf6 O-O O-O Nd5 Nxd5 cxd5 Ne7 f4', say: "After …Nxd5 cxd5 White's pawn takes the outpost, gaining queenside space and a protected wedge; …Ne7 retreats, and White strikes with f4, opening lines on the kingside where their space is. There is the Botvinnik tabiya: White owns the centre and the d5-wedge, has space on both wings, and a clear plan — a powerful, low-theory squeeze that has scored heavily for over fifty years.", sayShort: 'f4 — open the kingside, total clamp.', highlights: [H('d5'), H('f4', SOFT)] }),
    ],
  },
  ...
  "english-opening::Ultra-Symmetrical Variation": {
    ...
    beats: [
      ...
      b({ id: 'us2', moves: 'c4 c5 Nc3 Nc6 g3 g6 Bg2 Bg7 Nf3 Nf6 O-O O-O d3 d6 a3 a6 Rb1', say: "White unveils the plan first: d3, then a3 and Rb1, all preparing the b4 break. Because White moves first, they reach this set-up a tempo ahead of Black's mirror — and that single tempo is enough to be the one who opens lines and grabs space on the queenside.", sayShort: 'Rb1 — load the b4 break first.', highlights: [H('b4', SOFT)] }),
  ...
  beats: [
    ...
    b({ id: "mi5", moves: "c4 e6 Nc3 Nf6 e4 d5 e5 d4 exf6 dxc3 bxc3 Qxf6 Nf3 e5 Bd3 Na6 O-O Bd6 Bc2 Bg4 d4 Bxf3", say: "Bg4 d4 Bxf3 — White builds the big pawn centre with d4. You reach the Mikenas tabiya: White has the central pawn mass, the bishop trained on h7, and the more active position. Next to that initiative, the doubled c-pawns are an irrelevance — exactly how Caruana beat So.", sayShort: "d4 — the central pawn mass rolls.", highlights: [H("d4", KEY)] }),
  ],
},

  "english-opening::English: Hedgehog System": {
    openingId: "english-opening", title: "English — the Hedgehog bind", minutes: 9, orientation: "white",
    sources: ["concept:pos-space", "concept:pos-prophylaxis", "https://en.wikipedia.org/wiki/Hedgehog_(chess)"],
    beats: [
      { id: "hh1", moves: ["c4", "e6", "Nf3", "c5", "Nc3", "Nf6", "g3", "b6", "Bg2", "Bb7", "O-O", "Be7"], say: "The Hedgehog announces itself: …c5, …b6, …Bb7, …Be7 — Black plans to live on the first three ranks behind a shell of little pawns and wait for White to overreach. The English answer starts with the fianchetto: the g2-bishop will argue with the b7-bishop all game.", sayShort: "Bg2 — bishop against bishop, patience against patience.", highlights: [{ square: "b7", color: "rgba(80,140,255,0.32)" }, { square: "g2", color: "rgba(255,214,0,0.88)" }] },
      { id: "hh2", moves: ["c4", "e6", "Nf3", "c5", "Nc3", "Nf6", "g3", "b6", "Bg2", "Bb7", "O-O", "Be7", "d4", "cxd4", "Qxd4", "d6"], say: "d4 …cxd4 Qxd4! — the queen recaptures and stands untouchable in the centre: no …Nc6 tempo exists with the pawn back on b6. …d6 completes the shell — the classic Hedgehog wall of a6, b6, d6, e6 is taking shape, and every Black piece will sit behind it.", sayShort: "Qxd4 — recapture, untouchable.", highlights: [{ square: "d4", color: "rgba(255,214,0,0.88)" }, { square: "d6", color: "rgba(80,140,255,0.32)" }] },
      { id: "hh3", moves: ["c4", "e6", "Nf3", "c5", "Nc3", "Nf6", "g3", "b6", "Bg2", "Bb7", "O-O", "Be7", "d4", "cxd4", "Qxd4", "d6", "Rd1", "a6", "b3", "Nbd7"], say: "Rd1 leans on the d-file, …a6 finishes the shell, and b3 with the coming Bb2 completes White's double fianchetto. Now count the Hedgehog's only two dreams: the …b5 break and the …d5 break. White's entire setup exists to keep both under permanent guard.", sayShort: "b3 — guard both breaks, forever.", highlights: [{ square: "b5", color: "rgba(80,140,255,0.32)" }, { square: "d5", color: "rgba(80,140,255,0.32)" }] },
      { id: "hh4", moves: ["c4", "e6", "Nf3", "c5", "Nc3", "Nf6", "g3", "b6", "Bg2", "Bb7", "O-O", "Be7", "d4", "cxd4", "Qxd4", "d6", "Rd1", "a6", "b3", "Nbd7", "e4", "Qc8", "Bb2", "O-O", "Qe3", "Qc7"], say: "e4! joins c4 — the full bind stands. …Qc8 slides toward the long-diagonal battery, Bb2 answers on the other diagonal, and after …O-O and Qe3, …Qc7 completes Black's regrouping. This is the Hedgehog standoff in its purest form: White owns the space and both break-squares; Black owns a position with no targets and a coiled spring. The engine gives White a steady pull — and the practical burden of proving it. Play the bind with patience: improve, probe, and let the shell crack itself.", sayShort: "e4 — the full bind; patience wins it.", highlights: [{ square: "e4", color: "rgba(255,214,0,0.88)" }, { square: "c4", color: "rgba(80,140,255,0.32)" }] },
    ],
  },
};
