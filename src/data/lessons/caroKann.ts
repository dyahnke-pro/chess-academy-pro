...
export const CARO_KANN_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'ck1', moves: 'e4 c6 d4 d5',
      ...
      sayShort: 'c6 props up d5 — challenge the centre with a supported pawn, lines kept clear.',
    ...
    b({ id: 'ck2', moves: 'e4 c6 d4 d5 Nc3 dxe4 Nxe4 Bf5',
      ...
      sayShort: 'Bf5 — the bishop comes out before e6 ever traps it. The whole point of the Caro.',
    ...
    b({ id: 'ck3', moves: 'e4 c6 d4 d5 Nc3 dxe4 Nxe4 Bf5 Ng3 Bg6 h4 h6 Nf3 Nd7 h5 Bh7',
      ...
      sayShort: 'Stay a step ahead of the pawn storm: Bg6, h6, then Bh7. Mistime it and h5 traps the bishop on g6.',
    ...
    b({ id: 'ck4', moves: 'e4 c6 d4 d5 Nc3 dxe4 Nxe4 Bf5 Ng3 Bg6 h4 h6 Nf3 Nd7 h5 Bh7 Bd3 Bxd3 Qxd3',
      ...
      sayShort: 'Trade on d3 — the problem bishop is gone, swapped for White’s good one. A lasting structural plus.',
      highlights: [H('d3', KEY)] }),
    b({ id: 'ck5', moves: 'e4 c6 d4 d5 Nc3 dxe4 Nxe4 Bf5 Ng3 Bg6 h4 h6 Nf3 Nd7 h5 Bh7 Bd3 Bxd3 Qxd3 e6 Bd2 Ngf6',
      ...
      sayShort: 'Now e6 — the chain is complete, but the bishop is already outside it and traded. A fortress with no weak pieces.',
    ...
    b({ id: 'ck6', moves: 'e4 c6 d4 d5 Nc3 dxe4 Nxe4 Bf5 Ng3 Bg6 h4 h6 Nf3 Nd7 h5 Bh7 Bd3 Bxd3 Qxd3 e6 Bd2 Ngf6 O-O-O Be7 Kb1 O-O',
      ...
      sayShort: 'Opposite-side castling — Black races with the c5 break at White’s king; the Caro structure absorbs the storm.',
      highlights: [H('c5', ATK)] }),
  ],
};
