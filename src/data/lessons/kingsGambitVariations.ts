  ...
  'kings-gambit::King\'s Knight Gambit Classical': {
    ...
    beats: [
      ...
      },
      {
        ...
        highlights: [{ square: 'g7', color: KEY }, { square: 'f4', color: SOFT }],
        say: "Black fianchettoes with Bg7 to defend the g5-f4 chain along the long diagonal, and White castles — straight into the position, the rook landing on f1 behind the half-open file with the f4-pawn dead ahead. Black plays d6 to free his game. Notice the imbalance forming: Black is a pawn up but underdeveloped and behind in the race; White has every piece pointing at the king.",
        sayShort: 'O-O — castle into it, rook eyes f4.',
      },
      {
        id: 'centre',
        moves: ['e4', 'e5', 'f4', 'exf4', 'Nf3', 'g5', 'Bc4', 'Bg7', 'O-O', 'd6', 'd4', 'h6', 'c3'],
        highlights: [{ square: 'd4', color: KEY }, { square: 'c3', color: SOFT }],
        say: "d4 — the broad centre again, the recurring King's Gambit theme: trade the wing pawn for a commanding centre. Black plays h6 to bolster g5 once more, and White supports the centre with c3, keeping everything intact while preparing to pry the kingside open. White is in no hurry; the structure does the work.",
        sayShort: 'd4, c3 — build and brace the centre.',
      },
      {
        id: 'undermine',
        moves: ['e4', 'e5', 'f4', 'exf4', 'Nf3', 'g5', 'Bc4', 'Bg7', 'O-O', 'd6', 'd4', 'h6', 'c3', 'Nc6', 'g3'],
        highlights: [{ square: 'g3', color: KEY }, { square: 'f4', color: KEY }],
        say: "Here is the lever. After Nc6, White plays g3 — striking at the base of Black's pawn chain. The whole f4-g5 structure rests on f4, and g3 attacks it directly. If the chain dissolves, White's dark-squared bishop on c1 springs to life down the c1-h6 diagonal and the f-file blows open. Black must decide how to meet the break — and the sharpest try lets White invest material for a roaring initiative.",
        sayShort: 'g3 — strike the base of the f4 chain.',
      },
      {
        id: 'exchange-sac',
        moves: ['e4', 'e5', 'f4', 'exf4', 'Nf3', 'g5', 'Bc4', 'Bg7', 'O-O', 'd6', 'd4', 'h6', 'c3', 'Nc6', 'g3', 'Bh3', 'gxf4', 'Bxf1', 'Qxf1'],
        highlights: [{ square: 'f4', color: KEY }, { square: 'f1', color: SOFT }],
        say: "Black grabs the exchange — Bh3 forks the f1-rook, and after gxf4 opening the centre, Bxf1 Qxf1 White hands over rook for bishop. But look at what White bought: the crippling f4-g5 chain is gone, White's pawns own the centre, the queen and rook eye the open f-file, and the light squares around Black's king are bare. This is the soul of the Classical — material is a currency you spend to open the king.",
        sayShort: 'Qxf1 — give the exchange, shatter the chain.',
      },
      {
        id: 'outpost',
        moves: ['e4', 'e5', 'f4', 'exf4', 'Nf3', 'g5', 'Bc4', 'Bg7', 'O-O', 'd6', 'd4', 'h6', 'c3', 'Nc6', 'g3', 'Bh3', 'gxf4', 'Bxf1', 'Qxf1', 'gxf4', 'd5', 'Ne5'],
        arrows: [{ from: 'f3', to: 'e5', color: VIS }],
        highlights: [{ square: 'e5', color: KEY }, { square: 'd5', color: SOFT }],
        say: "The play resolves: gxf4 d5 — the centre pawn smashes forward, kicking the knight — Ne5, and Black's knight reaches e5, but so will White's. The position is a fortress of central pawns with open lines toward a king that never found safety. For the exchange, White has a permanent initiative and a structure Black can barely breathe in. That is the bargain the Classical King's Gambit offers, and history says it is a good one.",
        sayShort: 'd5, Ne5 — the centre rolls, lines stay open.',
      },
    ],
  },
