  ...
  'kings-gambit::King\'s Knight Gambit Classical': {
    ...
    beats: [
      ...
      },
      {
        ...
        say: "c3 braces the d4-pawn and quietly prepares queenside expansion, Black develops with Nc6, and White castles — the rook settling on f1 behind the half-open file. White has finished the gambit's job: every piece is out, the king is safe, and the centre is their.",
    ...
    beats: [
      {
        ...
        say: "Fischer's Defence — 3…d6. After Bobby Fischer lost a King's Gambit to Spassky he wrote a famous article, 'A Bust to the King's Gambit,' and this quiet pawn move was his recommendation. The point is subtle: Black still intends …g5 to hold the gambit pawn, but first they cover e5 and slams the door on the Bc4 tricks that crash through to f7. It is the most respected antidote of all.",
  ...
  'kings-gambit::Bishop\'s Gambit (3.Bc4)': {
    ...
    beats: [
      ...
      },
      {
        ...
        say: "Black generates counterplay — Re8+ drives the knight back to e2, and Ng4 jumps in looking for tricks against f2 and the king. The position is double-edged, and that is the point: the Bishop's Gambit trades a pawn for an open, piece-active battle where White's lead in development and bishop diagonal give them the practical pull. Sharp chess, exactly what you came here for.",
