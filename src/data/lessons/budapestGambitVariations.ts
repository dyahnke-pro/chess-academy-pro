...
export const BUDAPEST_GAMBIT_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'budapest-gambit::Budapest Gambit: Main Bf4 Line': {
    ...
    beats: [
      ...
      b({ id: 'mb3', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Bf4 Nc6 Nf3 Bb4+ Nbd2 Qe7 a3 Ngxe5 Nxe5 Nxe5 e3 Bxd2+ Qxd2 d6 Be2 O-O O-O Bf5 Rfd1', say: "Black finishes harmoniously — …d6, …O-O and the active …Bf5 developing the last piece. There is the Main Line tabiya: material is level and Black is fully developed. Be honest about it — this is White's best try and they keep a small pull from the bishop pair and slightly freer game, so Black is a touch worse here, but it is comfortable, solid, and easy to hold. Knowing this line is what makes the Budapest safe to play.", sayShort: '…Bf5 — solid, a shade worse but easy.', highlights: [H('f5', SOFT)] }),
    ],
  },
