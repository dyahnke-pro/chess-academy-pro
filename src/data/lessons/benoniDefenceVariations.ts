...
export const BENONI_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'benoni-defence::Czech Benoni (...e5 Closed Center)': {
    ...
    beats: [
      b({ id: 'bz1', moves: 'd4 Nf6 c4 c5 d5 e5', say: "The Czech Benoni — Black locks the centre completely with …c5 and …e5, declining to open a single line. It is the most solid, closed member of the Benoni family: a slow manoeuvring battle where Black bides their time and aims for the …f5 break behind the locked pawns.", sayShort: '…e5 — lock the centre, close the game.', highlights: [H('e5', KEY), H('c5', SOFT)] }),
  ...
  'benoni-defence::Taimanov Variation (f4/Bb5+)': {
    ...
    beats: [
      ...
      b({ id: 't4', moves: 'd4 Nf6 c4 c5 d5 e6 Nc3 exd5 cxd5 d6 e4 g6 f4 Bg7 Bb5+ Nfd7 a4 O-O Nf3 Na6 O-O Nc7 Bd3 a6', say: "O-O …Nc7 chases the b5-bishop back to d3, and …a6 clamps the queenside, preparing …b5. There is the Taimanov tabiya: Black fully developed and the standard Benoni queenside counterplay underway. Be honest about where this stands — the Taimanov is the toughest anti-Benoni and White's big centre gives a real, lasting pull; the engine rates Black clearly worse here, closer to a pawn down than to level, with the dynamic …b5 break as the practical counterplay to bank on. A difficult, double-edged game you take for the winning chances, not an equaliser.", sayShort: '…a6 — clamp, prepare …b5; clearly worse but sharp.', highlights: [H('a6')] }),
    ],
  },
  ...
  "benoni-defence::Modern Main Line (Nd2/f3) with ...b5 Race": {
    openingId: "benoni-defence", title: "Modern Benoni — the …b5 race against the f3 clamp", minutes: 9, orientation: "black",
    sources: ["concept:pawn-majority", "concept:pos-space", "https://en.wikipedia.org/wiki/Modern_Benoni"],
    beats: [
      { id: "bn1", moves: ["d4", "Nf6", "c4", "c5", "d5", "e6", "Nc3", "exd5", "cxd5", "d6"], say: "The Modern Benoni bargain, struck in five moves: Black concedes the centre and accepts the cramped d6-pawn, buying the half-open e-file, a future long-diagonal fianchetto, and a genuine queenside pawn majority. Unbalanced by design — both sides play to win.", sayShort: "…d6 — the bargain is struck.", highlights: [{ square: "d6", color: "rgba(255,214,0,0.88)" }] },
      { id: "bn2", moves: ["d4", "Nf6", "c4", "c5", "d5", "e6", "Nc3", "exd5", "cxd5", "d6", "Nf3", "g6", "e4", "Bg7", "Be2", "O-O", "O-O", "Re8"], say: "Both sides develop to their posts and …Re8 loads the half-open e-file — the file the early trade purchased. The rook leans on e4 from a distance, and every White centre decision now happens under observation.", sayShort: "…Re8 — the bought file, occupied.", highlights: [{ square: "e4", color: "rgba(80,140,255,0.32)" }, { square: "e8", color: "rgba(255,214,0,0.88)" }] },
      { id: "bn3", moves: ["d4", "Nf6", "c4", "c5", "d5", "e6", "Nc3", "exd5", "cxd5", "d6", "Nf3", "g6", "e4", "Bg7", "Be2", "O-O", "O-O", "Re8", "Nd2", "Na6", "f3", "Nc7"], say: "Nd2 and f3 are White's anti-Benoni clamp — the e4-point ends up triple-guarded and the position dares Black to find a plan. Black has one: …Na6-c7, the knight rerouting to shepherd the …b5 break that the whole queenside majority exists for.", sayShort: "…Nc7 — reroute for the b5 break.", highlights: [{ square: "b5", color: "rgba(80,140,255,0.32)" }, { square: "c7", color: "rgba(255,214,0,0.88)" }] },
      { id: "bn4", moves: ["d4", "Nf6", "c4", "c5", "d5", "e6", "Nc3", "exd5", "cxd5", "d6", "Nf3", "g6", "e4", "Bg7", "Be2", "O-O", "O-O", "Re8", "Nd2", "Na6", "f3", "Nc7", "a4", "b6", "Kh1", "Qe7", "Nc4", "Ba6"], say: "a4 fights the break; …b6 prepares it anyway. When Nc4 leans on the d6-pawn, …Ba6! pins the question to the knight — trade the clamp's best piece or lose it to the bishop. The engine leans White here, and that's the honest Benoni truth: it was never an equality claim, it's a fight claim. …b5 lands next, and every Black piece knows its job.", sayShort: "…Ba6 — question the clamp; b5 next.", arrows: [{ from: "a6", to: "c4", color: "rgba(40,185,95,0.92)" }, { from: "c4", to: "d6", color: "rgba(80,140,255,0.32)" }], highlights: [{ square: "c4", color: "rgba(255,214,0,0.88)" }, { square: "b5", color: "rgba(80,140,255,0.32)" }] },
    ],
  },
};
