...
export const SCOTCH_GAMBIT_VARIATION_LESSONS: Record<string, LessonScript> = {
  'scotch-gambit::Bc5 Defence (4…Bc5)': {
    ...
    beats: [
      ...
      b({ id: 'b3', moves: 'e4 e5 Nf3 Nc6 d4 exd4 Bc4 Bc5 c3 Nf6 e5 d5 Bb5 Ne4 cxd4 Bb6', say: "Bb5 pins the c6-knight, cxd4 recaptures the gambit pawn and builds a broad centre behind the e5-wedge, and …Bb6 tucks the bishop away. Material is level and White owns the centre.", sayShort: 'cxd4 — regain the pawn, big centre.', highlights: [H('b5'), H('d4'), H('e5')] }),
  ...
  'scotch-gambit::Bb4+ Check (4…Bb4+)': {
    ...
    beats: [
      ...
      b({ id: 'c3', moves: 'e4 e5 Nf3 Nc6 d4 exd4 Bc4 Bb4+ c3 dxc3 O-O Nf6 e5 d5 exf6 dxc4 fxg7 Rg8', say: "exf6! and fxg7 rip open Black's kingside; …dxc4 and …Rg8 try to hold the extra material, but Black's king has no shelter and their pieces are undeveloped.", sayShort: 'fxg7 — tear open the king.', highlights: [H('g7'), H('g8')] }),
  ...
  'scotch-gambit::Sharp f3 Centre (…Nf6)': {
    ...
    beats: [
      ...
      b({ id: 'f2', moves: 'e4 e5 Nf3 Nc6 d4 exd4 Bc4 Nf6 e5 d5 Bb5 Ne4 Nxd4 Bd7 Bxc6 bxc6 O-O Bc5', say: "…Bd7 unpins, White trades on c6 to hand Black doubled pawns on c6 and c7, castles, and meets …Bc5 — the bishop eyeing the d4-knight.", sayShort: 'Bxc6 — doubled c-pawns for Black.', highlights: [H('c6'), H('c7')] }),
      b({ id: 'f3', moves: 'e4 e5 Nf3 Nc6 d4 exd4 Bc4 Nf6 e5 d5 Bb5 Ne4 Nxd4 Bd7 Bxc6 bxc6 O-O Bc5 f3', say: "f3! — the sharp choice, kicking the e4-knight and preparing to build a broad f3-e5 pawn front. White plays for space and a kingside clamp rather than the quiet Be3.", sayShort: 'f3 — kick the knight, clamp.', highlights: [H('f3'), H('e4')] }),
