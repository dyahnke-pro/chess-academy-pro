...
export const FRENCH_DEFENCE_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'qd2-oo', moves: 'e4 e6 d4 d5 Nc3 Nf6 e5 Nfd7 f4 c5 Nf3 Nc6 Be3 Be7 Qd2 O-O', say: "Qd2 connects White's rooks and leans toward the kingside; Black castles into safety. You've reached the classic Classical standoff — White with the big chain and space, Black with pressure on d4 and a plan on both wings. Black now turns to the two French levers: …f6 or …f5 against e5, and queenside expansion.", sayShort: 'O-O — castle, then hit e5 and d4.', highlights: [H('e5'), H('d4', SOFT)] }),
