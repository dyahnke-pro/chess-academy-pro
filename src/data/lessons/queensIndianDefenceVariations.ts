...
export const QUEENS_INDIAN_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  'queens-indian::Queen\'s Indian: Fianchetto Variation (Deep)': {
    ...
    beats: [
      b({ id: 'fd1', moves: 'd4 Nf6 c4 e6 Nf3 b6 g3 Bb7 Bg2 Be7 O-O O-O Nc3 d5', say: "The main Fianchetto battle — both sides fianchetto and White adds Nc3, the most testing set-up. Black's recommendation is to meet strength with strength: …d5, challenging the centre directly rather than sitting passively. The fight is for the light squares and the e4-break, and Black grabs their share.", sayShort: '…d5 — challenge the centre directly.', highlights: [H('d5', SOFT)] }),
  ...
  'queens-indian::Queen\'s Indian: 4.e3 System': {
    ...
    beats: [
      ...
      b({ id: 'e33', moves: 'd4 Nf6 c4 e6 Nf3 b6 e3 Bb7 Bd3 Be7 O-O O-O Nc3 d5 cxd5 exd5 b3 Nbd7 Bb2 c5', say: "White double-fianchettoes with b3 and Bb2; Black completes the picture with …Nbd7 and the freeing …c5, hitting d4. Now the central tension is Black's to release on their terms, the b7-bishop and the d5-pawn jointly fighting for the centre. Symmetrical, balanced, double-edged.", sayShort: '…c5 — free the game, hit d4.', highlights: [H('c5'), H('d4', SOFT)] }),
  ...
  'queens-indian::Queen\'s Indian: Miles Variation (...Ba6)': {
    ...
    beats: [
      ...
      b({ id: 'm2', moves: 'd4 Nf6 c4 e6 Nf3 b6 g3 Ba6 Qa4 Bb7 Bg2 c5', say: "Qa4 defends c4, so …Bb7 returns to the long diagonal having provoked the awkward queen move, and …c5 strikes at d4. Black has gained concrete concessions from the …Ba6 thrust and now opens the centre on their terms.", sayShort: '…c5 — strike d4 on your terms.', highlights: [H('c5'), H('d4', SOFT)] }),
