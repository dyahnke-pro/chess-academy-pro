...
export const SCOTCH_GAME_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  orientation: "white",
  beats: [
    b({ id: "sg1", moves: "e4 e5 Nf3 Nc6 d4 exd4 Bc4", say: "The Scotch Gambit — pure romance. Instead of recapturing on d4, White plays 4.Bc4, leaving the pawn alive and slamming the bishop onto the f7-diagonal. The idea is speed: White develops with threats and counts on a lead in development to outweigh a single pawn. The d4-pawn can wait; the initiative cannot.", sayShort: "Bc4 — gambit the pawn, aim at f7.", arrows: [A("c4", "f7", ATK)], highlights: [H("c4", KEY), H("f7", KEY)] }),
    b({ id: "sg2", moves: "e4 e5 Nf3 Nc6 d4 exd4 Bc4 Nf6 e5 d5", say: "4…Nf6 5.e5! White doesn't defend e4 — he pushes past it, attacking the f6-knight and grabbing space. Black hits back with 5…d5, the only good move: it forks the c4-bishop and shields the knight. The centre is a tangle of tension, and both sides must play precisely.", sayShort: "e5 d5 — push past, Black forks the bishop.", highlights: [H("e5", KEY), H("d5", KEY)] }),
    b({ id: "sg3", moves: "e4 e5 Nf3 Nc6 d4 exd4 Bc4 Nf6 e5 d5 Bb5 Ne4 Nxd4", say: "6.Bb5 sidesteps the fork and pins the c6-knight; 6…Ne4 grabs an active outpost; and 7.Nxd4 — White finally collects the gambit pawn back, the knight returning to its beloved central square. Material is level again, but White has gained time and a grip on the centre. The 'gambit' was really just a clever move-order to reach a comfortable Scotch.", sayShort: "Bb5, Nxd4 — pin, then regain the pawn.", arrows: [A("b5", "c6", ATK)], highlights: [H("d4", KEY), H("c6", SOFT)] }),
    b({ id: "sg4", moves: "e4 e5 Nf3 Nc6 d4 exd4 Bc4 Nf6 e5 d5 Bb5 Ne4 Nxd4 Bd7 Bxc6 bxc6 O-O", say: "7…Bd7 unpins and 8.Bxc6 bxc6 trades into the familiar doubled c-pawns — White's recurring Scotch dividend — before 9.O-O brings the king to safety. White has emerged from the sharp gambit skirmish with the sounder structure and a fully coordinated position, exactly the practical edge the line is built to produce.", sayShort: "Bxc6, O-O — doubled pawns, king safe.", highlights: [H("c6", KEY)] }),
    b({ id: "sg5", moves: "e4 e5 Nf3 Nc6 d4 exd4 Bc4 Nf6 e5 d5 Bb5 Ne4 Nxd4 Bd7 Bxc6 bxc6 O-O Bc5 Be3 Bxd4", say: "9…Bc5 develops with a hit on the d4-knight, 10.Be3 defends and offers a trade, and 10…Bxd4 takes it. We've reached the Scotch Gambit tabiya: roughly level material, but White owns the better structure thanks to Black's tripled-up c-pawns and the open lines from the early skirmish. The romantic gambit has matured into a clean, pressable middlegame — the modern verdict on a 19th-century idea.", sayShort: "Bc5 Bxd4 — the tabiya: White presses the structure.", highlights: [H("d4", KEY)] }),
  ],
},
  ...
  orientation: "white",
  beats: [
    b({ id: "kb1", moves: "e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Bc5 Nb3", say: "Kasparov's own favourite. Against 4…Bc5, instead of defending the knight with Be3, White simply retreats it: 5.Nb3. The point is to sidestep the pin and the trades entirely — the knight nudges the c5-bishop and White keeps a flexible, fully intact position. It's the highest-level treatment of the Classical Scotch.", sayShort: "Nb3 — Kasparov's retreat, dodge the pin.", arrows: [A("b3", "c5", ATK)], highlights: [H("c5", KEY)] }),
    b({ id: "kb2", moves: "e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Bc5 Nb3 Bb6 Nc3 Nf6", say: "5…Bb6 tucks the bishop onto the safe a7-g1 diagonal, and 6.Nc3 Nf6 sees both sides complete natural development around the e4-pawn. White has avoided every early trade and kept all his pieces — a small, durable edge in flexibility that a great technician can squeeze for fifty moves.", sayShort: "Bb6, Nc3 Nf6 — quiet, flexible development.", arrows: [A("c3", "e4", VIS)], highlights: [H("b6", KEY), H("e4", SOFT)] }),
    b({ id: "kb3", moves: "e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Bc5 Nb3 Bb6 Nc3 Nf6 Qe2 d6 Be3", say: "7.Qe2 connects the plan — White intends long castling — 7…d6 props the centre, and 8.Be3 offers to trade the dark-squared bishops on b6. Removing Black's good bishop suits White's setup, and the queen on e2 already looks toward the kingside and the coming pawn storm.", sayShort: "Qe2 Be3 — prep O-O-O, offer the bishop trade.", arrows: [A("e3", "b6", VIS)], highlights: [H("b6", KEY)] }),
    b({ id: "kb4", moves: "e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Bc5 Nb3 Bb6 Nc3 Nf6 Qe2 d6 Be3 Bxe3 Qxe3 O-O O-O-O", say: "8…Bxe3 9.Qxe3 O-O 10.O-O-O — and the battle lines are drawn. White castles queenside and the rook on d1 lines up against the d6-pawn and the half-open d-file. With the kings on opposite wings, this becomes a race: White storms the kingside with his pawns, Black the queenside. Sharp, rich, and exactly the fighting chess Kasparov wanted from a 'quiet' opening.", sayShort: "O-O-O — opposite castling, the race begins.", arrows: [A("d1", "d6", VIS)], highlights: [H("d6", KEY)] }),
    b({ id: "kb5", moves: "e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Bc5 Nb3 Bb6 Nc3 Nf6 Qe2 d6 Be3 Bxe3 Qxe3 O-O O-O-O Be6 f3", say: "10…Be6 develops and challenges the b3-knight's outpost on c5, and 11.f3 anchors e4 and signals the coming g4-g5 pawn storm against Black's king. We've reached the Nb3 tabiya: opposite-side castling, mutual attacks, White a half-step ahead with the more natural pawn-storm. This is why a World Champion chose the Scotch — the 'simple' opening hides the sharpest of middlegames.", sayShort: "Be6 f3 — anchor e4, prepare the g-pawn storm.", arrows: [A("b3", "c5", INTENT)], highlights: [H("e6", KEY), H("f3", SOFT)] }),
  ],
},
};
