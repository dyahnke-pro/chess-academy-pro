...
export const SCOTCH_GAME_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  beats: [
    ...
    b({ id: "kb4", moves: "e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Bc5 Nb3 Bb6 Nc3 Nf6 Qe2 d6 Be3 Bxe3 Qxe3 O-O O-O-O", say: "Bxe3 Qxe3 O-O O-O-O — and the battle lines are drawn. White castles queenside and the rook on d1 lines up against the d6-pawn and the half-open d-file. With the kings on opposite wings, this becomes a race: White storms the kingside with their pawns, Black the queenside. Sharp, rich, and exactly the fighting chess Kasparov wanted from a 'quiet' opening.", sayShort: "O-O-O — opposite castling, the race begins.", arrows: [A("d1", "d6", VIS)], highlights: [H("d6", KEY)] }),
    b({ id: "kb5", moves: "e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Bc5 Nb3 Bb6 Nc3 Nf6 Qe2 d6 Be3 Bxe3 Qxe3 O-O O-O-O Be6 f3", say: "Be6 develops and challenges the b3-knight's outpost on c5, and f3 anchors e4 and signals the coming g4-g5 pawn storm against Black's king. You've reached the Nb3 tabiya: opposite-side castling, mutual attacks, White a half-step ahead with the more natural pawn-storm. This is why a World Champion chose the Scotch — the 'simple' opening hides the sharpest of middlegames.", sayShort: "Be6 f3 — anchor e4, prepare the g-pawn storm.", arrows: [A("b3", "c5", INTENT)], highlights: [H("e6", KEY), H("f3", SOFT)] }),
  ],
},
