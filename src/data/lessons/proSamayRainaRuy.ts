...
export const PRO_SAMAYRAINA_RUY_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'morphy', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7',
      ...
      say: "After a6 you keep the bishop alive with Ba4, develop Nf6, and castle — the Morphy main line. You are not afraid to give up the tension; your plan is the slow build-up that the Ruy is famous for. Black develops solidly with …Be7.",
    ...
    b({ id: 'c3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3',
      ...
      say: "Re1 defends e4, Black expands with …b5 and you retreat the bishop to b3, where it eyes the f7-square. Then c3 — the key move — preparing the big d4 push and giving the bishop a retreat to c2. This is the classical Closed Ruy structure.",
    ...
    b({ id: 'chigorin', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Na5 Bc2 c5 d4',
      ...
      say: "h3 makes luft and stops …Bg4. Black goes for the Chigorin with …Na5 hitting the b3-bishop, which drops back to c2, and …c5. Now you play d4 — the central break the whole opening was building toward. White has a big centre and the more active pieces.",
