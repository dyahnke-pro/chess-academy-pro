...
export const PIRC_DEFENCE_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'p1', moves: 'e4 d6',
      ...
      sayShort: "…d6 — invite the centre, then strike it.",
    ...
    b({ id: 'p2', moves: 'e4 d6 d4 Nf6 Nc3 g6',
      ...
      sayShort: "…Nf6, …g6 — the Pirc setup: concede, then target.",
    ...
    b({ id: 'p3', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O',
      ...
      sayShort: "…Bg7 — the Pirc's soul, eyeing d4.",
    ...
    b({ id: 'p4', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O O-O c6',
      ...
      sayShort: "…c6 — flexible; preps …d5, …b5, or …e5.",
    ...
    b({ id: 'p5', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O O-O c6 a4 Nbd7 h3 e5',
      ...
      sayShort: "…e5 — the payoff break, hitting d4 head-on.",
    ...
    b({ id: 'p6', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O O-O c6 a4 Nbd7 h3 e5 dxe5 dxe5 Be3 Qe7 Qd3 Nh5',
      ...
      sayShort: "…dxe5 — opens the d-file; Black equal.",
