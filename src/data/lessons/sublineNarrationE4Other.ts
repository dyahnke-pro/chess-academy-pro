...
const N66: SublineNarration = {
  intro: { say: "…Nb6 — Black retreats early, so grab the maximum with the Four Pawns Attack: f4 alongside e5 and d4 builds a huge pawn front that buries Black's pieces. You'll gain space on both wings, open the centre on your terms, and emerge with more room and the initiative — a clear, pleasant edge.", sayShort: "…Nb6 — Four Pawns, big space" },
  beats: [
    ...
    { atMove: 23, say: "…Bxf6 — Black recaptures. You're clearly better: more space on both wings, a lead in development, and the freer game. The Four Pawns has done its job.", sayShort: "…Bxf6 — you're clearly better.", highlights: [H('f6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pawn-chain', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};

const N67: SublineNarration = {
  intro: { say: "…Nb6 — Black retreats the knight in a d6-based setup. Fix the queenside with a4-a5, develop, then throw the h- and g-pawns forward against Black's fianchettoed king. It's sharp, and objectively you hold the edge: your central space and the kingside storm give a dangerous initiative worth more than any pawn you invest.", sayShort: "…Nb6 — fix the queenside, storm the king" },
  beats: [
    { atMove: 8, say: "a4 — gain queenside space and threaten a5 to fix the b6-knight.", sayShort: "a4 — grab space, threaten a5.", highlights: [H('a4')] },
    { atMove: 9, say: "…a5 — Black stops a5, fixing the queenside pawns.", sayShort: "…a5 — stop a5.", highlights: [H('a5', SOFT)] },
    { atMove: 10, say: "Nc3 — develop and take a grip on the centre.", sayShort: "Nc3 — grip the centre.", highlights: [H('c3')] },
    { atMove: 11, say: "…g6 — Black prepares to fianchetto.", sayShort: "…g6 — prep the fianchetto.", highlights: [H('g6', SOFT)] },
    { atMove: 12, say: "h4 — the sharp thrust: gain kingside space and aim the h-pawn at Black's coming castled position.", sayShort: "h4 — start the storm.", highlights: [H('h4')] },
    { atMove: 13, say: "…dxe5 — Black releases the central tension.", sayShort: "…dxe5 — Black takes.", highlights: [H('e5', SOFT)] },
    { atMove: 14, say: "Nxe5 — recapture, planting the knight on the strong central e5-outpost.", sayShort: "Nxe5 — centralise on e5.", highlights: [H('e5')] },
    { atMove: 15, say: "…Bg7 — Black fianchettoes, aiming at your e5-knight.", sayShort: "…Bg7 — the fianchetto.", highlights: [H('g7', SOFT)] },
    { atMove: 16, say: "Qf3 — develop the queen actively, defending e5 and eyeing the kingside.", sayShort: "Qf3 — active queen.", highlights: [H('f3')] },
    { atMove: 17, say: "…O-O — Black castles right into your advancing pawns.", sayShort: "…O-O — castles into the storm.", highlights: [H('g8', SOFT)] },
...
const N68: SublineNarration = {
  intro: { say: "…Nc6 — Black hits d4, but this lets you play sharply and win material. Kick with c4, ram d5, and let the pawns fork Black's knights around the board; a well-timed Qxd5 nets a piece for a couple of pawns. Consolidate and you're close to winning.", sayShort: "…Nc6 — c4/d5 forks, win material" },
  beats: [
    { atMove: 6, say: "c4 — kick the d5-knight and stake the broad centre.", sayShort: "c4 — kick, grab the centre.", highlights: [H('c4')] },
    { atMove: 7, say: "…Nb6 — the knight retreats to b6.", sayShort: "…Nb6 — retreat.", highlights: [H('b6', SOFT)] },
    { atMove: 8, say: "d5 — ram the pawn, attacking the c6-knight and gaining a huge space clamp.", sayShort: "d5 — ram, hit the knight.", highlights: [H('d5')] },
    { atMove: 9, say: "…Nxe5 — Black grabs the e5-pawn with the attacked knight.", sayShort: "…Nxe5 — grabs a pawn.", highlights: [H('e5', SOFT)] },
    { atMove: 10, say: "c5 — push again, hitting the b6-knight; both of Black's knights are being chased.", sayShort: "c5 — hit the other knight.", highlights: [H('c5')] },
    { atMove: 11, say: "…Nxd5 — Black grabs the d5-pawn with the b6-knight, up two pawns for the moment.", sayShort: "…Nxd5 — grabs another.", highlights: [H('d5', SOFT)] },
    { atMove: 12, say: "Qxd5 — the point: recapture the knight and centralise the queen. You've won a piece for two pawns.", sayShort: "Qxd5 — win the piece.", highlights: [H('d5')] },
    { atMove: 13, say: "…Nc6 — Black develops the remaining knight.", sayShort: "…Nc6 — develop.", highlights: [H('c6', SOFT)] },
    { atMove: 14, say: "Be3 — develop the bishop and reinforce your position.", sayShort: "Be3 — develop.", highlights: [H('e3')] },
    { atMove: 15, say: "…e6 — Black hits your centralised queen with the pawn.", sayShort: "…e6 — hit the queen.", highlights: [H('e6', SOFT)] },
    { atMove: 16, say: "Qd2 — retreat the queen to safety, keeping the extra material.", sayShort: "Qd2 — retreat, keep the piece.", highlights: [H('d2')] },
    { atMove: 17, say: "…b6 — Black challenges the advanced c5-pawn.", sayShort: "…b6 — hit c5.", highlights: [H('b6', SOFT)] },
    { atMove: 18, say: "cxb6 — take, damaging Black's queenside structure.", sayShort: "cxb6 — take.", highlights: [H('b6')] },
    { atMove: 19, say: "…axb6 — Black recaptures with a loose, split queenside.", sayShort: "…axb6 — loose pawns.", highlights: [H('b6', SOFT)] },
    { atMove: 20, say: "Nc3 — develop and complete your mobilisation.", sayShort: "Nc3 — develop.", highlights: [H('c3')] },
    { atMove: 21, say: "…Be7 — Black develops and prepares to castle.", sayShort: "…Be7 — develop.", highlights: [H('e7', SOFT)] },
    { atMove: 22, say: "Nf3 — bring out the last piece; everything is coming together.", sayShort: "Nf3 — develop.", highlights: [H('f3')] },
    { atMove: 23, say: "…O-O — Black castles. You're close to winning: a piece for two pawns, a sound position, and the more active pieces. Trade down and convert the material.", sayShort: "…O-O — you're near winning.", highlights: [H('g8', SOFT)] },
  ],
...
const N69: SublineNarration = {
  intro: { say: "…Nc6 — kick the knight with c4, then unleash the e6! break that shatters Black's kingside. After …fxe6 he's left with doubled, isolated e-pawns, an open f-file in front of his king, and a ruined structure. Develop against the wreckage and you stand clearly better.", sayShort: "…Nc6 — the e6 break wrecks the kingside" },
  beats: [
    { atMove: 8, say: "c4 — kick the d5-knight and stake the broad centre.", sayShort: "c4 — kick, grab the centre.", highlights: [H('c4')] },
    { atMove: 9, say: "…Nb6 — the knight retreats to b6.", sayShort: "…Nb6 — retreat.", highlights: [H('b6', SOFT)] },
    ...
    { atMove: 17, say: "…exd4 — Black recaptures with the pawn.", sayShort: "…exd4 — recapture.", highlights: [H('d4', SOFT)] },
    { atMove: 18, say: "Bxd4 — take the pawn, centralising the bishop on a commanding diagonal.", sayShort: "Bxd4 — centralise.", highlights: [H('d4')] },
    { atMove: 19, say: "…c5 — Black hits the bishop, trying to gain a tempo.", sayShort: "…c5 — hit the bishop.", highlights: [H('c5', SOFT)] },
    { atMove: 20, say: "Bc3 — retreat, keeping the bishop raking the long diagonal.", sayShort: "Bc3 — keep the diagonal.", highlights: [H('c3')] },
    { atMove: 21, say: "…e5 — Black pushes the doubled pawn forward, seeking space.", sayShort: "…e5 — push forward.", highlights: [H('e5', SOFT)] },
    { atMove: 22, say: "dxe6 — take en passant, opening lines toward Black's exposed king.", sayShort: "dxe6 — take en passant.", highlights: [H('e6')] },
    { atMove: 23, say: "…Qg5 — Black tries desperate counterplay. You're clearly better: Black's kingside is a permanent ruin, your passed e6-pawn is a monster, and your pieces are the active ones.", sayShort: "…Qg5 — you're clearly better.", highlights: [H('g5', SOFT)] },
  ],
  sources: ['concept:pawn-doubled', 'concept:pos-space', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};

const N70: SublineNarration = {
  intro: { say: "…b5 — an unsound lunge trying to shield the d5-knight from c4. Just take it: Bxb5 wins a clean pawn. Then stake the centre with c4, shrug off Black's desperate piece-play, and consolidate. You're a pawn up with a big centre — close to winning with simple, solid moves.", sayShort: "…b5 — Bxb5 wins a clean pawn" },
  beats: [
    { atMove: 6, say: "Bxb5 — snap the pawn. Black's …b5 was simply unsound; you're a clean pawn ahead.", sayShort: "Bxb5 — win the pawn.", highlights: [H('b5')] },
    { atMove: 7, say: "…c5 — Black tries to open the centre for activity to justify the pawn.", sayShort: "…c5 — seek activity.", highlights: [H('c5', SOFT)] },
    { atMove: 8, say: "c4 — kick the d5-knight and stake the broad centre, keeping your extra pawn.", sayShort: "c4 — grab the centre.", highlights: [H('c4')] },
    { atMove: 9, say: "…cxd4 — Black takes, trying to muddy the position.", sayShort: "…cxd4 — Black takes.", highlights: [H('d4', SOFT)] },
    { atMove: 10, say: "Qxd4 — recapture, centralising the queen with your extra pawn intact.", sayShort: "Qxd4 — centralise.", highlights: [H('d4')] },
    { atMove: 11, say: "…Nb4 — the knight jumps in, hunting for tricks.", sayShort: "…Nb4 — seek tricks.", highlights: [H('b4', SOFT)] },
    { atMove: 12, say: "Qd1 — calmly retreat the queen; Black's activity is a bluff with nothing behind it.", sayShort: "Qd1 — calm retreat.", highlights: [H('d1')] },
    { atMove: 13, say: "…Qc7 — Black develops, still hunting compensation.", sayShort: "…Qc7 — develop.", highlights: [H('c7', SOFT)] },
    ...
    { atMove: 21, say: "…Ne7 — Black develops the last knight.", sayShort: "…Ne7 — develop.", highlights: [H('e7', SOFT)] },
    { atMove: 22, say: "Qd6 — infiltrate and offer a queen trade, which suits the side that's up material.", sayShort: "Qd6 — offer a trade.", highlights: [H('d6')] },
    { atMove: 23, say: "…Qxd6 — Black trades. You're close to winning: a clean extra pawn, a big centre, and the freer game. Simplify and bring the pawn home.", sayShort: "…Qxd6 — you're near winning.", highlights: [H('d6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};

const N71: SublineNarration = {
  intro: { say: "…c6 — Black props the d5-knight before challenging your centre. Develop actively, let him trade off his good bishop for your knight, and keep the e5-wedge. You end up with the bishop pair, more space and an active queen swinging to the kingside — a clear, pleasant edge.", sayShort: "…c6 — take the bishop pair, keep e5" },
  beats: [
    { atMove: 8, say: "Bc4 — develop the bishop to an active post, pressing toward Black's position.", sayShort: "Bc4 — active bishop.", highlights: [H('c4')] },
    { atMove: 9, say: "…Bg4 — Black pins your f3-knight, trying to chip at your centre.", sayShort: "…Bg4 — pin the knight.", highlights: [H('g4', SOFT)] },
    ...
    { atMove: 17, say: "…Nd7 — Black develops, eyeing your e5-pawn.", sayShort: "…Nd7 — eye e5.", highlights: [H('d7', SOFT)] },
    { atMove: 18, say: "Qg3 — swing the queen to the kingside, eyeing g7 and the dark squares.", sayShort: "Qg3 — swing to the kingside.", highlights: [H('g3')] },
    { atMove: 19, say: "…Qc7 — Black develops, leaning on e5.", sayShort: "…Qc7 — develop.", highlights: [H('c7', SOFT)] },
...
const N72: SublineNarration = {
  intro: { say: "…dxe5 — Black exchanges, so recapture with the knight to a commanding central post. Develop actively, keep the e5-knight, and use your extra space to press. Black gets a solid fianchetto, but your dominant knight and freer pieces give a clear, pleasant edge.", sayShort: "…dxe5 — recapture Nxe5, dominate the centre" },
  beats: [
    ...
    { atMove: 15, say: "…O-O — Black castles.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 16, say: "h3 — a useful luft, taking g4 from Black's pieces.", sayShort: "h3 — take g4.", highlights: [H('h3')] },
    { atMove: 17, say: "…Nc7 — the knight retreats from d5, conceding the centre.", sayShort: "…Nc7 — retreat.", highlights: [H('c7', SOFT)] },
    { atMove: 18, say: "Bb3 — reroute the bishop to safety, keeping it on the strong a2-g8 diagonal.", sayShort: "Bb3 — keep the diagonal.", highlights: [H('b3')] },
    { atMove: 19, say: "…Be6 — Black develops, offering to trade the light bishops.", sayShort: "…Be6 — offer a trade.", highlights: [H('e6', SOFT)] },
    { atMove: 20, say: "c4 — gain queenside space, clamping down and cramping Black further.", sayShort: "c4 — grab space.", highlights: [H('c4')] },
    { atMove: 21, say: "…b5 — Black strikes back on the queenside for counterplay.", sayShort: "…b5 — counterplay.", highlights: [H('b5', SOFT)] },
    { atMove: 22, say: "Na3 — reroute the knight toward c4 and b5, into Black's loosening queenside.", sayShort: "Na3 — reroute.", highlights: [H('a3')] },
    { atMove: 23, say: "…bxc4 — Black takes. You're pleasantly better: the dominant e5-knight, more space, and the freer, better-coordinated pieces.", sayShort: "…bxc4 — you're pleasantly better.", highlights: [H('c4', SOFT)] },
  ],
  sources: ['concept:pos-outpost', 'concept:pos-space', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};
...
const N74: SublineNarration = {
  intro: { say: "…g6 — Black heads for a …Bg7 fianchetto against your big centre. Develop the bishop actively, keep it on the strong diagonal when challenged, and use a well-timed Ng5 to exploit the light-square holes that …g6 left. You hold the imposing centre and the freer game — a clear edge.", sayShort: "…g6 — keep the diagonal, hit the holes" },
  beats: [
    { atMove: 8, say: "Bc4 — develop the bishop to the active a2-g8 diagonal, pressing the d5-knight.", sayShort: "Bc4 — active diagonal.", highlights: [H('c4')] },
    { atMove: 9, say: "…Nb6 — the knight hits your bishop.", sayShort: "…Nb6 — hit the bishop.", highlights: [H('b6', SOFT)] },
    { atMove: 10, say: "Bb3 — retreat, keeping the bishop on its strong diagonal aimed at Black's kingside.", sayShort: "Bb3 — keep the diagonal.", highlights: [H('b3')] },
    ...
    { atMove: 13, say: "…a5 — Black stops a5, fixing the queenside.", sayShort: "…a5 — stop a5.", highlights: [H('a5', SOFT)] },
    { atMove: 14, say: "Ng5 — a sharp leap into the light-square holes …g6 created, eyeing e6 and f7.", sayShort: "Ng5 — hit the holes.", arrows: [A('g5', 'f7')], highlights: [H('f7')] },
    { atMove: 15, say: "…e6 — Black covers the sensitive squares, blunting the knight.", sayShort: "…e6 — cover the holes.", highlights: [H('e6', SOFT)] },
    { atMove: 16, say: "exd6 — open the position with the trade, targeting Black's structure.", sayShort: "exd6 — open the position.", highlights: [H('d6')] },
    { atMove: 17, say: "…cxd6 — Black recaptures, left with a weak, backward d6-pawn.", sayShort: "…cxd6 — weak d6-pawn.", highlights: [H('d6', SOFT)] },
    { atMove: 18, say: "Nc3 — develop and take a grip on the centre, especially d5.", sayShort: "Nc3 — grip the centre.", highlights: [H('c3')] },
    { atMove: 19, say: "…h6 — Black kicks the g5-knight.", sayShort: "…h6 — kick the knight.", highlights: [H('h6', SOFT)] },
    { atMove: 20, say: "Nf3 — retreat the knight to a good square, eyeing e5 and d4.", sayShort: "Nf3 — reroute.", highlights: [H('f3')] },
    { atMove: 21, say: "…Nc6 — Black develops.", sayShort: "…Nc6 — develop.", highlights: [H('c6', SOFT)] },
    { atMove: 22, say: "O-O — castle, king safe, your space edge intact.", sayShort: "O-O — king safe.", highlights: [H('g1')] },
    { atMove: 23, say: "…O-O — Black castles. You're clearly better: more space, a lead in development, and a lasting target on Black's weak d6-pawn.", sayShort: "…O-O — you're clearly better.", highlights: [H('g8', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};
...
const N75: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 16, say: "h3 — a useful luft, taking g4 from Black's pieces.", sayShort: "h3 — take g4.", highlights: [H('h3')] },
    { atMove: 17, say: "…Nc7 — the knight retreats from d5, conceding the centre.", sayShort: "…Nc7 — retreat.", highlights: [H('c7', SOFT)] },
    { atMove: 18, say: "Bb3 — reroute the bishop to safety, keeping it trained down the a2-g8 diagonal at f7.", sayShort: "Bb3 — keep eyeing f7.", arrows: [A('b3', 'f7')], highlights: [H('f7')] },
    { atMove: 19, say: "…Be6 — Black develops, offering to trade the light bishops.", sayShort: "…Be6 — offer a trade.", highlights: [H('e6', SOFT)] },
    { atMove: 20, say: "c4 — gain queenside space, clamping and cramping Black.", sayShort: "c4 — grab space.", highlights: [H('c4')] },
    { atMove: 21, say: "…b5 — Black strikes back on the queenside.", sayShort: "…b5 — counterplay.", highlights: [H('b5', SOFT)] },
    { atMove: 22, say: "Na3 — reroute the knight toward c4 and b5.", sayShort: "Na3 — reroute.", highlights: [H('a3')] },
    { atMove: 23, say: "…bxc4 — Black takes. You're pleasantly better: the dominant e5-knight, more space, and the freer, better-coordinated game.", sayShort: "…bxc4 — you're pleasantly better.", highlights: [H('c4', SOFT)] },
  ],
  sources: ['concept:pos-outpost', 'concept:pos-space', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};
...
const N76: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 12, say: "O-O — castle, king safe.", sayShort: "O-O — king safe.", highlights: [H('g1')] },
    { atMove: 13, say: "…Bg7 — Black fianchettoes.", sayShort: "…Bg7 — the fianchetto.", highlights: [H('g7', SOFT)] },
    { atMove: 14, say: "Re1 — back the centre with the rook.", sayShort: "Re1 — back the centre.", highlights: [H('e1')] },
    { atMove: 15, say: "…Bg4 — Black pins your f3-knight.", sayShort: "…Bg4 — pin the knight.", highlights: [H('g4', SOFT)] },
    { atMove: 16, say: "Nbd2 — develop the last knight, supporting e4 and heading toward c4.", sayShort: "Nbd2 — develop.", highlights: [H('d2')] },
    { atMove: 17, say: "…O-O — Black castles.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 18, say: "Bb3 — reroute the bishop to the strong a2-g8 diagonal.", sayShort: "Bb3 — the strong diagonal.", highlights: [H('b3')] },
    { atMove: 19, say: "…a5 — Black gains queenside space, probing.", sayShort: "…a5 — probe the queenside.", highlights: [H('a5', SOFT)] },
    { atMove: 20, say: "c4 — kick the d5-knight and widen the centre, seizing more space.", sayShort: "c4 — kick, widen.", highlights: [H('c4')] },
    { atMove: 21, say: "…Nf6 — the knight retreats from d5.", sayShort: "…Nf6 — retreat.", highlights: [H('f6', SOFT)] },
    { atMove: 22, say: "h3 — question the g4-bishop, forcing it to decide.", sayShort: "h3 — question the bishop.", highlights: [H('h3')] },
    { atMove: 23, say: "…Bxf3 — Black trades. You're clearly better: more space, the bishop pair, central control, and a lead in development.", sayShort: "…Bxf3 — you're clearly better.", highlights: [H('f3', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};

const N77: SublineNarration = {
  intro: { say: "…dxe5 — Black grabs a pawn and harasses with …Nb6. Chase the knight with a4-a5, recapture on e5, and develop with big central control. Black's kingside gets loose from the …f6 and …h5 lunges, and your space and development leave you clearly better.", sayShort: "…dxe5 — chase the knight, dominate" },
  beats: [
    { atMove: 10, say: "a5 — gain queenside space and kick the b6-knight with tempo.", sayShort: "a5 — kick the knight.", highlights: [H('a5')] },
    { atMove: 11, say: "…Nd5 — the knight retreats to d5.", sayShort: "…Nd5 — retreat.", highlights: [H('d5', SOFT)] },
    ...
    { atMove: 23, say: "…e6 — Black solidifies. You're clearly better: a big space edge, superior development, and Black's loosened kingside (f6, g6, h5 all soft) as lasting targets.", sayShort: "…e6 — you're clearly better.", highlights: [H('e6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};

// anti-alekhine-modern Bg4@7 (34% main line, student = WHITE). Dedicated
// White-oriented constant — the shared N4 intro is Black-perspective (correct
// for the alekhine-defence family, wrong here). Engine terminus +1.0.
const AME_BG4: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 13, say: "…Nb6 — the knight retreats to b6.", sayShort: "…Nb6 — retreat.", highlights: [H('b6', SOFT)] },
    { atMove: 14, say: "h3 — question the g4-bishop, forcing it to decide.", sayShort: "h3 — question the bishop.", highlights: [H('h3')] },
    { atMove: 15, say: "…Bh5 — the bishop keeps the pin, retreating to h5.", sayShort: "…Bh5 — keep the pin.", highlights: [H('h5', SOFT)] },
    { atMove: 16, say: "Nc3 — develop and take a grip on the centre, especially d5.", sayShort: "Nc3 — grip the centre.", highlights: [H('c3')] },
    { atMove: 17, say: "…O-O — Black castles.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 18, say: "Be3 — develop the last minor piece, reinforcing d4.", sayShort: "Be3 — reinforce d4.", highlights: [H('e3')] },
    { atMove: 19, say: "…Nc6 — Black develops, piling onto d4.", sayShort: "…Nc6 — pressure d4.", highlights: [H('c6', SOFT)] },
    { atMove: 20, say: "exd6 — open the position with the trade, targeting Black's structure.", sayShort: "exd6 — open the position.", highlights: [H('d6')] },
    { atMove: 21, say: "…cxd6 — Black recaptures, left with a backward d6-pawn.", sayShort: "…cxd6 — backward d6-pawn.", highlights: [H('d6', SOFT)] },
    { atMove: 22, say: "d5 — ram the pawn forward, gaining space and hitting the c6- and e6-points.", sayShort: "d5 — ram, gain space.", highlights: [H('d5')] },
    { atMove: 23, say: "…exd5 — Black takes. You're clearly better: more space, a lead in development, open lines from the d5-break, and a lasting target on Black's weak d6-pawn.", sayShort: "…exd5 — you're clearly better.", highlights: [H('d5', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-space', 'https://en.wikipedia.org/wiki/Alekhine%27s_Defence'],
};

const N78: SublineNarration = {
  intro: { say: "…Bxc3+ — Black trades the bishop for your knight to damage your structure. Be honest with yourself here: you get the bishop pair and a broad centre, but the doubled c-pawns are real and Black is comfortable — if anything, a hair better. Play for kingside space and your two bishops, but respect that this is a balanced fight, not an advantage.", sayShort: "…Bxc3+ — bishops vs doubled pawns; level" },
  beats: [
    ...
    { atMove: 21, say: "…O-O — Black castles into safety.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 22, say: "h5 — advance the pawn, gaining more kingside room and probing Black's shelter.", sayShort: "h5 — advance, probe.", highlights: [H('h5')] },
    { atMove: 23, say: "…f6 — Black strikes back at the centre. It's balanced — honestly a touch easier for Black thanks to your doubled pawns — so don't overpress. Nurse the two bishops and the kingside space and keep the game level.", sayShort: "…f6 — balanced; don't overpress.", highlights: [H('f6', SOFT)] },
  ],
  sources: ['concept:pos-bishop-pair', 'concept:pos-space', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};
...
const N79: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 12, say: "fxe4 — recapture, keeping your broad d4-e4 pawn centre.", sayShort: "fxe4 — big centre.", highlights: [H('e4'), H('d4', SOFT)] },
    { atMove: 13, say: "…Ngf6 — Black develops and pressures your e4-pawn.", sayShort: "…Ngf6 — pressure e4.", arrows: [A('f6', 'e4')], highlights: [H('e4')] },
    { atMove: 14, say: "Bd3 — develop the bishop, defending e4 and eyeing the kingside.", sayShort: "Bd3 — defend e4.", highlights: [H('d3')] },
    { atMove: 15, say: "…c5 — Black strikes at the base of your chain on d4.", sayShort: "…c5 — hit d4.", highlights: [H('c5', SOFT)] },
    { atMove: 16, say: "a3 — question the b4-bishop pinning your knight; make it decide.", sayShort: "a3 — question the bishop.", highlights: [H('a3')] },
    ...
    { atMove: 19, say: "…c4 — Black shoves the pawn to hit your bishop, but this overreaches and hands you a target.", sayShort: "…c4 — overreaches.", highlights: [H('c4', SOFT)] },
    { atMove: 20, say: "Bxc4 — snap it off. You win the pawn and your bishop lands actively; the two bishops now rake an open board.", sayShort: "Bxc4 — win the pawn.", highlights: [H('c4')] },
    { atMove: 21, say: "…Nxe4 — Black grabs the e4-pawn back with a tactic, restoring material.", sayShort: "…Nxe4 — grabs e4.", highlights: [H('e4', SOFT)] },
    { atMove: 22, say: "Qd3 — hit the e4-knight and centralise the queen, forcing Black to react.", sayShort: "Qd3 — hit the knight.", highlights: [H('d3'), H('e4', SOFT)] },
    { atMove: 23, say: "…Ndf6 — the knight retreats to defend. You're pleasantly better: the bishop pair, active pieces, and Black's looser structure give a small but lasting edge.", sayShort: "…Ndf6 — you hold the edge.", highlights: [H('f6', SOFT)] },
  ],
  sources: ['concept:pos-bishop-pair', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N80: SublineNarration = {
  intro: { say: "…Ne7 — a French-style setup. This one turns sharp fast: Black castles kingside, you castle queenside, and it's a straight race of opposite-wing pawn storms. Be clear-eyed — with best play it's roughly balanced, a genuine double-edged fight where whoever's attack lands first wins. Storm with h4-h5 and play accurately.", sayShort: "…Ne7 — sharp opposite-side race" },
  beats: [
    { atMove: 10, say: "a3 — question the b4-bishop and make it commit before you launch anything.", sayShort: "a3 — question the bishop.", highlights: [H('a3')] },
    { atMove: 11, say: "…Ba5 — Black keeps the pin on your c3-knight, retreating the bishop to a5.", sayShort: "…Ba5 — keep the pin.", highlights: [H('a5', SOFT)] },
...
const N81: SublineNarration = {
  intro: { say: "…Nf6 — natural development adding a second attacker to e4, but f3 holds the pawn and you have a pleasant plan: kick the knight with e5, let Black trade on c3 to hand you the bishop pair, then grab kingside space. Your two bishops and broad centre give a small, lasting edge.", sayShort: "…Nf6 — kick e5, take the bishops" },
  beats: [
    { atMove: 10, say: "e5 — gain space and kick the f6-knight, clamping the dark squares.", sayShort: "e5 — gain space, kick.", highlights: [H('e5')] },
    { atMove: 11, say: "…Nfd7 — the knight retreats, its outpost taken away.", sayShort: "…Nfd7 — retreat.", highlights: [H('d7', SOFT)] },
    { atMove: 12, say: "a3 — question the b4-bishop pinning your knight; make it decide.", sayShort: "a3 — question the bishop.", highlights: [H('a3')] },
    { atMove: 13, say: "…Bxc3+ — Black trades on c3, handing you the bishop pair.", sayShort: "…Bxc3+ — gives the bishop pair.", highlights: [H('c3', SOFT)] },
    { atMove: 14, say: "bxc3 — recapture toward the centre. Yes, the c-pawns are doubled, but you gain the two bishops, a fortress-strong centre, and the half-open b-file.", sayShort: "bxc3 — bishop pair, strong centre.", highlights: [H('c3'), H('d4', SOFT)] },
    ...
    { atMove: 22, say: "Ne2 — reroute the knight toward g3 or f4 to join the kingside, unbothered by the b2-pawn.", sayShort: "Ne2 — reroute the knight.", highlights: [H('e2')] },
    { atMove: 23, say: "…Qxb2 — Black grabs b2, but the queen wanders offside. You're a touch better: the bishop pair, kingside space, and the e5-wedge outweigh the pawn. Bring your pieces to the kingside and press.", sayShort: "…Qxb2 — you have the compensation.", highlights: [H('b2', SOFT)] },
  ],
  sources: ['concept:pos-bishop-pair', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N82: SublineNarration = {
  intro: { say: "…Qa5 — the queen joins the …Bb4 pin on your c3-knight, but she'll spend the whole opening shuffling. Break the pin, chase the queen with tempo, and calmly build your centre while she loses move after move. You come out clearly better with more space and a big lead in useful development.", sayShort: "…Qa5 — chase the queen, gain tempo" },
  beats: [
    { atMove: 10, say: "Bd2 — break the pin and offer to harass the queen. Your knight is free and your centre stands.", sayShort: "Bd2 — break the pin.", highlights: [H('d2')] },
    { atMove: 11, say: "…Qb6 — the queen sidesteps, still eyeing b2 and d4.", sayShort: "…Qb6 — sidestep.", highlights: [H('b6', SOFT)] },
    { atMove: 12, say: "Na4 — hit the queen and head for the strong c5-outpost, gaining a tempo.", sayShort: "Na4 — hit the queen.", arrows: [A('a4', 'b6')], highlights: [H('b6')] },
    { atMove: 13, say: "…Qa5 — the queen shuffles back to a5; that's two tempi wasted already.", sayShort: "…Qa5 — shuffles back.", highlights: [H('a5', SOFT)] },
    { atMove: 14, say: "c3 — solidify d4 and permanently take the b4-square from Black's pieces.", sayShort: "c3 — solidify d4.", highlights: [H('c3')] },
    { atMove: 15, say: "…Be7 — the bishop retreats, its pin gone and its adventure over.", sayShort: "…Be7 — retreat.", highlights: [H('e7', SOFT)] },
    ...
    { atMove: 23, say: "…Nxa6 — Black recaptures, the knight offside on a6. You're clearly better: the queen wasted three tempi, and you have more space, the c5-outpost, and the far better development.", sayShort: "…Nxa6 — you're clearly better.", highlights: [H('a6', SOFT)] },
  ],
...
const N83: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 11, say: "…dxe4 — Black trades in the centre.", sayShort: "…dxe4 — Black trades.", highlights: [H('e4', SOFT)] },
    { atMove: 12, say: "Ncxe4 — recapture with the knight, centralising it strongly.", sayShort: "Ncxe4 — centralise.", highlights: [H('e4')] },
    { atMove: 13, say: "…Ngf6 — Black develops and challenges your centralised knight.", sayShort: "…Ngf6 — challenge it.", highlights: [H('f6', SOFT)] },
    { atMove: 14, say: "c3 — a small solidifying move, cementing d4 before the bishops come out.", sayShort: "c3 — cement d4.", highlights: [H('c3')] },
    { atMove: 15, say: "…Be7 — Black develops and prepares to castle.", sayShort: "…Be7 — develop.", highlights: [H('e7', SOFT)] },
    ...
    { atMove: 23, say: "…cxd5 — Black takes. It's a balanced middlegame: your active pieces and the d5-break give a comfortable game, but Black is solid. Play it on the merits — no forced edge.", sayShort: "…cxd5 — comfortable, balanced.", highlights: [H('d5', SOFT)] },
  ],
...
const N84: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 23, say: "…h6 — Black makes luft. You're clearly better: the e5 space clamp, room on both wings, the surviving dark bishop against a knight, and a Black king still stuck in the centre.", sayShort: "…h6 — you're clearly better.", highlights: [H('h6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N85: SublineNarration = {
  intro: { say: "…dxe4 — Black trades then hits back with …e5 and …Bg4, and this line gets genuinely messy: you'll give up the e4-pawn and let your king walk to f2-g2, keeping the two bishops and a broad centre as compensation. Be honest — it's a sharp, roughly level fight, not a clean edge. Play forcing moves accurately and trust the bishop pair.", sayShort: "…dxe4 — sharp; bishops for an airy king" },
  beats: [
    { atMove: 6, say: "fxe4 — recapture and build the broad d4-e4 pawn centre.", sayShort: "fxe4 — big centre.", highlights: [H('e4'), H('d4', SOFT)] },
    { atMove: 7, say: "…e5 — Black strikes at d4 at once, opening the position.", sayShort: "…e5 — hit d4.", highlights: [H('e5', SOFT)] },
    { atMove: 8, say: "Nf3 — develop, defend d4 and hit the e5-pawn in one move.", sayShort: "Nf3 — develop, hit e5.", arrows: [A('f3', 'e5')], highlights: [H('e5')] },
    { atMove: 9, say: "…Bg4 — Black pins your knight to add pressure on d4.", sayShort: "…Bg4 — pin the knight.", highlights: [H('g4', SOFT)] },
    { atMove: 10, say: "c3 — prop up d4, holding your centre together against the pressure.", sayShort: "c3 — prop d4.", highlights: [H('c3')] },
    { atMove: 11, say: "…Nf6 — Black develops and jabs at your e4-pawn.", sayShort: "…Nf6 — hit e4.", arrows: [A('f6', 'e4')], highlights: [H('e4')] },
    { atMove: 12, say: "Qb3 — a strong double-purpose move: the queen eyes b7 and joins a battery on f7.", sayShort: "Qb3 — eye b7 and f7.", highlights: [H('b3')] },
    { atMove: 13, say: "…exd4 — Black grabs the pawn, opening lines further.", sayShort: "…exd4 — Black takes.", highlights: [H('d4', SOFT)] },
    { atMove: 14, say: "Bc4 — complete the battery, both queen and bishop bearing down on f7.", sayShort: "Bc4 — aim at f7.", arrows: [A('c4', 'f7')], highlights: [H('f7')] },
    { atMove: 15, say: "…Qe7 — Black defends f7 and the e-file, forced to react.", sayShort: "…Qe7 — defend f7.", highlights: [H('e7', SOFT)] },
    { atMove: 16, say: "cxd4 — recapture, restoring your broad centre.", sayShort: "cxd4 — restore the centre.", highlights: [H('d4')] },
    { atMove: 17, say: "…Qxe4+ — Black snatches the e4-pawn with check; here's where your king begins its walk.", sayShort: "…Qxe4+ — grabs with check.", highlights: [H('e4', SOFT)] },
    { atMove: 18, say: "Kf2 — step the king up. You give up castling, but the king is safe enough behind the pawns and the bishop pair is your compensation.", sayShort: "Kf2 — the king walks.", highlights: [H('f2')] },
    { atMove: 19, say: "…Bxf3 — Black trades off the pinned knight to break up your kingside.", sayShort: "…Bxf3 — trade the knight.", highlights: [H('f3', SOFT)] },
    { atMove: 20, say: "gxf3 — recapture. Your kingside pawns are ragged, but you keep the two bishops and a big centre — the trade-off this whole line is built on.", sayShort: "gxf3 — bishops for structure.", highlights: [H('f3')] },
    { atMove: 21, say: "…Qh4+ — Black checks again, chasing the king.", sayShort: "…Qh4+ — another check.", highlights: [H('h4', SOFT)] },
    { atMove: 22, say: "Kg2 — tuck the king to g2, and the checks run dry. The storm is weathered.", sayShort: "Kg2 — checks run out.", highlights: [H('g2')] },
    { atMove: 23, say: "…Nbd7 — Black develops. The dust settles on a sharp, roughly level position: your bishop pair and broad centre balance a slightly airy king. A fair, double-edged fight — keep calculating.", sayShort: "…Nbd7 — sharp and balanced.", highlights: [H('d7', SOFT)] },
  ],
  sources: ['concept:pos-bishop-pair', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N86: SublineNarration = {
  intro: { say: "…dxe4 — a French-style trade in the centre. Recapture, hold your broad d4-e4 pawn front, and develop actively; when Black strikes with …c5 you trade down through the centre and come out with the e4-pawn and more space. A small, pleasant edge for the better centre and freer pieces.", sayShort: "…dxe4 — hold the centre, press the edge" },
  beats: [
    { atMove: 10, say: "fxe4 — recapture and keep your broad d4-e4 pawn centre intact.", sayShort: "fxe4 — big centre.", highlights: [H('e4'), H('d4', SOFT)] },
    { atMove: 11, say: "…Nf6 — Black develops and adds an attacker to your e4-pawn.", sayShort: "…Nf6 — pressure e4.", arrows: [A('f6', 'e4')], highlights: [H('e4')] },
    { atMove: 12, say: "Qd3 — defend e4 and develop the queen to an active post eyeing the kingside.", sayShort: "Qd3 — defend e4, get active.", highlights: [H('d3')] },
    { atMove: 13, say: "…c5 — Black strikes at the base of your chain on d4.", sayShort: "…c5 — hit d4.", highlights: [H('c5', SOFT)] },
    { atMove: 14, say: "Nf3 — develop and add a defender to d4, meeting the pressure calmly.", sayShort: "Nf3 — develop, hold d4.", highlights: [H('f3')] },
    { atMove: 15, say: "…Nc6 — Black develops, piling onto d4.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 16, say: "a3 — question the b4-bishop and take b4 away from Black's pieces.", sayShort: "a3 — question the bishop.", highlights: [H('a3')] },
    { atMove: 17, say: "…Qa5 — Black keeps the pin on your c3-knight and eyes the queenside.", sayShort: "…Qa5 — keep the pin.", highlights: [H('a5', SOFT)] },
...
const N87: SublineNarration = {
  intro: { say: "…g6 — Black fianchettoes against the Fantasy. This plays into your hands: clamp the centre with e5 and build a broad f4-d4-e4 pawn front that buries the g7-bishop behind its own pawns and hands you a lasting space bind. Develop simply behind the wall and enjoy the extra room.", sayShort: "…g6 — clamp with e5, big space bind" },
  beats: [
    { atMove: 6, say: "Nc3 — develop and defend e4, the natural Fantasy move.", sayShort: "Nc3 — develop, defend e4.", highlights: [H('c3')] },
    { atMove: 7, say: "…Bg7 — Black fianchettoes, aiming the bishop down the long diagonal.", sayShort: "…Bg7 — the fianchetto.", highlights: [H('g7', SOFT)] },
    { atMove: 8, say: "e5 — clamp the centre, gaining space and, crucially, blunting that g7-bishop behind the pawn wall.", sayShort: "e5 — clamp, blunt the bishop.", highlights: [H('e5')] },
    { atMove: 9, say: "…f6 — Black strikes at your e5-spearhead, the natural try to break the bind.", sayShort: "…f6 — strike the wedge.", highlights: [H('f6', SOFT)] },
    { atMove: 10, say: "f4 — support e5 and build the broad pawn front. This is the big-clamp structure: d4, e5 and f4 all rolling.", sayShort: "f4 — build the pawn front.", highlights: [H('f4')] },
    { atMove: 11, say: "…Nh6 — the knight develops toward f5 or f7, seeking activity.", sayShort: "…Nh6 — develop.", highlights: [H('h6', SOFT)] },
    { atMove: 12, say: "Be2 — modest development, connecting toward castling.", sayShort: "Be2 — develop.", highlights: [H('e2')] },
    { atMove: 13, say: "…O-O — Black castles to safety.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
...
const N88: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 19, say: "…b5 — Black lunges at the c4-knight, but this only helps it reach its dream square.", sayShort: "…b5 — hits the knight.", highlights: [H('b5', SOFT)] },
    { atMove: 20, say: "Nce5 — the knight leaps to the commanding e5-outpost, dominating the centre and eyeing f7 and d7.", sayShort: "Nce5 — the e5 outpost.", highlights: [H('e5')] },
    { atMove: 21, say: "…Nf6 — Black develops, trying to challenge your central grip.", sayShort: "…Nf6 — develop.", highlights: [H('f6', SOFT)] },
    { atMove: 22, say: "Qxd4 — recover the pawn and centralise the queen. Material's level and your pieces are the active ones.", sayShort: "Qxd4 — recover, centralise.", highlights: [H('d4')] },
    { atMove: 23, say: "…Qa5+ — Black checks to disrupt, but it's a pinprick. You're pleasantly better: the dominant e5-knight, central control, and smoother development. Block the check and press your edge.", sayShort: "…Qa5+ — you're pleasantly better.", highlights: [H('a5', SOFT)] },
  ],
  sources: ['concept:pos-outpost', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N89: SublineNarration = {
  intro: { say: "…Nd7 — Black heads for a fianchetto after the central trade. Clamp with e5, gain space on both wings, castle long and develop your pieces to active posts. Your broad centre and the extra room leave Black cramped — a clear, pleasant edge.", sayShort: "…Nd7 — clamp with e5, space both wings" },
  beats: [
    { atMove: 8, say: "e5 — clamp the centre and grab space, cramping Black's setup from the start.", sayShort: "e5 — gain space, clamp.", highlights: [H('e5')] },
    { atMove: 9, say: "…g6 — Black prepares to fianchetto the bishop.", sayShort: "…g6 — prep the fianchetto.", highlights: [H('g6', SOFT)] },
    { atMove: 10, say: "Nc3 — develop and defend e4, building your position.", sayShort: "Nc3 — develop, defend e4.", highlights: [H('c3')] },
    { atMove: 11, say: "…Nb6 — Black reroutes the knight toward c4 or a4.", sayShort: "…Nb6 — reroute.", highlights: [H('b6', SOFT)] },
    { atMove: 12, say: "a4 — grab queenside space and threaten a5 to kick the b6-knight.", sayShort: "a4 — grab space, threaten a5.", highlights: [H('a4')] },
    { atMove: 13, say: "…a5 — Black stops a5, but concedes the b5-square for good.", sayShort: "…a5 — concedes b5.", highlights: [H('b5', SOFT)] },
    { atMove: 14, say: "Bf4 — develop the bishop to an active diagonal, guarding e5 and eyeing the c1-h6 line.", sayShort: "Bf4 — active bishop.", highlights: [H('f4')] },
    { atMove: 15, say: "…h5 — Black grabs some kingside space to keep your pieces off g4.", sayShort: "…h5 — take kingside space.", highlights: [H('h5', SOFT)] },
    { atMove: 16, say: "Qd2 — develop the queen, connect the rooks, and prepare to castle long.", sayShort: "Qd2 — develop, prep O-O-O.", highlights: [H('d2')] },
    { atMove: 17, say: "…Bh6 — Black offers to trade the dark-squared bishops.", sayShort: "…Bh6 — offer a trade.", highlights: [H('h6', SOFT)] },
    { atMove: 18, say: "Nf3 — develop and lend another defender to your e5-spearhead.", sayShort: "Nf3 — defend e5.", highlights: [H('f3')] },
    { atMove: 19, say: "…Bg4 — Black pins the knight, trying to chip at your centre.", sayShort: "…Bg4 — pin the knight.", highlights: [H('g4', SOFT)] },
    { atMove: 20, say: "O-O-O — castle long, connecting the rooks and seizing the open d-file.", sayShort: "O-O-O — king safe, take the d-file.", highlights: [H('c1')] },
    { atMove: 21, say: "…Nd5 — Black centralises the knight, offering trades to relieve the cramp.", sayShort: "…Nd5 — centralise.", highlights: [H('d5', SOFT)] },
    { atMove: 22, say: "Nxd5 — take, opening lines while keeping your space edge.", sayShort: "Nxd5 — take, open lines.", highlights: [H('d5')] },
    { atMove: 23, say: "…Bxf3 — Black grabs the knight, but after you recapture you stay clearly better: the e5 space clamp, the open d-file for your rook, and the more active pieces.", sayShort: "…Bxf3 — you're clearly better.", highlights: [H('f3', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};
...
const N91: SublineNarration = {
  intro: { say: "…e5 — a premature strike that simply drops a pawn. Grab it with dxe5 and don't be rattled by the …Bf2+ check and …Qd4 tricks that follow: trade the queens, let your king step up, and steer into a queenless middlegame where your king becomes a strong central piece. You keep a small, safe edge.", sayShort: "…e5 — grab the pawn, trade down" },
  beats: [
    { atMove: 6, say: "dxe5 — take the pawn; Black's early …e5 just gives you a free centre pawn.", sayShort: "dxe5 — win the pawn.", highlights: [H('e5')] },
    { atMove: 7, say: "…Qb6 — Black eyes b2 and f2, trying to conjure disruption for the pawn.", sayShort: "…Qb6 — seek tricks.", highlights: [H('b6', SOFT)] },
    { atMove: 8, say: "Nc3 — develop and defend e4, keeping your pieces coordinated.", sayShort: "Nc3 — develop, defend e4.", highlights: [H('c3')] },
    { atMove: 9, say: "…Bc5 — Black develops with a threat against f2.", sayShort: "…Bc5 — eye f2.", highlights: [H('c5', SOFT)] },
    { atMove: 10, say: "Na4 — hit both the c5-bishop and the b6-queen at once, gaining tempo.", sayShort: "Na4 — hit two pieces.", arrows: [A('a4', 'c5')], highlights: [H('c5'), H('b6', SOFT)] },
    { atMove: 11, say: "…Bf2+ — a disruptive check, but it leads nowhere concrete.", sayShort: "…Bf2+ — a spite check.", highlights: [H('f2', SOFT)] },
    { atMove: 12, say: "Ke2 — step the king up. With queens about to leave the board, the king is perfectly safe.", sayShort: "Ke2 — the king steps up.", highlights: [H('e2')] },
    { atMove: 13, say: "…Qd4 — Black centralises the queen, offering a trade.", sayShort: "…Qd4 — offer a trade.", highlights: [H('d4', SOFT)] },
    { atMove: 14, say: "Qxd4 — take the trade; with queens off, all of Black's disruption fizzles out.", sayShort: "Qxd4 — trade queens.", highlights: [H('d4')] },
    { atMove: 15, say: "…Bxd4 — Black recaptures.", sayShort: "…Bxd4 — recapture.", highlights: [H('d4', SOFT)] },
    { atMove: 16, say: "f4 — support your extra e5-pawn and grab more space.", sayShort: "f4 — support e5.", highlights: [H('f4')] },
    { atMove: 17, say: "…dxe4 — Black regains a pawn, opening the centre.", sayShort: "…dxe4 — regain a pawn.", highlights: [H('e4', SOFT)] },
    { atMove: 18, say: "Be3 — offer to trade the strong d4-bishop, simplifying toward a clean game.", sayShort: "Be3 — offer the trade.", highlights: [H('e3')] },
    { atMove: 19, say: "…Bxe3 — Black trades.", sayShort: "…Bxe3 — trade.", highlights: [H('e3', SOFT)] },
    { atMove: 20, say: "Kxe3 — recapture with the king; queenless, it's an active fighting piece, not a liability.", sayShort: "Kxe3 — the active king.", highlights: [H('e3')] },
    { atMove: 21, say: "…f6 — Black strikes at your e5-pawn to open lines.", sayShort: "…f6 — hit e5.", highlights: [H('f6', SOFT)] },
    { atMove: 22, say: "Kxe4 — the king marches boldly to e4, a superb central post with no queens to fear.", sayShort: "Kxe4 — king to the centre.", highlights: [H('e4')] },
    { atMove: 23, say: "…fxe5 — Black regains the pawn. It's an unusual queenless middlegame where you hold a small, safe edge: your king dominates the centre and your structure is the sounder. Play it as an endgame.", sayShort: "…fxe5 — a small, safe edge.", highlights: [H('e5', SOFT)] },
  ],
  sources: ['concept:pos-tempo', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};
...
const N92: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 17, say: "…exd4 — Black takes, and the centre begins to dissolve into symmetry.", sayShort: "…exd4 — Black takes.", highlights: [H('d4', SOFT)] },
    { atMove: 18, say: "Bxd4 — recapture, the bishop centralising on a commanding square.", sayShort: "Bxd4 — centralise the bishop.", highlights: [H('d4')] },
    { atMove: 19, say: "…Bc5 — Black offers to trade off your strong d4-bishop.", sayShort: "…Bc5 — offer a trade.", highlights: [H('c5', SOFT)] },
    { atMove: 20, say: "c3 — support the bishop and keep it on its post for now.", sayShort: "c3 — prop the bishop.", highlights: [H('c3')] },
    { atMove: 21, say: "…Bxd4 — Black trades anyway, simplifying toward equality.", sayShort: "…Bxd4 — Black trades.", highlights: [H('d4', SOFT)] },
    { atMove: 22, say: "cxd4 — recapture, leaving you a broad d4-e4 pawn duo — extra space, but nothing more against accurate play.", sayShort: "cxd4 — the pawn duo.", highlights: [H('d4'), H('e4', SOFT)] },
    { atMove: 23, say: "…Bg4 — Black develops with a pin on your f3-knight and fresh pressure on d4. It's fully level: your central pawns give space, his active pieces give counterplay. A fair, balanced game — respect the equality and play on the merits.", sayShort: "…Bg4 — it's level; play on.", highlights: [H('g4', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N93: SublineNarration = {
  intro: { say: "…e6 — a French shell after the central trade, but Black's …c5 lets you seize the initiative. Ram the d-pawn to d5 and, after the trades, you're left with a strong protected passed pawn and a big space bind. Reinforce it with c4 and centralise a knight on e4 — you come out clearly better.", sayShort: "…e6 — d5 gives a passed pawn" },
  beats: [
    { atMove: 8, say: "Nf3 — develop and defend d4, readying the central break.", sayShort: "Nf3 — develop, hold d4.", highlights: [H('f3')] },
    { atMove: 9, say: "…c5 — Black strikes at d4, but this opens the door to your d5-push.", sayShort: "…c5 — hits d4.", highlights: [H('c5', SOFT)] },
    { atMove: 10, say: "d5 — ram the pawn forward. Instead of resolving the tension, you gain a huge space clamp and head for a passed pawn.", sayShort: "d5 — ram, clamp space.", highlights: [H('d5')] },
    { atMove: 11, say: "…exd5 — Black takes, and now your e-pawn will recapture into a passed pawn.", sayShort: "…exd5 — Black takes.", highlights: [H('d5', SOFT)] },
    { atMove: 12, say: "exd5 — recapture, and there it is: a strong protected passed pawn on d5 that cramps Black's whole position.", sayShort: "exd5 — a passed pawn.", highlights: [H('d5')] },
    { atMove: 13, say: "…Bd6 — Black develops, eyeing the kingside dark squares.", sayShort: "…Bd6 — develop.", highlights: [H('d6', SOFT)] },
    { atMove: 14, say: "Nc3 — develop and lend a defender to the proud d5-pawn.", sayShort: "Nc3 — support d5.", highlights: [H('c3')] },
    { atMove: 15, say: "…Ne7 — Black develops, angling to blockade or challenge d5.", sayShort: "…Ne7 — challenge d5.", highlights: [H('e7', SOFT)] },
    { atMove: 16, say: "Bd3 — develop the bishop toward Black's kingside, eyeing h7.", sayShort: "Bd3 — aim at h7.", arrows: [A('d3', 'h7')], highlights: [H('h7')] },
    { atMove: 17, say: "…O-O — Black castles.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 18, say: "O-O — castle, king safe, your passed pawn and space firmly in hand.", sayShort: "O-O — king safe.", highlights: [H('g1')] },
    { atMove: 19, say: "…h6 — Black makes luft before you can drum up kingside threats.", sayShort: "…h6 — make luft.", highlights: [H('h6', SOFT)] },
...
const N94: SublineNarration = {
  intro: { say: "…exd4 — Black opens the centre, and this is your green light for a sound sacrificial attack. Sac the bishop on f7 to drag the king out, then rake it with checks to win back the material with interest. Played accurately you emerge clearly on top — a king stuck in the centre and a dead-lost pawn on c2. Attack with confidence.", sayShort: "…exd4 — the sound Bxf7+ attack" },
  beats: [
    { atMove: 10, say: "Bc4 — develop straight at f7, the sac square. You're happy to leave d4 hanging; development and the attack are the currency here.", sayShort: "Bc4 — aim at f7.", arrows: [A('c4', 'f7')], highlights: [H('f7')] },
    { atMove: 11, say: "…Bb4+ — Black checks, trying to develop with tempo and disrupt you.", sayShort: "…Bb4+ — a check.", highlights: [H('b4', SOFT)] },
    { atMove: 12, say: "c3 — block the check and offer the pawn; you want lines open, not a slow game.", sayShort: "c3 — block, offer the pawn.", highlights: [H('c3')] },
    { atMove: 13, say: "…dxc3 — Black grabs, opening the position — right into your attack.", sayShort: "…dxc3 — Black grabs.", highlights: [H('c3', SOFT)] },
    { atMove: 14, say: "Bxf7+ — the breakthrough! Sacrifice the bishop to rip open the king before Black can ever castle.", sayShort: "Bxf7+ — the sacrifice.", highlights: [H('f7')] },
    { atMove: 15, say: "…Kxf7 — forced; the king is dragged out into the open, exactly where you want it.", sayShort: "…Kxf7 — king dragged out.", highlights: [H('f7', SOFT)] },
    { atMove: 16, say: "Qb3+ — the point: a check that forks the exposed king and Black's loose b4-bishop.", sayShort: "Qb3+ — fork king and bishop.", arrows: [A('b3', 'b4')], highlights: [H('b4')] },
    { atMove: 17, say: "…Ke8 — the king scrambles home, but its castling rights are gone forever.", sayShort: "…Ke8 — king scrambles back.", highlights: [H('e8', SOFT)] },
    { atMove: 18, say: "Qxb4 — collect the bishop. The sacrifice is recouped: material's level and Black's king is stranded in the centre.", sayShort: "Qxb4 — win back the piece.", highlights: [H('b4')] },
    { atMove: 19, say: "…c2 — Black shoves the passed pawn as a desperate distraction.", sayShort: "…c2 — the runner.", highlights: [H('c2', SOFT)] },
...
const N95: SublineNarration = {
  intro: { say: "…g6 — a fianchetto after the central trade, but Black's …b5 lunge overreaches on the queenside. Develop actively toward f7, retreat your bishop to safety, clamp with e5, then hit the loose b5-pawn with a4. You end up with a big centre, the bishop pair, and targets on Black's ragged queenside.", sayShort: "…g6 — clamp, then punish …b5" },
  beats: [
    ...
    { atMove: 15, say: "…Nd5 — the knight hops to the centre.", sayShort: "…Nd5 — into the centre.", highlights: [H('d5', SOFT)] },
    { atMove: 16, say: "Nc3 — develop and challenge the d5-knight.", sayShort: "Nc3 — challenge the knight.", highlights: [H('c3')] },
    { atMove: 17, say: "…O-O — Black castles.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 18, say: "a4 — strike at the overextended b5-pawn, prying open Black's loose queenside.", sayShort: "a4 — hit the b5-pawn.", highlights: [H('a4'), H('b5', SOFT)] },
    { atMove: 19, say: "…Nxc3 — Black trades off before you win a piece with the pin.", sayShort: "…Nxc3 — trade.", highlights: [H('c3', SOFT)] },
    { atMove: 20, say: "bxc3 — recapture toward the centre: now you have a towering c3-d4-e5 pawn mass.", sayShort: "bxc3 — towering centre.", highlights: [H('c3'), H('e5', SOFT)] },
    { atMove: 21, say: "…bxa4 — Black grabs the pawn to avoid losing it outright.", sayShort: "…bxa4 — Black takes.", highlights: [H('a4', SOFT)] },
    { atMove: 22, say: "Rxa4 — recapture; the rook is active on the open a-file and Black's queenside is full of holes.", sayShort: "Rxa4 — active rook.", highlights: [H('a4')] },
    { atMove: 23, say: "…Nd7 — Black develops. You're clearly better: the big centre, the bishop pair, an active rook, and lasting targets on Black's shattered queenside pawns.", sayShort: "…Nd7 — you're clearly better.", highlights: [H('d7', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-bishop-pair', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N96: SublineNarration = {
  intro: { say: "…Nf6 — a Pirc-like fianchetto setup that leans on e4. Kick the knight with e5 and roll out the broad f4-d4-e4 pawn front, burying the g7-bishop behind the wall and grabbing a big space clamp. Behind that bind you have all the room; Black's pieces stay cramped.", sayShort: "…Nf6 — e5/f4 clamp, big space" },
  beats: [
    { atMove: 10, say: "e5 — gain space and kick the f6-knight, clamping the dark squares.", sayShort: "e5 — gain space, kick.", highlights: [H('e5')] },
    { atMove: 11, say: "…Nfd7 — the knight retreats, its outpost gone.", sayShort: "…Nfd7 — retreat.", highlights: [H('d7', SOFT)] },
    { atMove: 12, say: "f4 — build the broad pawn front. d4, e5 and f4 together are a suffocating space bind.", sayShort: "f4 — build the front.", highlights: [H('f4')] },
    { atMove: 13, say: "…Nb6 — Black reroutes the knight toward c4 or d5, hunting activity.", sayShort: "…Nb6 — reroute.", highlights: [H('b6', SOFT)] },
    { atMove: 14, say: "h3 — take the g4-square away and prepare g4 to expand further on the kingside.", sayShort: "h3 — prep g4.", highlights: [H('h3')] },
    { atMove: 15, say: "…h5 — Black stops your g4 in its tracks.", sayShort: "…h5 — stop g4.", highlights: [H('h5', SOFT)] },
    { atMove: 16, say: "Nf3 — develop and shore up your big pawn centre.", sayShort: "Nf3 — develop, hold the centre.", highlights: [H('f3')] },
    { atMove: 17, say: "…Bf5 — Black develops the bishop to an active outpost.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5', SOFT)] },
...
const N98: SublineNarration = {
  intro: { say: "…dxe4 — Black trades and fianchettoes. Recapture to build the broad centre, develop smoothly and castle, then roll forward with e5 and plant a knight on the dominant e4-square. Your central space and the active pieces leave Black cramped — a clear, pleasant edge.", sayShort: "…dxe4 — big centre, dominate e4" },
  beats: [
    { atMove: 8, say: "fxe4 — recapture and there's your broad d4-e4 pawn centre.", sayShort: "fxe4 — the big centre.", highlights: [H('e4'), H('d4', SOFT)] },
    { atMove: 9, say: "…Bg7 — Black fianchettoes, aiming down the long diagonal at your centre.", sayShort: "…Bg7 — the fianchetto.", highlights: [H('g7', SOFT)] },
    { atMove: 10, say: "Nf3 — develop and defend d4, meeting the diagonal pressure calmly.", sayShort: "Nf3 — develop, hold d4.", highlights: [H('f3')] },
    { atMove: 11, say: "…Nf6 — Black develops and pokes at your e4-pawn.", sayShort: "…Nf6 — pressure e4.", arrows: [A('f6', 'e4')], highlights: [H('e4')] },
    { atMove: 12, say: "Be2 — modest development, connecting toward castling.", sayShort: "Be2 — develop.", highlights: [H('e2')] },
    { atMove: 13, say: "…O-O — Black castles to safety.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 14, say: "O-O — castle, king safe, your centre intact.", sayShort: "O-O — king safe.", highlights: [H('g1')] },
    { atMove: 15, say: "…Bg4 — Black pins your knight, trying to chip at your centre.", sayShort: "…Bg4 — pin the knight.", highlights: [H('g4', SOFT)] },
    { atMove: 16, say: "e5 — push and kick the f6-knight, rolling the centre forward and gaining space.", sayShort: "e5 — gain space, kick.", highlights: [H('e5')] },
    { atMove: 17, say: "…Nd5 — the knight hops to the centre, but you have a fine square waiting.", sayShort: "…Nd5 — into the centre.", highlights: [H('d5', SOFT)] },
    { atMove: 18, say: "Ne4 — plant the knight on the dominant e4-outpost, eyeing d6, f6 and g5.", sayShort: "Ne4 — the e4 outpost.", highlights: [H('e4')] },
    { atMove: 19, say: "…f6 — Black strikes at your e5-spearhead to break the bind.", sayShort: "…f6 — strike the wedge.", highlights: [H('f6', SOFT)] },
    { atMove: 20, say: "c4 — kick the d5-knight and widen the centre, gaining still more room.", sayShort: "c4 — kick, widen.", highlights: [H('c4')] },
    { atMove: 21, say: "…Nc7 — the knight retreats to the rim, out of play.", sayShort: "…Nc7 — to the rim.", highlights: [H('c7', SOFT)] },
    { atMove: 22, say: "exf6 — take, opening lines toward Black's king.", sayShort: "exf6 — open lines.", highlights: [H('f6')] },
    { atMove: 23, say: "…exf6 — Black recaptures. You're clearly better: the broad centre, the dominant e4-knight, more space, and Black's knight stranded on c7. Press the space and the open lines.", sayShort: "…exf6 — you're clearly better.", highlights: [H('f6', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-outpost', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N99: SublineNarration = {
  intro: { say: "…dxe4 — against Black's fianchetto setup, this trade lets you build the broad pawn front the Fantasy dreams of. Recapture, roll the centre forward with e5, and use your development lead to win the c-pawn and reach a clean edge — you'll end up a pawn to the good with the freer game.", sayShort: "…dxe4 — build the centre, win a pawn" },
  beats: [
    { atMove: 10, say: "fxe4 — recapture and there's your broad d4-e4 pawn centre, the f-file half-open behind it.", sayShort: "fxe4 — the big centre.", highlights: [H('e4'), H('d4', SOFT)] },
    { atMove: 11, say: "…Nf6 — Black develops and pokes at your e4-pawn.", sayShort: "…Nf6 — pressure e4.", arrows: [A('f6', 'e4')], highlights: [H('e4')] },
    ...
    { atMove: 18, say: "dxc5 — take the pawn. You're now a pawn up, and the c5-pawn cramps Black's queenside too.", sayShort: "dxc5 — win the pawn.", highlights: [H('c5')] },
    { atMove: 19, say: "…Qe4 — the queen lunges after your e5-pawn, but she's walking into tempo losses.", sayShort: "…Qe4 — grabs at e5.", highlights: [H('e4', SOFT)] },
    { atMove: 20, say: "Bb5+ — develop with check, dragging a Black piece to a passive block and gaining a free tempo.", sayShort: "Bb5+ — develop with check.", highlights: [H('b5')] },
    { atMove: 21, say: "…Nc6 — Black blocks the check, the knight pinned to defending duties.", sayShort: "…Nc6 — forced block.", highlights: [H('c6', SOFT)] },
    { atMove: 22, say: "Qe2 — offer to trade queens and consolidate. With an extra pawn, simplifying into a technical game is exactly what you want.", sayShort: "Qe2 — consolidate the extra pawn.", highlights: [H('e2')] },
    { atMove: 23, say: "…O-O — Black castles. You're clearly better: a healthy extra pawn, the e5-wedge, and the smoother development. Trade down and convert the material.", sayShort: "…O-O — you're a pawn up.", highlights: [H('g8', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N100: SublineNarration = {
  intro: { say: "…e5 — with …Qb6 already eyeing b2, Black strikes at the centre. He'll even snatch the b2-pawn, but be honest about this one: with best play it's level. You get the pawn back and a fine central pawn front, but Black holds. Develop soundly, regain the material, and play a balanced game — no advantage to force.", sayShort: "…e5 — sharp but level" },
  beats: [
    { atMove: 12, say: "Nge2 — develop the knight toward the centre, flexible for d4 or f4 and reinforcing your pawn front.", sayShort: "Nge2 — flexible development.", highlights: [H('e2')] },
    { atMove: 13, say: "…Ne7 — Black develops, preparing to castle and support the centre.", sayShort: "…Ne7 — develop.", highlights: [H('e7', SOFT)] },
    { atMove: 14, say: "Qd2 — develop the queen, connect the rooks, and keep an eye on the dark squares.", sayShort: "Qd2 — develop, connect.", highlights: [H('d2')] },
    { atMove: 15, say: "…Qxb2 — Black grabs the b2-pawn, but the queen strays from the action to do it.", sayShort: "…Qxb2 — grabs the pawn.", highlights: [H('b2', SOFT)] },
    { atMove: 16, say: "Ra2 — the rook defends the second rank and harasses the raider, forcing her to retreat and lose time.", sayShort: "Ra2 — hit the queen.", arrows: [A('a2', 'b2')], highlights: [H('b2')] },
    { atMove: 17, say: "…Qb6 — the queen retreats with her extra pawn, but she's spent tempo you'll use.", sayShort: "…Qb6 — the queen retreats.", highlights: [H('b6', SOFT)] },
    { atMove: 18, say: "dxe5 — take in the centre, opening lines and regaining your investment as the position clarifies.", sayShort: "dxe5 — take back in the centre.", highlights: [H('e5')] },
    { atMove: 19, say: "…Qa5 — the queen sidesteps to a safer diagonal, eyeing your position.", sayShort: "…Qa5 — sidestep.", highlights: [H('a5', SOFT)] },
    { atMove: 20, say: "f4 — build a broad pawn front, clamping down on e5 and gaining kingside space.", sayShort: "f4 — build the pawn front.", highlights: [H('f4')] },
    { atMove: 21, say: "…O-O — Black tucks the king away at last.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 22, say: "Nd4 — plant the knight on the strong central outpost, eyeing c6, e6 and f5. Fully compensated for the pawn.", sayShort: "Nd4 — central outpost.", highlights: [H('d4')] },
    { atMove: 23, say: "…Rd8 — Black contests the d-file. It's level: Black's extra b2-pawn is balanced by your big centre, the d4-knight and the initiative. A fair fight — play it on the merits.", sayShort: "…Rd8 — it's balanced.", highlights: [H('d8', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N101: SublineNarration = {
  intro: { say: "…e6 — Black mixes a fianchetto with a French wall. Develop, sidestep the …Qb6 pressure with Rb1, and roll out the e5-f4 space clamp. When Black strikes with …c5 you trade cleanly through the centre and keep the extra room. Your broad centre and better development give a clear, pleasant edge.", sayShort: "…e6 — clamp with e5/f4, big space" },
  beats: [
    { atMove: 8, say: "Be3 — develop the bishop and reinforce your d4-e4 centre.", sayShort: "Be3 — reinforce the centre.", highlights: [H('e3')] },
    { atMove: 9, say: "…Qb6 — the queen leans on b2 and d4, the standard pressure.", sayShort: "…Qb6 — lean on b2/d4.", highlights: [H('b6', SOFT)] },
    { atMove: 10, say: "Rb1 — a tidy prophylactic move: it sidesteps …Qxb2 and readies the b-file, so you never have to worry about the pawn.", sayShort: "Rb1 — sidestep …Qxb2.", highlights: [H('b1')] },
    { atMove: 11, say: "…Nf6 — Black develops and pokes at your e4-pawn.", sayShort: "…Nf6 — pressure e4.", arrows: [A('f6', 'e4')], highlights: [H('e4')] },
    { atMove: 12, say: "e5 — kick the knight and clamp the centre, seizing space.", sayShort: "e5 — gain space, kick.", highlights: [H('e5')] },
    { atMove: 13, say: "…Nfd7 — the knight retreats, its outpost gone.", sayShort: "…Nfd7 — retreat.", highlights: [H('d7', SOFT)] },
    { atMove: 14, say: "f4 — build the broad pawn front. d4, e5 and f4 together are a suffocating bind.", sayShort: "f4 — build the front.", highlights: [H('f4')] },
    { atMove: 15, say: "…c5 — Black strikes at the base of your chain on d4.", sayShort: "…c5 — hit d4.", highlights: [H('c5', SOFT)] },
    { atMove: 16, say: "Nf3 — develop and add a defender to d4, meeting the pressure calmly.", sayShort: "Nf3 — develop, hold d4.", highlights: [H('f3')] },
    { atMove: 17, say: "…a6 — Black prepares …b5 for queenside counterplay.", sayShort: "…a6 — prep …b5.", highlights: [H('a6', SOFT)] },
    { atMove: 18, say: "Qd2 — develop the queen and connect the rooks, completing your setup.", sayShort: "Qd2 — develop, connect.", highlights: [H('d2')] },
    { atMove: 19, say: "…cxd4 — Black releases the tension, opening the centre.", sayShort: "…cxd4 — Black takes.", highlights: [H('d4', SOFT)] },
    { atMove: 20, say: "Nxd4 — recapture, centralising the knight on its best square.", sayShort: "Nxd4 — centralise.", highlights: [H('d4')] },
    { atMove: 21, say: "…Qc7 — the queen steps back to a safer post.", sayShort: "…Qc7 — regroup.", highlights: [H('c7', SOFT)] },
    { atMove: 22, say: "Bd3 — develop the bishop toward Black's kingside, completing your mobilisation.", sayShort: "Bd3 — develop.", highlights: [H('d3')] },
    { atMove: 23, say: "…Be7 — Black develops. You're clearly better: the e5-f4-d4 space clamp gives lasting room, your pieces are all active, and Black stays cramped. Hold the bind and pick your break.", sayShort: "…Be7 — you hold the bind.", highlights: [H('e7', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N102: SublineNarration = {
  intro: { say: "…Nf6 — Black hits e4 while the queen sits on b6. Kick the knight with e5, and when Black trades on c3 you get a massive c3-d4-e5 pawn centre plus the bishop pair. Then throw the pieces at the king: Ng5 and Bc4 pile onto f7 and you come out clearly on top.", sayShort: "…Nf6 — big centre, then hit f7" },
  beats: [
    { atMove: 10, say: "e5 — gain space and kick the f6-knight, clamping the centre.", sayShort: "e5 — gain space, kick.", highlights: [H('e5')] },
    { atMove: 11, say: "…Nd5 — the knight hops to the centre.", sayShort: "…Nd5 — into the centre.", highlights: [H('d5', SOFT)] },
    { atMove: 12, say: "Nf3 — develop and defend your e5-spearhead.", sayShort: "Nf3 — defend e5.", highlights: [H('f3')] },
    { atMove: 13, say: "…g6 — Black prepares to fianchetto the bishop.", sayShort: "…g6 — prep the fianchetto.", highlights: [H('g6', SOFT)] },
    { atMove: 14, say: "Be2 — modest development toward castling.", sayShort: "Be2 — develop.", highlights: [H('e2')] },
    { atMove: 15, say: "…Bg7 — Black fianchettoes, but the bishop bites on your e5-pawn.", sayShort: "…Bg7 — the fianchetto.", highlights: [H('g7', SOFT)] },
    { atMove: 16, say: "O-O — castle, king safe, ready to turn to the attack.", sayShort: "O-O — king safe.", highlights: [H('g1')] },
    { atMove: 17, say: "…Nxc3 — Black trades off the d5-knight for your c3-knight.", sayShort: "…Nxc3 — trade.", highlights: [H('c3', SOFT)] },
    { atMove: 18, say: "bxc3 — recapture toward the centre: now you have a towering c3-d4-e5 pawn mass and the bishop pair.", sayShort: "bxc3 — towering centre.", highlights: [H('c3'), H('e5', SOFT)] },
    { atMove: 19, say: "…c5 — Black strikes at your d4-pawn, seeking counterplay.", sayShort: "…c5 — hit d4.", highlights: [H('c5', SOFT)] },
    { atMove: 20, say: "Ng5 — leap the knight toward f7 and e6, taking direct aim at Black's king.", sayShort: "Ng5 — attack f7.", arrows: [A('g5', 'f7')], highlights: [H('f7')] },
    { atMove: 21, say: "…O-O — Black castles into the coming pressure.", sayShort: "…O-O — Black castles.", highlights: [H('g8', SOFT)] },
    { atMove: 22, say: "Bc4 — bring the bishop into the attack, doubling up on f7 with the g5-knight.", sayShort: "Bc4 — pile onto f7.", arrows: [A('c4', 'f7')], highlights: [H('f7')] },
    { atMove: 23, say: "…cxd4 — Black grabs a pawn, but it's too slow. You're clearly better: a huge centre, the bishop pair, and a real attack bearing down on f7. Keep the pieces coming.", sayShort: "…cxd4 — you have the attack.", highlights: [H('d4', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-initiative', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N103: SublineNarration = {
  intro: { say: "…e5 — with the queen already on b6, Black lunges at your centre, but it just drops a pawn. Take it with dxe5, ride out the …Bf2+ and …Qd4 disruption by trading queens, and steer into a queenless middlegame where your king strides to the centre as a strong piece. You hold a small, safe edge.", sayShort: "…e5 — grab the pawn, trade down" },
  beats: [
    { atMove: 8, say: "dxe5 — take the pawn; the …e5 lunge simply hands you a free centre pawn.", sayShort: "dxe5 — win the pawn.", highlights: [H('e5')] },
    { atMove: 9, say: "…Bc5 — Black develops with a threat on f2, chasing complications.", sayShort: "…Bc5 — eye f2.", highlights: [H('c5', SOFT)] },
    { atMove: 10, say: "Na4 — hit the c5-bishop and the b6-queen together, gaining a tempo.", sayShort: "Na4 — hit two pieces.", arrows: [A('a4', 'c5')], highlights: [H('c5'), H('b6', SOFT)] },
    { atMove: 11, say: "…Bf2+ — a disruptive check that leads nowhere concrete.", sayShort: "…Bf2+ — a spite check.", highlights: [H('f2', SOFT)] },
    { atMove: 12, say: "Ke2 — step the king up; with the queens about to come off, it's perfectly safe.", sayShort: "Ke2 — the king steps up.", highlights: [H('e2')] },
    { atMove: 13, say: "…Qd4 — Black centralises and offers a queen trade.", sayShort: "…Qd4 — offer a trade.", highlights: [H('d4', SOFT)] },
    { atMove: 14, say: "Qxd4 — take it; queens off, and Black's disruption evaporates.", sayShort: "Qxd4 — trade queens.", highlights: [H('d4')] },
    { atMove: 15, say: "…Bxd4 — Black recaptures.", sayShort: "…Bxd4 — recapture.", highlights: [H('d4', SOFT)] },
    { atMove: 16, say: "f4 — support the extra e5-pawn and take more space.", sayShort: "f4 — support e5.", highlights: [H('f4')] },
    { atMove: 17, say: "…dxe4 — Black regains a pawn, opening the centre.", sayShort: "…dxe4 — regain a pawn.", highlights: [H('e4', SOFT)] },
    { atMove: 18, say: "Be3 — offer to trade the d4-bishop, simplifying toward a clean position.", sayShort: "Be3 — offer the trade.", highlights: [H('e3')] },
    { atMove: 19, say: "…Bxe3 — Black trades.", sayShort: "…Bxe3 — trade.", highlights: [H('e3', SOFT)] },
    { atMove: 20, say: "Kxe3 — recapture with the king; in a queenless game it's an asset, not a target.", sayShort: "Kxe3 — the active king.", highlights: [H('e3')] },
    { atMove: 21, say: "…f6 — Black strikes at your e5-pawn to open lines.", sayShort: "…f6 — hit e5.", highlights: [H('f6', SOFT)] },
    { atMove: 22, say: "Kxe4 — march the king to e4, a commanding central square with no queens to fear.", sayShort: "Kxe4 — king to the centre.", highlights: [H('e4')] },
    { atMove: 23, say: "…fxe5 — Black regains the pawn. It's a queenless middlegame with a small, safe edge for you: your king rules the centre and your structure is sounder. Treat it as an endgame.", sayShort: "…fxe5 — a small, safe edge.", highlights: [H('e5', SOFT)] },
  ],
  sources: ['concept:pos-tempo', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N104: SublineNarration = {
  intro: { say: "…e5 — Black strikes at d4 straight away, and after the queens come off this heads into a balanced, simplified middlegame. Play it honestly: the queen trade on d4 dissolves the tension, and it's dead level. You'll castle long for activity down the d-file and grab kingside space with e5, but there's no attack to force — just an equal, pleasant position to play out on technique.", sayShort: "…e5 — queens off; it's level" },
  beats: [
    { atMove: 10, say: "Nf3 — develop and hit the e5-pawn, forcing Black to resolve the central tension.", sayShort: "Nf3 — hit e5.", arrows: [A('f3', 'e5')], highlights: [H('e5')] },
    { atMove: 11, say: "…exd4 — Black takes on d4, opening the centre.", sayShort: "…exd4 — Black takes.", highlights: [H('d4', SOFT)] },
    { atMove: 12, say: "Qxd4 — recapture, centralising the queen and offering a trade that simplifies the game.", sayShort: "Qxd4 — centralise, offer a trade.", highlights: [H('d4')] },
    { atMove: 13, say: "…Qxd4 — Black takes the trade; with queens off, this becomes a calm, level battle of pieces.", sayShort: "…Qxd4 — queens come off.", highlights: [H('d4', SOFT)] },
    { atMove: 14, say: "Nxd4 — recapture, the knight landing on a strong central outpost. Balanced, but your pieces are comfortably placed.", sayShort: "Nxd4 — central outpost.", highlights: [H('d4')] },
    { atMove: 15, say: "…Bc5 — Black develops with tempo, hitting your centralised knight.", sayShort: "…Bc5 — hit the knight.", arrows: [A('c5', 'd4')], highlights: [H('d4', SOFT)] },
    ...
    { atMove: 23, say: "…Nxe5 — Black grabs the pawn, but you have full compensation: active pieces and the open d-file bearing down. It's dead level — a fair fight to be decided by technique, not by any opening edge.", sayShort: "…Nxe5 — level, play on technique.", highlights: [H('e5', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};
...
const N105: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 9, say: "…Nd7 — Black develops toward the centre.", sayShort: "…Nd7 — develop.", highlights: [H('d7', SOFT)] },
    { atMove: 10, say: "Nf2 — the knight completes its journey, a rock-solid guardian of e4.", sayShort: "Nf2 — guard e4.", highlights: [H('f2')] },
    { atMove: 11, say: "…dxe4 — Black trades in the centre.", sayShort: "…dxe4 — Black trades.", highlights: [H('e4', SOFT)] },
    { atMove: 12, say: "Ncxe4 — recapture with the knight, centralising it on a strong square.", sayShort: "Ncxe4 — centralise.", highlights: [H('e4')] },
    { atMove: 13, say: "…Ngf6 — Black develops and challenges your centralised knight.", sayShort: "…Ngf6 — challenge the knight.", highlights: [H('f6', SOFT)] },
    { atMove: 14, say: "c3 — a small solidifying move, cementing d4 before you develop the bishops.", sayShort: "c3 — cement d4.", highlights: [H('c3')] },
    { atMove: 15, say: "…Be7 — Black develops and prepares to castle.", sayShort: "…Be7 — develop.", highlights: [H('e7', SOFT)] },
    ...
    { atMove: 23, say: "…cxd5 — Black takes. It's a balanced middlegame: your active pieces and the d5-break give a comfortable game, but Black is solid. Play it on the merits — no forced advantage, just a pleasant position.", sayShort: "…cxd5 — comfortable, balanced.", highlights: [H('d5', SOFT)] },
  ],
  sources: ['concept:pos-center', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Caro%E2%80%93Kann_Defence'],
};

const N106: SublineNarration = {
  intro: { say: "…Bd7 — Black develops the bishop early and heads into a slow, maneuvering Advance where nobody rushes. This is a patient positional battle: you'll overprotect d4 with the Na3-c2 route, tuck your king, and prepare a Rg1 and g4 pawn-storm to kick Black's blockading knight off f5. Understand the plan and the moves play themselves.", sayShort: "…Bd7 — a slow maneuvering game" },
  beats: [
    { atMove: 8, say: "Nf3 — develop and defend d4, the anchor of your whole chain. Nothing fancy in the Advance's early moves; sound development first.", sayShort: "Nf3 — develop, hold d4.", highlights: [H('f3')] },
    { atMove: 9, say: "…Nc6 — Black brings the knight up to lean on d4.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 10, say: "Be2 — modest development. The bishop has no glamorous diagonal here, so it simply gets out of the way and connects the rooks.", sayShort: "Be2 — quiet development.", highlights: [H('e2')] },
    { atMove: 11, say: "…Nge7 — Black reroutes the knight toward f5, the ideal French blockading square.", sayShort: "…Nge7 — heading for f5.", highlights: [H('e7', SOFT)] },
    { atMove: 12, say: "Na3 — the key regrouping: the knight is bound for c2, where it overprotects d4 and frees you to expand. An awkward-looking square with a clear purpose.", sayShort: "Na3 — reroute to c2.", arrows: [A('a3', 'c2')], highlights: [H('c2')] },
    { atMove: 13, say: "…Nf5 — the knight reaches its dream square, blockading and pressing d4. This is the piece you'll eventually want to chase away.", sayShort: "…Nf5 — the blockading knight.", highlights: [H('f5', SOFT)] },
    { atMove: 14, say: "O-O — castle, king to safety, and prepare to organise on the kingside.", sayShort: "O-O — king safe.", highlights: [H('g1')] },
    { atMove: 15, say: "…cxd4 — Black releases the tension in the centre.", sayShort: "…cxd4 — Black takes.", highlights: [H('d4', SOFT)] },
    { atMove: 16, say: "cxd4 — recapture, restoring the broad d4-e5 pawn centre. Your space stands.", sayShort: "cxd4 — restore the centre.", highlights: [H('d4'), H('e5', SOFT)] },
    { atMove: 17, say: "…Be7 — Black develops and prepares to castle.", sayShort: "…Be7 — develop.", highlights: [H('e7', SOFT)] },
    { atMove: 18, say: "Kh1 — a quiet, far-sighted move: it steps the king off the g1-a7 diagonal so you can play g4 later without any tactical worry. Preparation before action.", sayShort: "Kh1 — prep the g4 push.", highlights: [H('h1')] },
    { atMove: 19, say: "…O-O — Black castles into the same wing where you're about to expand — exactly what you were hoping for.", sayShort: "…O-O — Black castles kingside.", highlights: [H('g8', SOFT)] },
    { atMove: 20, say: "Nc2 — the knight completes its journey, cementing d4 so nothing can distract you from the coming pawn-storm.", sayShort: "Nc2 — cement d4.", highlights: [H('c2')] },
    { atMove: 21, say: "…Be8 — Black reroutes the bishop toward the kingside, sensing where the game is headed.", sayShort: "…Be8 — reroute.", highlights: [H('e8', SOFT)] },
    { atMove: 22, say: "Rg1 — the rook backs the g-pawn: g4 is coming to blast the f5-knight off its perch and open lines at Black's castled king. This is the whole point of Kh1 and Nc2.", sayShort: "Rg1 — load the g4 storm.", highlights: [H('g1'), H('g4', SOFT)] },
    { atMove: 23, say: "…Nh4 — the knight sidesteps the coming g4. It's a rich, maneuvering middlegame where you hold the trumps: more space, a rock-solid centre, and a ready-made kingside attack.", sayShort: "…Nh4 — you hold the trumps.", highlights: [H('h4', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-development', 'https://en.wikipedia.org/wiki/French_Defence'],
};

const N107: SublineNarration = {
  intro: { say: "…Nge7 — the Paulsen Attack setup. Black's knight heads for f5 or g6 to lean on d4 without blocking the c6-knight. Your answer is the classic Nc3-a3-c2 reroute: pile a second and third defender onto d4, keep the chain rock-solid, then, with the centre secure, expand on the kingside with h4. Overprotection first, aggression second.", sayShort: "…Nge7 Paulsen — overprotect d4" },
  beats: [
    { atMove: 10, say: "Na3 — an odd-looking square with a clear destination: the knight is bound for c2, where it becomes a second defender of d4. Trust the route.", sayShort: "Na3 — reroute to c2.", arrows: [A('a3', 'c2')], highlights: [H('c2')] },
    { atMove: 11, say: "…cxd4 — Black releases the tension, opening the c-file.", sayShort: "…cxd4 — Black takes.", highlights: [H('d4', SOFT)] },
    { atMove: 12, say: "cxd4 — recapture toward the centre; the d4-e5 pawn pair stands tall.", sayShort: "cxd4 — restore the centre.", highlights: [H('d4'), H('e5', SOFT)] },
    { atMove: 13, say: "…Qb6 — the queen leans on d4 and b2, the standard French pressure.", sayShort: "…Qb6 — lean on d4.", highlights: [H('b6', SOFT)] },
    { atMove: 14, say: "Nc2 — the knight arrives, overprotecting d4 and covering b4. Now the pawn is defended three times and Black's pressure runs into a wall.", sayShort: "Nc2 — overprotect d4.", arrows: [A('c2', 'd4')], highlights: [H('d4')] },
    { atMove: 15, say: "…Bd7 — Black develops, still eyeing the …Bb5 trade of light bishops.", sayShort: "…Bd7 — prep …Bb5.", highlights: [H('d7', SOFT)] },
    ...
    { atMove: 23, say: "…h6 — Black slows the h5-advance and makes luft. You're clearly better: the secure centre, more space, and a Black king with no comfortable shelter. Overprotection paid off.", sayShort: "…h6 — you're clearly better.", highlights: [H('h6', SOFT)] },
  ],
...
const N108: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 12, say: "Bb5 — pin the c6-knight against the e8-king along the diagonal. The knight is a key defender of d4 and e5, and now it's tied down.", sayShort: "Bb5 — pin the knight.", arrows: [A('b5', 'c6')], highlights: [H('c6'), H('e8', SOFT)] },
...
const N109: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 17, say: "…Ng6 — the knight eyes e5 and hops toward f4/h4, trying to find activity.", sayShort: "…Ng6 — eye e5.", highlights: [H('g6', SOFT)] },
    { atMove: 18, say: "h4 — gain kingside space with a threat attached: the pawn is coming to h5 to kick that g6-knight off its square.", sayShort: "h4 — space, threaten h5.", highlights: [H('h4')] },
    { atMove: 19, say: "…Be7 — Black develops and eyes the h4-pawn, trying to make something of your advance.", sayShort: "…Be7 — develop.", highlights: [H('e7', SOFT)] },
    { atMove: 20, say: "h5 — shove the knight to the rim. Space gained, and Black's pieces get pushed backward.", sayShort: "h5 — kick the knight.", highlights: [H('h5')] },
    { atMove: 21, say: "…Nh4 — the knight jumps to h4 and offers to trade your good f3-knight, Black's best practical try.", sayShort: "…Nh4 — offer a trade.", highlights: [H('h4', SOFT)] },
    { atMove: 22, say: "Nxd4 — and now you collect. The knight snaps up the d4-pawn with tempo, landing centralised. Material is level again — and you got there with a big head start in development.", sayShort: "Nxd4 — win the pawn back.", highlights: [H('d4')] },
    { atMove: 23, say: "…g6 — Black tries to shake the h5-pawn loose. You're comfortably better: more space, a safer king, the e5-wedge, and the initiative — everything the pawn was 'worth' and more.", sayShort: "…g6 — you're comfortably better.", highlights: [H('g6', SOFT)] },
  ],
...
const N111: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 16, say: "Rh3 — a flexible rook lift onto the third rank, ready to swing wherever the play opens.", sayShort: "Rh3 — flexible rook lift.", highlights: [H('h3')] },
    { atMove: 17, say: "…Ne7 — Black develops the kingside knight, heading for f5 or g6.", sayShort: "…Ne7 — develop.", highlights: [H('e7', SOFT)] },
    { atMove: 18, say: "Kf1 — with the centre closed, king safety is flexible: you begin an artificial castling by hand, the king strolling to g1 in no danger.", sayShort: "Kf1 — castle by hand.", highlights: [H('f1')] },
    { atMove: 19, say: "…Nc6 — Black develops, adding another attacker to d4.", sayShort: "…Nc6 — pressure d4.", highlights: [H('c6', SOFT)] },
    { atMove: 20, say: "Qe2 — develop the queen and connect the rooks, completing your mobilisation.", sayShort: "Qe2 — develop, connect.", highlights: [H('e2')] },
    { atMove: 21, say: "…Nc7 — Black finally reroutes the offside a6-knight back toward the centre.", sayShort: "…Nc7 — reroute the knight.", highlights: [H('c7', SOFT)] },
    { atMove: 22, say: "Kg1 — the king completes its walk to safety. Artificial castling done, and you never lost a beat of your space-grabbing plan.", sayShort: "Kg1 — king tucked away.", highlights: [H('g1')] },
    { atMove: 23, say: "…O-O-O — Black castles queenside at last. You're clearly better: space on both wings, a safe king, and Black's pieces still sorting themselves out. The slow …b6 plan simply gave you too much time.", sayShort: "…O-O-O — you're clearly better.", highlights: [H('c8', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pawn-chain', 'https://en.wikipedia.org/wiki/French_Defence'],
};
...
const N112: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 19, say: "…Ng4 — the knight jabs at your e3-bishop, trying to provoke a concession.", sayShort: "…Ng4 — hit the bishop.", highlights: [H('g4', SOFT)] },
    { atMove: 20, say: "O-O — castle and stay unbothered. If Black trades on e3, you'll be delighted — it hands you the half-open f-file straight at f7.", sayShort: "O-O — invite the e3 trade.", highlights: [H('g1')] },
    { atMove: 21, say: "…Nxe3 — Black takes the bishop, trading off a defender.", sayShort: "…Nxe3 — Black trades.", highlights: [H('e3', SOFT)] },
    { atMove: 22, say: "fxe3 — recapture toward the centre. Yes, you have doubled e-pawns, but look what half-opens: the f-file, a ready-made avenue for your rook toward f7 the moment the f3-knight steps aside. That's a genuine attacking asset.", sayShort: "fxe3 — half-open the f-file.", highlights: [H('f2'), H('f7', SOFT)] },
    { atMove: 23, say: "…Be7 — Black develops and prepares to castle out of the danger. You're comfortably better: more space, the mobile centre, and the open f-file aimed at his king. The squeeze is working.", sayShort: "…Be7 — you're pressing.", highlights: [H('e7', SOFT)] },
  ],
...
const N113: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 23, say: "…Qb6 — Black hurries the queen back to defend. You're clearly better: the queenside opened in your favour, your king is safe, and the b-file plus the e5-wedge give you all the play. b3 did its job.", sayShort: "…Qb6 — you're clearly better.", highlights: [H('b6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-initiative', 'https://en.wikipedia.org/wiki/French_Defence'],
};
...
const N117: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 23, say: "…Ng6 — Black regroups, hunting for activity. You hold a pleasant edge: the b5-hole, active pieces, and a sound structure. …a5 bought queenside calm at the cost of a lasting weakness.", sayShort: "…Ng6 — you hold the edge.", highlights: [H('g6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-development', 'https://en.wikipedia.org/wiki/French_Defence'],
};
...
const N118: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 21, say: "…Bg7 — Black completes the fianchetto, the bishop raking the long diagonal into your queenside.", sayShort: "…Bg7 — the long diagonal.", highlights: [H('g7', SOFT)] },
    { atMove: 22, say: "b3 — challenge the over-extended …c4-pawn and pry the queenside open, exactly where you want to play.", sayShort: "b3 — undermine c4.", highlights: [H('b3'), H('c4', SOFT)] },
    { atMove: 23, say: "…O-O — Black finally castles. You're comfortably better: the e5-wedge, a lead in development, the b3-break landing on Black's loose queenside, and a soft e6-pawn to target. …f6 came too soon.", sayShort: "…O-O — you're comfortably better.", highlights: [H('g8', SOFT)] },
  ],
  sources: ['concept:pawn-chain', 'concept:pos-development', 'https://en.wikipedia.org/wiki/French_Defence'],
};

const N119: SublineNarration = {
  intro: { say: "…f6 — with the queenside already locked by …c4, Black turns to the head of the chain and strikes at e5, the other thematic French break. Meet it head-on: let the pawns come off in the centre, keep your e5-wedge, and use your lead in development. When the smoke clears you'll have the freer pieces and a target on Black's slightly loosened kingside.", sayShort: "…f6 lever — meet it head-on" },
  beats: [
    { atMove: 14, say: "Be2 — quiet, solid development. You calmly finish mobilising before Black's …f6 lever lands; no need to react before you're ready.", sayShort: "Be2 — develop, stay solid.", highlights: [H('e2')] },
    { atMove: 15, say: "…fxe5 — Black opens the f-file and challenges your spearhead, the point of …f6.", sayShort: "…fxe5 — strike the chain.", highlights: [H('e5', SOFT)] },
    { atMove: 16, say: "Nxe5 — recapture with the knight, landing it on a superb central outpost that eyes d7, f7 and g6.", sayShort: "Nxe5 — centralise the knight.", arrows: [A('e5', 'f7')], highlights: [H('e5')] },
    { atMove: 17, say: "…Nxe5 — Black trades off your beautiful knight, the only way to relieve the pressure.", sayShort: "…Nxe5 — Black trades.", highlights: [H('e5', SOFT)] },
    { atMove: 18, say: "dxe5 — recapture toward the centre and there it is again: the e5-wedge restored, cramping Black just as before, only now the position is more open and your pieces are freer.", sayShort: "dxe5 — restore the wedge.", highlights: [H('e5')] },
    { atMove: 19, say: "…Bc5 — Black develops with tempo, the bishop raking the a7-g1 diagonal toward f2.", sayShort: "…Bc5 — eye f2.", arrows: [A('c5', 'f2')], highlights: [H('f2')] },
...
const N147: SublineNarration = {
  intro: { say: "…Bb7 — your 150 setup is humming: e4 and d4 in the centre, the e3-bishop and d2-queen lined up for Bh6. He grabs queenside space, but your a3 blunts …b4. Thrust h4 to provoke …h5, reroute the knight into the g5-hole that leaves, and keep the dark-squared bishop biting. His king is stuck on e8 — you're comfortably better.", sayShort: "h4 provokes …h5, Ng5 grips" },
  beats: [
    { atMove: 12, say: "h4 — the 150's thrust; it provokes …h5 and hands you the g5-square for your knight.", sayShort: "h4 — provoke …h5, grab g5.", highlights: [H('h4'), H('g5', SOFT)] },
    { atMove: 14, say: "Nh3 reroutes the knight toward the g5-hole …h5 just created.", sayShort: "Nh3 — reroute to g5.", arrows: [A('h3', 'g5')], highlights: [H('g5')] },
    { atMove: 16, say: "Ng5 lands on the outpost, glaring at f7 and e6 in his camp.", sayShort: "Ng5 — the outpost.", highlights: [H('g5'), H('f7', SOFT)] },
    { atMove: 18, say: "Be2 eyes the loose h5-pawn and clears the way to swap off his active knight.", sayShort: "Be2 — target h5.", arrows: [A('e2', 'h5')], highlights: [H('h5')] },
    { atMove: 20, say: "Bf4 sidesteps the …Ng4 hit and keeps the dark-squared bishop biting at d6.", sayShort: "Bf4 — keep the dark grip.", arrows: [A('f4', 'd6')], highlights: [H('d6')] },
    { atMove: 22, say: "dxe5 cracks the centre open while his king still sits on e8 — you're clearly on top.", sayShort: "dxe5 — open on the stuck king.", highlights: [H('e5'), H('e8', SOFT)] },
  ],
  sources: ['concept:att-kingside-storm', 'concept:pos-outpost', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N148: SublineNarration = {
  intro: { say: "…Nd7 — he bolsters the centre behind …a6/…b5 and preps …c5. Your a3 keeps …b4 in check while the e3-bishop and d2-queen stay trained on h6. Clamp the centre with d5, and when he castles kingside, trade the fianchetto bishop with Bh6 and crash Qxh6 in beside his king — you're first to the attack.", sayShort: "d5 clamp, then Bh6 and Qxh6" },
  beats: [
    { atMove: 12, say: "Nf3 develops, the knight eyeing the e5- and g5-squares as your setup completes.", sayShort: "Nf3 — develop, eye e5/g5.", arrows: [A('f3', 'e5')], highlights: [H('e5')] },
    { atMove: 14, say: "d5 — ram the spearhead home; the clamp freezes his queenside and opens your game.", sayShort: "d5 — the space clamp.", highlights: [H('d5')] },
    { atMove: 16, say: "Bd3 eyes the kingside from behind e4 and shrugs off …Nxd3, which only opens the c-file at his king.", sayShort: "Bd3 — aim at the king.", highlights: [H('d3')] },
    { atMove: 17, say: "…O-O — he tucks the king away, but straight into your Bh6 plan.", sayShort: "…O-O — into the Bh6 plan.", highlights: [H('g8')] },
    { atMove: 18, say: "Bh6 offers the trade of his best defender; the dark squares round his king go soft.", sayShort: "Bh6 — strip the defender.", arrows: [A('h6', 'g7')], highlights: [H('g7')] },
    { atMove: 20, say: "dxe6 — the en-passant break rips his king's cover open at the crucial moment.", sayShort: "dxe6 — rip the cover open.", highlights: [H('e6')] },
    { atMove: 22, say: "Qxh6 — the queen crashes in beside his king; your attack is faster.", sayShort: "Qxh6 — invade the king.", highlights: [H('h6')] },
  ],
...
const N149: SublineNarration = {
  intro: { say: "…Nd7 — an early knight that does little to contest your centre. Complete the battery with Qd2, thrust h4 to provoke …h5, and reroute the knight via h3 into g5. When he expands with …b5, strike back with a4, then plant a knight on the d5-outpost — two knights and the bishop swarm his king. You're clearly better.", sayShort: "Qd2, h4, a4, Nd5 — swarm the king" },
  beats: [
    { atMove: 8, say: "Qd2 completes the 150 battery — bishop on e3, queen right behind, both trained on h6.", sayShort: "Qd2 — the 150 battery.", highlights: [H('e3', SOFT), H('h6', SOFT)] },
    { atMove: 10, say: "h4 provokes …h5 and opens the h3-g5 route for your knight.", sayShort: "h4 — provoke …h5.", highlights: [H('h4'), H('g5', SOFT)] },
    { atMove: 12, say: "Nh3 heads for the g5-hole …h5 just made.", sayShort: "Nh3 — reroute to g5.", arrows: [A('h3', 'g5')], highlights: [H('g5')] },
    { atMove: 14, say: "a4 strikes back at his …b5 push, prising the queenside open on your terms.", sayShort: "a4 — strike the queenside.", highlights: [H('a4')] },
    { atMove: 16, say: "Nd5 — the knight jumps to the dream outpost, hitting c7 and e7 and dominating the board.", sayShort: "Nd5 — the dream outpost.", highlights: [H('d5')] },
    { atMove: 18, say: "Nxf6+ swaps into his camp with tempo, dragging a defender off.", sayShort: "Nxf6+ — trade with tempo.", highlights: [H('f6')] },
    { atMove: 20, say: "Ng5 lands on the second outpost, both knights swarming his king.", sayShort: "Ng5 — the second outpost.", highlights: [H('g5')] },
    { atMove: 22, say: "Bc4 joins in, the bishop raking straight at f7; you're clearly on top.", sayShort: "Bc4 — rake at f7.", arrows: [A('c4', 'f7')], highlights: [H('f7')] },
  ],
  sources: ['concept:pos-outpost', 'concept:att-kingside-storm', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N150: SublineNarration = {
  intro: { say: "…Nd7 — he holds the knight back behind …a6, keeping breaks in reserve. Your full 150 structure is set. Thrust h4 to provoke …h5, reroute the knight via h3 to g5, hit back at his …b5 with a4, and drop a knight onto the d5-outpost. Both knights plus the c4-bishop converge on his king — a clear pull.", sayShort: "h4, a4, Nd5 — converge on the king" },
  beats: [
    { atMove: 10, say: "h4 provokes …h5 and opens the h3-g5 route for your knight.", sayShort: "h4 — provoke …h5.", highlights: [H('h4'), H('g5', SOFT)] },
    { atMove: 12, say: "Nh3 heads for the g5-hole …h5 just made.", sayShort: "Nh3 — reroute to g5.", arrows: [A('h3', 'g5')], highlights: [H('g5')] },
    { atMove: 14, say: "a4 hits back at his …b5, cracking the queenside open on your terms.", sayShort: "a4 — strike the queenside.", highlights: [H('a4')] },
    { atMove: 16, say: "Nd5 leaps to the dominant outpost, hitting c7 and e7.", sayShort: "Nd5 — dominant outpost.", highlights: [H('d5')] },
    { atMove: 18, say: "Nxf6+ trades into his camp with tempo, peeling off a defender.", sayShort: "Nxf6+ — trade with tempo.", highlights: [H('f6')] },
    { atMove: 20, say: "Ng5 grabs the second outpost, both knights on his king.", sayShort: "Ng5 — the second outpost.", highlights: [H('g5')] },
    { atMove: 22, say: "Bc4 develops with a stare at f7; you're clearly better.", sayShort: "Bc4 — rake at f7.", arrows: [A('c4', 'f7')], highlights: [H('f7')] },
  ],
  sources: ['concept:pos-outpost', 'concept:att-kingside-storm', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N151: SublineNarration = {
  intro: { say: "…Nf6 — he challenges e4 and steers toward Pirc-flavoured play. Meet it Sämisch-style: f3 nails down e4 and clears the way for the kingside pawns. Clamp with d5, open when it suits you, and when he tries to free himself with …d5, snap it off and pile onto the open d-file with a pin. His centre collapses — you keep a big edge.", sayShort: "f3 brace, d5 clamp, pin the d-file" },
  beats: [
    { atMove: 8, say: "Qd2 completes the battery, the queen and e3-bishop lined up at h6.", sayShort: "Qd2 — the 150 battery.", highlights: [H('h6', SOFT)] },
    { atMove: 10, say: "f3 — the Sämisch brace: it nails down e4 and clears the way for g4, h4 and Bh6.", sayShort: "f3 — brace, prep the storm.", highlights: [H('f3'), H('e4', SOFT)] },
    { atMove: 12, say: "d5 clamps the centre, gaining space and shutting his pieces out.", sayShort: "d5 — the space clamp.", highlights: [H('d5')] },
    { atMove: 14, say: "dxe6 opens the position while your development is streets ahead.", sayShort: "dxe6 — open with the lead.", highlights: [H('e6')] },
    { atMove: 16, say: "Nge2 develops the last piece, heading for the strong central squares.", sayShort: "Nge2 — finish developing.", highlights: [H('e2')] },
    { atMove: 18, say: "exd5 snaps off his central pawn; his hoped-for break only helps you.", sayShort: "exd5 — take the centre.", highlights: [H('d5')] },
    { atMove: 20, say: "Rd1 stacks behind the queen on the open file, ramping up the pin on the d5-knight.", sayShort: "Rd1 — pin down the d-file.", arrows: [A('d2', 'd5')], highlights: [H('d5')] },
    { atMove: 22, say: "Nxd5 collects on d5; his centre is gone and you keep a big, lasting edge.", sayShort: "Nxd5 — win the centre; big edge.", highlights: [H('d5')] },
  ],
  sources: ['concept:pos-center', 'concept:tac-pin', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N152: SublineNarration = {
  intro: { say: "…a6 — a slow flank move. Strike at once with h4 to provoke …h5, develop Bg5 to clamp the f6- and e7-squares, and complete with Qd2. Open the centre with dxc5 and e5, then trade queens into a pleasant edge — his backward d6-pawn on the open file is a lasting target you'll press with the rooks.", sayShort: "h4, Bg5, then press the d6-pawn" },
  beats: [
    { atMove: 6, say: "h4 — the sharp 150 flank thrust, provoking …h5 and grabbing kingside space early.", sayShort: "h4 — provoke …h5.", highlights: [H('h4')] },
    { atMove: 8, say: "Bg5 develops actively, clamping f6 and e7 so his knight can't settle.", sayShort: "Bg5 — clamp f6 and e7.", arrows: [A('g5', 'e7')], highlights: [H('e7'), H('f6', SOFT)] },
    { atMove: 10, say: "Qd2 completes the battery and readies long castling.", sayShort: "Qd2 — battery, prep O-O-O.", highlights: [H('d2')] },
    { atMove: 14, say: "dxc5 opens the centre, and you'll win the tempo back on the loose c5-pawn.", sayShort: "dxc5 — open the centre.", highlights: [H('c5')] },
    { atMove: 16, say: "e5 strikes in the centre, prising open lines against his uncastled king.", sayShort: "e5 — strike the centre.", highlights: [H('e5')] },
    { atMove: 20, say: "Qxd6 trades queens into a pleasant edge — his d6-pawn is weak on the open file.", sayShort: "Qxd6 — trade into an edge.", highlights: [H('d6')] },
    { atMove: 22, say: "O-O-O connects the rooks against that backward d6-pawn; a small but lasting pull.", sayShort: "O-O-O — pile on d6.", highlights: [H('c1'), H('d6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-initiative', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N153: SublineNarration = {
  intro: { say: "…c5 — the Pterodactyl, where he gives up his best bishop with …Bxc3+. Recapture bxc3 for a broad c3-e4 centre and the bishop pair, seize the open b-file with Rb1, and roll the pawns with f4. His dark squares are permanently weak with no bishop to guard them — you keep a clear edge.", sayShort: "…Bxc3+ hands you the bishop pair" },
  beats: [
    { atMove: 6, say: "dxc5 grabs the pawn; he'll spend time regaining it while you develop.", sayShort: "dxc5 — grab the pawn.", highlights: [H('c5')] },
    { atMove: 7, say: "…Bxc3+ — he gives his best bishop to double your c-pawns; in return you get the bishop pair.", sayShort: "…Bxc3+ — you get the bishop pair.", highlights: [H('c3')] },
    { atMove: 8, say: "bxc3 builds a broad c3-e4 pawn centre and opens the b-file straight at b7.", sayShort: "bxc3 — big centre, open b-file.", highlights: [H('c3'), H('b7', SOFT)] },
    { atMove: 10, say: "Rb1 seizes the open b-file, leaning on b7 with tempo.", sayShort: "Rb1 — seize the b-file.", arrows: [A('b1', 'b7')], highlights: [H('b7')] },
    { atMove: 12, say: "Bd3 develops toward the kingside, the bishop pair beginning to talk.", sayShort: "Bd3 — develop, eye the king.", highlights: [H('d3')] },
    { atMove: 18, say: "Be3 develops with a hit on his queen, gaining a tempo.", sayShort: "Be3 — develop, hit the queen.", highlights: [H('e3')] },
    { atMove: 20, say: "f4 kicks the e5-knight and rolls your centre forward.", sayShort: "f4 — kick, roll the centre.", highlights: [H('f4')] },
    { atMove: 22, say: "cxd3 rebuilds a big d3-e4-f4 phalanx; the bishop pair and space give you a clear edge.", sayShort: "cxd3 — big centre; clear edge.", highlights: [H('d3')] },
  ],
  sources: ['concept:pos-bishop-pair', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N154: SublineNarration = {
  intro: { say: "…c6 then …d5 — he counters in the centre, but you clamp it French-style with e5, burying his light-squared bishop's prospects. From there it's a sharp kingside operation: swing the queen out, harry the …Bg4 bishop with Nh4, and prise the kingside open with g4. You come out a shade better in a double-edged fight.", sayShort: "e5 clamp, then a kingside operation" },
  beats: [
    { atMove: 6, say: "Nf3 develops and eyes e5, meeting his …c6/…d5 plan head-on.", sayShort: "Nf3 — develop, eye e5.", arrows: [A('f3', 'e5')], highlights: [H('e5')] },
    { atMove: 8, say: "e5 — clamp the centre French-style; the wedge grabs space and buries his light-squared bishop.", sayShort: "e5 — clamp, grab space.", highlights: [H('e5')] },
    { atMove: 10, say: "Qd3 sidesteps the …Bg4 pin and readies Nh4 to harry the bishop.", sayShort: "Qd3 — sidestep, prep Nh4.", highlights: [H('d3')] },
    { atMove: 12, say: "Nh4 jumps to the rim to hit g6 and reroute toward the f5-outpost.", sayShort: "Nh4 — reroute to f5.", arrows: [A('h4', 'f5')], highlights: [H('f5')] },
    { atMove: 14, say: "Qg3 swings the queen to the kingside, piling onto g6 and the dark squares.", sayShort: "Qg3 — swing at the kingside.", highlights: [H('g6', SOFT)] },
    { atMove: 18, say: "Bxh6 swaps off a defender, softening the dark squares by his king.", sayShort: "Bxh6 — soften the king.", highlights: [H('h6')] },
    { atMove: 20, say: "g4 hits the h5-bishop and prises the kingside open; you emerge a shade better.", sayShort: "g4 — pry open the kingside.", highlights: [H('g4'), H('h5', SOFT)] },
  ],
...
const N155: SublineNarration = {
  intro: { say: "…c6 with …b5 — a slower queenside plan. Here you castle short and let your space edge do the talking: complete the battery, reroute the knight Ne2-g3 toward the f5-outpost, and trade his best defender with Bh6. Prop d4 with c3 so his …c5 and …e5 breaks fizzle. A comfortable, lasting pull.", sayShort: "O-O, Ne2-g3-f5, Bh6 — press" },
  beats: [
    { atMove: 8, say: "Qd2 completes the battery, queen and bishop aimed at h6.", sayShort: "Qd2 — the 150 battery.", highlights: [H('h6', SOFT)] },
    { atMove: 10, say: "Bd3 develops behind e4, defending the pawn and poised to swing at the kingside.", sayShort: "Bd3 — develop, back e4.", highlights: [H('d3')] },
    { atMove: 14, say: "Ne2 reroutes the knight toward g3 and the fine f5-outpost.", sayShort: "Ne2 — reroute to g3-f5.", arrows: [A('e2', 'g3')], highlights: [H('g3')] },
    { atMove: 16, say: "O-O tucks the king away short; with a space edge you don't need the long-castle storm here.", sayShort: "O-O — king safe.", highlights: [H('g1')] },
    { atMove: 18, say: "Bh6 swaps off his best defender, softening the dark squares round his king.", sayShort: "Bh6 — strip the defender.", arrows: [A('h6', 'g7')], highlights: [H('g7')] },
    { atMove: 20, say: "Ng3 heads for f5, the outpost that makes your space count.", sayShort: "Ng3 — off to f5.", arrows: [A('g3', 'f5')], highlights: [H('f5')] },
    { atMove: 22, say: "c3 props d4 so his …c5 and …e5 breaks find no traction; you keep a comfortable pull.", sayShort: "c3 — shore up d4; comfy pull.", highlights: [H('d4', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-outpost', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N156: SublineNarration = {
  intro: { say: "…d5 — the Mittenberger Gambit. Take it with exd5 and simply hold the extra pawn: Bc4 and Bb3 prop the d5-spearhead, Qf3 overprotects it, and h3 makes luft. Once you've consolidated, return the pawn on your terms with dxe6 and trade into a comfortable, better structure. His gambit buys activity, not compensation.", sayShort: "exd5, hold it, then trade into an edge" },
  beats: [
    { atMove: 6, say: "exd5 — snap off the gambit pawn; you'll bank it and consolidate.", sayShort: "exd5 — grab the pawn.", highlights: [H('d5')] },
    { atMove: 8, say: "Bc4 props up the extra d5-pawn and takes aim at the a2-g8 diagonal.", sayShort: "Bc4 — defend d5.", highlights: [H('d5')] },
    { atMove: 10, say: "Bb3 tucks the bishop safe on the diagonal, still guarding d5.", sayShort: "Bb3 — safe, still guards d5.", highlights: [H('b3'), H('d5', SOFT)] },
    { atMove: 12, say: "Qf3 develops and adds a third defender to the d5-pawn.", sayShort: "Qf3 — overprotect d5.", arrows: [A('f3', 'd5')], highlights: [H('d5')] },
    { atMove: 14, say: "h3 makes luft and denies his pieces the g4-square.", sayShort: "h3 — luft, deny g4.", highlights: [H('h3'), H('g4', SOFT)] },
    { atMove: 16, say: "Nge2 develops the last knight, connecting your rooks.", sayShort: "Nge2 — finish developing.", highlights: [H('e2')] },
    { atMove: 18, say: "a4 halts his …a5-a4 lunge before it can hit your b3-bishop.", sayShort: "a4 — stop …a4.", highlights: [H('a4')] },
    { atMove: 20, say: "dxe6 returns the pawn on your terms, trading into a comfortable, better structure.", sayShort: "dxe6 — trade into an edge.", highlights: [H('e6')] },
  ],
  sources: ['concept:pos-center', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N157: SublineNarration = {
  intro: { say: "…Nd7 — he props the centre with …c6 and …b5. Answer with the broad-centre plan: make luft with h3, develop, then build the big e4-d4-f4 pawn front. Ram e5 to cramp him, and challenge his light bishop on the long diagonal with Bf3. You seize space across the whole board and stand comfortably better.", sayShort: "f4 big centre, e5 ram, Bf3 clamp" },
  beats: [
    { atMove: 12, say: "h3 makes luft and denies his pieces the g4-square before you expand.", sayShort: "h3 — luft, deny g4.", highlights: [H('h3'), H('g4', SOFT)] },
    { atMove: 14, say: "Be2 develops the bishop, readying the big pawn advance.", sayShort: "Be2 — develop.", highlights: [H('e2')] },
    { atMove: 16, say: "f4 — build the broad e4-d4-f4 centre; you seize space across the board.", sayShort: "f4 — the big centre.", highlights: [H('f4'), H('e4', SOFT), H('d4', SOFT)] },
    { atMove: 18, say: "dxc5 opens the centre; you'll regain the pawn and keep your space.", sayShort: "dxc5 — open the centre.", highlights: [H('c5')] },
    { atMove: 20, say: "e5 rams the wedge home, hitting d6 and cramping his whole position.", sayShort: "e5 — ram, cramp him.", highlights: [H('e5'), H('d6', SOFT)] },
    { atMove: 22, say: "Bf3 challenges his light bishop on the long diagonal, clamping the light squares; you're comfortably better.", sayShort: "Bf3 — clamp the long diagonal.", arrows: [A('f3', 'b7')], highlights: [H('b7')] },
  ],
  sources: ['concept:pos-space', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N158: SublineNarration = {
  intro: { say: "…Nf6 — he develops but hasn't castled. Pounce: Bh6 swaps his fianchetto bishop, Qxh6 lands the queen beside his king on e8, and you keep everything solid through his …b4 counter-lunge. When he over-presses, Rxa5 nets his queen and you come out ahead in the complications.", sayShort: "Bh6, Qxh6 — hit the uncastled king" },
  beats: [
    { atMove: 12, say: "Bh6 swaps off his fianchetto bishop; with his king still on e8, the dark squares turn sour.", sayShort: "Bh6 — strip the defender.", arrows: [A('h6', 'g7')], highlights: [H('g7')] },
    { atMove: 14, say: "Qxh6 — the queen lands right by his uncastled king, eyeing the soft dark squares.", sayShort: "Qxh6 — invade near the king.", highlights: [H('h6'), H('e8', SOFT)] },
    { atMove: 16, say: "Nf3 develops and keeps your king ready to tuck away.", sayShort: "Nf3 — develop.", highlights: [H('f3')] },
    { atMove: 18, say: "Nd1 calmly sidesteps his …b4 push, holding everything together.", sayShort: "Nd1 — sidestep, hold firm.", highlights: [H('d1')] },
    { atMove: 20, say: "c3 blocks the check and keeps your structure intact through the complications.", sayShort: "c3 — block, stay solid.", highlights: [H('c3')] },
    { atMove: 22, say: "Rxa5 grabs his queen; after the smoke clears you keep a small edge.", sayShort: "Rxa5 — win the queen.", highlights: [H('a5')] },
  ],
...
const N159: SublineNarration = {
  intro: { say: "…a5 — a slow queenside prod. Develop Nf3, trade the fianchetto bishop with Bh6, and once he castles kingside, roll h4-h5 to tear the shell open. Crash Qxh6 in beside his king, regroup calmly from the …Ng4 hit, and plant a knight on g5. Both pieces swarm the king — you're clearly on top.", sayShort: "Bh6, h4, Ng5 — swarm the castled king" },
  beats: [
    { atMove: 12, say: "Nf3 develops, the knight eyeing the g5-square for later.", sayShort: "Nf3 — develop, eye g5.", arrows: [A('f3', 'g5')], highlights: [H('g5')] },
    { atMove: 14, say: "Bh6 offers the trade of his key defender before he's even castled safely.", sayShort: "Bh6 — strip the defender.", arrows: [A('h6', 'g7')], highlights: [H('g7')] },
    { atMove: 16, say: "h4 — with the g7-bishop gone, the storm rolls; h4-h5 will tear open his castled king.", sayShort: "h4 — storm the castled king.", highlights: [H('h4'), H('h5', SOFT)] },
    { atMove: 18, say: "Qxh6 crashes the queen in beside his king; the dark squares are yours.", sayShort: "Qxh6 — invade the king.", highlights: [H('h6')] },
    { atMove: 20, say: "Qd2 slips back from the …Ng4 hit, regrouping without losing the initiative.", sayShort: "Qd2 — regroup, keep pressing.", highlights: [H('d2')] },
    { atMove: 22, say: "Ng5 lands on the outpost, both pieces swarming his king; you're clearly on top.", sayShort: "Ng5 — swarm the king.", highlights: [H('g5')] },
  ],
  sources: ['concept:att-kingside-storm', 'concept:pos-outpost', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N160: SublineNarration = {
  intro: { say: "…a6 — a slow prod behind …c6/…b5. Build the broad e4-d4-f4 centre, develop, make luft with h3, and castle long. Open with dxc5 while you're better developed, then recapture Qxc3 to centralise the queen on the long diagonal. The bishop pair and space leave you clearly better.", sayShort: "f4 centre, O-O-O, Qxc3 — clear edge" },
  beats: [
    { atMove: 12, say: "f4 — build the broad e4-d4-f4 centre; you take space across the board and eye e5.", sayShort: "f4 — the big centre.", highlights: [H('f4'), H('e5', SOFT)] },
    { atMove: 14, say: "Nf3 develops and supports the coming central pushes.", sayShort: "Nf3 — develop.", highlights: [H('f3')] },
    { atMove: 16, say: "h3 makes luft and denies his pieces g4 before you castle.", sayShort: "h3 — luft, deny g4.", highlights: [H('h3'), H('g4', SOFT)] },
    { atMove: 18, say: "O-O-O tucks the king to the queenside and swings a rook toward the centre and his king.", sayShort: "O-O-O — castle long, attack.", highlights: [H('c1')] },
    { atMove: 20, say: "dxc5 opens the position while you're better developed.", sayShort: "dxc5 — open with the lead.", highlights: [H('c5')] },
    { atMove: 22, say: "Qxc3 recaptures and centralises the queen on the long diagonal; the bishop pair and space leave you clearly better.", sayShort: "Qxc3 — centralise; clear edge.", arrows: [A('c3', 'g7')], highlights: [H('g7')] },
  ],
  sources: ['concept:pos-space', 'concept:pos-center', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};

const N161: SublineNarration = {
  intro: { say: "…a6 — the most popular try, prepping …b5. Stop it cold with a4 and claim queenside space. Develop naturally, make luft with h3, castle short, and let your firm d3-d4-e4 centre do the talking. Fix his queenside with a5 to poke at b6 — a comfortable, lasting pull with no risk.", sayShort: "a4 stops …b5; space and a firm centre" },
  beats: [
    { atMove: 8, say: "a4 — stop his …b5 in its tracks and claim queenside space.", sayShort: "a4 — stop …b5.", highlights: [H('a4')] },
    { atMove: 10, say: "Nf3 develops, guarding d4 and eyeing the centre.", sayShort: "Nf3 — develop, guard d4.", highlights: [H('f3')] },
    { atMove: 12, say: "h3 makes luft and denies his pieces the g4-square.", sayShort: "h3 — luft, deny g4.", highlights: [H('h3'), H('g4', SOFT)] },
    { atMove: 14, say: "Bd3 develops behind e4, poised to swing at the kingside.", sayShort: "Bd3 — develop, eye the king.", highlights: [H('d3')] },
    { atMove: 16, say: "Qd2 connects the rooks and calmly shrugs off …Nb4.", sayShort: "Qd2 — connect, hold firm.", highlights: [H('d2')] },
    { atMove: 18, say: "O-O brings the king to safety; your space edge does the talking.", sayShort: "O-O — king safe.", highlights: [H('g1')] },
    { atMove: 20, say: "cxd3 — recapture toward the centre; the half-open c-file and firm centre favour you.", sayShort: "cxd3 — open the c-file.", highlights: [H('d3'), H('c1', SOFT)] },
    { atMove: 22, say: "a5 fixes his queenside and pokes at b6; you keep a comfortable pull.", sayShort: "a5 — fix, press b6.", highlights: [H('a5'), H('b6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Modern_Defense'],
};
...
const N164: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 12, say: "Bc4 — develop the bishop straight at f7, Black's tender square.", sayShort: "Bc4 — aim at f7.", arrows: [A('c4', 'f7')], highlights: [H('f7')] },
    { atMove: 13, say: "…e6 — Black covers f7 and blunts the bishop.", sayShort: "…e6 — cover f7.", highlights: [H('e6', SOFT)] },
    { atMove: 14, say: "g4 — gain kingside space and kick the f5-bishop.", sayShort: "g4 — space, kick the bishop.", highlights: [H('g4')] },
    { atMove: 15, say: "…Bg6 — the bishop retreats to g6.", sayShort: "…Bg6 — retreat.", highlights: [H('g6', SOFT)] },
    ...
    { atMove: 23, say: "…Ne8 — the knight retreats passively. You're clearly better: more space, superior development, and above all a Black king marooned in the centre with no castling.", sayShort: "…Ne8 — you're clearly better.", highlights: [H('e8', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-king-safety', 'https://en.wikipedia.org/wiki/Scandinavian_Defense'],
};

const N165: SublineNarration = {
  intro: { say: "…Bg4 — with the bishop already on c4, Black pins your f3-knight. Question it with h3; when he trades you get the bishop pair and an active queen. Castle long, develop, and use your two bishops and central space against Black's slow, time-wasting queen play. A clear, pleasant edge.", sayShort: "…Bg4 — h3, take the bishop pair" },
  beats: [
    { atMove: 12, say: "h3 — question the g4-bishop, forcing it to decide.", sayShort: "h3 — question the bishop.", highlights: [H('g4', SOFT)] },
    { atMove: 13, say: "…Bxf3 — Black trades, handing you the bishop pair.", sayShort: "…Bxf3 — gives the bishops.", highlights: [H('f3', SOFT)] },
    { atMove: 14, say: "Qxf3 — recapture; the queen is active and you own the two bishops.", sayShort: "Qxf3 — active queen, bishops.", highlights: [H('f3')] },
    ...
    { atMove: 23, say: "…Bb4 — Black develops with a pin on the c3-knight. You're clearly better: the bishop pair, more space, and a lead in development while Black's queen wasted time.", sayShort: "…Bb4 — you're clearly better.", highlights: [H('b4', SOFT)] },
  ],
...
const N166: SublineNarration = {
  intro: { say: "…Bg4 — Black pins your f3-knight to ease the pressure on d4. Question it with h3; when he trades, you get the bishop pair and an active queen on f3. Castle long onto the open d-file, develop, and use your two bishops and lead in development. A clear, pleasant edge.", sayShort: "…Bg4 — h3, take the bishop pair" },
  beats: [
    ...
    { atMove: 14, say: "Bd2 — develop and prepare to castle long.", sayShort: "Bd2 — prep O-O-O.", highlights: [H('d2')] },
    { atMove: 15, say: "…Nbd7 — Black develops.", sayShort: "…Nbd7 — develop.", highlights: [H('d7', SOFT)] },
    { atMove: 16, say: "O-O-O — castle long, connecting the rooks and bringing one to the d-file behind your centre.", sayShort: "O-O-O — king safe, rook to d-file.", highlights: [H('c1')] },
    { atMove: 17, say: "…e6 — Black solidifies.", sayShort: "…e6 — solidify.", highlights: [H('e6', SOFT)] },
    { atMove: 18, say: "Bc4 — develop the light bishop to an active post, eyeing e6 and f7.", sayShort: "Bc4 — active bishop.", highlights: [H('c4')] },
    { atMove: 19, say: "…Bb4 — Black pins the c3-knight, trying to trade off a piece.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4', SOFT)] },
    { atMove: 20, say: "a3 — question the b4-bishop.", sayShort: "a3 — question the bishop.", highlights: [H('a3')] },
    { atMove: 21, say: "…Bxc3 — Black trades on c3.", sayShort: "…Bxc3 — trade.", highlights: [H('c3', SOFT)] },
    { atMove: 22, say: "Bxc3 — recapture with the bishop, keeping the bishop pair intact.", sayShort: "Bxc3 — keep the bishops.", highlights: [H('c3')] },
    { atMove: 23, say: "…Qd8 — Black retreats the queen. You're clearly better: the bishop pair, the rook on the open d-file, more space, and a lead in development while Black's king still sits in the centre.", sayShort: "…Qd8 — you're clearly better.", highlights: [H('d8', SOFT)] },
  ],
  sources: ['concept:pos-bishop-pair', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Scandinavian_Defense'],
};
...
const N167: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 12, say: "Bd2 — develop and prepare to challenge the a5-queen while supporting a d5-break.", sayShort: "Bd2 — develop, prep d5.", highlights: [H('d2')] },
    { atMove: 13, say: "…e6 — Black solidifies.", sayShort: "…e6 — solidify.", highlights: [H('e6', SOFT)] },
    { atMove: 14, say: "d5! — the central break, hitting the c6-knight and gaining space with tempo.", sayShort: "d5 — the central break.", highlights: [H('d5')] },
    { atMove: 15, say: "…Nb4 — the knight jumps to b4 to avoid loss.", sayShort: "…Nb4 — dodge.", highlights: [H('b4', SOFT)] },
    { atMove: 16, say: "Bxd7+ — trade with check, disrupting Black's coordination.", sayShort: "Bxd7+ — trade with check.", highlights: [H('d7')] },
    { atMove: 17, say: "…Nxd7 — Black recaptures.", sayShort: "…Nxd7 — recapture.", highlights: [H('d7', SOFT)] },
...
const N168: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 14, say: "O-O-O — castle long. Opposite-side castling: now h4-h5 and the bishop battery all point at Black's king.", sayShort: "O-O-O — opposite sides, storm coming.", highlights: [H('c1')] },
    ...
    { atMove: 18, say: "Bf4 — reroute the bishop with tempo, hitting the d6-queen and eyeing the b8-h2 diagonal.", sayShort: "Bf4 — hit the queen.", arrows: [A('f4', 'd6')], highlights: [H('d6')] },
    { atMove: 19, say: "…Qb6 — the queen sidesteps to b6.", sayShort: "…Qb6 — sidestep.", highlights: [H('b6', SOFT)] },
    { atMove: 20, say: "h3 — question the g4-bishop, forcing it to decide.", sayShort: "h3 — question the bishop.", highlights: [H('h3')] },
    { atMove: 21, say: "…Bxf3 — Black trades, handing you the bishop pair.", sayShort: "…Bxf3 — gives the bishops.", highlights: [H('f3', SOFT)] },
    { atMove: 22, say: "Bxf3 — recapture; you own the two bishops and the bishop rakes toward b7.", sayShort: "Bxf3 — bishop pair.", highlights: [H('f3')] },
    { atMove: 23, say: "…c6 — Black solidifies. You're clearly better: opposite-side castling with the faster attack (h4-h5 and the bishops aimed at Black's king), the bishop pair, and more space.", sayShort: "…c6 — you have the faster attack.", highlights: [H('c6', SOFT)] },
  ],
  sources: ['concept:att-kingside-storm', 'concept:pos-bishop-pair', 'https://en.wikipedia.org/wiki/Scandinavian_Defense'],
};
...
const N169: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 7, say: "…Nf6 — Black develops.", sayShort: "…Nf6 — develop.", highlights: [H('f6', SOFT)] },
    { atMove: 8, say: "Nf3 — develop and control the e5-square.", sayShort: "Nf3 — develop, control e5.", highlights: [H('f3')] },
    { atMove: 9, say: "…e6 — Black solidifies, French-style.", sayShort: "…e6 — solidify.", highlights: [H('e6', SOFT)] },
    { atMove: 10, say: "Bd3 — develop the bishop toward Black's kingside.", sayShort: "Bd3 — develop.", highlights: [H('d3')] },
    ...
    { atMove: 23, say: "…Bd6 — Black challenges. You're clearly better: opposite-side castling with the faster attack, the dominant e5-knight, and a lead in development while Black's queen wasted time at home.", sayShort: "…Bd6 — you have the faster attack.", highlights: [H('d6', SOFT)] },
  ],
...
const N170: SublineNarration = {
  intro: { say: "…c6 — Black gives the a5-queen a retreat and shores up d5. Develop with Bd2 toward long castling, then roll the g- and h-pawns forward. When Black grabs a pawn on g4, don't flinch — your kingside space and initiative are worth far more, and you stand clearly better.", sayShort: "…c6 — develop, then storm with g4-h4" },
  beats: [
    { atMove: 8, say: "Bd2 — develop and prepare O-O-O, the standard anti-Scandi setup that keeps eyeing the a5-queen.", sayShort: "Bd2 — develop, prep O-O-O.", highlights: [H('d2')] },
    { atMove: 9, say: "…Nf6 — Black develops.", sayShort: "…Nf6 — develop.", highlights: [H('f6', SOFT)] },
    { atMove: 10, say: "h3 — a useful prophylactic, taking g4 from Black and preparing g4 yourself.", sayShort: "h3 — prep g4.", highlights: [H('h3')] },
    { atMove: 11, say: "…Qb6 — the queen reroutes, eyeing b2 and d4.", sayShort: "…Qb6 — reroute.", highlights: [H('b6', SOFT)] },
    { atMove: 12, say: "Nf3 — develop and defend d4.", sayShort: "Nf3 — develop, hold d4.", highlights: [H('f3')] },
    { atMove: 13, say: "…Bf5 — Black develops the bishop actively.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5', SOFT)] },
    { atMove: 14, say: "g4 — gain kingside space and kick the bishop.", sayShort: "g4 — space, kick the bishop.", highlights: [H('g4')] },
    { atMove: 15, say: "…Bg6 — the bishop retreats.", sayShort: "…Bg6 — retreat.", highlights: [H('g6', SOFT)] },
    { atMove: 16, say: "h4 — keep the storm rolling, threatening h5 to trap the bishop.", sayShort: "h4 — keep rolling.", highlights: [H('h4')] },
    { atMove: 17, say: "…Nxg4 — Black snatches the g4-pawn, a greedy grab that opens lines for you.", sayShort: "…Nxg4 — greedy grab.", highlights: [H('g4', SOFT)] },
    { atMove: 18, say: "h5 — ram the pawn, trapping and kicking the g6-bishop.", sayShort: "h5 — trap the bishop.", highlights: [H('h5')] },
    { atMove: 19, say: "…Bf5 — the bishop scrambles for a square.", sayShort: "…Bf5 — scramble.", highlights: [H('f5', SOFT)] },
    { atMove: 20, say: "Nh4 — attack the f5-bishop and swing the knight toward the kingside.", sayShort: "Nh4 — hit the bishop.", highlights: [H('h4')] },
    { atMove: 21, say: "…Bd7 — the bishop retreats to safety.", sayShort: "…Bd7 — retreat.", highlights: [H('d7', SOFT)] },
    { atMove: 22, say: "Qe2 — develop, connect the rooks, and prepare O-O-O; your kingside initiative is worth far more than the g4-pawn.", sayShort: "Qe2 — develop, prep O-O-O.", highlights: [H('e2')] },
    { atMove: 23, say: "…Na6 — Black develops awkwardly to the rim. You're clearly better: kingside space and initiative, Black's misplaced pieces, and full compensation-plus for the pawn.", sayShort: "…Na6 — you're clearly better.", highlights: [H('a6', SOFT)] },
  ],
  sources: ['concept:pos-space', 'concept:pos-initiative', 'https://en.wikipedia.org/wiki/Scandinavian_Defense'],
};
...
const N172: SublineNarration = {
  intro: { say: "…Qa5 — the main-line retreat. The queen sits actively but she'll be chased around, and every tempo you spend chasing her you spend developing. Build the big d4-centre, plant a knight on e5, gain kingside space, and use your lead in development. A clear, pleasant edge.", sayShort: "…Qa5 — chase the queen, build the centre" },
  beats: [
    { atMove: 6, say: "d4 — stake the big pawn centre, the space that's the Scandinavian's price.", sayShort: "d4 — stake the centre.", highlights: [H('d4')] },
    { atMove: 7, say: "…Bf5 — Black develops the bishop actively outside the pawn chain.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5', SOFT)] },
    { atMove: 8, say: "Nf3 — develop and take control of the e5-square.", sayShort: "Nf3 — develop, control e5.", highlights: [H('f3')] },
    { atMove: 9, say: "…c6 — Black gives the queen a retreat and shores up d5.", sayShort: "…c6 — prep a retreat.", highlights: [H('c6', SOFT)] },
    { atMove: 10, say: "Ne5 — plant the knight on the dominant e5-outpost, eyeing f7 and d7.", sayShort: "Ne5 — the e5 outpost.", arrows: [A('e5', 'f7')], highlights: [H('f7')] },
    { atMove: 11, say: "…Nd7 — Black challenges the strong knight.", sayShort: "…Nd7 — challenge it.", highlights: [H('d7', SOFT)] },
    { atMove: 12, say: "Nc4 — reroute with tempo, hitting the a5-queen and gaining a free move.", sayShort: "Nc4 — hit the queen.", arrows: [A('c4', 'a5')], highlights: [H('a5')] },
    { atMove: 13, say: "…Qd8 — the queen scurries all the way home, having achieved nothing but lost time.", sayShort: "…Qd8 — the queen retreats home.", highlights: [H('d8', SOFT)] },
    { atMove: 14, say: "g4 — gain kingside space and kick the f5-bishop.", sayShort: "g4 — space, kick the bishop.", highlights: [H('g4')] },
    { atMove: 15, say: "…Be6 — the bishop retreats.", sayShort: "…Be6 — retreat.", highlights: [H('e6', SOFT)] },
    { atMove: 16, say: "Ne3 — reroute the knight toward the f5- and d5-holes.", sayShort: "Ne3 — eye the holes.", highlights: [H('e3')] },
    { atMove: 17, say: "…g6 — Black covers f5.", sayShort: "…g6 — cover f5.", highlights: [H('g6', SOFT)] },
    { atMove: 18, say: "f4 — build a broad kingside pawn front, taking still more space.", sayShort: "f4 — build the front.", highlights: [H('f4')] },
    { atMove: 19, say: "…Nb6 — Black develops the knight.", sayShort: "…Nb6 — develop.", highlights: [H('b6', SOFT)] },
    { atMove: 20, say: "f5 — ram the pawn forward, prying open lines and hitting the e6-bishop.", sayShort: "f5 — ram, open lines.", highlights: [H('f5')] },
    { atMove: 21, say: "…Bd5 — the bishop centralises to escape the pawn.", sayShort: "…Bd5 — escape.", highlights: [H('d5', SOFT)] },
    { atMove: 22, say: "Ncxd5 — trade, opening the position where your space and development dominate.", sayShort: "Ncxd5 — trade, open up.", highlights: [H('d5')] },
    { atMove: 23, say: "…Nxd5 — Black recaptures. You're clearly better: a big space edge, a strong kingside pawn front, superior development, and Black's queen having wandered a5-d8 for nothing.", sayShort: "…Nxd5 — you're clearly better.", highlights: [H('d5', SOFT)] },
  ],
...
const N173: SublineNarration = {
  ...
  sources: ['concept:pos-space', 'concept:pos-outpost', 'https://en.wikipedia.org/wiki/Scandinavian_Defense'],
};
...
const N175: SublineNarration = {
  intro: { say: "…c6 — with …Qd6 Black sets a solid but passive shell. Develop calmly, take the bishop pair when he trades on f3, castle, and expand with c4. Your two bishops, central space and lead in development give a comfortable, lasting edge against his cramped setup.", sayShort: "…c6 — take the bishops, expand with c4" },
  beats: [
    { atMove: 10, say: "Be2 — develop and prepare to castle; no need to rush against Black's passive shell.", sayShort: "Be2 — develop, prep O-O.", highlights: [H('e2')] },
    { atMove: 11, say: "…Bg4 — Black pins your f3-knight.", sayShort: "…Bg4 — pin the knight.", highlights: [H('g4', SOFT)] },
    { atMove: 12, say: "h3 — question the bishop and make it decide.", sayShort: "h3 — question the bishop.", highlights: [H('h3')] },
    { atMove: 13, say: "…Bxf3 — Black trades, handing you the bishop pair.", sayShort: "…Bxf3 — gives the bishops.", highlights: [H('f3', SOFT)] },
    ...
    { atMove: 21, say: "…Be7 — Black develops the bishop.", sayShort: "…Be7 — develop.", highlights: [H('e7', SOFT)] },
    { atMove: 22, say: "Bf4 — develop with tempo, hitting the c7-queen and eyeing d6.", sayShort: "Bf4 — hit the queen.", arrows: [A('f4', 'c7')], highlights: [H('c7')] },
    { atMove: 23, say: "…Bd6 — Black offers to trade off your active bishop. You're comfortably better: the bishop pair, more space from c4-d4, and the freer game against a cramped setup.", sayShort: "…Bd6 — you're comfortably better.", highlights: [H('d6', SOFT)] },
  ],
  sources: ['concept:pos-bishop-pair', 'concept:pos-space', 'https://en.wikipedia.org/wiki/Scandinavian_Defense'],
};
...
const N177: SublineNarration = {
  intro: { say: "…g6 — with the queen on d6, Black fianchettoes. Set up the aggressive Bg5 + Qd2 battery, castle long, and prepare to storm his kingside with h4-h5 while your bishops rake toward his king. Opposite-side castling with you the better-developed side and the faster attack — a clear, dangerous edge.", sayShort: "…g6 — Bg5/Qd2, O-O-O, storm the king" },
  beats: [
    { atMove: 10, say: "Bg5 — develop with a pin-threat on the f6-knight, part of the aggressive setup.", sayShort: "Bg5 — pin-threat on f6.", highlights: [H('g5')] },
    { atMove: 11, say: "…Bg7 — Black completes the fianchetto.", sayShort: "…Bg7 — the fianchetto.", highlights: [H('g7', SOFT)] },
    { atMove: 12, say: "Qd2 — connect the Bg5-Qd2 battery aimed at h6 and prepare to castle long.", sayShort: "Qd2 — the h6 battery.", highlights: [H('d2')] },
    { atMove: 13, say: "…O-O — Black castles kingside, into the wing you're about to storm.", sayShort: "…O-O — castles into the storm.", highlights: [H('g8', SOFT)] },
    { atMove: 14, say: "O-O-O — castle long. Opposite-side castling: h4-h5 and the bishop battery all point at Black's king.", sayShort: "O-O-O — opposite sides, storm coming.", highlights: [H('c1')] },
    { atMove: 15, say: "…Bg4 — Black pins your f3-knight, seeking counterplay.", sayShort: "…Bg4 — pin the knight.", highlights: [H('g4', SOFT)] },
    { atMove: 16, say: "Be2 — break the pin calmly, keeping your attacking setup intact.", sayShort: "Be2 — break the pin.", highlights: [H('e2')] },
    { atMove: 17, say: "…Nbd7 — Black develops.", sayShort: "…Nbd7 — develop.", highlights: [H('d7', SOFT)] },
    { atMove: 18, say: "Bf4 — reroute the bishop with tempo, hitting the d6-queen and eyeing the b8-h2 diagonal.", sayShort: "Bf4 — hit the queen.", arrows: [A('f4', 'd6')], highlights: [H('d6')] },
    ...
    { atMove: 21, say: "…Bxf3 — Black trades, handing you the bishop pair.", sayShort: "…Bxf3 — gives the bishops.", highlights: [H('f3', SOFT)] },
    { atMove: 22, say: "Bxf3 — recapture; you own the two bishops and the bishop rakes toward b7.", sayShort: "Bxf3 — bishop pair.", highlights: [H('f3')] },
    { atMove: 23, say: "…c6 — Black solidifies. You're clearly better: opposite-side castling with the faster attack, the bishop pair, and more space.", sayShort: "…c6 — you have the faster attack.", highlights: [H('c6', SOFT)] },
  ],
  sources: ['concept:att-kingside-storm', 'concept:pos-bishop-pair', 'https://en.wikipedia.org/wiki/Scandinavian_Defense'],
};
...
export const SUBLINE_NARRATION_E4OTHER: Record<string, SublineNarration> = {
  ...
  'alekhine-defence::0::Nf3@6': { ...N4, beats: [
    { atMove: 7, say: "…dxe5 undermines White's pawn chain, opening the position for your pieces.", sayShort: "…dxe5 — undermine the chain.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bg7 fianchettoes onto the long diagonal, your bishop raking the centre.", sayShort: "…Bg7 — the long diagonal.", arrows: [A('g7', 'b2')], highlights: [H('b2')] },
    { atMove: 21, say: "…b5 expands and hits White's c4-pawn, gaining queenside space.", sayShort: "…b5 — hit c4, expand.", arrows: [A('b5', 'c4')], highlights: [H('c4')] },
  ] },
  'alekhine-defence::0::Nf3@8': N5,
  'alekhine-defence::0::Qb3@18': N6,
  'alekhine-defence::0::a3@18': N7,
  'alekhine-defence::0::c4@4': { ...N8, beats: [
    { atMove: 9, say: "…dxe5 undermines White's broad centre, opening lines for your pieces.", sayShort: "…dxe5 — undermine the centre.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bf5 develops the bishop actively, eyeing the light squares and centre.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5')] },
    { atMove: 17, say: "…Bb4 pins the c3-knight, pressuring White's overextended centre.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4')] },
  ] },
  'alekhine-defence::0::exd6@8': { ...N9, beats: [
    { atMove: 9, say: "…cxd6 recaptures toward the centre, opening the c-file for your rook.", sayShort: "…cxd6 — open the c-file.", highlights: [H('d6')] },
    { atMove: 11, say: "…Bg4 develops with a pin on f3, pressuring White's setup.", sayShort: "…Bg4 — pin the knight.", highlights: [H('g4')] },
    { atMove: 21, say: "…Bg7 fianchettoes onto the long diagonal, your pieces harmonious.", sayShort: "…Bg7 — the long diagonal.", arrows: [A('g7', 'b2')], highlights: [H('b2')] },
  ] },
  ...
  'alekhine-defence::1::c4@4': { ...N8, beats: [
    { atMove: 9, say: "…dxe5 undermines White's broad centre, opening lines for your pieces.", sayShort: "…dxe5 — undermine the centre.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bf5 develops the bishop actively, eyeing the light squares and centre.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5')] },
    { atMove: 17, say: "…Bb4 pins the c3-knight, pressuring White's overextended centre.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4')] },
  ] },
  'alekhine-defence::1::c4@6': { ...N9, beats: [
    { atMove: 9, say: "…dxe5 undermines White's broad centre, opening lines for your pieces.", sayShort: "…dxe5 — undermine the centre.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bf5 develops the bishop actively, eyeing the light squares and centre.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5')] },
    { atMove: 17, say: "…Bb4 pins the c3-knight, pressuring White's overextended centre.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4')] },
  ] },
  ...
  'alekhine-defence::2::Nc3@10': { ...N9, beats: [
    { atMove: 13, say: "…Bf6 develops the bishop toward the long diagonal and the centre.", sayShort: "…Bf6 — toward the diagonal.", highlights: [H('f6')] },
    { atMove: 15, say: "…Nc6 develops with pressure, your pieces flowing out.", sayShort: "…Nc6 — develop with pressure.", highlights: [H('c6')] },
    { atMove: 23, say: "…O-O tucks the king safe, your solid setup ready for play.", sayShort: "…O-O — king safe.", highlights: [H('g8')] },
  ] },
  'alekhine-defence::2::Nc3@14': N19,
  'alekhine-defence::2::a3@18': N20,
  'alekhine-defence::2::b3@16': N21,
  'alekhine-defence::2::c4@4': { ...N8, beats: [
    { atMove: 9, say: "…dxe5 undermines White's broad centre, opening lines for your pieces.", sayShort: "…dxe5 — undermine the centre.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bf5 develops the bishop actively, eyeing the light squares and centre.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5')] },
    { atMove: 17, say: "…Bb4 pins the c3-knight, pressuring White's overextended centre.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4')] },
  ] },
  ...
  'alekhine-defence::3::Nc3@10': { ...N8, beats: [
    { atMove: 13, say: "…Bf6 develops the bishop toward the long diagonal and the centre.", sayShort: "…Bf6 — toward the diagonal.", highlights: [H('f6')] },
    { atMove: 15, say: "…Nc6 develops with pressure, your pieces flowing out.", sayShort: "…Nc6 — develop with pressure.", highlights: [H('c6')] },
    { atMove: 23, say: "…O-O tucks the king safe, your solid setup ready for play.", sayShort: "…O-O — king safe.", highlights: [H('g8')] },
  ] },
  ...
  'alekhine-defence::4::d4@4': { ...N4, beats: [
    { atMove: 9, say: "…dxe5 undermines White's broad centre, opening lines for your pieces.", sayShort: "…dxe5 — undermine the centre.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bf5 develops the bishop actively, eyeing the light squares and centre.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5')] },
    { atMove: 17, say: "…Bb4 pins the c3-knight, pressuring White's overextended centre.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4')] },
  ] },
  ...
  'alekhine-defence::5::c4@4': { ...N8, beats: [
    { atMove: 9, say: "…dxe5 undermines White's broad centre, opening lines for your pieces.", sayShort: "…dxe5 — undermine the centre.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bf5 develops the bishop actively, eyeing the light squares and centre.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5')] },
    { atMove: 17, say: "…Bb4 pins the c3-knight, pressuring White's overextended centre.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4')] },
  ] },
  'alekhine-defence::5::c4@6': { ...N9, beats: [
    { atMove: 9, say: "…dxe5 undermines White's broad centre, opening lines for your pieces.", sayShort: "…dxe5 — undermine the centre.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bf5 develops the bishop actively, eyeing the light squares and centre.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5')] },
    { atMove: 17, say: "…Bb4 pins the c3-knight, pressuring White's overextended centre.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4')] },
  ] },
  ...
  'alekhine-defence::6::c4@4': { ...N8, beats: [
    { atMove: 9, say: "…dxe5 undermines White's broad centre, opening lines for your pieces.", sayShort: "…dxe5 — undermine the centre.", highlights: [H('e5')] },
    { atMove: 13, say: "…Bf5 develops the bishop actively, eyeing the light squares and centre.", sayShort: "…Bf5 — active bishop.", highlights: [H('f5')] },
    { atMove: 17, say: "…Bb4 pins the c3-knight, pressuring White's overextended centre.", sayShort: "…Bb4 — pin the knight.", highlights: [H('b4')] },
  ] },
  ...
  'anti-alekhine-modern::1::Bg4@7': AME_BG4,
  ...
  'anti-alekhine-modern::2::Bg4@7': AME_BG4,
  ...
  'anti-alekhine-modern::3::Bg4@7': AME_BG4,
  ...
  'caro-kann::5::c4@6': { ...N209, beats: [
    { atMove: 7, say: "…Nf6 develops with a hit on e4, putting White's c4 push to the test.", sayShort: "…Nf6 — develop, hit e4.", arrows: [A('f6', 'e4')], highlights: [H('e4')] },
    { atMove: 13, say: "…e5 strikes the centre, claiming space and freeing your pieces.", sayShort: "…e5 — strike the centre.", highlights: [H('e5')] },
    { atMove: 15, say: "…Nxe5 wins the central pawn, your pieces active with the edge.", sayShort: "…Nxe5 — win the pawn.", highlights: [H('e5')] },
  ] },
  ...
  'french-defence::1::e5@4': { ...N115, beats: [
    { atMove: 5, say: "…c5 strikes at White's centre at once, the French's standard Advance counter.", sayShort: "…c5 — strike the centre.", highlights: [H('c5')] },
    { atMove: 9, say: "…Nc6 develops with pressure on d4, undermining the chain.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 17, say: "…Ng6 reroutes the knight toward f4 and the kingside dark squares.", sayShort: "…Ng6 — reroute, eye f4.", arrows: [A('g6', 'f4')], highlights: [H('f4')] },
  ] },
  ...
  'french-defence::2::e5@4': { ...N115, beats: [
    { atMove: 5, say: "…c5 strikes at White's centre at once, the French's standard Advance counter.", sayShort: "…c5 — strike the centre.", highlights: [H('c5')] },
    { atMove: 9, say: "…Nc6 develops with pressure on d4, undermining the chain.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 17, say: "…Ng6 reroutes the knight toward f4 and the kingside dark squares.", sayShort: "…Ng6 — reroute, eye f4.", arrows: [A('g6', 'f4')], highlights: [H('f4')] },
  ] },
  ...
  'french-defence::3::e5@4': { ...N115, beats: [
    { atMove: 5, say: "…c5 strikes at White's centre at once, the French's standard Advance counter.", sayShort: "…c5 — strike the centre.", highlights: [H('c5')] },
    { atMove: 9, say: "…Nc6 develops with pressure on d4, undermining the chain.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 17, say: "…Ng6 reroutes the knight toward f4 and the kingside dark squares.", sayShort: "…Ng6 — reroute, eye f4.", arrows: [A('g6', 'f4')], highlights: [H('f4')] },
  ] },
  ...
  'french-defence::5::e5@4': { ...N115, beats: [
    { atMove: 5, say: "…c5 strikes at White's centre at once, the French's standard Advance counter.", sayShort: "…c5 — strike the centre.", highlights: [H('c5')] },
    { atMove: 9, say: "…Nc6 develops with pressure on d4, undermining the chain.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 17, say: "…Ng6 reroutes the knight toward f4 and the kingside dark squares.", sayShort: "…Ng6 — reroute, eye f4.", arrows: [A('g6', 'f4')], highlights: [H('f4')] },
  ] },
  ...
  'french-defence::6::e5@4': { ...N115, beats: [
    { atMove: 5, say: "…c5 strikes at White's centre at once, the French's standard Advance counter.", sayShort: "…c5 — strike the centre.", highlights: [H('c5')] },
    { atMove: 9, say: "…Nc6 develops with pressure on d4, undermining the chain.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 17, say: "…Ng6 reroutes the knight toward f4 and the kingside dark squares.", sayShort: "…Ng6 — reroute, eye f4.", arrows: [A('g6', 'f4')], highlights: [H('f4')] },
  ] },
  ...
  'french-defence::8::e5@4': { ...N115, beats: [
    { atMove: 5, say: "…c5 strikes at White's centre at once, the French's standard Advance counter.", sayShort: "…c5 — strike the centre.", highlights: [H('c5')] },
    { atMove: 9, say: "…Nc6 develops with pressure on d4, undermining the chain.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 17, say: "…Ng6 reroutes the knight toward f4 and the kingside dark squares.", sayShort: "…Ng6 — reroute, eye f4.", arrows: [A('g6', 'f4')], highlights: [H('f4')] },
  ] },
  ...
  'french-defence::9::e5@4': { ...N115, beats: [
    { atMove: 5, say: "…c5 strikes at White's centre at once, the French's standard Advance counter.", sayShort: "…c5 — strike the centre.", highlights: [H('c5')] },
    { atMove: 9, say: "…Nc6 develops with pressure on d4, undermining the chain.", sayShort: "…Nc6 — pressure d4.", arrows: [A('c6', 'd4')], highlights: [H('d4')] },
    { atMove: 17, say: "…Ng6 reroutes the knight toward f4 and the kingside dark squares.", sayShort: "…Ng6 — reroute, eye f4.", arrows: [A('g6', 'f4')], highlights: [H('f4')] },
  ] },
  ...
  'scandinavian-defence::3::g3@10': { ...N168, beats: [
    ...
    { atMove: 19, say: "…Nd5 centralises the knight on a dominant square, eyeing key points.", sayShort: "…Nd5 — central knight.", highlights: [H('d5')] },
  ] },
