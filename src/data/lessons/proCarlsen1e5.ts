...
const OPEN_BERLIN: LessonScript = {
  ...
  beats: [
    b({ id: 'nf6', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6', arrows: [A('f6', 'e4')], highlights: [H('f6')], say: "The Berlin Defence — ...Nf6 hits e4 and invites the famous Berlin Wall. This was Carlsen's choice in World Championship play: the soundest, most fortress-like answer to the Ruy Lopez, where Black heads straight for an endgame he knows how to hold and his opponent must break down.", sayShort: 'Nf6 — the Berlin Wall.' }),
    b({ id: 'endgame', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8', highlights: [H('d8'), H('f5')], say: "The Berlin endgame: queens come off and Black's king walks to d8. It looks strange, but it's a famous fortress — Black has the bishop pair and a solid structure to offset the lost castling rights. Carlsen has held this position against the best players alive and won it more than once.", sayShort: 'Queens off — the Berlin endgame.' }),
    b({ id: 'nf5', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8 h3 Ke8 Nc3 Ne7', highlights: [H('f5'), H('e7')], say: "Black regroups: the king tucks to e8 and the knight reroutes from f5 to e7 and on toward d5 or g6. Black's two bishops are a long-term asset; White's extra kingside pawn is hard to make count. A deep technical battle where Black is fully equal — and Carlsen's endgame mastery makes it dangerous for White.", sayShort: 'Reroute — bishops hold the draw.' }),
  ],
};
...
const FOUR_KNIGHTS: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'd6', moves: 'e4 e5 Nf3 Nc6 Nc3 Nf6 Bb5 Bb4 O-O O-O d3 d6', highlights: [H('d6'), H('e5')], say: "Both sides castle and play d3/...d6, reaching a solid, balanced Italian-style middlegame. Black has equalised comfortably and can play for a win in a long game by gradually improving his pieces. Risk-free, sound, and exactly the kind of position Carlsen outplays opponents in.", sayShort: 'd6 — comfortable equality.' }),
  ],
};
