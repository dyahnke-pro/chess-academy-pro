...
const OPEN_BERLIN: LessonScript = {
  ...
  beats: [
    b({ id: 'nf6', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6', arrows: [A('f6', 'e4')], highlights: [H('f6')], say: "The Berlin Defence — ...Nf6 hits e4 and invites the famous Berlin Wall. This was this repertoire's choice in World Championship play: the soundest, most fortress-like answer to the Ruy Lopez, where Black heads straight for an endgame they know how to hold and their opponent must break down.", sayShort: 'Nf6 — the Berlin Wall.' }),
...
const FOUR_KNIGHTS: LessonScript = {
  ...
  beats: [
    b({ id: 'bb4', moves: 'e4 e5 Nf3 Nc6 Nc3 Nf6 Bb5 Bb4', arrows: [A('b4', 'c3')], highlights: [H('b4')], say: "The symmetrical Four Knights — Black mirrors with ...Bb4, pinning White's c3-knight just as their own is pinned. The symmetry is Black's friend here: equal development, equal chances, and a comfortable, well-understood structure where mistakes, not preparation, decide.", sayShort: 'Bb4 — mirror the pin.' }),
    b({ id: 'd6', moves: 'e4 e5 Nf3 Nc6 Nc3 Nf6 Bb5 Bb4 O-O O-O d3 d6', highlights: [H('d6'), H('e5')], say: "Both sides castle and play d3/...d6, reaching a solid, balanced Italian-style middlegame. Black has equalised comfortably and can play for a win in a long game by gradually improving their pieces. Risk-free, sound, and exactly the kind of position this repertoire outplays opponents in.", sayShort: 'd6 — comfortable equality.' }),
  ],
};
