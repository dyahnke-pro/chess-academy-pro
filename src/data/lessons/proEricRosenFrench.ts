...
export const PRO_ERICROSEN_FRENCH_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'e6', moves: 'e4 e6 d4 d5',
      ...
      say: "The French Defense. You answer e4 with …e6 and …d5, challenging the centre at once. It is a fighting, counter-attacking defense built on a rock-solid pawn chain — Black invites White to overextend, then strikes back at the base.",
    ...
    b({ id: 'nf6', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 Be7',
      ...
      say: "Against Nc3 you play the Classical with …Nf6, hitting e4, and when White pins with Bg5 you calmly unpin with …Be7. Solid and principled — you are not afraid of the pin because the coming exchanges only help free your game.",
      sayShort: '…Nf6, …Be7 — the Classical.' }),
    b({ id: 'e5', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 Be7 e5 Nfd7 Bxe7 Qxe7',
      arrows: [], highlights: [{ square: 'e5', color: KEY }, { square: 'e7', color: KEY }],
      say: "White pushes e5, gaining space and forcing the knight back to d7, then trades the dark bishops. After …Qxe7 Black has the classic French structure — and the trade of dark-squared bishops actually eases your cramped position. Now you go to work on the centre.",
    ...
    b({ id: 'c5', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5 Be7 e5 Nfd7 Bxe7 Qxe7 f4 O-O Nf3 c5',
      ...
      say: "…c5! The thematic French break, striking at the base of White's d4-e5 pawn chain. While White builds on the kingside with f4 and Nf3, you hammer the queenside and centre. The whole French battle is this race: White attacks the king, Black attacks the chain.",
