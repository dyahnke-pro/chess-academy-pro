...
export const SEMI_SLAV_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'semi-slav::Botvinnik Variation Deep': {
    ...
    beats: [
      ...
      b({ id: 'bo4', moves: 'd4 d5 c4 c6 Nf3 Nf6 Nc3 e6 Bg5 dxc4 e4 b5 e5 h6 Bh4 g5 Nxg5 hxg5 Bxg5 Nbd7 exf6 Bb7 g3 c5 d5 Qb6 Bg2 O-O-O O-O b4 Na4 Qa5', say: "d5 …Qb6 and …O-O-O tuck the king behind the pawn avalanche; …b4 chases the knight to a4 and …Qa5 piles on. There is the Botvinnik tabiya: bedlam — White's central pawns and attack against Black's extra piece, queenside pawn storm, and bishop pair. A balanced, terrifying, beautiful fight, sound for both sides with precise play.", sayShort: '…Qa5 — the king storms in, chaos balanced.', highlights: [H('b4'), H('a5')] }),
    ],
  },
