...
export const PRO_AMAN_FRENCH_WHITE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'pro-aman-french-white::Winawer (…Bb4)': {
    ...
    beats: [
      ...
      b({ id: 'h4', moves: 'e4 e6 d4 d5 Nc3 Bb4 e5 c5 a3 Bxc3+ bxc3 Ne7 h4', highlights: [H('h4')],
      ...
      b({ id: 'middlegame', moves: 'e4 e6 d4 d5 Nc3 Bb4 e5 c5 a3 Bxc3+ bxc3 Ne7 h4 Qc7 Nf3 b6', arrows: [A('g1', 'f3')], highlights: [H('e5')],
  ...
  'pro-aman-french-white::Classical (…Nf6)': {
    ...
    sources: SRC,
    beats: [
      b({ id: 'bg5', moves: 'e4 e6 d4 d5 Nc3 Nf6 Bg5', arrows: [A('c1', 'g5')], highlights: [H('g5')],
