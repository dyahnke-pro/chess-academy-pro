...
export const NIMZO_INDIAN_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'qc2-oo', moves: 'd4 Nf6 c4 e6 Nc3 Bb4 Qc2 O-O', say: "4.Qc2 — the Classical, the most popular line. White protects the knight and prepares to recapture on c3 with the queen, avoiding the doubled pawns that define the other variations. Black castles, develops, and bides their time: the bishop will trade on c3 at the right moment, and Black plays for control of e4 and the light squares.", sayShort: 'O-O — castle, keep the …Bxc3 idea ready.', highlights: [H('c3', SOFT)] }),
