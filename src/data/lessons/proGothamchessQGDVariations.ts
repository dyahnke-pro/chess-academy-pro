...
const BF4: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'd4 d5 c4 e6 Nf3 Nf6 Nc3 Be7 Bf4 O-O',
      highlights: [{ square: 'e7', color: SOFT }], say: "The Queen's Gambit Declined. You decline the c4-pawn with the solid …e6, develop naturally, and castle. White plays the modern Bf4 line. So far it's textbook: White has a space edge, you have a fortress and a plan to chip at the centre with …c5.",
    ...
    b({ id: 'c5', moves: 'd4 d5 c4 e6 Nf3 Nf6 Nc3 Be7 Bf4 O-O e3 c5 dxc5 Bxc5',
      ...
      say: "You strike with the move that defines the QGD — …c5, hitting d4 and freeing your game. After the trade you recapture with the bishop, and watch it transform: a moment ago passive on e7, now it rakes toward White's king. The break frees you AND activates your worst piece.",
...
const EXCHANGE: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'd4 d5 c4 e6 Nc3 Nf6 cxd5 exd5 Bg5 Be7',
      highlights: [{ square: 'd5', color: KEY }], say: "The Exchange QGD — White trades on d5 and you recapture with the e-pawn, reaching the famous Carlsbad structure. White will try a minority attack on the queenside; you get your chances in the centre and kingside. It's one of the most instructive structures in all of chess, and Black is completely solid.",
    ...
    b({ id: 'setup', moves: 'd4 d5 c4 e6 Nc3 Nf6 cxd5 exd5 Bg5 Be7 e3 O-O Bd3 Nbd7 Nf3 Re8 Qc2 c6',
      ...
      say: "You set up the model defensive formation: …Nbd7, …Re8 on the half-open file, and …c6 to brace the queenside against White's coming b4-b5 minority attack. Every piece has a defensive job and an attacking future. This is textbook Carlsbad handling.",
