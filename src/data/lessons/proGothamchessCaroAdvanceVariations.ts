...
const MAIN_LINE: LessonScript = {
  ...
  beats: [
    b({
      ...
      say:
        "Against the Caro, this repertoire grabs space with e5 — the Advance. This is his bread-and-butter line: 423 games at a crushing 73%. Black develops the light-squared bishop outside the chain to f5, exactly as the Caro wants. So your whole plan is built around making that bishop regret it.",
    ...
    b({
      ...
      say:
        "Bg5 develops the dark-squared bishop to an active square, where it eyes the kingside and clamps down on the dark squares. Black hits back with Qb6, pressuring d4 and b2. You're happy to let the queen wander — it's not developing Black's pieces.",
    ...
    b({
      ...
      say:
        "Here's the point: Bd3, offering to trade the light-squared bishops. When Black takes, you recapture with the queen — and now You have the good bishop and Black has none. His remaining bishop is the bad one, about to be locked in by his own …e6. That's a lasting structural edge.",
    ...
    b({
      ...
      say:
        "And you open a second front: c4, striking at Black's d5-pawn. Here's the middlegame picture — you have more space, the better bishop, a target on h5, and now pressure on the queenside too. White plays on both wings while Black sits cramped and passive. This is the squeeze that wins 73% of this repertoire's Caros.",
...
const C5_LINE: LessonScript = {
  ...
  beats: [
    b({
      ...
      say:
        "Instead of …Bf5, Black challenges the centre immediately with c5. You take — dxc5 — heading into the Botvinnik-Carls structure. For the moment you're a pawn up; the question is whether Black can win it back without falling behind in development.",
    ...
    b({
      ...
      say:
        "Black plays e6, getting ready to round up the c5-pawn; you slot in the quiet a3 — and it's deceptively important. It takes the b4-square away from Black's bishop and prepares b4 yourself, so you could even try to HOLD the extra pawn with a queenside clamp.",
    ...
    b({
      ...
      say:
        "Black recaptures with the bishop on c5, regaining the pawn, and develops the knight to c6; you bring your knight to f3, defending e5 and developing toward the kingside. Material is level again — but the e5-pawn still cramps Black's whole position.",
