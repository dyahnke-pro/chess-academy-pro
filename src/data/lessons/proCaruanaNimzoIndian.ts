...
export const PRO_CARUANA_NIMZO_INDIAN_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'qc2', moves: 'd4 Nf6 c4 e6 Nc3 Bb4 Qc2 O-O', say: "White chooses the Classical Qc2, defending the knight and preparing to recapture on c3 with the queen — keeping the pawn structure intact for now. Black calmly castles and completes their kingside.", sayShort: '…O-O — castle, stay flexible.', highlights: [H('g8')] }),
    ...
    b({ id: 'mid', moves: 'd4 Nf6 c4 e6 Nc3 Bb4 Qc2 O-O a3 Bxc3+ Qxc3 d6 Bg5 h6 Bh4 g5 Bg3 Ne4 Qc2 Nxg3', say: "White retreats the queen and Black captures the g3-bishop with the knight. Black has traded their pieces to leave White with shattered, doubled pawns and no good bishop — the Nimzo strategy fulfilled: structural damage and a comfortable game.", sayShort: '…Nxg3 — win the bishop pair.', arrows: [A('e4', 'g3')], highlights: [H('g3')] }),
  ],
};
