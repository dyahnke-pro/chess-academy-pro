...
export const CATALAN_OPENING_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  orientation: "white",
  beats: [
    b({ id: "sl1", moves: "d4 d5 c4 c6 Nf3 Nf6 g3", say: "When Black starts with a Slav move-order, ...c6, White still fianchettoes into a Catalan-Slav with g3. The same long-diagonal pressure applies, and after Black grabs the gambit pawn with ...dxc4 White will use their development and the fianchettoed bishop to recover it with a pull.", sayShort: "g3 — the Catalan-Slav fianchetto.", highlights: [H("g3", KEY)] }),
    b({ id: "sl2", moves: "d4 d5 c4 c6 Nf3 Nf6 g3 dxc4 Bg2 g6 O-O Bg7 a4", say: "dxc4 Bg2 g6 O-O Bg7 a4 — Black takes on c4 and fianchettoes their own bishop. a4! is the key prophylaxis: it prevents Black from holding the extra pawn with ...b5. White will round up the c4-pawn at leisure while keeping the bishop's long-diagonal grip.", sayShort: "a4 — stop …b5, recover c4 later.", highlights: [H("c4", KEY), H("a4", SOFT)] }),
  ...
  "catalan-opening::Early Qa4+ Line": {
    openingId: "catalan-opening", title: "Catalan — regaining c4 through the …Bd7 defence", minutes: 8, orientation: "white",
    sources: ["concept:pawn-fianchetto", "concept:pos-development", "https://en.wikipedia.org/wiki/Catalan_Opening"],
    beats: [
      { id: "ca1", moves: ["d4", "Nf6", "c4", "e6", "g3", "d5", "Bg2", "dxc4", "Nf3", "Bd7"], say: "The Catalan promise: the g2-bishop's long diagonal against Black's whole queenside. Black grabs c4 and plays …Bd7, the move built to blunt the standard Qa4-check regain — the bishop stands ready to block on c6. White doesn't argue. White improves.", sayShort: "…Bd7 — Black blocks the check; White improves.", highlights: [{ square: "c4", color: "rgba(255,214,0,0.88)" }, { square: "d7", color: "rgba(80,140,255,0.32)" }] },
      { id: "ca2", moves: ["d4", "Nf6", "c4", "e6", "g3", "d5", "Bg2", "dxc4", "Nf3", "Bd7", "Ne5", "Bc6", "Nxc6", "Nxc6"], say: "Ne5! does two jobs in one move: it attacks the d7-bishop and vacates f3, opening the g2-bishop's full view down the long diagonal. …Bc6 tries to shut that view; Nxc6 …Nxc6 removes the blocker. Twice White traded a knight move for diagonal daylight.", sayShort: "Ne5 — hit the bishop, open the diagonal.", arrows: [{ from: "g2", to: "c6", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "c6", color: "rgba(80,140,255,0.32)" }] },
      { id: "ca3", moves: ["d4", "Nf6", "c4", "e6", "g3", "d5", "Bg2", "dxc4", "Nf3", "Bd7", "Ne5", "Bc6", "Nxc6", "Nxc6", "O-O", "Qd7", "e3", "O-O-O"], say: "White castles and shores up d4 with e3; Black answers …Qd7 and castles LONG — kings on opposite wings, with Black still clutching the c4-pawn. Sharp choice: the queenside they castled into is exactly where the g2-bishop and White's coming play point.", sayShort: "…O-O-O — opposite wings, pawn still owed.", highlights: [{ square: "c4", color: "rgba(255,214,0,0.88)" }] },
      { id: "ca4", moves: ["d4", "Nf6", "c4", "e6", "g3", "d5", "Bg2", "dxc4", "Nf3", "Bd7", "Ne5", "Bc6", "Nxc6", "Nxc6", "O-O", "Qd7", "e3", "O-O-O", "Qa4", "Nd5", "Qxc4"], say: "And now Qa4 — the very move …Bd7 was meant to stop, arriving anyway with the blocking bishop long gone, leaning on the c6-knight. …Nd5 centralises, and Qxc4 collects the pawn at last. Ledger: material restored, queens facing a queenside king, the Catalan bishop staring through the centre. The engine gives White the pull — patience paid the whole bill.", sayShort: "Qxc4 — the pawn comes home with interest.", highlights: [{ square: "c4", color: "rgba(255,214,0,0.88)" }] },
    ],
  },
};
