...
export const CATALAN_OPENING_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "catalan-opening::Early Qa4+ Line": {
    ...
    beats: [
      ...
      { id: "ca3", moves: ["d4", "Nf6", "c4", "e6", "g3", "d5", "Bg2", "dxc4", "Nf3", "Bd7", "Ne5", "Bc6", "Nxc6", "Nxc6", "O-O", "Qd7", "e3", "O-O-O"], say: "White castles and shores up d4 with e3; Black answers …Qd7 and castles LONG — kings on opposite wings, with Black still clutching the c4-pawn. Sharp choice: the queenside he castled into is exactly where the g2-bishop and White's coming play point.", sayShort: "…O-O-O — opposite wings, pawn still owed.", highlights: [{ square: "c8", color: "rgba(80,140,255,0.32)" }, { square: "c4", color: "rgba(255,214,0,0.88)" }] },
