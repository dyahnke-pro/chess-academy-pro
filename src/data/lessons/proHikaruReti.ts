...
export const PRO_HIKARU_RETI_LESSON: LessonScript = {
  ...
  title: "This repertoire's Réti — the Flexible Road into the b2-Bishop System",
  minutes: 11,
  orientation: 'white',
  kind: 'variation',
  sources: SRC,
  beats: [
    b({ id: 'nf3', moves: 'Nf3', highlights: [H('f3')], say: "Nf3 — the most flexible first move in chess, and one of this repertoire's favourites. It develops, controls e5, and commits to nothing. He uses it to steer toward the same hypermodern positions he loves, on his terms.", sayShort: 'Nf3 — flexible, commit to nothing.' }),
    b({ id: 'b3', moves: 'Nf3 Nf6 b3 g6 Bb2', arrows: [A('b2', 'g7')], highlights: [H('b2')], say: "And here's the tell: b3 and Bb2. The Réti transposes straight into this repertoire's beloved long-diagonal system — the same b2-bishop weapon as his Nimzo-Larsen, just reached a different way. The bishop owns the long road toward g7.", sayShort: 'Bb2 — the long-diagonal system.' }),
    ...
    b({ id: 'break', moves: 'Nf3 Nf6 b3 g6 Bb2 Bg7 d4 O-O e3 d6 Be2 Nbd7 O-O e5 dxe5', highlights: [H('e5')], say: "Black challenges the centre with e5, and this repertoire takes — dxe5. Opening the position plays into White's hands: the b2-bishop's diagonal stretches further and the pieces get active.", sayShort: 'dxe5 — open it for the bishop.' }),
