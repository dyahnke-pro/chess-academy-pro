...
export const SICILIAN_ALAPIN_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "sicilian-alapin::Alapin: Stoltz Attack (4.Nf3 before d4)": {
    openingId: 'sicilian-alapin', title: 'Alapin — Facing the Stoltz Attack', minutes: 9, orientation: 'black',
    sources: ['concept:pos-center', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Sicilian_Defence,_Alapin_Variation'],
    beats: [
      b({ id: 'st1', moves: 'e4 c5 c3 Nf6 e5 Nd5 Nf3 Nc6', say: "The modern Alapin move order: instead of pushing d4 at once, White develops with Nf3 first. The point is to dodge the classical line's early queen trade and keep pieces on for a real middlegame. Black needs no special medicine yet — the knight already sits beautifully on d5, and …Nc6 develops with pressure on e5. Same sound setup, different move order.", sayShort: "…Nc6 — develop, nothing to fear yet.", highlights: [H('d5', SOFT), H('e5', SOFT)] }),
      b({ id: 'st2', moves: 'e4 c5 c3 Nf6 e5 Nd5 Nf3 Nc6 Bc4 Nb6 Bb3 d5', say: "Bc4 stares at the d5-knight, so …Nb6 steps aside with tempo and the bishop drops to b3. Now the move that defines Black's whole handling of the Stoltz: …d5! Strike the centre before White consolidates with d4. White's only serious try is taking en passant — and Black is happy to allow it, because the recapture develops the queen and dissolves White's proud e5-pawn in one stroke.", sayShort: "…d5! — strike before White consolidates.", highlights: [H('d5'), H('e5', SOFT)] }),
      b({ id: 'st3', moves: 'e4 c5 c3 Nf6 e5 Nd5 Nf3 Nc6 Bc4 Nb6 Bb3 d5 exd6 Qxd6 O-O Be6 Bxe6 Qxe6', say: "En passant, and …Qxd6 recaptures with an active queen — no weak pawn left behind. Then the cleanest equalising idea in the line: …Be6, offering the light-squared bishops. White's b3-bishop was their best attacker aimed at f7, so Black trades it off on Black's own terms, and after …Qxe6 the queen re-centralises in the same breath. Count the position: even material, no weaknesses, every Black piece on a sound square.", sayShort: "…Be6 — trade White's best bishop.", highlights: [H('e6'), H('b3', SOFT)] }),
      b({ id: 'st4', moves: 'e4 c5 c3 Nf6 e5 Nd5 Nf3 Nc6 Bc4 Nb6 Bb3 d5 exd6 Qxd6 O-O Be6 Bxe6 Qxe6 a4 Qd7 a5 Nd5 a6 b6', say: "With the position objectively level, White reaches for the one idea that changes its character without taking risk: the rolling a-pawn — a4, a5, a6 — grabbing queenside space and prodding for a weakness. Stay calm and answer each nudge concretely. …Qd7 sidesteps, …Nd5 plants the knight back on its dream central square, and when the pawn lands on a6, …b6 simply closes the door. The march has ended with a pawn on a6 that Black can surround later — space, but also a responsibility.", sayShort: "…b6 — calmly shut the a-pawn out.", highlights: [H('a6'), H('b6', SOFT), H('d5', SOFT)] }),
      b({ id: 'st5', moves: 'e4 c5 c3 Nf6 e5 Nd5 Nf3 Nc6 Bc4 Nb6 Bb3 d5 exd6 Qxd6 O-O Be6 Bxe6 Qxe6 a4 Qd7 a5 Nd5 a6 b6 d4 e6 Ne5 Nxe5 dxe5 Be7', say: "Only now does White finally play d4 and jump a knight to e5 — and Black meets both without blinking: …e6 solidifies the centre, …Nxe5 removes the intruder, and …Be7 prepares to castle. White's recapture leaves a pawn on e5 that takes space but attacks nothing. This is the Stoltz tabiya in full: a balanced middlegame where Black is fully developed, has no weaknesses to defend, and knows exactly where every piece belongs. When a line has a drawish reputation, this is what it takes to actually hold it — concrete, unhurried moves.", sayShort: "…Be7 — level middlegame, castle next.", highlights: [H('e5', SOFT), H('e7')] }),
    ],
  },
  ...
  "sicilian-alapin::Alapin: 2...d5 3.exd5 Qxd5 4.d4 Nc6 (with ...e5)": {
    ...
    beats: [
      ...
      b({ id: 'ne4', moves: 'e4 c5 c3 d5 exd5 Qxd5 d4 Nc6 Nf3 e5 dxe5 Qxd1+ Kxd1 Nge7 Bd3 Be6 Na3 O-O-O', say: "…Nge7 keeps the option of …Ng6 against the e5-pawn, …Be6 develops toward the queenside, and …O-O-O lands the rook on the open d-file — the d3-bishop is its first target, with the king on d1 x-rayed behind it. Black has castled in an endgame White never chose — development and the safer king are the compensation for the pawn White still holds on e5.", sayShort: '…O-O-O — the rook hits the d-file first.', arrows: [A('d8', 'd3', ATK)], highlights: [H('d1', SOFT), H('e5')] }),
      b({ id: 'ne5', moves: 'e4 c5 c3 d5 exd5 Qxd5 d4 Nc6 Nf3 e5 dxe5 Qxd1+ Kxd1 Nge7 Bd3 Be6 Na3 O-O-O Kc2 Nd5 Bd2 h6', say: "With best play the picture sharpens: the White king walks to c2 by hand while …Nd5 re-centralises, hitting the c3-pawn and forcing Bd2 to babysit it. …h6 takes g5 away from White's pieces. Be honest about the ledger: White still holds the extra e5-pawn and the engine gives them a small pull — Black's full development, the d-file, and the walking king are genuine compensation, but this is the fighting choice, not the safe one. If you want risk-free equality, the …Nf6 recapture two tabs over is your line.", sayShort: '…h6 — activity for the pawn; the fighting choice.', arrows: [A('d5', 'c3', ATK)], highlights: [H('e5', SOFT), H('c3')] }),
    ],
  },
  ...
  "sicilian-alapin::Alapin: 2...e6 Solid (French Structure)": {
    openingId: "sicilian-alapin", title: "Alapin — 2…e6, the French structure without the bad bishop", minutes: 8, orientation: "black",
    sources: ["concept:pawn-chain", "concept:pos-development", "https://en.wikipedia.org/wiki/Sicilian_Defence,_Alapin_Variation"],
    beats: [
      { id: "e61", moves: ["e4", "c5", "c3", "e6", "d4", "d5", "e5"], say: "…e6 and …d5 steer the Alapin into a French-style pawn chain: White's pawns on e5 and d4, Black's on d5 and e6. The strategy writes itself — White owns kingside space, so Black attacks the chain at its base on d4.", sayShort: "…d5 — build the chain, target d4.", highlights: [{ square: "d4", color: "rgba(255,214,0,0.88)" }, { square: "e5", color: "rgba(80,140,255,0.32)" }] },
      { id: "e62", moves: ["e4", "c5", "c3", "e6", "d4", "d5", "e5", "Nc6", "Nf3", "Bd7", "Be2", "Nge7", "O-O", "Nf5"], say: "Here is the difference from a real French: the light-squared bishop got out to d7 BEFORE …e6 shut the door — the French player's eternal problem, solved by move order. Then the king's knight takes the scenic route, …Nge7 to …Nf5, landing where it attacks d4 and no pawn can ever kick it.", sayShort: "…Nf5 — the knight finds its dream square.", arrows: [{ from: "f5", to: "d4", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "f5", color: "rgba(255,214,0,0.88)" }] },
      { id: "e63", moves: ["e4", "c5", "c3", "e6", "d4", "d5", "e5", "Nc6", "Nf3", "Bd7", "Be2", "Nge7", "O-O", "Nf5", "Na3", "cxd4", "cxd4", "Be7", "Nc2", "O-O"], say: "…cxd4 opens the c-file — Black's file, because their rooks arrive there first — and …Be7 with …O-O completes the setup. Count the pressure on d4: the c6-knight and the f5-knight both bite it, and White's queenside knight had to detour through a3 and c2 just to hold the base.", sayShort: "…O-O — two knights bite d4.", arrows: [{ from: "c6", to: "d4", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "d4", color: "rgba(255,214,0,0.88)" }] },
      { id: "e64", moves: ["e4", "c5", "c3", "e6", "d4", "d5", "e5", "Nc6", "Nf3", "Bd7", "Be2", "Nge7", "O-O", "Nf5", "Na3", "cxd4", "cxd4", "Be7", "Nc2", "O-O", "Bd3", "f6"], say: "Bd3 finally challenges the f5-knight — and …f6! strikes the chain at its head, the break this whole setup was built to deliver. Whatever White does about e5, the position opens on Black's terms. The engine gives White's space a small nod and nothing more; Black has the freed bishop, the c-file, and the cleaner plan.", sayShort: "…f6 — strike the chain at its head.", arrows: [{ from: "d3", to: "f5", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "f6", color: "rgba(255,214,0,0.88)" }, { square: "e5", color: "rgba(80,140,255,0.32)" }] },
    ],
  },

  "sicilian-alapin::Alapin: 2...g6 Fianchetto": {
    openingId: "sicilian-alapin", title: "Alapin — the 2…g6 fianchetto grip", minutes: 9, orientation: "black",
    sources: ["concept:pawn-fianchetto", "concept:pos-bishop-pair", "https://en.wikipedia.org/wiki/Sicilian_Defence,_Alapin_Variation"],
    beats: [
      { id: "g61", moves: ["e4", "c5", "c3", "g6", "d4", "cxd4", "cxd4", "d5", "e5"], say: "…g6 says: build your big centre, I will aim a bishop at it. After the c-pawns trade, …d5 forces the decision and e5 closes the long diagonal for now — but a chain fixed on d4 and e5 is exactly what a fianchettoed bishop dreams of gnawing on.", sayShort: "…d5 — fix the chain, feed the bishop.", highlights: [{ square: "e5", color: "rgba(255,214,0,0.88)" }, { square: "d4", color: "rgba(80,140,255,0.32)" }] },
      { id: "g62", moves: ["e4", "c5", "c3", "g6", "d4", "cxd4", "cxd4", "d5", "e5", "Bg7", "Nc3", "Nc6", "Nf3", "Nh6"], say: "…Bg7 takes the diagonal, …Nc6 leans on d4, and …Nh6 starts the same journey the …e6 lines use: destination f5, joining the siege of d4. From h6 the knight also keeps f7 covered — development without a single loose end.", sayShort: "…Nh6 — next stop f5.", highlights: [{ square: "f5", color: "rgba(80,140,255,0.32)" }] },
      { id: "g63", moves: ["e4", "c5", "c3", "g6", "d4", "cxd4", "cxd4", "d5", "e5", "Bg7", "Nc3", "Nc6", "Nf3", "Nh6", "Bb5", "O-O", "Bxc6", "bxc6", "O-O", "Bg4"], say: "White trades on c6 to ease the pressure and Black recaptures toward the centre — the doubled c-pawns buy the half-open b-file and reinforce d5. Then …Bg4 develops the last minor piece with a direct question to the f3-knight, d4's key defender.", sayShort: "…Bg4 — question the d4-defender.", arrows: [{ from: "g4", to: "f3", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "d4", color: "rgba(80,140,255,0.32)" }] },
      { id: "g64", moves: ["e4", "c5", "c3", "g6", "d4", "cxd4", "cxd4", "d5", "e5", "Bg7", "Nc3", "Nc6", "Nf3", "Nh6", "Bb5", "O-O", "Bxc6", "bxc6", "O-O", "Bg4", "h3", "Bxf3", "Qxf3", "Nf5", "Rd1"], say: "…Bxf3 removes the defender before it can be saved, and …Nf5 completes the journey begun on move seven: the knight lands on its perfect square, hitting d4 one more time. White lashes the pawn to a rook with Rd1. The engine actually prefers Black here — the g7-bishop, the f5-knight and the b-file all point at the same targets, and Black's game plays itself.", sayShort: "…Nf5 — every piece points at d4.", arrows: [{ from: "f5", to: "d4", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "d4", color: "rgba(255,214,0,0.88)" }] },
    ],
  },
};
