...
export const SICILIAN_ALAPIN_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "sicilian-alapin::Alapin: Stoltz Attack (4.Nf3 before d4)": {
    ...
    beats: [
      ...
      b({ id: 'st3', moves: 'e4 c5 c3 Nf6 e5 Nd5 Nf3 Nc6 Bc4 Nb6 Bb3 d5 exd6 Qxd6 O-O Be6 Bxe6 Qxe6', say: "En passant, and …Qxd6 recaptures with an active queen — no weak pawn left behind. Then the cleanest equalising idea in the line: …Be6, offering the light-squared bishops. White's b3-bishop was his best attacker aimed at f7, so Black trades it off on Black's own terms, and after …Qxe6 the queen re-centralises in the same breath. Count the position: even material, no weaknesses, every Black piece on a sound square.", sayShort: "…Be6 — trade White's best bishop.", highlights: [H('e6'), H('b3', SOFT)] }),
