...
const VS_D5C5: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'e4', moves: 'Nf3 d5 g3 c5 Bg2 Nc6 O-O e6 d3 Nf6 Nbd2 Be7 e4 O-O Re1',
      ...
      say: "Now the system shows its teeth: e4, staking your claim to the kingside, then Re1 to back the e-pawn and clear f1 for the knight. Black castles right into the storm. Everything is in place — the next idea on your minds is e5.",
    ...
    b({ id: 'mg-plan', moves: 'Nf3 d5 g3 c5 Bg2 Nc6 O-O e6 d3 Nf6 Nbd2 Be7 e4 O-O Re1',
      ...
      say: "Here's the famous KIA plan — the one Fischer used to crush opponents. Push e5 to gain space and chase the f6-knight away from its king; reroute the d2-knight via f1 to g4; bring the queen to e2 aiming at h5; and storm with the f- and h-pawns. Black's queenside counterplay is real but slower. In a race for the king, the faster attacker wins — and that's you.",
...
const VS_SICILIAN: LessonScript = {
  ...
  beats: [
    b({ id: 'setup', moves: 'Nf3 c5 g3 Nc6 Bg2 g6 O-O Bg7 d3 Nf6 Nbd2 d6',
      highlights: [{ square: 'g2', color: KEY }], say: "Against a Sicilian fianchetto, the KIA shines. Black mirrors your fianchetto, but you still have the extra tempo and the same easy system: Bg2, d3, Nbd2. No theory, no danger — just your familiar setup against a player who has to figure out the position from scratch.",
