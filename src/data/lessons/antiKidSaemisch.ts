...
export const ANTI_KID_SAEMISCH_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'sae1', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 f3',
      say: "Against the King's Indian, the Sämisch is the bruiser: f3 props up e4 so you can build the biggest centre in chess — pawns on c4, d4 AND e4, all defended. Where other lines let Black chip at e4, here it is granite. You take the space and dare Black to break it.",
    ...
    b({ id: 'sae2', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 f3 O-O Be3 e5 d5',
      say: "Black castles and strikes the centre with e5; you close it with d5. This is the Sämisch bind — the d5-pawn cramps Black's whole position and hands you a lasting space advantage on both wings. Be3 supports the plan and eyes a later Qd2 and kingside pawn storm.",
    ...
    b({ id: 'sae3', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 f3 O-O Be3 e5 d5 c6 Bd3 cxd5 cxd5',
      say: "Black tries the c6 break to loosen the clamp; you recapture cxd5, keeping the wedge on d5 and now owning the half-open c-file for your rooks. The bishop develops to d3, part of a natural piece deployment behind the space advantage.",
    ...
    b({ id: 'sae4', moves: 'd4 Nf6 c4 g6 Nc3 Bg7 e4 d6 f3 O-O Be3 e5 d5 c6 Bd3 cxd5 cxd5 Na6 Nge2 Nc5 Bc2 a5',
      say: "Black reroutes the knight to c5 to hit the bishop, which slides to c2, safe and still eyeing the kingside. You have reached the Sämisch dream: a granite centre, more space on every part of the board, the c-file, and a clear plan of Qd2 and g4-h4 to storm Black's king. This is a game White plays to win.",
