...
const CLASSICAL_MAIN: LessonScript = {
  ...
  beats: [
    b({ id: 'bf5', moves: 'e4 c6 d4 d5 Nc3 dxe4 Nxe4 Bf5',
      ...
      say: "The Classical Caro. You trade on e4 and develop the light-squared bishop OUTSIDE the pawn chain with Bf5, hitting the knight. This is the whole point of the Caro over the French — that bishop is free and active before you ever play …e6.",
    ...
    b({ id: 'trade', moves: 'e4 c6 d4 d5 Nc3 dxe4 Nxe4 Bf5 Ng3 Bg6 h4 h6 Nf3 Nd7 h5 Bh7 Bd3 Bxd3 Qxd3',
      ...
      say: "White chases the bishop with h4-h5; you calmly tuck it to h7, just as planned. When White offers the trade with Bd3, you take — swapping off White's attacking light-squared bishop and taking the venom out of the position. You're left with a clean, easy game.",
...
const TARTAKOWER: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'e4 c6 Nc3 d5 Nf3 Nf6 e5 Ne4',
      ...
      say: "When White develops both knights, you play …Nf6 and, after e5, leap into e4 — a bold, active post right in White's half. This is the sharp Tartakower line: instead of a quiet Caro you get a dynamic, French-Advance-style fight where your pieces come alive.",
    ...
    b({ id: 'mg-c5', moves: 'e4 c6 Nc3 d5 Nf3 Nf6 e5 Ne4 Ne2 Qb6 d4 e6 Ng3 Nxg3 hxg3 c5',
      ...
      say: "And the freeing break — …c5, hitting d4 and opening the position for your pieces. Here's the middlegame: it's a French-Advance structure, but with your queen active on b6, White's kingside slightly damaged, and the …c5 lever cracking the centre. It's the sharpest, most double-edged Caro line — dynamic equality where the better-prepared side wins.",
...
const TWO_KNIGHTS_BG4: LessonScript = {
  ...
  beats: [
    b({ id: 'bg4', moves: 'e4 c6 Nc3 d5 Nf3 Bg4',
      ...
      say: "Against the Two Knights, the cleanest equaliser: …Bg4, pinning the f3-knight. You develop your light-squared bishop actively and immediately create pressure. The whole line is about trading pieces to reach a safe, simple position.",
      sayShort: 'Bg4 — pin the knight.' }),
    b({ id: 'trade', moves: 'e4 c6 Nc3 d5 Nf3 Bg4 h3 Bxf3 Qxf3 e6 d4 Nf6 Bd3 dxe4 Nxe4 Nxe4 Qxe4 Nd7',
      highlights: [{ square: 'd7', color: SOFT }], say: "When questioned, you trade on f3 — giving up the bishop for the knight to simplify — then exchange the central pawns and knights. Every trade takes you closer to a clean, weakness-free position where White's slight space edge means nothing.",
    ...
    b({ id: 'mg-plan', moves: 'e4 c6 Nc3 d5 Nf3 Bg4 h3 Bxf3 Qxf3 e6 d4 Nf6 Bd3 dxe4 Nxe4 Nxe4 Qxe4 Nd7 O-O Nf6',
      ...
      say: "You round things out with …Nf6, hitting White's centralised queen. Here's the middlegame: a rock-solid, slightly cramped but utterly sound position. The plan is simple — …Bd6 or …Be7, castle, and break with …c5 or …e5 when ready. White has a tiny pull; you have a fortress that's almost impossible to crack. Classic Caro safety.",
...
const ADVANCE_BF5: LessonScript = {
  ...
  beats: [
    b({ id: 'bf5', moves: 'e4 c6 d4 d5 e5 Bf5',
      ...
      say: "White grabs space with the Advance, e5. And here's why the Caro beats the French: before you lock the centre with …e6, you get your light-squared bishop OUT to f5. In the French this bishop is a lifelong prisoner; in the Caro it's free and active. That one difference is the whole point.",
    ...
    b({ id: 'c5', moves: 'e4 c6 d4 d5 e5 Bf5 Nf3 e6 Be2 c5 Be3 Nd7 O-O Ne7 Nbd2 Nc6 c3 cxd4 cxd4',
      arrows: [{ from: 'c6', to: 'c5', color: VIS }], highlights: [{ square: 'c5', color: KEY }, { square: 'd4', color: SOFT }],
      say: "You develop behind the safety of your structure and strike with the thematic …c5, hitting the base of White's chain on d4. After the trades, White is left with an isolated d4-pawn to defend. You've turned his space advantage into a target.",
    ...
    b({ id: 'mg-plan', moves: 'e4 c6 d4 d5 e5 Bf5 Nf3 e6 Be2 c5 Be3 Nd7 O-O Ne7 Nbd2 Nc6 c3 cxd4 cxd4',
      ...
      say: "Here's the middlegame, and the engine calls it dead level. You have the active light-squared bishop on f5, knights pressuring the isolated d4-pawn, and an easy plan: …Be7, …O-O, double on the c- and d-files, and pile onto d4. White's space is neutralised; your pieces are better placed. This is the Caro at its best — equal and easy to play.",
...
const ADVANCE_C5: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'bxc5', moves: 'e4 c6 d4 d5 e5 c5 dxc5 e6 a3 Bxc5 Nf3 Nc6 Bd3 Nge7',
      ...
      say: "White grabs the pawn with dxc5; you prepare …e6 and round it back up with …Bxc5, developing the bishop to an active diagonal. You bring the knights out to c6 and e7 — the e7-square keeps your structure flexible and supports a future …f6 break.",
    ...
    b({ id: 'mg-plan', moves: 'e4 c6 d4 d5 e5 c5 dxc5 e6 a3 Bxc5 Nf3 Nc6 Bd3 Nge7 b4 Bb6',
      ...
      say: "White gains queenside space with b4; you tuck the bishop to b6, still active. Here's the middlegame plan: castle, then undermine White's cramping e5-pawn with …f6. Once e5 falls or trades, the position opens up for your pieces and your slightly freer development tells. A dynamic, fully equal fight — exactly what an active Caro player wants.",
...
const EXCHANGE: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'e4 c6 d4 d5 exd5 cxd5 Bd3 Nc6 c3 Nf6',
      highlights: [{ square: 'd5', color: KEY }], say: "The Exchange Caro — the most harmless try. White trades on d5 and you recapture, reaching a symmetric structure: your d5-pawn mirrors White's d4. You develop naturally with …Nc6 and …Nf6. There's nothing to fear here; you just play good moves and equalise effortlessly.",
    ...
    b({ id: 'develop', moves: 'e4 c6 d4 d5 exd5 cxd5 Bd3 Nc6 c3 Nf6 Bf4 Bg4 Qb3 Qd7 Nd2 e6 Ngf3 Bd6 Bxd6 Qxd6',
      ...
      say: "You get your light-squared bishop out to g4 BEFORE playing …e6 — the eternal Caro priority — then meet White's queenside probe with …Qd7 and trade the dark bishops on d6. Every piece reaches a good square; nothing gets buried. Harmonious development is the whole battle here.",
    ...
    b({ id: 'mg-plan', moves: 'e4 c6 d4 d5 exd5 cxd5 Bd3 Nc6 c3 Nf6 Bf4 Bg4 Qb3 Qd7 Nd2 e6 Ngf3 Bd6 Bxd6 Qxd6 O-O O-O',
      ...
      say: "Both sides castle into a dead-level, symmetric middlegame. Here's the plan: contest the only open file with …Rac8, and look for the …Ne4 or …Ne7-f5 outpost to give your knight a great square. With no weaknesses and easy piece play, you hold comfortable equality and play for the long game. The Exchange Caro is a draw offer you happily decline.",
...
const PANOV: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'develop', moves: 'e4 c6 d4 d5 exd5 cxd5 c4 Nf6 Nc3 g6 cxd5 Nxd5 Bc4 Nb6 Bb3 Bg7 Nf3 O-O O-O Nc6',
      ...
      say: "You trade on d5, develop the fianchetto bishop to g7 — raking the long diagonal toward d4 — and castle. The bishop on g7 and the knight on c6 both pressure White's isolated d4-pawn. You're fully developed, perfectly safe, and already targeting White's one weakness.",
...
const FANTASY: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'e4 c6 d4 d5 f3 dxe4 fxe4 e5',
      ...
      say: "The Fantasy Variation — White props up the centre with the odd-looking f3. You trade on e4 and strike back immediately with …e5, hitting d4 and refusing to let White build a comfortable big centre. The key is to stay solid and not get greedy.",
      sayShort: '…e5 — hit back in the centre.' }),
    b({ id: 'bg4', moves: 'e4 c6 d4 d5 f3 dxe4 fxe4 e5 Nf3 Bg4',
      arrows: [{ from: 'c8', to: 'g4', color: VIS }], highlights: [{ square: 'g4', color: KEY }, { square: 'f3', color: SOFT }],
      say: "Instead of grabbing the d4-pawn — which leads to a dangerous gambit for White — you play the calm, strong …Bg4, pinning the f3-knight. You develop with pressure and keep the position simple. Declining the pawn is the mature choice: solidity over greed.",
    ...
    b({ id: 'mg-plan', moves: 'e4 c6 d4 d5 f3 dxe4 fxe4 e5 Nf3 Bg4 Bc4 Nd7 O-O Ngf6 c3 Bd6',
      ...
      say: "You develop harmoniously — …Nd7, …Ngf6, …Bd6 — defending your e5-pawn and covering all the key squares. Here's the middlegame, and the engine calls it equal. You have a solid central pawn on e5, the bishop pin on g4, and easy development. The plan: castle, keep the centre stable, and play a calm, balanced game. By declining White's gambit pawn, you took all the danger out of the Fantasy.",
