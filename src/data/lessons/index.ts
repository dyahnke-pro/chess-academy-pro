...
import { PRO_NARODITSKY_VIENNA_LESSON } from './proNaroditskyVienna';
...
import { PRO_GOTHAMCHESS_ITALIAN_LESSON } from './proGothamItalian';
import { PRO_GOTHAMCHESS_ITALIAN_VARIATION_LESSONS } from './proGothamItalianVariations';
...
import { PRO_GOTHAMCHESS_PONZIANI_LESSON } from './proGothamPonziani';
import { PRO_GOTHAMCHESS_FANTASY_CARO_LESSON } from './proGothamFantasyCaro';
import { PRO_GOTHAMCHESS_MILNER_BARRY_LESSON } from './proGothamMilnerBarry';
import { PRO_GOTHAMCHESS_QGD_LESSON } from './proGothamQGD';
import { PRO_GOTHAMCHESS_STAFFORD_REFUTE_LESSON } from './proGothamStaffordRefute';
...
const LESSONS: Record<string, LessonScript> = {
  ...
  [PRO_NARODITSKY_SCOTCH_LESSON.openingId]: PRO_NARODITSKY_SCOTCH_LESSON,
  [PRO_NARODITSKY_VIENNA_LESSON.openingId]: PRO_NARODITSKY_VIENNA_LESSON,
  [PRO_NARODITSKY_JOBAVA_LESSON.openingId]: PRO_NARODITSKY_JOBAVA_LESSON,
...
const VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  ...PRO_NARODITSKY_SCOTCH_VARIATION_LESSONS,
  ...PRO_NARODITSKY_VIENNA_VARIATION_LESSONS,
