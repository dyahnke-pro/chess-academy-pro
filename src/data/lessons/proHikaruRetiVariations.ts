...
const KIA: LessonScript = {
  ...
  beats: [
    b({ id: 'bb2', moves: 'Nf3 Nf6 b3 g6 Bb2', arrows: [A('b2', 'g7')], highlights: [H('b2')], say: "From the flexible Nf3, Hikaru transposes into his favourite structure — b3 and Bb2. It's the same long-diagonal weapon as his Nimzo-Larsen, just reached a different way; the bishop owns the road toward g7.", sayShort: 'Bb2 — the long-diagonal system.' }),
...
const VS_D5: LessonScript = {
  ...
  beats: [
    b({ id: 'bb2', moves: 'Nf3 d5 b3 Nf6 Bb2', arrows: [A('b2', 'g7')], highlights: [H('b2')], say: "Against the solid ...d5, Hikaru fianchettoes — Bb2. The setup becomes a reversed London with an extra tempo: the dark-squared bishop leans down the long diagonal while White prepares the centre.", sayShort: 'Bb2 — reversed London, a tempo up.' }),
...
const VS_C5: LessonScript = {
  ...
  beats: [
    b({ id: 'bb2', moves: 'Nf3 c5 b3 Nc6 Bb2', arrows: [A('b2', 'g7')], highlights: [H('b2')], say: "Against ...c5, Hikaru fianchettoes again — Bb2 — and the bishop's diagonal already points toward Black's kingside. The flexible move order keeps White comfortable.", sayShort: 'Bb2 — claim the diagonal.' }),
