...
export const ENGLUND_GAMBIT_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'check', moves: 'd4 e5 dxe5 Nc6 Nf3 Qe7 Bf4 Qb4+', say: "…Qb4+! The queen leaps out with check, forking the white king and the undefended b2-pawn. White must deal with the check first.", sayShort: '…Qb4+ — check and fork b2.', arrows: [A('b4', 'e1')], highlights: [H('b4'), H('b2')] }),
