...
export const PRO_CARLSEN_RUY_LOPEZ_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'a4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O a4', highlights: [H('a4'), H('b5')], say: "a4 — the modern anti-Marshall. Rather than walk into the razor-sharp Marshall Gambit, this repertoire pokes at the b5-pawn first, keeping the game positional. It's a small, annoying probe on the wing, exactly the kind of low-risk pressure he thrives on.", sayShort: 'a4 — dodge the Marshall.' }),
    b({ id: 'squeeze', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O a4 b4 d3 d6 Nbd2', arrows: [A('d2', 'f1')], highlights: [H('d3'), H('f1')], say: "Black locks the queenside with b4; White settles the centre with d3 and begins the signature Spanish manoeuvre — the knight from d2 heading to f1 and then g3, swinging the whole army toward the kingside. Slow, harmonious, relentless. This is how this repertoire wins game after game from almost nothing.", sayShort: 'Nbd2 — the Spanish knight tour.' }),
  ],
};
