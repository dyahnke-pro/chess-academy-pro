...
const RETI_C4: LessonScript = {
  ...
  beats: [
    b({ id: 'c4', moves: 'Nf3 Nf6 c4 g6 Nc3 Bg7 e4', highlights: [H('c4'), H('e4')], say: "When Black fianchettoes, White grabs the full centre with c4 and e4 — transposing into a big-centre system a tempo up on a King's Indian. White gets exactly the space and structure they want, with the move order denying Black their sharpest setups.", sayShort: 'c4, e4 — seize the centre.' }),
    b({ id: 'd4', moves: 'Nf3 Nf6 c4 g6 Nc3 Bg7 e4 d6 d4 O-O Be2 e5', highlights: [H('d4'), H('e5')], say: "White builds the full d4/e4 centre and develops naturally. When Black strikes with …e5, White has a comfortable, classical King's-Indian-with-colours-reversed where their extra space and tempo tell. A pleasant strategic battle on White's terms.", sayShort: 'd4 — the big centre, a tempo up.' }),
  ],
};
