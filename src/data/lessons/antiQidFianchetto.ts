...
export const ANTI_QID_FIANCHETTO_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'qid1', moves: 'd4 Nf6 c4 e6 Nf3 b6 g3 Ba6',
      say: "The Queen's Indian is a battle for the long light diagonal — Black fianchettoes …b6 and, here, needles c4 with …Ba6. Your answer is the mirror: g3 and Bg2, contesting the very same diagonal from the other side. Whoever owns those long light squares owns the game.",
    ...
    b({ id: 'qid2', moves: 'd4 Nf6 c4 e6 Nf3 b6 g3 Ba6 b3 Bb4+ Bd2 Be7 Bg2',
      say: "b3 quietly defends c4, taking all the sting out of the a6-bishop. Black checks on b4 and drops back to e7 — a little loss of time — while you complete the fianchetto with Bg2. The bishop takes its post on the long light diagonal, ready to bear down the moment the f3-knight clears; Black's bishop, meanwhile, just bites on the granite of your b3-pawn.",
    ...
    b({ id: 'qid3', moves: 'd4 Nf6 c4 e6 Nf3 b6 g3 Ba6 b3 Bb4+ Bd2 Be7 Bg2 c6 Bc3',
      say: "Black props a coming …d5 with …c6; you lift the dark-squared bishop to c3, onto the long dark diagonal, where it reinforces d4 AND eyes the kingside dark squares for when the centre cracks. Now BOTH your bishops sit on their long diagonals — one on each colour. That's harmony, and it quietly out-coordinates Black.",
    ...
    b({ id: 'qid4', moves: 'd4 Nf6 c4 e6 Nf3 b6 g3 Ba6 b3 Bb4+ Bd2 Be7 Bg2 c6 Bc3 d5 Nbd2 Nbd7 e4 Nxe4 Nxe4 dxe4',
      say: "When Black finally frees with …d5, you strike the centre with e4. The knights come off, the position cracks open toward Black's slightly worse-placed pieces, and your two long-diagonal bishops come roaring into their own. A small but nagging pull — the Queen's Indian handled the classical way.",
