...
const BERLIN: LessonScript = {
  ...
  beats: [
    b({ id: 'nf6', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4',
      ...
      say: "The rock-solid Berlin: Black grabs e4 and you strike the centre with d4. Rather than fear the famous Berlin endgame, you play it with understanding — White keeps a small, durable edge thanks to the kingside pawn majority.",
    ...
    b({ id: 'endgame', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8',
      ...
      say: "The Berlin endgame. Queens come off and Black's king is stuck on d8 having lost the right to castle. In return Black has the bishop pair, but your extra kingside pawn and Black's shattered queenside structure give White the long-term pull.",
...
const EXCHANGE: LessonScript = {
  ...
  beats: [
    b({ id: 'bxc6', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Bxc6 dxc6',
      ...
      say: "The Exchange Ruy — a clean, low-theory try. You trade on c6, doubling Black's pawns. You concede the bishop pair, but in return Black's pawn structure is permanently damaged: the queenside majority can never make a healthy passed pawn.",
    ...
    b({ id: 'd4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Bxc6 dxc6 O-O f6 d4 exd4 Nxd4 c5',
      ...
      say: "You castle and break with d4, trading into a position where the pawn structure does all the talking. Black's bishop pair is real, but in the endgame White's healthy 4-vs-3 kingside majority creates an outside passed pawn while Black's queenside majority is crippled.",
...
const STEINITZ: LessonScript = {
  ...
  beats: [
    b({ id: 'd6', moves: 'e4 e5 Nf3 Nc6 Bb5 d6 d4 Bd7 Nc3 Nf6 O-O Be7',
      ...
      say: "Against the solid but passive Steinitz (…d6), you grab the centre with d4 at once. Black's setup is cramped; you develop classically with Nc3 and castle, enjoying more space and easier development.",
    ...
    b({ id: 'center', moves: 'e4 e5 Nf3 Nc6 Bb5 d6 d4 Bd7 Nc3 Nf6 O-O Be7 Re1 exd4 Nxd4 O-O',
      ...
      say: "Re1 piles on e5, and after Black releases with …exd4 you recapture with the knight, reaching an Open-Sicilian-style position with a strong knight on d4 and a clear space edge. Black is solid but passive — perfect to squeeze.",
