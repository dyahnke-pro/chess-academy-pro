...
export const PETROV_DEFENCE_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'nxe4', moves: 'e4 e5 Nf3 Nf6 Nxe5 d6 Nf3 Nxe4', say: "Nf3 retreats, and only now …Nxe4 restores the material. The pawn count is level, the structure is symmetric, and Black has the position they wanted: nothing to defend, no weaknesses, and a knight as active as White's on e4.", sayShort: '…Nxe4 — restore material, symmetric and sound.', highlights: [H('e4')] }),
