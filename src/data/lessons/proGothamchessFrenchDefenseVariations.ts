...
const RUBINSTEIN: LessonScript = {
  ...
  beats: [
    b({ id: 'gxf6', moves: 'e4 e6 d4 d5 Nc3 dxe4 Nxe4 Nf6 Nxf6+ gxf6',
      ...
      say: "The Rubinstein French with the bold …gxf6 recapture. Yes, your f-pawns are doubled — but look what you got: a half-open g-file aimed at White's kingside and a pawn on f6 ready to support a big centre. This isn't a weakness; it's a weapon most opponents have no idea how to meet.",
    ...
    b({ id: 'e5', moves: 'e4 e6 d4 d5 Nc3 dxe4 Nxe4 Nf6 Nxf6+ gxf6 Nf3 Nc6 g3 e5',
      ...
      say: "You develop …Nc6, pressuring d4, and strike with …e5! Now those 'ugly' doubled pawns pay off: the f6-pawn rock-solidly supports e5, giving you a broad, strong centre. Black is rarely this active in the French — that's the whole point of the …gxf6 line.",
...
const TARRASCH: LessonScript = {
  ...
  beats: [
    b({ id: 'gxf6', moves: 'e4 e6 d4 d5 Nd2 dxe4 Nxe4 Nf6 Nxf6+ gxf6 Nf3 Nc6 g3 e5',
      arrows: [{ from: 'e6', to: 'e5', color: VIS }], highlights: [{ square: 'e5', color: KEY }, { square: 'f6', color: SOFT }],
      say: "Against the Tarrasch move order (Nd2), you use the same Rubinstein idea — recapture with …gxf6 for the g-file and the big centre, then blast …e5 supported by the f6-pawn. Same powerful, active structure: a broad centre and an open file pointed at White's king.",
    ...
    b({ id: 'd5-nb4', moves: 'e4 e6 d4 d5 Nd2 dxe4 Nxe4 Nf6 Nxf6+ gxf6 Nf3 Nc6 g3 e5 d5 Nb4',
      ...
      say: "White lunges d5 to kick your knight, but you jump to b4 — and this is the key point. From b4 the knight eyes c2, where it would fork White's king on e1 and the rook on a1. That …Nc2+ threat is real and nasty, and White is suddenly the one with problems.",
    ...
    b({ id: 'mg-bf5', moves: 'e4 e6 d4 d5 Nd2 dxe4 Nxe4 Nf6 Nxf6+ gxf6 Nf3 Nc6 g3 e5 d5 Nb4 c4 Bf5',
      ...
      say: "White grabs space with c4; you develop …Bf5, eyeing c2 to support the fork and hitting White's loose queenside. Here's the middlegame, and the engine actually FAVOURS Black: the knight on b4 with the …Nc2+ fork hanging, your bishops raking open lines, and White's king stuck in the centre. You're not just equal here — you're better. Active piece play has beaten White's space grab.",
...
const EXCHANGE: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'e4 e6 d4 d5 exd5 exd5',
      highlights: [{ square: 'd5', color: KEY }], say: "The Exchange French — White's most harmless try, dissolving the central tension into a symmetric structure. People say it's a draw. You say it's a free, easy game where your bishops are unleashed — the very pieces the French normally struggles to activate.",
    ...
    b({ id: 'develop', moves: 'e4 e6 d4 d5 exd5 exd5 Nf3 Bd6 Bd3 Bg4',
      ...
      say: "You get BOTH bishops out actively — …Bd6 on its best diagonal and …Bg4 pinning White's knight. In a normal French these bishops are problem pieces; in the Exchange they're your best pieces. You develop with total freedom and perfect harmony.",
    ...
    b({ id: 'mg-plan', moves: 'e4 e6 d4 d5 exd5 exd5 Nf3 Bd6 Bd3 Bg4',
      ...
      say: "Here's the middlegame — and it's dead level, but full of life if you want it. The plan: …Nc6 and …Qd7, then choose your king. Castle queenside and you can pawn-storm White's king; castle kingside for a calm game. With symmetric pawns but more active pieces, the Exchange French is a draw offer you happily decline and play to win. Don't fear it — relish it.",
