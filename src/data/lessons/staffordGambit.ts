...
export const STAFFORD_GAMBIT_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'shot', moves: 'e4 e5 Nf3 Nf6 Nxe5 Nc6 Nxc6 dxc6 d3 Bc5 h3 Nxe4 dxe4 Bxf2+', say: "…Nxe4! blows it open — and after dxe4, …Bxf2+! the bishop crashes in with check. The point: the f2-strike comes with a discovered hit, and the white queen has no shelter.", sayShort: '…Bxf2+ — crash through with check.', arrows: [A('c5', 'f2')], highlights: [H('f2')] }),
