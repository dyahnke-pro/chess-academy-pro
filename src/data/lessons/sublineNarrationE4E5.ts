...
const RUY_OPEN: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 14, say: "dxe5 opens lines — Black's pieces are active, but their loosened queenside from …a6 and …b5 is the chronic weakness. Develop, double on the open files, and press the structural edge.", sayShort: "dxe5 — open lines, press structure.", highlights: [H('e5', SOFT)] },
  ],
  sources: RUY,
};
...
const RUY_SCHLIEMANN_W: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 8, say: "Nxe4 — the knight lands on a dominant central post, eyeing d6 and g5. Your structure is whole while Black has spent a kingside pawn and bared the e8-h5 diagonal; develop, castle, and the holes around their king tell.", sayShort: "Nxe4 — dominant central knight.", arrows: [A('e4', 'd6')], highlights: [H('e4', KEY)] },
...
const IT_GRECO_BXC3: SublineNarration = {
  intro: {
    say: "…Bxc3+ — Black trades the dark bishop off, and bxc3 hands you exactly what the Giuoco dreams of: a towering d4-e4 pawn centre on a half-open b-file. Black has surrendered their most active piece to dent your pawns, but those pawns are a battering ram, not a weakness. Push d5 or e5, open lines for the bishop pair, and storm forward.",
...
const IT_EVANS_DEEP: SublineNarration = {
  intro: {
    say: "Deep in the Evans Gambit, your pawns dominate the board — the broad d4-e4-d5 wedge cramps Black while your pieces eye their king. The gambit pawn is a memory; the lead in space and time is the reality. Keep developing toward the king, open a file with f4 or a rook-lift, and convert the initiative the gambit bought you.",
...
const TK_SCOTCH: SublineNarration = {
  intro: {
    say: "d4 — White swerves into the Scotch, trading the central pawns to free their pieces early. The book equalizer is precise and well worth knowing: after the exchanges, …Qe7 pressures the advanced e5-pawn and …Nd5 plants the knight on a dominant central blockade. You accept doubled c-pawns but gain the bishop pair and rock-solid piece play — a comfortable, fully equal game.",
  ...
  beats: [
    ...
    { atMove: 7, say: "…Nf6 develops with a hit on the e4-pawn, forcing the pace. White usually relieves it by trading on c6 — which only hands you the bishop pair and a half-open b-file aimed at their queenside.", sayShort: "…Nf6 — develop, strike e4.", arrows: [A('f6', 'e4')], highlights: [H('e4', ATK)] },
...
const SC_GORING: SublineNarration = {
  intro: {
    say: "The Göring Gambit — you've fed a pawn to rip the centre open and seize a commanding lead in development. This is attacking chess: Bc4 glares at f7, you castle in a flash, and the open lines pour your rooks toward Black's king before they can untangle. Down a pawn and completely on top — develop with threats and make the initiative pay.",
    sayShort: 'Göring — a pawn for a roaring attack.',
  },
  beats: [
    { atMove: 10, say: "Bc4 — the gambit bishop trains on f7. You're a pawn down with a commanding lead in development; castle, throw the rooks onto the open files, and the lines reach Black's king before they untangle.", sayShort: "Bc4 — eye f7, develop and attack.", arrows: [A('c4', 'f7')], highlights: [H('f7', KEY)] },
  ],
  sources: SC_INIT,
};
...
const SC_NF6_EARLY: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 6, say: "dxe5 clamps the centre; Black regains the pawn with …Nxe4, but the e5-wedge cramps their game while you develop Bc4 and Bd3 toward their king.", sayShort: "dxe5 — clamp the e5-wedge.", arrows: [A('e5', 'f6')], highlights: [H('f6', ATK)] },
...
const SCG_MAIN: SublineNarration = {
  intro: {
    say: "The Scotch Gambit proper — you've given the d-pawn to rush your pieces out and aim the bishop at f7. The e5-pawn jabs the f6-knight and grabs space, Bb5 pins, and your lead in development is the whole point. Castle fast, throw the rooks onto the open files, and pour the attack onto Black's king before they untangle. Down a pawn, fully on top.",
...
const EV_BE7_5: SublineNarration = {
  intro: {
    say: "…Be7 — the passive Hungarian Defence, Black dodging your Italian. Punish the timidity by seizing the centre: d4 and the exchanges on d4 and c6 let you ram e5, clamping the board and cramping Black while your pieces flow toward their king.",
...
const KG_ACC_D5: SublineNarration = {
  intro: {
    say: "…d5 — the Modern Defence, Black handing the pawn straight back to free their game and kill your attack. Accept the deal: take on d5, and you out-develop them in the open position. Material levels out, but Bc4, castling and the half-open f-file leave you a step ahead with the pleasanter game.",
...
const KG_ACC_NE7: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 6, say: "d4 — the broad centre stands. Black strikes back with …d5 to stake their own claim; you simply keep developing toward it.", sayShort: "d4 — full centre, keep rolling.", highlights: [H('d4', KEY)] },
...
const KG_ACC_BE7: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 6, say: "Bc4 aims straight at f7 and clears the back rank for castling. Black develops …Nf6; you follow with d4, Nc3 and Bxf4, regaining the pawn with the freer game and the f-file pointed at their king.", sayShort: "Bc4 — aim f7, then d4.", arrows: [A('c4', 'f7')], highlights: [H('f7', KEY)] },
  ],
  sources: KG,
};
...
const PT_D4: SublineNarration = {
  ...
  beats: [
    { atMove: 9, say: "…Nd7 — challenge White's advanced e5-knight head-on, offering the trade that dissolves all their pressure. Simple, solid, symmetrical: White is left with a position that refuses to give them a target.", sayShort: "…Nd7 — challenge e5, trade off.", highlights: [H('e5', KEY)] },
  ],
  sources: PT_CTR,
};
...
const PT_5NC3: SublineNarration = {
  ...
  beats: [
    { atMove: 9, say: "…Nxc3 — trade the knights; after dxc3 White grabs the bishop pair but saddles themselves with doubled c-pawns. Your structure is the sounder one — develop, castle long, and let the healthy pawns tell.", sayShort: "…Nxc3 — trade, give White doubled pawns.", highlights: [H('c3', KEY)] },
  ],
  sources: PT,
};
...
const SCH_D4: SublineNarration = {
  ...
  beats: [
    { atMove: 6, say: "d4 hits e5 and tries to blow the centre open before you're ready — meet force with force. …fxe4 keeps the lines open and your e4-pawn cramps White's kingside; don't let them consolidate.", sayShort: "d4 — answer …fxe4.", arrows: [A('f5', 'e4')], highlights: [H('e4', KEY)] },
...
const SCH_SCOTCH: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 7, say: "…Nf6 develops with a hit on the e4-pawn, forcing the pace. White usually relieves the pressure by trading on c6 — which only hands you the bishop pair and a half-open b-file pointing at their queenside.", sayShort: "…Nf6 — develop, strike e4.", arrows: [A('f6', 'e4')], highlights: [H('e4', ATK)] },
    ...
    { atMove: 13, say: "…Nd5 lands on the perfect central blockade, screening everything and eyeing f4 and c3. With the bishop pair, the rock on d5 and effortless development, you're fully equal and pleasant to play — White's sidestep gained them nothing.", sayShort: "…Nd5 — the dream blockade.", arrows: [A('d5', 'f4')], highlights: [H('d5', KEY)] },
  ],
  sources: SCH_DEV,
};
...
const COV_RUY_A6: SublineNarration = {
  intro: {
    say: "…a6 — the Morphy Defence, by far Black's most popular try: they put the question to your bishop at once. Retreat to a4, keeping the pin on the a4-e8 diagonal so the c6-knight stays tied down; you castle, play c3 and d4, and steer into the main Closed Ruy with a comfortable, lasting initiative.",
    sayShort: "…a6 — Ba4, hold the pin.",
  },
  beats: [
    { atMove: 6, say: "a6 pokes the bishop — don't surrender the pin. Ba4 keeps the clamp on c6 along the a4-e8 road, so Black can't free their game easily while you prepare c3 and d4.", sayShort: "Ba4 — keep the c6 pin.", arrows: [A('a4', 'c6')], highlights: [H('c6', KEY)] },
  ],
  sources: ['book:ruy-lopez', 'concept:pos-development', 'https://en.wikipedia.org/wiki/Ruy_Lopez'],
};
...
export const COV_FK_ND4: SublineNarration = {
  intro: {
    say: "…Nd4 — the Rubinstein, Black's sharpest Four Knights try: they ignore the hit on c6 and jumps into your camp. The clean reply is Nxd4 exd4, when Black's recaptured pawn lands on d4 as a long-term target and you hold the easier game; if you'd rather keep pieces on, Ba4 or Bc4 also leaves you a small, safe pull. No tricks to fear.",
...
const COV_PT_BC4: SublineNarration = {
  intro: {
    say: "Bc4+ — the Cochrane bite: White checks to justify the knight they sacrificed on f7. Block with …d5 — your f6-knight guards the pawn, the check fizzles, and you simply keep the extra piece. Tuck the king to safety, untangle, and convert; White's two pawns aren't nearly enough for the material.",
...
const COV_PH_RE1: SublineNarration = {
  intro: {
    say: "Re1 — the Philidor main tabiya; White piles on the e-file behind their big centre and you're solid but cramped. Free it with patience: play …c6 and …Qc7 first, then strike with …exd4 and aim for the …d5 break to blow the centre open. Played accurately, the cramp dissolves into a fully sound game.",
...
export const SUBLINE_NARRATION_E4E5: Record<string, SublineNarration> = {
  ...
  'italian-game::2::h6@11': { ...IT_PIANISSIMO, beats: [{ atMove: 11, say: "h6 — a useful luft. Keep building: O-O, Re1, the Nbd2-f1-g3 tour, and prepare d4. The Pianissimo rewards patience; improve every piece and strike the centre when the moment is right.", sayShort: "h6 — build slowly, then d4.", arrows: [A('c4', 'f7')], highlights: [H('d4', KEY)] },
    { atMove: 12, say: "d4 cracks the centre at once; after …exd4 cxd4 you own the broad d4-e4 duo, cramping Black and pointing your pieces at their king.", sayShort: "d4 — claim the full centre.", arrows: [A('d4', 'e5')], highlights: [H('e5', ATK)] },
  ...
  'italian-game::0::a6@7': { ...IT_GP_WAIT, beats: [
    ...
    { atMove: 8, say: "d4 cracks the centre open. Black tucks the bishop to a7, and now the tactical Nxe5 wins a pawn or tears open the e-file toward their king.", sayShort: "d4 — crack it, then Nxe5.", arrows: [A('d4', 'e5')], highlights: [H('e5', ATK)] },
  ...
  'italian-game::0::Qf6@7': { ...IT_GP_WAIT, intro: { say: "…Qf6 brings the queen out early to eye f2 — but it's a target, not a threat. Gain space and tempo: b4 nudges the c5-bishop back, a4 and b5 cramp the queenside, and d4 claims the centre while Black's queen sits awkwardly.", sayShort: "…Qf6 — gain space, b4 and d4." }, beats: [
    ...
    { atMove: 8, say: "b4 hits the bishop and grabs space; a4 and b5 follow to cramp Black, and d4 claims the centre while their queen is misplaced.", sayShort: "b4 — gain space, hit the bishop.", arrows: [A('b4', 'c5')], highlights: [H('c5', ATK)] },
    { atMove: 14, say: "d4 seizes the centre — your space on both wings squeezes Black while the early …Qf6 has cost them coordination. Castle and press the bind.", sayShort: "d4 — seize the centre, squeeze.", arrows: [A('d4', 'e5')], highlights: [H('e5', ATK)] },
  ] },
  ...
  'italian-game::3::Nge7@15': { ...IT_EVANS_DEEP, beats: [{ atMove: 16, say: "Ng5 — the knight pounces at f7, and with Qb3 coming the threats pile up against Black's stranded king before they can castle.", sayShort: "Ng5 — pounce at f7.", arrows: [A('g5', 'f7')], highlights: [H('g5'), H('f7', ATK)] }, { atMove: 18, say: "Qb3 — the queen joins the assault on f7; the battery and the g5-knight overwhelm the defence. This is the Evans initiative at full tilt.", sayShort: "Qb3 — pile on f7.", arrows: [A('b3', 'f7')], highlights: [H('b3'), H('f7', ATK)] }] },
  ...
  'italian-game::5::Nxe4@7': { ...IT_SCOTCH_GAMBIT, beats: [{ atMove: 8, say: "dxe5 — you grab the centre, the e5-pawn cramping Black while their e4-knight must retreat; White's space and lead in development tell.", sayShort: "dxe5 — grab the centre.", highlights: [H('e5')] }, { atMove: 10, say: "Qe2 — the queen eyes the e-file and the c5-knight, keeping Black's pieces awkward; White develops with pressure.", sayShort: "Qe2 — eye the e-file.", highlights: [H('e2')] }] },
  ...
  'two-knights-defence::0::exf6@10': { ...TK_MAXLANGE, beats: [{ atMove: 11, say: "…d3 — you ram the passed pawn deep into White's position, jamming their development; the Dubois Réti hands Black a strong initiative.", sayShort: "…d3 — ram the passer.", highlights: [H('d3')] }, { atMove: 15, say: "…dxc4 — you grab the bishop, banking material in the complications; Black emerges with the better game.", sayShort: "…dxc4 — bank material.", highlights: [H('c4')] }] },
  ...
  'two-knights-defence::3::Nc3@10': { ...TK_MAXLANGE, beats: [{ atMove: 11, say: "…dxc3 — you grab the knight, banking material in the Nakhmanson; White's attack looks fierce but accurate defence leaves Black ahead.", sayShort: "…dxc3 — bank the knight.", highlights: [H('c3')] }, { atMove: 17, say: "…Be7 — you develop, shoring up the king and consolidating; Black's extra material decides if they stay calm.", sayShort: "…Be7 — shore up, consolidate.", highlights: [H('e7')] }] },
  ...
  'four-knights-game::3::Nf6@19': { ...FK_HALLOWEEN, beats: [{ atMove: 20, say: "f5 — the pawn phalanx surges, clamping Black's kingside and freezing their pieces; the Halloween centre keeps the initiative alive.", sayShort: "f5 — surge, clamp.", highlights: [H('f5')] }, { atMove: 22, say: "Nb5 — the knight leaps in, hitting c7 and harrying the king stuck in the centre; your pawns and pieces converge for the piece.", sayShort: "Nb5 — leap in, hit c7.", arrows: [A('b5', 'c7')], highlights: [H('b5'), H('c7', ATK)] }] },
  ...
  'four-knights-game::5::f5@15': { ...FK_ITALIAN_FT, beats: [{ atMove: 16, say: "Bxc6 — you snap the knight, doubling Black's pawns before collecting e5; their overextended f5-push has left the king exposed.", sayShort: "Bxc6 — double his pawns.", highlights: [H('c6')] }, { atMove: 18, say: "Nxe5 — the knight grabs the centre pawn, banking material with the better structure; White stands clearly on top.", sayShort: "Nxe5 — bank the pawn.", highlights: [H('e5')] }] },
  ...
  'scotch-game::5::Nf6@7': { ...SC_STEINITZ_QH4, beats: [
    ...
    { atMove: 9, say: "…bxc6 — Black's queenside pawns are doubled and their structure dented. Now seize the centre by force.", sayShort: "…bxc6 — his pawns are doubled.", arrows: [A('e4', 'e5')], highlights: [H('c6', SOFT), H('e5', KEY)] },
  ...
  'scotch-game::5::Qf6@7': { ...SC_STEINITZ_QH4, beats: [
    ...
    { atMove: 8, say: "Be3 shores up the d4-knight and develops with tempo. Black posts …Bc5; you stand solid with the centre and the better structure, and Black's queen will cost them a tempo to retreat.", sayShort: "Be3 — defend d4, develop.", arrows: [A('e3', 'd4')], highlights: [H('d4', KEY)] },
  ...
  'scotch-game::5::Bc5@9': { ...SC_STEINITZ_QH4, beats: [
    { atMove: 9, say: "…Bc5 develops in the Steinitz raid line, but Black's early queen sortie has left them loose. Your Nb5 already eyes c7 — develop and threaten.", sayShort: "…Bc5 — Nb5 eyes c7.", arrows: [A('b5', 'c7')], highlights: [H('c7', KEY)] },
  ...
  'evans-gambit::0::exd4@11': { ...EV_ATTACK, beats: [{ atMove: 12, say: "O-O — you ignore the pawn and castle, throwing your rook onto the half-open files. The lead in development is the gambit's whole point; speed beats material here.", sayShort: "O-O — castle, lead in development.", highlights: [H('g1')] }, { atMove: 14, say: "Ba3 — the bishop slices to a3, stopping Black from castling and pinning their hopes to an awkward king. With the centre about to roll e5, your attack writes itself.", sayShort: "Ba3 — stop castling, then e5.", arrows: [A('a3', 'f8')], highlights: [H('a3'), H('f8', ATK)] }] },
  'evans-gambit::0::Na5@19': { ...EV_ATTACK, beats: [{ atMove: 20, say: "Bxf7+! — the classic Evans blow. The king is dragged onto f7, stripped of shelter, and your pieces pour in down the open lines for the sacrificed pawn and more.", sayShort: "Bxf7+ — drag the king out.", arrows: [A('f7', 'e8')], highlights: [H('f7', ATK)] }, { atMove: 22, say: "Rd8+ — the rook checks into the open d-file, harrying the exposed king. Black is a pawn up on paper but their king is naked in the centre; that's the trade you wanted.", sayShort: "Rd8+ — harry the open king.", arrows: [A('d8', 'e8')], highlights: [H('d8')] }] },
  ...
  'evans-gambit::4::exd4@11': { ...EV_ATTACK, beats: [{ atMove: 12, say: "O-O — you ignore the pawn and castle, throwing your rook onto the half-open files. The lead in development is the gambit's whole point; speed beats material.", sayShort: "O-O — castle, lead in development.", highlights: [H('g1')] }, { atMove: 14, say: "Ba3 — the bishop slices to a3, stopping Black from castling and pinning their hopes to an awkward king. With e5 about to roll, your attack writes itself.", sayShort: "Ba3 — stop castling, then e5.", arrows: [A('a3', 'f8')], highlights: [H('a3'), H('f8', ATK)] }] },
  ...
  'evans-gambit::5::Nge7@15': { ...EV_ATTACK, beats: [{ atMove: 16, say: "Ng5 — the knight pounces at f7, and with Qb3 coming the threats pile up against Black's stranded king before they can castle.", sayShort: "Ng5 — pounce at f7.", arrows: [A('g5', 'f7')], highlights: [H('g5'), H('f7', ATK)] }, { atMove: 18, say: "Qb3 — the queen joins the assault on f7; the battery and the g5-knight overwhelm the defence. This is the Evans initiative at full tilt.", sayShort: "Qb3 — pile on f7.", arrows: [A('b3', 'f7')], highlights: [H('b3'), H('f7', ATK)] }] },
  'evans-gambit::5::Ne5@17': { ...EV_ATTACK, beats: [{ atMove: 18, say: "Nxe5 — you trade off Black's centralised knight and keep your pawn duo and the open lines; the d5-wedge cramps them badly.", sayShort: "Nxe5 — trade, keep the wedge.", highlights: [H('e5'), H('d5', SOFT)] }, { atMove: 22, say: "Ba3 — the bishop rakes to a3, hitting the e7-knight's shelter and the dark squares while Black scrambles to castle. Pressure everywhere.", sayShort: "Ba3 — rake, pressure the king.", arrows: [A('a3', 'f8')], highlights: [H('a3'), H('f8', ATK)] }] },
  ...
  'evans-gambit::6::Nge7@15': { ...EV_ATTACK, beats: [{ atMove: 16, say: "Ng5 — the knight jumps at f7, the eternal Evans target; Black must lash out, and every pawn break opens lines toward their king.", sayShort: "Ng5 — hit f7, open lines.", arrows: [A('g5', 'f7')], highlights: [H('g5'), H('f7', ATK)] }, { atMove: 22, say: "Qa4+ — the check regains the piece on c4 with interest, leaving you a clear initiative and the powerful d6-pawn deep in Black's camp.", sayShort: "Qa4+ — regain material, press d6.", arrows: [A('a4', 'e8')], highlights: [H('a4')] }] },
  ...
  'kings-gambit::5::d6@9': { ...KG_KIESERITZKY, beats: [
    ...
    { atMove: 10, say: "Nxg4 — a pawn regained and the knight still eyeing f6 and h6. Black challenges it with …Nf6; you welcome the trade that opens their king.", sayShort: "Nxg4 — pawn back, keep pressing.", highlights: [H('g4', SOFT)] },
  ...
  'vienna-game::0::Nc6@9': { ...VN_F4D5, intro: {
    ...
    { atMove: 10, say: "Bb5 pins the c6-knight; Bxc6+ doubles Black's pawns and you castle into a structural edge with the half-open f-file at their king.", sayShort: "Bb5 — pin, double his pawns.", arrows: [A('b5', 'c6')], highlights: [H('c6', KEY)] },
  ] },
  ...
  'petrov-defence::0::c4@12': { ...PT_MAIN, beats: [
    ...
    { atMove: 13, say: "…Bb4+ forces Kf1 — White's king is stuck in the centre and their rooks are disconnected. Develop …Bf5 and castle; the lead in king safety is yours.", sayShort: "…Bb4+ — strip his castling.", arrows: [A('b4', 'e1')], highlights: [H('e1', ATK)] },
  ...
  'petrov-defence::0::Re1@14': { ...PT_MAIN, beats: [
    ...
    { atMove: 19, say: "…Nxc3 trades into doubled White pawns, then …Bxd3 swaps off their attacking bishop. You emerge with the better structure and a comfortable, fully equal game.", sayShort: "…Nxc3 — trade into a better structure.", highlights: [H('c3', SOFT)] },
  ] },
  'petrov-defence::0::Nc3@14': { ...PT_MAIN, beats: [
    ...
    { atMove: 17, say: "…Nxc3 hands White doubled c-pawns; …Bxd3 removes their attacker. Castle, occupy the open files, and the structural edge gives a pleasant, equal game.", sayShort: "…Nxc3 — better structure, equal.", highlights: [H('c3', KEY)] },
  ] },
  'petrov-defence::0::cxd5@16': { ...PT_MAIN, beats: [
    { atMove: 16, say: "cxd5 — White grabs on d5, but it loosens their own pieces. Strike back: …Nxd3 first, removing their strong light-squared bishop with tempo.", sayShort: "cxd5 — answer …Nxd3.", arrows: [A('b4', 'd3')], highlights: [H('d3', ATK)] },
  ...
  'petrov-defence::1::Nd2@12': { ...PT_D4, beats: [
    ...
    { atMove: 13, say: "…Qh4 lunges in, pressuring f2 and forcing White to mind their king before consolidating. The Petrov turns active — your queen sets the pace.", sayShort: "…Qh4 — pressure f2.", arrows: [A('h4', 'f2')], highlights: [H('f2', ATK)] },
  ...
  'petrov-defence::3::Bd3@10': { ...PT_COCHRANE, intro: { say: "The Cochrane Gambit — White flung a knight onto f7 to drag your king into the open. It is completely sound for you: you're a full piece up for a pawn, and the whole game is one idea — get the king safe and the extra material wins itself. Untangle with …Re8, walk the king to g8, and don't grab, don't panic.", sayShort: 'Cochrane — …Re8, king to g8.' }, beats: [{ atMove: 10, say: "Bd3 eyes your king down the b1-h7 diagonal, but you're a whole piece up — the bishop barks, it cannot bite. Don't grab and don't panic: tuck the rook to e8 and walk the king to g8, and the extra piece simply wins.", sayShort: "Bd3 — …Re8, king to g8.", arrows: [A('f7', 'g8')], highlights: [H('g8', KEY)] }] },
  'petrov-defence::3::Bd3@12': { ...PT_COCHRANE, beats: [{ atMove: 13, say: "…Kg8 — you tuck the king to safety by hand; a piece up for two pawns, your job is simply to consolidate and convert the Cochrane material.", sayShort: "…Kg8 — tuck the king, consolidate.", highlights: [H('g8')] }, { atMove: 15, say: "…Nc6 — you develop and bolster the centre; with the extra piece and the king tucked away, Black is winning if they stay solid.", sayShort: "…Nc6 — develop, stay solid.", highlights: [H('c6')] }] },
  ...
  'petrov-defence::5::c4@12': { ...PT_MAIN, beats: [{ atMove: 13, say: "…Bb4+ — a check that develops with tempo, disrupting White before they coordinate; the Petrov's active setup keeps Black equal.", sayShort: "…Bb4+ — disrupt, develop.", arrows: [A('b4', 'e1')], highlights: [H('b4')] }, { atMove: 17, say: "…Bf5 — the bishop develops to an active post, supporting the strong e4-knight; Black is fully equal with harmonious pieces.", sayShort: "…Bf5 — support the knight.", highlights: [H('f5')] }] },
  ...
  'schliemann-defence::0::Bxc6@8': { ...SCH_SHARP, beats: [
    ...
    { atMove: 9, say: "…dxc6 opens the d-file for your rook and frees the light bishop, which now rakes the long diagonal all the way to White's kingside. The e4-pawn jams them, the bishop pair is yours — White won a bishop but handed you the initiative.", sayShort: "…dxc6 — bishop pair, e-pawn cramps.", arrows: [A('c8', 'g4')], highlights: [H('e4', KEY), H('c6', SOFT)] },
  ] },
  'schliemann-defence::1::Bc4@4': SCH_ITALIAN,
  'schliemann-defence::1::d4@4': SCH_SCOTCH,
  'schliemann-defence::1::Nc3@4': SCH_FOUR_KNIGHTS,
  'schliemann-defence::1::Ng1@10': { ...SCH_SHARP, beats: [{ atMove: 11, say: "…e3 — you ram the pawn deeper, jamming White's development and cramping their king; the Jaenisch's initiative is the compensation for the pawn.", sayShort: "…e3 — ram the wedge.", highlights: [H('e3')] }, { atMove: 19, say: "…Ne5 — the knight leaps to a dominant central post after the trades, hitting White's loose pieces; Black's activity holds the balance.", sayShort: "…Ne5 — dominant post.", highlights: [H('e5')] }] },
  'schliemann-defence::1::Nc3@6': SCH_NC3,
  'schliemann-defence::1::d3@10': { ...SCH_SHARP, beats: [{ atMove: 11, say: "…e3 — you ram the pawn deep into White's position, jamming their development; the Jaenisch Gambit's initiative answers the pawn.", sayShort: "…e3 — ram the wedge.", highlights: [H('e3')] }, { atMove: 21, say: "…Bd6 — the bishop develops actively, eyeing the kingside; with the bishop pair from the doubled c-pawns, Black's pieces hold the balance.", sayShort: "…Bd6 — develop actively.", highlights: [H('d6')] }] },
  ...
  'danish-gambit::0::Be6@15': { ...DAN_BB4, beats: [
    ...
    { atMove: 17, say: "…fxe6 leaves Black's kingside pawns shattered and the f-file half-open at their king. Pile your rook onto f-file, hit b7 with the queen, and the gambit's initiative rolls on.", sayShort: "…fxe6 — shattered king, open f-file.", highlights: [H('e6', SOFT), H('b7', SOFT)] },
  ] },
  ...
  'stafford-gambit::0::h3@10': { ...STAF_ACCEPTED, beats: [{ atMove: 11, say: "…Nxe4 — the Stafford's signature blow. You snatch the pawn back with tempo and rip open the centre; when White recaptures, the f2-fork is waiting.", sayShort: "…Nxe4 — regain the pawn, open lines.", highlights: [H('e4')] }, { atMove: 13, say: "…Bxf2+ — the point. The check drags White's king onto e2, where it will never feel safe. You are down material, but a king stuck in the centre is the Stafford's whole bet.", sayShort: "…Bxf2+ — drag the king out.", highlights: [H('f2')] }, { atMove: 15, say: "…Qh4 — the queen piles in on the stranded king. Be honest: you are worse on material, but this is the trap you signed up for — make White defend a naked king and find every only-move.", sayShort: "…Qh4 — hunt the exposed king.", highlights: [H('e2')] }] },
  ...
  'marshall-attack::0::exd5@16': { ...MAR_MAIN, beats: [
    ...
    { atMove: 21, say: "…Nf6 redevelops with tempo, eyeing e4 and g4 and clearing d5. The pieces gather now: …Bd6, …Qh4 and …Bb7 swing at White's king while they cling to the pawn.", sayShort: "…Nf6 — regroup, gather the attack.", arrows: [A('f6', 'g4')], highlights: [H('g4', KEY)] },
