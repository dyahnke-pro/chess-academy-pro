...
export const SUBLINE_NARRATION_E4E5: Record<string, SublineNarration> = {
  ...
  'four-knights-game::5::Bc5@13': { ...FK_ITALIAN_FT, beats: [{ atMove: 13, say: "Bc5 develops in the symmetrical fork-trick line. There's no attack here — just a quiet, even game where your slightly freer pieces nag. Castle, post a rook on e1, and press the e-file. The win, if it comes, is squeezed from small edges.", sayShort: "Bc5 — castle, press the e-file.", highlights: [H('e4', KEY)] }] },
  ...
  'four-knights-game::5::Bd7@13': { ...FK_ITALIAN_FT, beats: [{ atMove: 13, say: "Bd7 develops quietly. The fork-trick line is near-symmetrical and level; castle, line a rook on e1, and the slightly freer pieces give a nagging pull. There's nothing to force — out-manoeuvre from the marginally better coordination.", sayShort: "Bd7 — castle, squeeze the e-file.", highlights: [H('e4', KEY)] }] },
  ...
  'vienna-game::2::Nxe4@5': { ...VN_FRANKENSTEIN, beats: [{ atMove: 9, say: "Be7 — the main Frankenstein-Dracula tabiya. Your queen barges on h5, Bb3 keeps the bishop alive, and Nb5 leaps at c7, ripping into Black's queenside. Theory calls it balanced, but the practical pressure is enormous — keep hurling pieces at the king.", sayShort: "Be7 — Nb5 at c7, keep attacking.", arrows: [A('c3', 'b5')], highlights: [H('c7', KEY)] }] },
  ...
  'vienna-game::4::Nge7@11': { ...VN_HAMPPE, beats: [{ atMove: 11, say: "Nge7 develops to bolster the kingside. Press: h4 cracks g5, O-O and the f-file build, and Bxf4 recovers the pawn with the initiative. Your d4-centre and the bishop on f7 dominate — open lines and attack the king.", sayShort: "Nge7 — h4 and Bxf4, press.", arrows: [A('c4', 'f7')], highlights: [H('f4', KEY)] }] },
