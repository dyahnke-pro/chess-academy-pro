...
const FK_G6: SublineNarration = {
  ...
  beats: [
    { atMove: 8, say: "Nxd4 — you've claimed the full classical centre against Black's fianchetto. The knight dominates from d4 and the e4-pawn cramps Black's whole kingside; with more space and faster development, you set the agenda while the fianchettoed bishop stares at your solid centre.", arrows: [A('d4', 'c6')], highlights: [H('d4', KEY), H('e4', SOFT)] },
  ],
  sources: FK_CTR,
};
...
const MAR_ANTI: SublineNarration = {
  ...
  beats: [
    { atMove: 14, say: "White slips in a4 or h3 to dodge your Marshall — no matter. Bb7 aims the bishop at e4 down the long diagonal, and you slide into sound Zaitsev-style structures with comfortable equality.", sayShort: "Anti-Marshall — …Bb7 eyes e4.", highlights: [H('e4', KEY)] },
  ],
  sources: MAR_DEV,
};
