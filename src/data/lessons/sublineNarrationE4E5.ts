...
const EV_BE7_5: SublineNarration = {
  ...
  beats: [
    ...
    { atMove: 18, say: "Bd3 trains the bishop on h7 and Black's king, completing a harmonious setup with the extra central space. Castle and press a pleasant, lasting initiative for the better structure.", sayShort: "Bd3 — aim h7, press the space.", arrows: [A('d3', 'h7')], highlights: [H('h7', ATK)] },
  ],
  sources: EV_CTR,
};
...
export const SUBLINE_NARRATION_E4E5: Record<string, SublineNarration> = {
  ...
  'evans-gambit::3::Bb6@7': { ...EV_BB6_QUIET, beats: [{ atMove: 8, say: "a4 — declining the pawn lets you turn the tempo into a queenside lunge. a4 threatens a5, chasing the a7-bishop and prising open lines before Black is settled.", sayShort: "a4 — lunge, threaten a5.", arrows: [A('a4', 'a5')], highlights: [H('a4'), H('b6', SOFT)] }, { atMove: 14, say: "d4 — now the centre rolls. You've gained space on both wings; the broad pawns and freer pieces give the easier game without ever risking material.", sayShort: "d4 — roll the centre, easier game.", highlights: [H('d4'), H('e4', SOFT)] }] },
  ...
  'evans-gambit::4::Bb6@7': { ...EV_BB6_QUIET, beats: [{ atMove: 8, say: "a4 — declining the pawn lets you turn the tempo into a queenside lunge. a4 threatens a5, chasing the a7-bishop and prising open lines before Black is settled.", sayShort: "a4 — lunge, threaten a5.", arrows: [A('a4', 'a5')], highlights: [H('a4'), H('b6', SOFT)] }, { atMove: 14, say: "d4 — now the centre rolls. You've gained space on both wings; the broad pawns and freer pieces give the easier game without ever risking material.", sayShort: "d4 — roll the centre, easier game.", highlights: [H('d4'), H('e4', SOFT)] }] },
  ...
  'evans-gambit::6::Bb6@7': { ...EV_BB6_QUIET, beats: [{ atMove: 8, say: "a4 — declining the pawn lets you turn the tempo into a queenside lunge. a4 threatens a5, chasing the a7-bishop and prising open lines before Black is settled.", sayShort: "a4 — lunge, threaten a5.", arrows: [A('a4', 'a5')], highlights: [H('a4'), H('b6', SOFT)] }, { atMove: 14, say: "d4 — now the centre rolls. You've gained space on both wings; the broad pawns and freer pieces give the easier game without ever risking material.", sayShort: "d4 — roll the centre, easier game.", highlights: [H('d4'), H('e4', SOFT)] }] },
  ...
  'evans-gambit::7::Bb6@7': { ...EV_BB6_QUIET, beats: [{ atMove: 8, say: "a4 — declining the pawn lets you turn the tempo into a queenside lunge. a4 threatens a5, chasing the a7-bishop and prising open lines before Black is settled.", sayShort: "a4 — lunge, threaten a5.", arrows: [A('a4', 'a5')], highlights: [H('a4'), H('b6', SOFT)] }, { atMove: 14, say: "d4 — now the centre rolls. You've gained space on both wings; the broad pawns and freer pieces give the easier game without ever risking material.", sayShort: "d4 — roll the centre, easier game.", highlights: [H('d4'), H('e4', SOFT)] }] },
  ...
  'vienna-game::0::Bc5@9': { ...VN_F4D5, beats: [
    ...
    { atMove: 14, say: "d4 stakes out the centre and shuts the c5-bishop out of the game; Bd2 and Bd3 follow, and the half-open f-file remains your rook's highway.", sayShort: "d4 — seize the centre.", arrows: [A('d2', 'd4')], highlights: [H('d4', KEY)] },
  ...
  'vienna-game::0::f5@11': { ...VN_F4D5, beats: [
    ...
    { atMove: 16, say: "d3 challenges the e4-knight; after the trade your bishop on g2 rakes the long diagonal and the weakened light squares around Black's king are permanent targets.", sayShort: "d3 — hit e4, target light squares.", highlights: [H('e4', KEY)] },
  ] },
