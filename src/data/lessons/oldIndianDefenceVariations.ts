...
export const OLD_INDIAN_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'old-indian-defence::Old Indian: Czech Variation': {
    ...
    beats: [
      ...
      b({ id: 'c4', moves: 'd4 Nf6 c4 d6 Nc3 Nbd7 e4 e5 Nf3 Be7 Be2 O-O O-O c6 Re1 Qc7 Bf1 Re8 d5 c5', say: "White locks the centre with d5, and …c5! fixes the Czech-Benoni structure: a closed centre where Black plays for …Ne8–g7–f5 or the …f5 break and dark-square play. There is the Czech tabiya — be clear-eyed about it: White's extra space gives a genuine pull and Black is objectively worse — clearly so, close to a pawn's pull — but the structure is rock-solid and hard to crack, a fortress you hold for the draw. The flexible …Nc5 of the main line is the objectively better try; take the Czech lock only as a low-risk, solid defence, never as a claim to equality.", sayShort: '…c5 — locks it; solid but clearly worse.', highlights: [H('c5'), H('d5', SOFT)] }),
    ],
  },
  ...
  'old-indian-defence::Old Indian: Be2 Development': {
    ...
    beats: [
      ...
      b({ id: 'e4', moves: 'd4 Nf6 c4 d6 Nc3 Nbd7 e4 e5 Nf3 Be7 Be2 O-O O-O c6 Qc2 Re8 Rd1 Bf8 d5 c5', say: "White closes with d5, and …c5! locks the centre into the typical Old-Indian/Benoni structure. There is the Be2 tabiya: a closed centre with a future …Nc5 outpost and …f5 break for Black. Be honest about the balance — White's space gives a real, lasting pull and Black is clearly worse — close to a pawn's worth — but the position is sound and resilient, a fortress with clear, patient plans. The main line's flexible …Nc5 is objectively the better try; the Old Indian's bargain here is plain — clearly worse, but tough and easy to hold for the draw.", sayShort: '…c5 — locks it; sound but clearly worse.', highlights: [H('c5'), H('d5', SOFT)] }),
    ],
  },
};
