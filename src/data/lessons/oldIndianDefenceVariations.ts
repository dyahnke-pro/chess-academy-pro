...
export const OLD_INDIAN_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'old-indian-defence::Old Indian: Be2 Development': {
    ...
    beats: [
      b({ id: 'e1', moves: 'd4 Nf6 c4 d6 Nc3 Nbd7 e4 e5 Nf3 Be7 Be2 O-O', say: "Against White's classical Be2 and Qc2 development, Black sets up the same reliable Old Indian foothold: …d6, …Nbd7, …e5, …Be7, castle. Solidity first; the plan crystallises once White shows how they handle the centre.", sayShort: '…O-O — the reliable foothold.', highlights: [H('e5')] }),
