...
export const NIMZO_INDIAN_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'nimzo-indian::Rubinstein System (4.e3)': {
    ...
    beats: [
      ...
      b({ id: 'ru3', moves: 'd4 Nf6 c4 e6 Nc3 Bb4 e3 O-O Bd3 d5 Nf3 c5 O-O dxc4 Bxc4 Nbd7 Qe2 b6 Rd1 Bb7', say: "Both castle; Black clarifies with …dxc4 and fianchettoes …b6 and …Bb7, the light bishop raking the long diagonal at e4 and White's king. Every black piece has a job — the b7-bishop, the b4-bishop, the knights — all bearing on the centre and the light squares.", sayShort: '…Bb7 — the bishop rakes the long diagonal.', arrows: [A('b7', 'e4', SOFT)], highlights: [H('e4')] }),
