...
export const PRO_SAMAYRAINA_KINGS_GAMBIT_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'd4', moves: 'e4 e5 f4 exf4 Bc4 Nf6 Nc3 d6 d4',
      ...
      say: "We bring out the knight to c3 and seize the big centre with d4. The gambit pawn is temporary; the lead in development and the broad pawn centre are the real compensation this repertoire is after.",
    ...
    b({ id: 'bxf4', moves: 'e4 e5 f4 exf4 Bc4 Nf6 Nc3 d6 d4 Nc6 Bxf4 Bg4 Nf3',
      ...
      say: "We recapture with Bxf4, and now every white piece is active with the centre firmly ours. From here this repertoire castles long and storms the kingside — the King's Gambit dream made real.",
