...
export const PRO_SAMAYRAINA_KINGS_GAMBIT_LESSON: LessonScript = {
  openingId: 'pro-samayraina-kings-gambit', title: "This repertoire's King's Gambit — the Bishop's Gambit", minutes: 8,
  ...
  beats: [
    b({ id: 'f4', moves: 'e4 e5 f4',
      ...
      say: "The King's Gambit — This repertoire's wildest weapon, 800-plus games. f4 offers a pawn to tear open the f-file and seize the centre. This is the most romantic, attacking opening in chess, and he plays it for the king-hunt.",
    ...
    b({ id: 'bc4', moves: 'e4 e5 f4 exf4 Bc4',
      ...
      say: "Black grabs with exf4 and this repertoire chooses the Bishop's Gambit — Bc4, training the bishop straight at f7 and developing fast instead of rushing to win the pawn back. Speed and the attack come first.",
    ...
    b({ id: 'd4', moves: 'e4 e5 f4 exf4 Bc4 Nf6 Nc3 d6 d4',
      ...
      say: "You bring out the knight to c3 and seize the big centre with d4. The gambit pawn is temporary; the lead in development and the broad pawn centre are the real compensation this repertoire is after.",
    ...
    b({ id: 'bxf4', moves: 'e4 e5 f4 exf4 Bc4 Nf6 Nc3 d6 d4 Nc6 Bxf4 Bg4 Nf3',
      ...
      say: "You recapture with Bxf4, and now every white piece is active with the centre firmly yours. From here this repertoire castles long and storms the kingside — the King's Gambit dream made real.",
    ...
    b({ id: 'plan', moves: 'e4 e5 f4 exf4 Bc4 Nf6 Nc3 d6 d4 Nc6 Bxf4 Bg4 Nf3',
      ...
      say: "The plan: castle queenside, roll the central pawns with d5 and e5, and hurl the kingside pawns at Black's king. Sharp, double-edged, and exactly the chaos where this repertoire's tactics shine.",
