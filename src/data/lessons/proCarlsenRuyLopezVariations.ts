...
const ITALIAN: LessonScript = {
  ...
  beats: [
    b({ id: 'bc4', moves: 'e4 e5 Nf3 Nc6 Bc4', arrows: [A('c4', 'f7')], highlights: [H('f7')], say: "This repertoire's other great e5 weapon — the Italian. The bishop goes to c4 and trains on f7, the most vulnerable square in Black's camp. Where the Ruy pressures c6, the Italian aims straight at the king's doorstep.", sayShort: 'Bc4 — point at f7.' }),
    b({ id: 'd3', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 d3 Bc5 O-O d6 c3', highlights: [H('d3'), H('c3')], say: "The modern Giuoco Pianissimo — the 'very quiet game'. White plays the restrained d3 and prepares c3 and d4 at their own pace. No early clashes; just a slow build where the better-coordinated side eventually breaks through. This repertoire's favourite way to play for a win without risk.", sayShort: 'd3, c3 — the quiet build.' }),
    b({ id: 'a5', moves: 'e4 e5 Nf3 Nc6 Bc4 Nf6 d3 Bc5 O-O d6 c3 a5', highlights: [H('a5'), H('d4')], say: "Black grabs queenside space with a5 to stop White's b4, and the position settles into a long manoeuvring game. White will prepare d4 to open the centre when their pieces are best placed. A rich, almost symmetrical fight that rewards the deeper understanding — This repertoire's home turf.", sayShort: 'a5 — both sides manoeuvre, d4 looms.' }),
  ],
};
...
const BERLIN: LessonScript = {
  ...
  beats: [
    b({ id: 'd3', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 d3', highlights: [H('d3')], say: "Against the rock-solid Berlin, this repertoire sidesteps the famous drawish endgame with the quiet d3 — the Anti-Berlin. He keeps the queens on and the pieces flexible, steering toward a slow middlegame where his technique can grind rather than a forced simplification.", sayShort: 'd3 — dodge the Berlin endgame.' }),
    b({ id: 'bxc6', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 d3 Bc5 Bxc6 dxc6', arrows: [A('b5', 'c6')], highlights: [H('c6')], say: "The structural idea: Bxc6 trades the bishop for the knight and saddles Black with doubled c-pawns. White concedes the bishop pair but gets the healthier majority and a simple, durable plan — a typical this repertoire long-term trade of one small thing for another.", sayShort: 'Bxc6 — double the c-pawns.' }),
    b({ id: 'oo', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 d3 Bc5 Bxc6 dxc6 O-O Nd7 c3', highlights: [H('c3'), H('e5')], say: "White castles and plays c3, preparing to challenge the centre and reach a queenside pawn-majority endgame where the doubled c-pawns tell. It's a tiny, nagging edge — the kind this repertoire converts more often than anyone alive.", sayShort: 'c3 — head for the better endgame.' }),
  ],
};
...
const PETROV: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'c4', moves: 'e4 e5 Nf3 Nf6 Nxe5 d6 Nf3 Nxe4 d4 d5 Bd3 Bd6 O-O O-O c4 c6 Re1', arrows: [A('e1', 'e4')], highlights: [H('c4')], say: "c4 strikes at Black's d5-pawn to open lines, and Re1 takes the half-open e-file. White generates the only imbalance available against the Petrov — a touch more activity — and from there it's pure this repertoire technique.", sayShort: 'c4, Re1 — pry it open.' }),
  ],
};
...
const FOUR_KNIGHTS: LessonScript = {
  ...
  beats: [
    b({ id: 'nc3', moves: 'e4 e5 Nf3 Nc6 Nc3 Nf6 d4', highlights: [H('d4')], say: "The Scotch Four Knights — all four knights out, then d4 to open the centre. A classical, principled way to play for a small, durable pull. This repertoire uses it to steer the game into clean structures where his technique outweighs his opponent's preparation.", sayShort: 'd4 — classical central break.' }),
