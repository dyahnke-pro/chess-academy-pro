...
export const PRO_CARUANA_ITALIAN_LESSON: LessonScript = {
  ...
  title: "This repertoire's Italian Game",
  minutes: 10,
  orientation: 'white',
  kind: 'variation',
  sources: SRC,
  beats: [
    b({ id: 'bc4', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5', say: "The Italian Game — Bc4 develops the bishop to its most natural diagonal, eyeing f7. Black mirrors with Bc5. This is the modern main line at the top, and this repertoire plays it as a slow, deep strategic battle.", sayShort: 'Bc4 — the Italian bishop.', arrows: [A('f1', 'c4')], highlights: [H('c4')] }),
    ...
    b({ id: 'a4', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d3 d6 O-O O-O Re1 a6 a4', say: "This repertoire brings the rook to e1 to back the centre, then grabs queenside space with a4, restraining Black's b5. Small, precise improving moves — the modern Italian is a maneuvering game.", sayShort: 'Re1, a4 — centralise, gain space.', arrows: [A('a2', 'a4')], highlights: [H('a4')] }),
    b({ id: 'nbd2', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d3 d6 O-O O-O Re1 a6 a4 Ba7 Nbd2 Be6', say: "Black tucks the bishop to a7; this repertoire reroutes the knight via d2 toward f1 and g3, and Black offers a trade with Be6. The position is a fully-developed Pianissimo where the better-coordinated side presses.", sayShort: 'Nbd2 — reroute the knight.', arrows: [A('b1', 'd2')], highlights: [H('d2')] }),
    b({ id: 'bxe6', moves: 'e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d3 d6 O-O O-O Re1 a6 a4 Ba7 Nbd2 Be6 Bxe6 fxe6', say: "This repertoire takes on e6, and Black must recapture with the f-pawn — saddling themselves with a weak, isolated e6-pawn and a slightly loosened king. White trades into a clean structural edge and presses the weakness, the textbook this repertoire grind.", sayShort: 'Bxe6 — give Black a weak e6-pawn.', arrows: [A('c4', 'e6')], highlights: [H('e6')] }),
  ],
};
