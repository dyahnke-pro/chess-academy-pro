...
const G5_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'bud-g5-2', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Bf4 g5 Bg3 Bg7 Nf3 Nc6 h4',
      say: "Nf3 develops, and after Nc6 you strike at the root of the weakness with h4 — attacking the g5-pawn head-on. The whole g5 adventure is backfiring: Black's kingside is coming apart at the seams and their king has nowhere safe to shelter.",
    ...
    b({ id: 'bud-g5-3', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Bf4 g5 Bg3 Bg7 Nf3 Nc6 h4 Ngxe5 Nxe5 Nxe5 Nc3',
      say: "Black regains the pawn — Ngxe5 — and after the trades a knight lands on e5. Material is level again, but look at the wreckage: Black's kingside pawns are loose, their king is exposed, and you develop Nc3 with a raking initiative. The pawn came back; the weaknesses are forever.",
