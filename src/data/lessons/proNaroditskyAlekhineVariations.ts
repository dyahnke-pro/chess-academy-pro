...
const NC3_TWO_KNIGHTS: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "White pins with Bb5, the Spanish idea — and here is his actual answer, played in 103 of his 132 games at this position: Nd4, the Rubinstein. Instead of suffering the pin, the knight jumps INTO the centre and asks the bishop what it is doing. Trade on d4 and we recapture toward the middle; retreat and we have gained time. The pin never happens.",
    ...
    b({
      ...
      say: "The bishop steps to c4 rather than trade, and we develop classically around our centralized knight — bishop to c5, pawn to d6 propping e5. White spends a move on h3, and notice the ledger: our knight has stood proudly on d4 for three moves and White still has not dislodged it.",
...
const C4_MODERN: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "White develops the bishop to d3, and we castle — immediately. His corpus is nearly unanimous here: sixty of sixty-one games tuck the king away before anything else. King safety first; the pressure on White's stretched pawns comes after, from a position that can never be caught in the centre.",
...
const NF3_QUIET: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "White develops Be2, and we play the key Alekhine move — Bf5, getting the light-squared bishop OUTSIDE the pawn chain before we ever play e6. This is what makes the Alekhine pleasant: unlike the Caro or French, our light bishop never gets buried. It stands active on f5 while we finish the wall behind it.",
    ...
    b({
      ...
      say: "White expands with c4 and resolves the centre, and we recapture with the C-pawn — keeping the wall compact and the c-file half-open for our rook. Now the honest accounting: the engine leans White in this sideline, most of a pawn with best play. His corpus answer is seventeen wins to eight — the structure holds, and the coming a5-a4 march gives real counterplay. Know the toll, play the position; that is what a fighting sideline is.",
