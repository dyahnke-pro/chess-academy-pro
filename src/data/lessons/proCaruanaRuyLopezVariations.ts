...
const MORPHY_CLOSED: LessonScript = {
  ...
  beats: [
    b({ id: 'ba4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4', say: "When Black plays a6, this repertoire retreats the bishop to a4, keeping the pin on the long diagonal. This is the Closed Ruy — the deepest, richest battleground in all of chess, where this repertoire's preparation is unmatched.", sayShort: 'Ba4 — keep the pin.', arrows: [A('b5', 'a4')], highlights: [H('a4')] }),
...
const BERLIN_ENDGAME: LessonScript = {
  ...
  beats: [
    b({ id: 'oo', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O', say: "Against the Berlin, this repertoire castles and invites the famous endgame. He has defended and attacked this structure at the very top, including the World Championship — nobody understands it more deeply.", sayShort: 'O-O — invite the Berlin.', arrows: [A('f1', 'g1')], highlights: [H('g1')] }),
    ...
    b({ id: 'g4', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8 h3 Bd7 Rd1 Kc8 g4 Ne7 Ng5 Be8', say: "This repertoire expands with g4, gaining kingside space and harassing the f5-knight back to e7. The knight jumps to g5 to pressure f7 and e6. White slowly converts the structural edge — the patient Berlin grind that is this repertoire's trademark.", sayShort: 'g4 — gain space, press.', arrows: [A('g2', 'g4')], highlights: [H('g4')] }),
  ],
};
...
const OPEN_RUY: LessonScript = {
  ...
  beats: [
    b({ id: 'nxe4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4', say: "In the Open Ruy, Black snatches the e4-pawn right after castling. It is the most concrete, forcing way to meet the Spanish — and this repertoire meets concrete with concrete.", sayShort: 'Nxe4 — the Open Ruy.', highlights: [H('e4')] }),
    ...
    b({ id: 'nbd2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4 d4 b5 Bb3 d5 dxe5 Be6 Nbd2 Nc5 c3 Be7', say: "This repertoire brings the queen's knight to d2 to challenge the strong central knight, Black retreats to c5 to hit the b3-bishop, and c3 shores up the centre while Black completes development. A rich, dynamically balanced middlegame.", sayShort: 'Nbd2 — challenge the centre.', arrows: [A('b1', 'd2')], highlights: [H('d2')] }),
    ...
    b({ id: 'mid', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4 d4 b5 Bb3 d5 dxe5 Be6 Nbd2 Nc5 c3 Be7 Bc2 d4 Nb3 d3', say: "Black grabs space with d4 and pushes d3 to jam White's queenside, but the advanced pawn becomes a long-term weakness. White rounds it up with patient play — the structural battle the Open Ruy always comes down to, where this repertoire's technique shines.", sayShort: 'd3 — a long-term weakness.', highlights: [H('d3')] }),
  ],
};
