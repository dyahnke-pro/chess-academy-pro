...
export const PRO_HIKARU_PIRC_MODERN_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'b5', moves: 'e4 g6 d4 Bg7 Nc3 a6 Be3 b5', arrows: [A('b7', 'b5')], highlights: [H('b5')], say: "And the signature: …b5. Black expands on the queenside, gaining space and eyeing …b4 to kick White's knight. This Modern/hippo hybrid keeps the position fluid and full of winning chances — exactly what Hikaru wants.", sayShort: '…b5 — queenside space, kick the knight.' }),
