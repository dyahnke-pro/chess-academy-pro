...
export const PRO_HIKARU_PIRC_MODERN_LESSON: LessonScript = {
  ...
  sources: SRC,
  beats: [
    b({ id: 'g6', moves: 'e4 g6', highlights: [H('g6')], say: "This repertoire plays ...g6 against almost everything — their #1 weapon as Black, scoring over 86% even against fellow grandmasters. Their own reason: you reach the same positions every game, so you understand them better than your opponent ever will.", sayShort: '…g6 — same positions, deeper feel.' }),
    b({ id: 'bg7', moves: 'e4 g6 d4 Bg7 Nc3 a6', arrows: [A('f8', 'g7')], highlights: [H('g7')], say: "The bishop fianchettoes to g7 and Black plays the flexible …a6. You give White the big centre on purpose — a big centre is also a big target — and prepare to undermine it from the wings.", sayShort: '…Bg7, …a6 — flexible, give the centre.' }),
