...
export const GEM_NARRATION: Record<string, GemNarration> = {
  // Najdorf 6.Be3 ...Ng4 tab + Fischer-Sozin tab + Kalashnikov tab — hand-curated 2026-07-16.
  'sicilian-najdorf:e4_c5_Nf3_d6_d4_cxd4_Nxd4_Nf6_Nc3_a6_Be3_Ng4_Bg5_h6_Bh4_g5_Bg3_Bg7_Be2_h5:f3': {
    sources: ["concept:tac-fork", "concept:pos-weak-squares", "https://en.wikipedia.org/wiki/Sicilian_Defence,_Najdorf_Variation"],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "…h5 — the kingside pawns keep rolling and the g3-bishop starts running out of air. White's best is the Nf5 pawn sacrifice, trading material for activity.",
      "f3? — White finally asks the g4-knight to leave. But the pawn just stepped past e3, and the knight knows exactly where to go.",
      "…Ne3! — the octopus lands. It forks the d1-queen and c2, and nothing can take it: the f-pawn walked by one move ago.",
      "Qd3 — the queen sidesteps, still holding c2.",
      "…Bxd4! — the g7-bishop wins the knight outright. The queen can't recapture: Nxc2 would fork king and queen from the other side.",
      "Nd1 — White scrambles to trade off the monster on e3.",
      "…Qb6 — the queen backs the d4-bishop and leans on b2. Every Black piece pulls in the same direction.",
      "Nxe3 — the octopus is finally removed—",
    ...
    learn: [
      ...
      "",
      "",
      "h5 — squeeze the bishop",
      "",
      "Ne3 — the octopus fork",
      "",
      "Bxd4 — win the knight",
      "",
      "Qb6 — pile on",
  ...
  'sicilian-najdorf:e4_c5_Nf3_d6_d4_cxd4_Nxd4_Nf6_Nc3_a6_Bc4_e6_Bb3_b5_O-O_Be7_Qf3_Qc7:e5': {
    sources: ["concept:tac-zwischen", "concept:pos-development", "concept:pos-initiative", "https://en.wikipedia.org/wiki/Sicilian_Defence,_Najdorf_Variation"],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "…Qc7 — the queen settles on the Sicilian's favourite square, watching e5 and the c-file alike. White's main plan is Qg3, pressing d6 and g7.",
      "e5? — the space grab looks aggressive, but it opens the long light diagonal toward White's own queen — and Black's light-squared bishop was born for that diagonal.",
      "…Bb7! — developed with a threat: the bishop stares straight through the vacated e4-square at the f3-queen.",
      "exd6 — the sting in White's idea: the pawn forks the c7-queen and the e7-bishop, so the f3-queen can't be touched yet.",
      "…Bxd6 — the bishop swallows the pawn, kills the fork, and lands on its best attacking diagonal. The queen on f3 is still under fire.",
      "Qh3 — the queen finally runs, a full tempo spent.",
      "…Nc6 — another piece out, another lean on the d4-knight.",
      "Nce2 — White props up d4.",
    ...
    learn: [
      ...
      "",
      "",
      "Qc7 — the Sicilian post",
      "",
      "Bb7 — hit the queen",
      "",
      "Bxd6 — take, kill the fork",
      "",
      "Nc6 — develop, lean on d4",
      "",
      "Nxd4 — trade a defender",
      "",
      "O-O — castle, bishops rule",
      "",
    ],
  },
  'sicilian-sveshnikov:e4_c5_Nf3_Nc6_d4_cxd4_Nxd4_e5_Nb5_d6_N1c3_a6_Na3_b5_Nd5_Nf6_c4_b4:Nxb4': {
    sources: ["concept:tac-fork", "concept:tac-trap", "https://en.wikipedia.org/wiki/Sicilian_Defence#Kalashnikov_Variation"],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "…b4 — the pawn stabs at the a3-knight and asks White's pieces to justify themselves. The mandatory move is Nc2 — eight in ten games find it.",
      "Nxb4? — the d5-knight grabs the pawn and steps straight into a net.",
      "…Qa5! — the queen joins the c6-knight against b4: attacked twice, defended by nothing, the knight is caught.",
      "Bd2 — the bishop stretches along the diagonal to hold b4.",
      "…Nxb4 — Black takes anyway: two attackers beat one defender, and if the bishop recaptures, Qxb4 comes with check.",
      "Nc2 — White declines to recapture and tries to evict the intruder instead.",
      "…Nxc2+ — the knight grabs its challenger with check.",
      "Qxc2 — the queen must take.",
    ...
    learn: [
      ...
      "Nxb4 — two beat one",
      "",
      "Nxc2 — take with check",
      "",
      "Qb6 — step aside, stay up",
      "",
      "a5 — march the majority",
      "",
    ],
  },
  'sicilian-sveshnikov:e4_c5_Nf3_Nc6_d4_cxd4_Nxd4_e5_Nb5_d6_N1c3_a6_Na3_b5_Nd5_Nf6_c4_b4:Qa4': {
    sources: ["concept:pos-outpost", "concept:pos-development", "https://en.wikipedia.org/wiki/Sicilian_Defence#Kalashnikov_Variation"],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "…b4 — the pawn stabs at the a3-knight. Nc2 is the mandatory retreat — White's choice in eight of ten games.",
      "Qa4? — instead of saving the knight, White counter-attacks, hitting the loose c6-knight and hoping Black panics.",
      "…Bd7! — one developing move answers everything: the bishop defends c6, and the a3-knight is still hanging to the b4-pawn.",
      "Nb1 — the knight slinks all the way home to dodge the pawn.",
      "…Nxe4! — with the queen offside on a4 and the knight back on b1, nobody guards e4. Black simply takes the centre pawn.",
      "Qd1 — the queen trudges back; the a4 adventure cost the e4-pawn and two full tempi.",
      "…Nc5 — the knight hops back to a perfect square, eyeing b3 and d3.",
      "Be3 — White develops and asks the c5-knight a question.",
    ...
    learn: [
      ...
      "b4 — kick the knight",
      "",
      "Bd7 — defend, renew the threat",
      "",
      "Nxe4 — snap the pawn",
      "",
      "Nc5 — the perfect outpost",
      "",
      "g6 — fianchetto, stay solid",
      "",
      "Bg7 — the long diagonal",
      "",
    ],
  },
  // King's Gambit — Fischer Defense, the premature …Bg4 pin (hand-curated
  // 2026-07-16). 23% of the node's 1.58M games; Bxf4 repays the gambit with
  // interest. Engine-verified +0.70 (jump 1.37 from the gambit baseline).
  'kings-gambit:e4_e5_f4_exf4_Nf3_d6_d4:Bg4': {
    sources: ['concept:pos-center', 'concept:tac-pin', 'https://en.wikipedia.org/wiki/King%27s_Gambit'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "d4 \u2014 the King's Gambit takes the whole centre while the f4-pawn hangs in the balance. Black's one job is to hold it with \u2026g5.",
    ...
    learn: [
      ...
      "",
      "",
      "d4 \u2014 the centre, while f4 hangs",
      "",
      "Bxf4 \u2014 the debt repaid",
      "",
      "Be2 \u2014 break the pin calmly",
      "",
      "h3 \u2014 the question",
      "",
  ...
  'sicilian-sveshnikov:e4_c5_Nf3_Nc6_d4_cxd4_Nxd4_Nf6_Nc3_e5_Nf3_Bb4_Bd3_d5:a3': {
    sources: ['concept:tac-fork', 'concept:tac-zwischen', 'https://en.wikipedia.org/wiki/Sicilian_Defence,_Sveshnikov_Variation'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "\u2026d5! \u2014 the break that punishes the quiet retreat: the centre opens while White's pieces stand on ceremony. Only the immediate exd5 keeps the balance.",
      "a3? \u2014 poking the b4-bishop with the centre on fire.",
      "\u2026Bxc3+! \u2014 the right order: take the knight WITH CHECK, so White has no time to resolve the centre.",
      "bxc3 \u2014 forced, and the queenside pawns crumple.",
      "\u2026dxe4! \u2014 the point: the little pawn forks the d3-bishop and the f3-knight. One of them falls.",
      "Nxe5 \u2014 the desperado: the knight grabs a pawn on its way out.",
      "\u2026Nxe5 \u2014 recaptured. The fork still stands.",
      "Bb5+ \u2014 the bishop flees with a check, buying one tempo.",
      "\u2026Bd7 \u2014 the calm block; everything stays defended.",
      "Qd6 \u2014 White lunges, hoping for chaos.",
      "\u2026Qe7 \u2014 no chaos: the queen trade is offered from strength.",
      "Qxe7+ \u2014 accepted. A whole piece up with the queens gone (+5) \u2014 the a3 poke cost White the game in six moves.",
    ],
    learn: [
      "",
      "",
      ...
      "d5 \u2014 the break lands",
      "",
      "Bxc3 \u2014 take with check first",
      "",
      "dxe4 \u2014 the little fork",
      "",
      "Nxe5 \u2014 recapture, fork stands",
      "",
      "Bd7 \u2014 calm block",
      "",
      "Qe7 \u2014 trade from strength",
      "",
    ],
  },
  // Anti-Sveshnikov 6.Nf3 — the …d5 break node (hand-curated 2026-07-16):
  // two of White's three common replies lose a piece to …Bxc3/…dxe4.
  'sicilian-sveshnikov:e4_c5_Nf3_Nc6_d4_cxd4_Nxd4_Nf6_Nc3_e5_Nf3_Bb4_Bd3_d5:Bd2': {
    sources: ['concept:tac-fork', 'concept:tac-overloaded', 'https://en.wikipedia.org/wiki/Sicilian_Defence,_Sveshnikov_Variation'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "\u2026d5! \u2014 the break that punishes the quiet retreat: the centre opens while White's pieces stand on ceremony. Only the immediate exd5 keeps the balance.",
      "Bd2? \u2014 defending the pin and abandoning the centre in the same motion.",
      "\u2026Bxc3 \u2014 take the knight; the defender on d2 must spend itself recapturing.",
      "Bxc3 \u2014 and now nothing holds the centre together.",
      "\u2026dxe4! \u2014 the same little fork: d3-bishop and f3-knight, pick one to lose.",
  ...
  // Italian — Hungarian Defense Qh5 node (hand-curated 2026-07-16): the two
  // wrong f7-defences, both engine-verified crushes.
  'italian-game:e4_e5_Nf3_Nc6_Bc4_Be7_d4_d6_dxe5_Nxe5_Nxe5_dxe5_Qh5:Be6': {
    sources: ['concept:tac-double-attack', 'concept:tac-overloaded', 'https://en.wikipedia.org/wiki/Italian_Game'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "Qh5 \u2014 the double question: the queen eyes the f7-mate with the c4-bishop behind her, and the e5-pawn at the same time. Black has exactly one good answer \u2014 \u2026g6.",
      "\u2026Be6? \u2014 blocking the bishop's diagonal looks logical and loses on the spot.",
      "Bxe6! \u2014 remove the blocker. Now f7 and e5 are both burning again and Black cannot cover both.",
      "\u2026g6 \u2014 the right move, two tempi too late: the queen is kicked but collects.",
      "Qxe5 \u2014 the pawn falls, and the queen stares down the long diagonal at the h8-rook.",
      "\u2026Bf6 \u2014 Black blocks the diagonal.",
      "Qb5+! \u2014 the queen switches wings: check, and the b7-pawn is next.",
    ...
    learn: [
      ...
      "",
      "",
      "Qh5 \u2014 two threats at once",
      "",
      "Bxe6 \u2014 remove the blocker",
      "",
      "Qxe5 \u2014 collect, eye h8",
      "",
      "Qb5 \u2014 switch wings",
      ...
      "Bxf7 \u2014 cash in",
      "",
      "Qxb7 \u2014 sweep with check",
      "",
    ],
  },
  // Italian — Hungarian Defense Qh5 node (hand-curated 2026-07-16): the two
  // wrong f7-defences, both engine-verified crushes.
  'italian-game:e4_e5_Nf3_Nc6_Bc4_Be7_d4_d6_dxe5_Nxe5_Nxe5_dxe5_Qh5:Nh6': {
    sources: ['concept:tac-fork', 'concept:tac-overloaded', 'https://en.wikipedia.org/wiki/Italian_Game'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "Qh5 \u2014 the double question: the queen eyes the f7-mate with the c4-bishop behind her, and the e5-pawn at the same time. Black has exactly one good answer \u2014 \u2026g6.",
      "\u2026Nh6? \u2014 guarding f7 with the knight, and hanging it in the same breath.",
      "Bxh6! \u2014 take it. The point sits one move deeper: recapturing opens the g-file and the queen forks e5 and the h8-rook.",
      "\u2026O-O \u2014 so Black declines, staying a whole piece down.",
      "Be3 \u2014 the bishop retreats to safety, keeping every gain.",
      "\u2026b5 \u2014 Black lashes out on the wing.",
      "Bd5 \u2014 the bishop centralises, untouchable, anchoring the whole position.",
    ...
    learn: [
      ...
      "Qh5 \u2014 two threats at once",
      "",
      "Bxh6 \u2014 take; the fork guards you",
      "",
      "Be3 \u2014 keep every gain",
      "",
      "Bd5 \u2014 untouchable anchor",
      "",
      "O-O \u2014 a piece up, tidy",
      "",
      "a3 \u2014 stop the pawns",
  ...
  // French Defence — variation-tab pass (hand-curated 2026-07-16).
  'french-defence:e4_e6_d4_d5_Nc3_Bb4_e5_c5_a3_Bxc3+_bxc3_Ne7_Qg4_Qc7_Qxg7_Rg8_Qxh7_cxd4:cxd4': {
    sources: ['concept:tac-fork', 'concept:tac-double-attack', 'https://en.wikipedia.org/wiki/French_Defence'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "\u2026cxd4 \u2014 the poisoned-pawn Winawer at full boil: both queens have raided, and now Black opens the centre. White must NOT recapture with the pawn.",
      "cxd4?? \u2014 but that is exactly what happens in thousands of games. The pawn recapture leaves c3 and the whole dark-square complex undefended.",
      "\u2026Qc3+!! \u2014 the fork the Winawer has punished for a century: check to the king, attack on the d4-pawn, and the a1-rook already in the queen's sights.",
      "Kd1 \u2014 the king walks; blocking loses the same material more slowly.",
      "\u2026Qxd4+ \u2014 the queen eats the centre pawn with another check.",
      "Bd3 \u2014 White blocks at last.",
      "\u2026Qxa1 \u2014 and the rook falls. A rook and two pawns for nothing \u2014 count it.",
      "Nf3 \u2014 White develops, hoping the a1-queen gets trapped. She doesn't.",
    ...
    learn: [
      ...
      "",
      "Qc3+ \u2014 the century-old fork",
      "",
      "Qxd4 \u2014 eat with check",
      "",
      "Qxa1 \u2014 the rook falls",
      "",
      "Nbc6 \u2014 cover the escape",
      "",
      "Bd7 \u2014 light the exit lamp",
      "",
    ],
  },
  // French Defence — variation-tab pass (hand-curated 2026-07-16).
  'french-defence:e4_e6_d4_d5_e5_c5_c3_Nc6_Nf3_Qb6:b3': {
    sources: ['concept:pawn-chain', 'concept:pos-tempo', 'https://en.wikipedia.org/wiki/French_Defence'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "\u2026Qb6 \u2014 the Advance French's signature: the queen leans on b2 and the d4-pawn at once, and every White reply is a small confession.",
      "b3? \u2014 this one confesses too much: the pawn that defended c3's future now weakens the whole chain's base.",
      "\u2026cxd4! \u2014 take at once. The point: White cannot recapture, because cxd4 hands the d4-pawn to the c6-knight with the queen behind it.",
      "Bd3 \u2014 so White develops around the hole and hopes.",
      "\u2026Bd7 \u2014 Black develops calmly; the extra central tension is a debt White still owes.",
      "White castles.",
      "\u2026Nge7 \u2014 the knight heads for f5 and g6, all while d4 stays sore.",
    ...
    learn: [
      ...
      "",
      "",
      "Qb6 \u2014 lean on the base",
      "",
      "cxd4 \u2014 take; they can't retake",
      "",
      "Bd7 \u2014 calm development",
      "",
      "Nge7 \u2014 toward f5",
      "",
      "dxc3 \u2014 collect the debt",
      "",
      "Ng6 \u2014 prod e5",
      "",
    ],
  ...
  'sicilian-alapin:e4_c5_c3_Nf6_e5_Nd5_d4_cxd4_cxd4_d6_Nf3_e6_Nc3_Nxc3_bxc3_Qc7_Bd2_Nd7_exd6_Bxd6_Bd3_b6_O-O_Bb7_Re1_O-O:Bxh7+': {
    sources: ['concept:att-greek-gift', 'concept:pos-king-safety', 'https://en.wikipedia.org/wiki/Sicilian_Defence,_Alapin_Variation'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "\u2026O-O \u2014 Black castles into a fully developed, rock-solid position. Every defensive square is covered \u2014 remember that.",
      "Bxh7+? \u2014 the Greek gift, played on hope: for the sacrifice to work White needs a knight landing on g5 with tempo and open lines behind it. Neither exists here.",
      "\u2026Kxh7 \u2014 take it. The whole refutation is one calm capture: count White's follow-up pieces and find none that arrive.",
    ...
    learn: [
      ...
      "",
      "",
      "O-O \u2014 every square covered",
      "",
      "Kxh7 \u2014 take it, calmly",
      "",
      "Kg8 \u2014 stroll home",
      "",
      "Rac8 \u2014 your attack now",
      "",
      "Bf4 \u2014 trade down to win",
      "",
      "Nf6 \u2014 cover everything",
      "",
    ],
  },
  ...
  'sicilian-dragon:e4_c5_Nf3_d6_d4_cxd4_Nxd4_Nf6_Nc3_g6_Be3_Bg7_f3_O-O_Qd2_Nc6_Bc4_Bd7_O-O-O_Rc8:Kb1': {
    sources: ['concept:tac-discovered', 'concept:tac-xray', 'https://en.wikipedia.org/wiki/Sicilian_Defence,_Dragon_Variation'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "\u2026Rc8 \u2014 the rook loads onto the half-open c-file, x-raying straight through the c6-knight at White's c4-bishop and the c3-knight behind it. White's bishop must retreat to b3 \u2014 everything else loses material.",
      "Kb1? \u2014 a natural king tuck at exactly the wrong moment: the c4-bishop stays loose against the loaded rook.",
      "\u2026Nxd4! \u2014 the removal shot. The knight takes, and every recapture runs into the c-file or the g7-bishop.",
      "Qxd4 \u2014 the queen recaptures, stepping onto the long diagonal the g7-bishop owns.",
      "\u2026Ng4!! \u2014 the discovery: the f6-knight leaps away, the g7-bishop hits the d4-queen, and the knight attacks the e3-bishop for good measure.",
      "fxg4 \u2014 White takes the knight; there was nothing better.",
      "\u2026Bxd4 \u2014 the bishop collects the queen. Queen for knight and bishop \u2014 the Dragon's oldest trick, executed on schedule.",
      "Rxd4 \u2014 White gets the bishop back.",
    ...
    learn: [
      ...
      "Rc8 \u2014 load the c-file",
      "",
      "Nxd4 \u2014 the removal shot",
      "",
      "Ng4 \u2014 discover on the queen",
      "",
      "Bxd4 \u2014 collect the queen",
      "",
      "b5 \u2014 now the attack",
      "",
      "a5 \u2014 roll the pawns",
  ...
  // slips skip the mandatory Bb3 and lose material to the same …Nxd4! removal
  // shot; engine-verified at movetime 8000, quiet-end graded.
  'sicilian-dragon:e4_c5_Nf3_d6_d4_cxd4_Nxd4_Nf6_Nc3_g6_Be3_Bg7_f3_O-O_Qd2_Nc6_Bc4_Bd7_O-O-O_Rc8:g4': {
    sources: ['concept:tac-xray', 'concept:pos-initiative', 'https://en.wikipedia.org/wiki/Sicilian_Defence,_Dragon_Variation'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "\u2026Rc8 \u2014 the rook loads onto the half-open c-file, x-raying straight through the c6-knight at White's c4-bishop and the c3-knight behind it. White's bishop must retreat to b3 \u2014 everything else loses material.",
      "g4? \u2014 the storm launches with the c4-bishop still standing in the c8-rook's x-ray. One move of preparation short.",
      "\u2026Nxd4! \u2014 the same removal shot the whole Dragon is built around: every recapture loses material to the file or the diagonal.",
      "Bxf7+ \u2014 the desperado: White cashes the doomed bishop with check.",
      "\u2026Rxf7 \u2014 Black simply takes; the rook is happy on f7.",
      "Bxd4 \u2014 White regains the knight.",
      "\u2026b5! \u2014 and the attack begins while Black banks the extra piece: the pawn storm hits first on the queenside.",
    ...
    learn: [
      ...
      "Rxf7 \u2014 take, happily",
      "",
      "b5 \u2014 attack a piece up",
      "",
      "Nh5 \u2014 eye the f4-hole",
      "",
      "Nxg7 \u2014 a piece for a pawn",
      "",
    ],
  },
  // Sicilian Dragon — the Rc8 x-ray node (hand-curated 2026-07-16). All three
  // slips skip the mandatory Bb3 and lose material to the same …Nxd4! removal
  // shot; engine-verified at movetime 8000, quiet-end graded.
  'sicilian-dragon:e4_c5_Nf3_d6_d4_cxd4_Nxd4_Nf6_Nc3_g6_Be3_Bg7_f3_O-O_Qd2_Nc6_Bc4_Bd7_O-O-O_Rc8:h4': {
    sources: ['concept:tac-xray', 'concept:att-queenside-attack', 'https://en.wikipedia.org/wiki/Sicilian_Defence,_Dragon_Variation'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "\u2026Rc8 \u2014 the rook loads onto the half-open c-file, x-raying straight through the c6-knight at White's c4-bishop and the c3-knight behind it. White's bishop must retreat to b3 \u2014 everything else loses material.",
      "h4? \u2014 the h-pawn lunges while the c4-bishop stands in the c8-rook's x-ray. The storm needed Bb3 first.",
      "\u2026Nxd4! \u2014 the removal shot lands again: take the d4-knight and every recapture costs White material.",
      "Bxf7+ \u2014 the desperado check, cashing the doomed bishop.",
      "\u2026Rxf7 \u2014 taken, with thanks.",
      "Bxd4 \u2014 White regains the knight and hopes the storm still scares.",
      "\u2026Qa5! \u2014 it doesn't: the queen leaps out, hitting the a2-pawn and pinning ideas against the c3-knight.",
    ...
    learn: [
      ...
      "Rxf7 \u2014 with thanks",
      "",
      "Qa5 \u2014 leap at the king",
      "",
      "Be6 \u2014 the strong diagonal",
      "",
      "Bc4 \u2014 clamp the king",
      "",
    ],
  },
  // Evans Gambit — Compromised Defence, the Qb3 battery node (hand-curated
  // 2026-07-16 per the no-bots doctrine; explorer frequencies + engine-verified
  // playouts at movetime 8000, quiet-end graded).
  'evans-gambit:e4_e5_Nf3_Nc6_Bc4_Bc5_b4_Bxb4_c3_Ba5_d4_exd4_O-O_dxc3_Qb3:Qf6': {
    sources: ['concept:pos-initiative', 'concept:pos-tempo', 'https://en.wikipedia.org/wiki/Evans_Gambit'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "",
      "Qb3 \u2014 the battery lands: queen and bishop both stare at f7, and Black's whole Compromised Defence hangs on finding the one good answer.",
      "\u2026Qf6 \u2014 Black guards f7 with the queen, but she stands on a square White can hit. The right defence was Qe7; this one comes with a refund.",
      "Bg5! \u2014 the punish: the queen is attacked at once and must abandon her post or block the f-pawn forever.",
      "\u2026Qg6 \u2014 the queen slides aside, staying near the kingside.",
      "Nxc3 \u2014 White calmly collects the c3-pawn with development. Count it: two of the three gambit pawns are home, and every White piece plays.",
      "\u2026Bxc3 \u2014 Black trades off the defender-less bishop.",
      "Qxc3 \u2014 the queen recaptures, eyeing the long dark diagonal toward g7.",
      "\u2026Nf6 \u2014 Black finally develops.",
      "e5 \u2014 the pawn rolls forward with tempo on the f6-knight.",
      "\u2026Ne4 \u2014 the knight jumps in, hitting the c3-queen.",
      "Qe3 \u2014 the queen steps aside, keeping the e5-wedge and the initiative. White stands clearly better: the pull the engine confirms at half a pawn, with every attacking idea still on the board.",
      "\u2026O-O \u2014 Black castles at last, a full opening behind.",
    ],
    learn: [
      "",
      "",
      ...
      "Bg5 \u2014 hit the queen",
      "",
      "Nxc3 \u2014 collect with development",
      "",
      "Qxc3 \u2014 eye the diagonal",
      "",
      "e5 \u2014 roll with tempo",
      "",
      "Qe3 \u2014 keep the wedge",
  ...
  // 2026-07-16 per the no-bots doctrine; explorer frequencies + engine-verified
  // playouts at movetime 8000, quiet-end graded).
  'evans-gambit:e4_e5_Nf3_Nc6_Bc4_Bc5_b4_Bxb4_c3_Ba5_d4_exd4_O-O_dxc3_Qb3:Nf6': {
    sources: ['concept:tac-pin', 'concept:pos-king-safety', 'https://en.wikipedia.org/wiki/Evans_Gambit'],
    watch: [
      "",
      "",
      "",
  ...
  // 2026-07-16 per the no-bots doctrine; explorer frequencies + engine-verified
  // playouts at movetime 8000, quiet-end graded).
  'evans-gambit:e4_e5_Nf3_Nc6_Bc4_Bc5_b4_Bxb4_c3_Ba5_d4_exd4_O-O_dxc3_Qb3:d5': {
    sources: ['concept:tac-double-attack', 'concept:pos-king-safety', 'https://en.wikipedia.org/wiki/Evans_Gambit'],
    watch: [
      "",
      "",
      "",
      ...
      "",
      "Qb3 \u2014 the battery lands: queen and bishop both stare at f7, and Black's whole Compromised Defence hangs on finding the one good answer.",
      "\u2026d5 \u2014 Black blocks the battery with the pawn. It looks natural and it loses on the spot.",
      "exd5! \u2014 the punish: the pawn recaptures with tempo on the c6-knight, and the block became a lever that ripped Black's own centre open.",
      "\u2026Nce7 \u2014 the knight retreats, bumping into its own pieces.",
      "Ba3! \u2014 the dark-squared bishop takes the a3-f8 diagonal, and Black's king will never castle.",
      "\u2026c2 \u2014 Black shoves the passed pawn in desperation.",
      "Nc3 \u2014 White develops and corrals the runner; it goes nowhere.",
      "\u2026Kf8 \u2014 the king steps aside by hand \u2014 the saddest castling in chess.",
      "Ne5 \u2014 the knight lands in the heart of the position, eyeing f7 and d7.",
      "\u2026Nh6 \u2014 Black defends f7 from the rim.",
      "Rfe1 \u2014 the rook joins; every White piece aims at the stranded king.",
      "\u2026Bf5 \u2014 Black develops at last, five pawns' worth of position too late. The engine calls it completely winning for White.",
    ],
    learn: [
      "",
      "",
      ...
      "Qb3 \u2014 battery on f7",
      "",
      "exd5 \u2014 the block backfires",
      "",
      "Ba3 \u2014 no castling, ever",
      "",
      "Nc3 \u2014 corral the runner",
      "",
      "Ne5 \u2014 into the heart",
      "",
      "Rfe1 \u2014 everyone aims",
  ...
  'italian-game:e4_e5_Nf3_Nc6_Bc4_Nf6_d4:Nxd4': {
    ...
    watch: [
      '', '', '', '', '', '', '',
      'Nxd4? The knight grabs the d4-pawn — but the c6-knight was the e5-pawn’s only guard. White does not recapture: Bxf7+ first drags the king onto the square where the e5-fork lands.',
  ...
  'kings-gambit:e4_e5_f4_d5_exd5_e4_d3_Nf6_dxe4_Nxe4_Nf3_Bc5_Qe2_Bf5_Nc3:Bb4': {
    ...
    watch: [
      ...
      'Qb5+! A check that also attacks the bishop on b4 — a fork hitting the king and the bishop down two lines at once. Black must answer the check and cannot save the bishop.',
      '',
  ...
  'scotch-game:e4_e5_Nf3_Nc6_d4_exd4_Nxd4_Bc5_Be3_Qf6_c3_Nge7_Bc4_O-O_O-O_d6_Nxc6:Bxe3': {
    watch: ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Bxe3? Black grabs the bishop instead of dealing with the knight on c6 — a costly slip.', 'fxe3 — recapturing, and the c6-knight is a monster on the sixth, bearing down on the e7-knight — Nxe7+ wins it with check.', '', 'Nxe7+ — the knight falls with check; White is a clean piece up.', '', '', '', '', ''],
    learn: ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'fxe3 — recapture, the knight dominates.', '', 'Nxe7+ — check, win a piece.', '', '', '', '', ''],
  ...
  'pro-gothamchess-italian:e4_e5_Nf3_Nc6_Bc4_Bc5_c3_Nf6_d4_exd4_cxd4_Bb4+_Nc3_Nxe4_O-O_Bxc3_bxc3:Nxc3': {
    ...
    learn: [
      ...
      'Qe1+ — check, then win the c3-knight',
      'Ne7 — forced block',
  ...
  'pro-naroditsky-alapin:e4_c5_c3_d5_exd5_Qxd5_d4_Nf6_Nf3_e6_Na3_Nc6_Be3_cxd4_Nb5:Bd6': {
    watch: ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '…Bd6?? — it covers c7 against the Nb5–c7 fork, but leaves the d5-queen exposed on the long light diagonal.', 'Bc4! — the bishop attacks the d5-queen. With Nb5 raking c7 and d6, the queen finds no square that escapes and still holds everything — material falls.', '…Bb8 — Black tries to wriggle.', 'Bxd5 — White simply takes the queen; the rest is mopping up.', '', 'Bxc6+ — picking up another piece with check.', '', 'Nbd4 — White is up a queen, completely winning.', ''],
  ...
  "pro-samayraina-open-sicilian:e4_c5_Nf3_Nc6_d4_cxd4_Nxd4_Nf6_Nc3_e5_Ndb5_d6_Bg5_a6_Bxf6:Qxf6": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/Sicilian-Defense-Open"],
    watch: ["","","","","","","","","","","","","","","","Qxf6? — the wrong recapture. …gxf6 was forced; taking with the queen allows a family fork.","Nc7+! The fork — the knight forks the king and the a8-rook. After …Kd8 Nxa8 White wins the exchange.","","Nxa8 — the knight snares the rook in the corner and escapes via b6, snapping the c8-bishop too. White is up decisive material.","","","","",""],
  ...
  "pro-samayraina-open-sicilian:e4_c5_Nf3_g6_d4_cxd4_Nxd4_Nf6_Nc3_Bg7_Be2:Qa5": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/Sicilian-Defense-Open"],
    watch: ["","","","","","","","","","","","Qa5? — the queen sortie hits nothing and only hands White tempi to chase her.","Nb3 — questioning the offside queen; she must trudge all the way back to d8.","","e5 — the f6-knight is kicked home too; Black has thrown away three tempi and White seizes the centre.","","","","",""],
  ...
  "pro-samayraina-ruy:e4_e5_Nf3_Nc6_Bb5_a6_Bxc6_dxc6_O-O_f6_d4_exd4_Nxd4:Bc5": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/Ruy-Lopez"],
    watch: ["","","","","","","","","","","","","","Bc5? — developing into a check. The c5-bishop has no protection and White wins it by force.","Qh5+! A check that also forks — after …g6 the queen snaps the c5-bishop, then takes c6 with another check. A clean piece up.","","Qxc5 — the queen snaps the loose bishop; a clean piece up, and Qxc6+ scoops another pawn with check.","","","","",""],
  ...
  "pro-samayraina-ruy:e4_e5_Nf3_Nc6_Bb5_d6_d4:a6": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/Ruy-Lopez"],
    watch: ["","","","","","","","a6? — kicking the bishop loses a pawn in this exact position. The d4-tension is not yet resolved.","Bxc6+! and dxe5 — White wins the e5-pawn cleanly because the pin and the central tension favour White.","","dxe5 — the central pawn falls; White is a clean pawn up and Black is saddled with doubled c-pawns.","","","","",""],
  ...
  "pro-samayraina-ruy:e4_e5_Nf3_Nc6_Bb5_d6_d4_Bd7_Nc3_Nf6_O-O_Be7_Re1_exd4_Nxd4:Ne5": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/Ruy-Lopez"],
    watch: ["","","","","","","","","","","","","","","","Ne5? — the knight jumps in but invites Nf5, hitting the e7-bishop with tempo.","Nf5 — eyeing the e7-bishop; after …O-O Nxe7+ White trades into the bishop pair and a pull.","","Nxe7+ — picking up the bishop pair; White is comfortably better.","","","","",""],
  ...
  "pro-samayraina-caro-white:e4_c6_d4_d5_exd5_cxd5_Bd3_Nc6_c3_Nf6_Bf4_Bg4_Qb3:b6": {
    ...
    watch: ["","","","","","","","","","","","","","b6? — slow and weakening; it does nothing about the pin or the centre.","h3 — putting the question to the g4-bishop; it must retreat passively to c8.","","Nf3 — the bishop is shut back in and White develops with a comfortable, lasting edge.","","","","",""],
  ...
  "pro-samayraina-caro-white:e4_c6_d4_d5_exd5_cxd5_Bd3_Nc6_c3_Nf6_Bf4_Bg4_Qb3_Qd7_Nd2_e6_Ngf3:Be7": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/Caro-Kann-Defense-Panov-Attack"],
    watch: ["","","","","","","","","","","","","","","","","","Be7? — passive; it lets the knight jump to e5 and trade off Black’s active bishop.","Ne5 — hitting the g4-bishop; after the trade White keeps a pleasant space edge.","","Nxg4 — White swaps off Black’s good bishop and stands clearly more comfortable.","","","","",""],
  ...
  "pro-samayraina-french-white:e4_e6_d4_d5_exd5_exd5_Bd3_Bd6_Nf3_Ne7_O-O_O-O_Re1:Bg4": {
    ...
    watch: ["","","","","","","","","","","","","","Bg4? — the pin ignores the loose h7-pawn. White has the classic Greek-gift sacrifice.","Bxh7+! The Greek gift — …Kxh7 Ng5+ and the queen swings to the h-file; the king is hunted down.","","Ng5+ — the knight leaps in with check; after Kg8 Qxg4 White has regained the piece, pocketed the h7-pawn, and shredded Black’s king.","","","","",""],
    learn: ["","","","","","","","","","","","","","","Bxh7+ — the Greek gift","","","","","","",""],
  },
  "pro-samayraina-french-white:e4_e6_d4_d5_exd5_exd5_Bd3_Bd6_Nf3_Ne7_O-O_O-O_Re1_Bg4_c3:c6": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/French-Defense-Exchange-Variation"],
    watch: ["","","","","","","","","","","","","","","","c6? — too slow; the kingside is already fatally weak. The Greek gift lands.","Bxh7+! The bishop sacrifice rips open the king — Ng5+ and the queen follow for a decisive attack.","","Ng5+ — check, and after Kg8 Qxg4 White has won back the piece plus the h7-pawn, with a raging attack on the bared king.","","","","",""],
  ...
  "pro-samayraina-open-e5:e4_e5_Nf3_Nc6_d4_exd4:Ng5": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/Ruy-Lopez"],
    watch: ["","","","","","","Ng5? — a pointless lunge at f7 that defends nothing; the knight just gets chased back.","…Be7 — calmly developing; the g5-knight has no follow-up and must retreat, leaving Black the extra d4-pawn.","","…Nf6 — Black completes development a clean pawn up, the gambit refuted.","","","","",""],
  ...
  "pro-samayraina-scandi:e4_d5_exd5_Qxd5_Nc3_Qd8_d4_Nf6_Nf3_c6_Bc4_Bg4_h3_Bxf3_Qxf3_e6:Bg5": {
    sources: ["concept:tac-trap","concept:pos-initiative","https://www.chess.com/openings/Scandinavian-Defense"],
    watch: ["","","","","","","","","","","","","","","","","Bg5? — it ignores the loose d4-pawn; Black simply snaps it off.","…Qxd4 — winning the undefended central pawn; Black is a clean pawn up.","","…Nbd7 — Black consolidates the extra pawn with an easy game.","","","","",""],
  ...
  "pro-aman-reti:Nf3_d5_g3_Nf6_Bg2_e6_O-O_Be7_d3_O-O_Nbd2_c5_e4:d4": {
    ...
    watch: ["","","","","","","","","","","","","","d4?! — closing the centre hands White the e4-square and a free hand on the kingside; the d4-pawn becomes a target.","a4! — gaining queenside space and fixing Black’s structure before turning to the kingside.","","e5 — the centre rolls forward, gaining space and clamping the f6-knight out.","","Nc4 — the knight reroutes to the strong c4-outpost, eyeing the queenside holes.","","Nfd2 — doubling knights toward c4/e4, White comfortably better with the space bind.",""],
    learn: ["","","","","","","","","","","","","","","a4 — gain space, fix the structure","","e5 — roll forward, clamp f6","","Nc4 — reroute to the outpost","","",""],
  },
