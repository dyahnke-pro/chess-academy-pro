...
const GP_F4: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'f5', moves: 'e4 c5 Nc3 Nc6 f4 g6 Nf3 Bg7 Bc4 e6 f5 Nge7 fxe6', arrows: [A('f5', 'e6')], highlights: [H('e6')], say: "After e6, f5 lunges and trades on e6 — Black's pawns are split, the e6-pawn is weak, and the lines toward their king are torn open. The Grand Prix at full throttle.", sayShort: 'f5, fxe6 — split the pawns.' }),
