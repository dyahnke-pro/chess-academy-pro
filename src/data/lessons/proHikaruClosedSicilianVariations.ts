...
const GP_F4: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'bc4', moves: 'e4 c5 Nc3 Nc6 f4 g6 Nf3 Bg7 Bc4', arrows: [A('f1', 'c4')], highlights: [H('c4')], say: "Black fianchettoes and Hikaru develops the bishop to c4 — the attacking setup, aiming at f7 and supporting the f5-break that's about to crack the kingside.", sayShort: 'Bc4 — eye f7, prep f5.' }),
...
const GP_G6: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'bc4', moves: 'e4 c5 Nc3 Nc6 f4 g6 Nf3 Bg7 Bc4', arrows: [A('f1', 'c4')], highlights: [H('c4')], say: "Hikaru sets up the attack: Nf3 and Bc4, the bishop trained on f7. Every piece points toward the kingside while Black is still getting organised.", sayShort: 'Bc4 — aim at the king.' }),
...
const GP_E6: LessonScript = {
  ...
  beats: [
    b({ id: 'f4', moves: 'e4 c5 Nc3 Nc6 f4 e6', highlights: [H('f4')], say: "Against the solid ...e6, Black is ready to meet a kingside storm head-on, so Hikaru switches plans. The f4-pawn still grips the centre, but now the play turns positional.", sayShort: 'f4 vs ...e6 — switch plans.' }),
