...
const VS_C5: LessonScript = {
  ...
  beats: [
    b({ id: 'c5', moves: 'e4 e6 d4 d5 exd5 exd5 Nf3 Nf6 Bd3 c5',
      ...
      say: "In the Exchange, when Black strikes with …c5 to break the symmetry, you are happy — it hands you an isolated-queen's-pawn position where your pieces become very active. The symmetry is gone and the game opens up in White's favour.",
    ...
    b({ id: 'dxc5', moves: 'e4 e6 d4 d5 exd5 exd5 Nf3 Nf6 Bd3 c5 dxc5 Bxc5 O-O O-O',
      ...
      say: "You take on c5 and castle, leaving Black with the isolated d5-pawn. The bishop on d3 eyes h7, your pieces flow to active squares, and the d5-pawn is a long-term target. White has the easier, more pleasant game.",
...
const VS_BD6: LessonScript = {
  ...
  beats: [
    b({ id: 'bd6', moves: 'e4 e6 d4 d5 exd5 exd5 Bd3 Bd6',
      ...
      say: "Black mirrors your development with …Bd6. In the symmetrical Exchange, the player who gets to the good squares FIRST and breaks the symmetry gets the edge — so you play actively and grab the open e-file before Black does.",
    ...
    b({ id: 'develop', moves: 'e4 e6 d4 d5 exd5 exd5 Bd3 Bd6 Nf3 Ne7 O-O O-O Re1 Bg4',
      ...
      say: "Nf3, castle, and Re1 — seizing the open e-file first. Black develops …Bg4 to pin, but you have the initiative and the more harmonious setup. The half-open e-file points at Black's position.",
