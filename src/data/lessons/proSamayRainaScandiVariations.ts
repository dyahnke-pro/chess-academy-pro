...
const QA5: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'bf5', moves: 'e4 d5 exd5 Qxd5 Nc3 Qa5 d4 Nf6 Nf3 c6 Bc4 Bf5',
      ...
      say: "You build the classic …c6 / …Bf5 setup — a little fortress where the queen on a5, the bishop outside the chain on f5, and the solid c6-pawn give Black a sound, flexible position. The bishop is the star, developed before …e6 buries it.",
...
const C6_GAMBIT: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'bg4', moves: 'e4 d5 exd5 Qxd5 Nc3 Qd8 d4 Nf6 Nf3 c6 Bc4 Bg4',
      ...
      say: "…Bg4 pins the f3-knight — the defender of d4. This is the other way to solve the bishop: instead of …Bf5, you trade it for White's knight and pick up the d4-pawn's defender, easing any pressure on your position.",
