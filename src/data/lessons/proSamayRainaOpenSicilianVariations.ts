...
const SVESHNIKOV: LessonScript = {
  ...
  beats: [
    b({ id: 'nc6', moves: 'e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 Nf6 Nc3 e5 Ndb5',
      ...
      say: "When Black plays the Sveshnikov with an early e5, the knight jumps to b5 — heading for the d6-square and pressuring the hole Black just created on d5. Black's central pawns look impressive, but the d5-square is a permanent home for your pieces.",
    ...
    b({ id: 'bg5', moves: 'e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 Nf6 Nc3 e5 Ndb5 d6 Bg5',
      ...
      say: "After d6 you pin and pressure the f6-knight with Bg5 — the knight that guards d5. Removing or distracting it is the whole battle: once it goes, the d5-square is yours forever.",
    ...
    b({ id: 'na3', moves: 'e4 c5 Nf3 Nc6 d4 cxd4 Nxd4 Nf6 Nc3 e5 Ndb5 d6 Bg5 a6 Bxf6 gxf6 Na3 b5',
      ...
      say: "Black kicks the b5-knight and you trade on f6, shattering Black's kingside pawns. The knight reroutes via a3 toward c4 and d5. Black has the bishop pair and central pawns, but the chronic d5-weakness and the doubled f-pawns give White a long-term structural target — the main Sveshnikov battleground.",
...
const TAIMANOV: LessonScript = {
  ...
  beats: [
    b({ id: 'e6', moves: 'e4 c5 Nf3 e6 d4 cxd4 Nxd4 Nc6 Nc3 Qc7 Be2',
      ...
      say: "Against the flexible Taimanov (…e6 and …Qc7) you keep it simple with the classical Be2 development. Black's setup is solid but passive; you develop, castle, and look to clamp down with a knight or the f4-f5 break later.",
    ...
    b({ id: 'oo', moves: 'e4 c5 Nf3 e6 d4 cxd4 Nxd4 Nc6 Nc3 Qc7 Be2 a6 O-O Nf6 Be3',
      ...
      say: "You castle and develop the bishop to e3, building the standard English-Attack-style structure. The pieces are harmoniously placed and White keeps a pleasant space edge with Black still needing to find a plan.",
...
const ACC_DRAGON: LessonScript = {
  ...
  beats: [
    b({ id: 'g6', moves: 'e4 c5 Nf3 g6 d4 cxd4 Nxd4 Nf6 Nc3 Bg7 Be3',
      ...
      say: "Against the Dragon fianchetto you set up the English Attack: Be3, preparing f3, Qd2 and a kingside pawn storm with h4-h5. The Dragon bishop is dangerous, so you race to attack the king before it bites.",
    ...
    b({ id: 'develop', moves: 'e4 c5 Nf3 g6 d4 cxd4 Nxd4 Nf6 Nc3 Bg7 Be2 Nc6 Be3 O-O',
      ...
      say: "With the calmer Be2 setup you develop solidly, castle, and keep the strong knight on d4 controlling the centre. Against the Accelerated move order you are careful to meet …d5 ideas, but the extra space and the firm centre keep White on top.",
