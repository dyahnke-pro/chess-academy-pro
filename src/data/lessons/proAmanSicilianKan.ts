...
export const PRO_AMAN_SICILIAN_KAN_LESSON: LessonScript = {
  ...
  sources: SRC,
  beats: [
    b({ id: 'c5', moves: 'e4 c5', highlights: [H('c5')],
    ...
    b({ id: 'e6', moves: 'e4 c5 Nf3 e6', highlights: [H('e6')],
    ...
    b({ id: 'middlegame', moves: 'e4 c5 Nf3 e6 d4 cxd4 Nxd4 a6 Nc3 Qc7 Bd3 Nf6 O-O d6 f4 Nbd7 Kh1 b5', highlights: [H('b5'), H('b7')],
