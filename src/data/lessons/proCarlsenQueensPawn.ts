...
const CATALAN: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'bg2', moves: 'd4 Nf6 c4 e6 Nf3 d5 g3 Be7 Bg2 O-O O-O', arrows: [A('g2', 'b7')], highlights: [H('g2')], say: "Bg2 and castling complete the setup. The bishop on g2 rakes the whole long diagonal toward b7 and a8 — a slow-burning pressure that lasts the entire game. This repertoire has won countless games where this single bishop quietly decides the outcome.", sayShort: 'Bg2 — rake the long diagonal.' }),
    b({ id: 'qxc4', moves: 'd4 Nf6 c4 e6 Nf3 d5 g3 Be7 Bg2 O-O O-O dxc4 Qc2 a6 Qxc4', highlights: [H('c4')], say: "Black grabs the c4-pawn but can't hold it; White recaptures with the queen and enjoys a lasting space edge and that magnificent bishop. The Open Catalan is one of the safest ways in chess to play for a win with White — exactly why it's a this repertoire staple.", sayShort: 'Qxc4 — regain it, keep the pull.' }),
  ],
};
...
const QID: LessonScript = {
  ...
  beats: [
    b({ id: 'g3', moves: 'd4 Nf6 c4 e6 Nf3 b6 g3', highlights: [H('g3')], say: "Against the Queen's Indian's ...b6, this repertoire fianchettoes with g3 to neutralise Black's light-squared bishop before it gets active. It becomes a battle of the two long-diagonal bishops — and White's, supported by more central space, holds the upper hand.", sayShort: 'g3 — contest the light squares.' }),
