...
export const GRUNFELD_DEFENCE_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "grunfeld-defence::Neo-Grünfeld (g3 without Nc3)": {
    openingId: "grunfeld-defence", title: "Neo-Grünfeld — hand the pawn back on your terms", minutes: 8, orientation: "black",
    sources: ["concept:pawn-doubled", "concept:tac-double-attack", "https://en.wikipedia.org/wiki/Gr%C3%BCnfeld_Defence"],
    beats: [
      { id: "ng1", moves: ["d4", "Nf6", "c4", "g6", "g3", "d5", "Bg2", "Bg7", "Nf3", "O-O"], say: "White's g3 ducks the main-line Grünfeld brawls, hoping for a quiet fianchetto squeeze. Black plays the same honest system regardless: …d5 stakes the centre, the g7-bishop takes the long diagonal, castle and ask questions.", sayShort: "…O-O — same system, no fear.", highlights: [{ square: "g7", color: "rgba(80,140,255,0.32)" }, { square: "d5", color: "rgba(255,214,0,0.88)" }] },
      { id: "ng2", moves: ["d4", "Nf6", "c4", "g6", "g3", "d5", "Bg2", "Bg7", "Nf3", "O-O", "O-O", "dxc4", "Na3", "c3"], say: "…dxc4 takes the pawn and Na3 sets out to fetch it back — so …c3! hands it over on Black's terms instead: the b2-pawn is dragged sideways, and the tidy queenside majority White wanted becomes doubled wreckage on the c-file.", sayShort: "…c3 — return it broken.", highlights: [{ square: "c3", color: "rgba(255,214,0,0.88)" }, { square: "b2", color: "rgba(80,140,255,0.32)" }] },
      { id: "ng3", moves: ["d4", "Nf6", "c4", "g6", "g3", "d5", "Bg2", "Bg7", "Nf3", "O-O", "O-O", "dxc4", "Na3", "c3", "bxc3", "c5", "dxc5", "Qa5"], say: "…c5 bites the centre, and after dxc5 comes the point of the whole sequence: …Qa5! — one queen move attacking three targets: the a3-knight up the file, the c3-pawn along the diagonal, and the c5-pawn across the rank. White cannot hold everything.", sayShort: "…Qa5 — one move, three targets.", arrows: [{ from: "a5", to: "a3", color: "rgba(40,185,95,0.92)" }, { from: "a5", to: "c3", color: "rgba(40,185,95,0.92)" }, { from: "a5", to: "c5", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "a3", color: "rgba(255,214,0,0.88)" }, { square: "c5", color: "rgba(80,140,255,0.32)" }] },
      { id: "ng4", moves: ["d4", "Nf6", "c4", "g6", "g3", "d5", "Bg2", "Bg7", "Nf3", "O-O", "O-O", "dxc4", "Na3", "c3", "bxc3", "c5", "dxc5", "Qa5", "Qb3", "Qxc5", "Be3", "Qa5"], say: "Qb3 holds what it can, …Qxc5 collects the pawn, and when Be3 hits the queen she simply steps back to a5, keeping the a3-knight and c3-pawn under watch. Material level, White's structure permanently dented — the engine calls it equal, and only one side has the long-term target. The Neo-Grünfeld, defused by move twelve.", sayShort: "…Qa5 — level, and the c3-wreck stays.", highlights: [{ square: "c3", color: "rgba(255,214,0,0.88)" }, { square: "a5", color: "rgba(80,140,255,0.32)" }] },
    ],
  },
};
