...
const VS_RUY: LessonScript = {
  ...
  beats: [
    b({ id: 'a6-nf6', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6',
      ...
      say: "When White tries the Ruy with Bb5, you play the main line: a6 to question the bishop, then Nf6 hitting e4. The most respected, most principled answer to the Spanish.",
    ...
    b({ id: 'be7', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3',
      ...
      say: "You develop Be7, castle, and expand with b5, kicking the bishop to b3; d6 then supports e5 and frees the c8-bishop. This is the rock-solid Closed Ruy that has served champions for a century.",
...
const VS_SCOTCH: LessonScript = {
  ...
  beats: [
    b({ id: 'd4', moves: 'e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Nf6 Nc3 Bb4',
      ...
      say: "Against the Scotch, after …exd4 and Nxd4 you hit e4 with …Nf6 and pin the c3-knight with …Bb4 — the solid Schmidt approach. You get rapid development and pressure on e4, fully equalising.",
    ...
    b({ id: 'trade', moves: 'e4 e5 Nf3 Nc6 d4 exd4 Nxd4 Nf6 Nc3 Bb4 Nxc6 bxc6 Bd3 d5',
      ...
      say: "White trades on c6 and you recapture …bxc6, then strike the centre with …d5! The doubled c-pawns are a small concession; in return Black gets a strong centre, the bishop pair, and active piece play.",
...
const VS_FOUR_KNIGHTS: LessonScript = {
  ...
  beats: [
    b({ id: 'nf6', moves: 'e4 e5 Nf3 Nc6 Nc3 Nf6 Bb5 Bb4',
      ...
      say: "The symmetrical Four Knights. You copy with …Nf6 and, when White pins with Bb5, you pin right back with …Bb4 — the principled, fully-equal Symmetrical Variation. Black keeps the balance with easy development.",
    ...
    b({ id: 'oo', moves: 'e4 e5 Nf3 Nc6 Nc3 Nf6 Bb5 Bb4 O-O O-O d3 d6 Bg5 Bxc3 bxc3 Qe7',
      ...
      say: "Both castle; you break the symmetry at the right moment with …Bxc3, damaging White's queenside pawns, and regroup with …Qe7. Black has a sound structure and a clear plan against the doubled c-pawns.",
