...
export const BUDAPEST_GAMBIT_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'ng4', moves: 'd4 Nf6 c4 e5 dxe5 Ng4', say: "dxe5 …Ng4! — the knight pounces, chasing the e5-pawn it intends to win back. This is the gambit's whole idea: Black doesn't sit and regret the pawn, they hunt it down while developing with tempo and gaining the initiative.", sayShort: '…Ng4 — hunt the e5-pawn back.', arrows: [A('g4', 'e5')], highlights: [H('g4'), H('e5')] }),
