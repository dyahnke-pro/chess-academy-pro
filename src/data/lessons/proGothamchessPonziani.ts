...
export const PRO_GOTHAMCHESS_PONZIANI_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say:
        "The Ponziani — e4 e5 Nf3 Nc6 c3. A 200-year-old surprise weapon. The little c3-move has one job: to support d4 next, so you can build the big centre most opponents never prepare against. This repertoire beats grandmasters with this precisely because nobody studies it.",
    ...
    b({
      ...
      say:
        "Black develops Nf6; you strike with d4. After …exd4 you don't recapture yet — you push e5 first, kicking the f6-knight with tempo. Win the tempo before you win the pawn back: that's the Ponziani's bite.",
    ...
    b({
      ...
      say:
        "The knight jumps to d5; you hit it with Qb3 — the queen attacks the d5-knight along the diagonal and leans on b7 at the same time. Double pressure, and Black has to spend time defending instead of developing.",
    ...
    b({
      ...
      say:
        "Black retreats the knight to b6; now you recapture, cxd4, and there it is — the big e5-and-d4 pawn duo, a commanding centre. The knight on b6 is offside, your queen is active on b3, and you have all the space.",
    ...
    b({
      ...
      say:
        "Black hits your centre with d6; you develop with Bb5, pinning the c6-knight against the king. The knight is the only thing holding Black's position together — so you tie it down and prepare to trade it off.",
    ...
    b({
      ...
      say:
        "Black develops Be6, kicking the queen; you take on c6 with check, and after …bxc6 Black's queenside pawns are doubled and weak. You've reached the middlegame with a clear, lasting edge: the big centre and a permanent target on the c6- and c7-pawns.",
