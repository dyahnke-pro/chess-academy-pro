...
const E6_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'te6-2', moves: 'd4 Nf6 Bg5 e6 e4 h6 Bxf6 Qxf6',
      say: "White grabs the full centre with e4; you immediately prod the bishop with …h6. After Bxf6 you recapture with the queen — …Qxf6. Count what just happened: White has traded off their dark-squared bishop, so you now own the two bishops, and your queen sits actively on f6, eyeing d4 and the long dark diagonal.",
...
const C5_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'tc5-4', moves: 'd4 Nf6 Bg5 c5 Bxf6 gxf6 d5 Qb6 Qc1 f5 c4 Bg7 Nc3 d6',
      say: "White buttresses the d5-wedge with c4; you fianchetto …Bg7 onto the long diagonal and play …d6 to blunt the centre and prepare your pieces. Your dark-squared bishop is a monster with no rival — White gave their away on f6 — and it rakes the whole long diagonal.",
