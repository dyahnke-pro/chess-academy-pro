...
// Student plays WHITE. Board-accurate — note you do NOT claim the bishop pair
...
export const PRO_GOTHAMCHESS_TROMPOWSKY_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say:
        "Black plays the solid e6, keeping things flexible; you develop the knight to d2, supporting an eventual e4 and keeping your structure compact. No hurry — the bishop on g5 is already doing its job.",
    ...
    b({
      ...
      say:
        "Black builds the centre with d5 and breaks the pin by developing the bishop to e7; you play the modest e3, solidifying d4 and opening the light-squared bishop. Classic Trompowsky: small, solid moves, no weaknesses.",
    ...
    b({
      ...
      say:
        "Bd3 trains the light-squared bishop toward h7, c3 buttresses d4, and Black fianchettoes with b6 and castles. You've reached the middlegame — and now the plan begins. This position is exactly where the middlegame plan takes over.",
    ...
    b({
      ...
      highlights: [{ square: 'f6', color: KEY }],
      say:
        "Here's the key decision: Bxf6. You give up your dark-squared bishop for the knight. In return, the recapturing bishop on f6 is going to become a target — because the f-pawn is about to roll right at it. You're not playing for the bishop pair; you're playing for the storm.",
    ...
    b({
      ...
      say:
        "f4 — and there's the point. You grab kingside space and load up the f5-push, which will hit e6 and pry open lines toward Black's king. The bishop sitting on f6 has nowhere good to go. This is the Trompowsky's hidden teeth: a quiet system that becomes a pawn-storm attack.",
    ...
    b({
      ...
      say:
        "If Black trades anyway, you recapture and the queen lands on d3 — centralised, eyeing h7 and the kingside. Step back: you have the f4-f5 pawn roller, kingside space, the queen aimed at the king, and a clear plan. The Trompowsky started as the quietest move on the board and turned into a direct attack. That's the whole idea.",
