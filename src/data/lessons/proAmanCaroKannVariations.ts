...
export const PRO_AMAN_CARO_KANN_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'pro-aman-caro-kann::Advance (…Bf5)': {
    ...
    beats: [
      ...
      b({ id: 'ne7', moves: 'e4 c6 d4 d5 e5 Bf5 Nf3 e6 Be2 Nd7 O-O Ne7', arrows: [A('g8', 'e7')], highlights: [H('g6'), H('f6'), H('e7')],
      ...
      b({ id: 'bg6', moves: 'e4 c6 d4 d5 e5 Bf5 Nf3 e6 Be2 Nd7 O-O Ne7 Nh4 Bg6', arrows: [A('f5', 'g6')], highlights: [H('c5'), H('f6'), H('g6')],
  ...
  'pro-aman-caro-kann::vs Exchange (3.exd5)': {
    ...
    beats: [
      ...
      b({ id: 'qc7', moves: 'e4 c6 d4 d5 exd5 cxd5 Bd3 Nc6 c3 Qc7', arrows: [A('d8', 'c7')], highlights: [H('f4'), H('c7')],
