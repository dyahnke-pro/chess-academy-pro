...
export const SMITH_MORRA_GAMBIT_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'smith-morra-gambit::Alapin Declined (2…Nf6)': {
    ...
    beats: [
      ...
      b({ id: 'a4', moves: 'e4 c5 d4 cxd4 c3 Nf6 e5 Nd5 Nf3 Nc6 cxd4 d6 Bc4 Nb6 Bb5 dxe5 Nxe5 Bd7 Nxd7 Qxd7 Nc3 e6 O-O Be7', say: "The minor pieces trade off and White castles with an easy, slightly pleasant game — no gambit pawn given at all in this line, just a healthy Alapin with the freer position.", sayShort: 'O-O — an easy, pleasant edge.' }),
    ],
  },
