...
export const SMITH_MORRA_GAMBIT_VARIATION_LESSONS: Record<string, LessonScript> = {
  'smith-morra-gambit::Classical Defence (…d6 & …e6)': {
    ...
    beats: [
      ...
      b({ id: 'c4', moves: 'e4 c5 d4 cxd4 c3 dxc3 Nxc3 Nc6 Nf3 d6 Bc4 e6 O-O Be7 Qe2 Nf6 Rd1 e5 Be3 O-O Rac1 Bg4', say: "Be3 and Rac1 complete the dream: BOTH rooks on the half-open c- and d-files, both bishops out, the queen active. White is a pawn down and stands fully comfortably — the open files and the d5-hole are lasting compensation.", sayShort: 'Rac1 — both rooks on the open files.', highlights: [H('c1'), H('d1'), H('d5')] }),
    ],
  },
  'smith-morra-gambit::Alapin Declined (2…Nf6)': {
    ...
    beats: [
      ...
      b({ id: 'a3', moves: 'e4 c5 d4 cxd4 c3 Nf6 e5 Nd5 Nf3 Nc6 cxd4 d6 Bc4 Nb6 Bb5 dxe5 Nxe5', say: "Bc4 hits the d5-knight, …Nb6 retreats, Bb5 pins the c6-knight, and after the central trade Nxe5 White's pieces are beautifully active around the e5-square.", sayShort: 'Nxe5 — active piece play.', highlights: [H('e5'), H('b5')] }),
      b({ id: 'a4', moves: 'e4 c5 d4 cxd4 c3 Nf6 e5 Nd5 Nf3 Nc6 cxd4 d6 Bc4 Nb6 Bb5 dxe5 Nxe5 Bd7 Nxd7 Qxd7 Nc3 e6 O-O Be7', say: "The minor pieces trade off and White castles with an easy, slightly pleasant game — no gambit pawn given at all in this line, just a healthy Alapin with the freer position.", sayShort: 'O-O — an easy, pleasant edge.', highlights: [H('e5')] }),
    ],
  },
  'smith-morra-gambit::d3 Return Declined': {
    ...
    beats: [
      ...
      b({ id: 'd2', moves: 'e4 c5 d4 cxd4 c3 d3 Bxd3 Nc6 c4', say: "Bxd3 recaptures the pawn, and c4! clamps the centre — a Maróczy Bind. White trades the gambit idea for a big, durable space advantage.", sayShort: 'c4 — clamp with the Maróczy Bind.', arrows: [A('c4', 'd5')], highlights: [H('c4'), H('d5')] }),
      ...
      b({ id: 'd4', moves: 'e4 c5 d4 cxd4 c3 d3 Bxd3 Nc6 c4 g6 Nc3 Bg7 Nf3 d6 O-O Nf6 h3 O-O Be3 Nd7 Rc1 Nde5', say: "h3, Be3 and Rc1 finish development with the rook on the half-open c-file. White is a clear pawn for nothing — no, BETTER: the Bind hands White a lasting space edge worth more than the returned pawn.", sayShort: 'Rc1 — bind plus the c-file.', highlights: [H('c4'), H('e4'), H('c1')] }),
    ],
  },
};
