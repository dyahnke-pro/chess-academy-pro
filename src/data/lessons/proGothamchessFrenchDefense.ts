...
export const PRO_GOTHAMCHESS_FRENCH_DEFENSE_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say:
        "The French — e4 e6, then …d5. Against the main Nc3 you play the Rubinstein: dxe4, trading off the centre right away. Some say it's passive. This repertoire plays it as a coiled spring — you're about to take on a striking pawn structure that most opponents have no idea how to meet.",
    ...
    b({
      ...
      say:
        "You challenge the e4-knight with Nf6, and after it takes, here's the bold choice: recapture with the g-pawn. Yes, your f-pawns are doubled now. But look what you got — a half-open g-file pointing at White's kingside, and a pawn on f6 ready to support a big centre. This isn't a weakness; it's a weapon.",
    ...
    b({
      ...
      say:
        "White develops the knight to f3; you bring yours to c6, pressuring White's d4-pawn and preparing the central break that justifies your whole structure. Every Black piece is going to point at the centre.",
    ...
    b({
      ...
      say:
        "White fianchettoes with g3; you strike with e5! And now those 'ugly' doubled pawns pay off: the f6-pawn rock-solidly supports e5, so you get a broad, strong centre. Black is rarely this active in the French — that's the point of the …gxf6 line.",
