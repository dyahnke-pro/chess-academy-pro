...
export const PRO_AMAN_RUY_LOPEZ_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  'pro-aman-ruy-lopez::Morphy (…a6)': {
    ...
    beats: [
      ...
      b({ id: 'bb3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3', arrows: [A('a4', 'b3')], highlights: [H('b3')],
  ...
  'pro-aman-ruy-lopez::Berlin (…Nf6)': {
    ...
    beats: [
      ...
      b({ id: 'oo', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 d3 Bc5 c3 O-O O-O d6', highlights: [H('c3')],
