...
import { SUBLINE_NARRATION_PRO_NAR_NAJ_ALEK_RUY } from './sublineNarrationProNaroditskyNajAlekRuy';
...
import { SUBLINE_NARRATION_PRO_CARUANA_NAJDORF } from './sublineNarrationProCaruanaNajdorf';
...
const MERGED_NARRATION: Record<string, SublineNarration> = {
  ...
  // Pro repertoire — Caruana + Carlsen subline narration (transcript-grounded).
  ...
  // Deep coverage — Naroditsky Najdorf + Alekhine + Ruy deviations (line-grounded).
  ...SUBLINE_NARRATION_PRO_NAR_NAJ_ALEK_RUY,
  // Deep coverage — Naroditsky Jobava + Fantasy deviations (line-grounded).
  ...SUBLINE_NARRATION_PRO_NAR_JOB_FAN,
  // Deep coverage — Naroditsky Dragodorf sublines + the deep tail (completes his set).
  ...
  // Caruana Najdorf — English Attack White 7th-move deviations (OTB build).
  ...SUBLINE_NARRATION_PRO_CARUANA_NAJDORF,
};
