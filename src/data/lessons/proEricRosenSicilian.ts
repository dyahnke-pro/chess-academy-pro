...
export const PRO_ERICROSEN_SICILIAN_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "The Accelerated Dragon. You trade your c-pawn for White's d-pawn and fianchetto the bishop fast with g6 — the 'accelerated' idea is that by delaying d6 you keep the option of the freeing …d5 break in one go. The dragon bishop will breathe fire down the long diagonal.",
    ...
    b({
      ...
      say: "White's most testing reply is c4 — the Maroczy Bind. The two pawns on c4 and e4 clamp down on d5 and take away your thematic break. This is the critical battleground: you accept a little less space in return for a rock-solid, flexible position with no weaknesses.",
    ...
    b({
      ...
      say: "You develop naturally — Bg7 onto the long diagonal, Nf6 hitting e4, and White completes the bind with Be3 and Nc3. The bishop on g7 already pressures the d4-knight and the centre; it is the best piece on the board.",
    ...
    b({
      ...
      say: "Both sides castle and you slot the pawn to d6, completing a flexible, harmonious setup. Nothing is weak, every piece has a job, and now the real Maroczy fight begins: how does Black generate play against the space bind?",
    ...
    b({
      ...
      say: "The standard Maroczy plan: trade a pair of knights with Nxd4 to relieve the cramp, then bring the bishop to d7 and follow with …a5 to grab queenside squares. Fewer pieces means the space bind matters less and your pieces find good homes.",
    ...
    b({
      ...
      say: "…a5! The key Maroczy lever. It gains queenside space, fixes White's b-pawn as a target, and clamps the b4-square for your pieces. From here you play …Nd7-c5 or …a4 and chip away — the bind cuts both ways once you have your own space.",
