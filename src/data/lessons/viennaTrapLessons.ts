...
const WURZBURGER: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      say: "Nf3! The trap springs — and it is the LAST thing Black is expecting. White completely ignores the knight on g3 and develops with TEMPO, attacking the Black queen on h4. Suddenly Black must save his queen before he saves his knight. The greedy plan reverses on him in a single move. This is the Wurzburger Trap: White's saving idea is not defence but counter-attack on the most powerful Black piece.",
    ...
    },
    {
      ...
      highlights: [H('h5', KEY)],
      say: "Qh5 — Black retreats the queen, but every queen-move now has consequences. He picked h5 because it still hovers near the kingside and pins the f3-knight along the h5-d1 diagonal. Black hopes the pin saves the day and that his knight on g3 will be defendable next move. But the pin is illusory — White's queen on d1 has an answer — and the g3-knight is hanging to the h2-pawn the entire time.",
...
const HAMPPE_MUZIO: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      say: "g4 — Black, having already been promised this kingside expansion, attacks the f3-knight. He thinks the knight has to retreat or trade itself for a pawn. He thinks White will play Ne5 or Nh4 in shame. But there is a third option that has terrified opponents for nearly two centuries.",
...
const COPYCAT_QG4: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      say: "Qxf2+! Black goes all-in on his original counter-attack. The queen captures the f2-pawn with check on the White king on e1. To a club player this looks decisive — the queen and bishop are now both threatening checkmate, and the c4-bishop is still on the long diagonal. Surely White must give up the king's right to castle and run? Yes. But that's exactly what he wants.",
    ...
    },
    {
      ...
      say: "Kd1!! White WALKS the king to d1 — a brilliant in-between move that refuses to spend tempo on defence. The king steps off e1 onto d1 where no Black piece can reach with check, and crucially the Nd5 STILL threatens Nxc7+ winning the rook. Black has temporarily won a pawn at f2, but his queen is dangerously exposed and his entire game-plan is hanging by a thread. Steinitz himself walked his king like this in attacking lines; the principle is the same — when you have the initiative, you can afford the king-walk.",
    ...
    },
    {
      ...
      say: "Black tries Kf8 to dodge the Nxc7+ fork by removing the rook target. White develops with Nh3 — bringing the other knight into play with eyes on g5 and f4 — and Black tries to consolidate with Qd4 threatening to trade queens off and escape the storm. White answers d3! protecting the position and continuing to develop. Black's queen is far from his army; every piece White brings out makes the queen's situation worse.",
...
const PIERCE_GAMBIT: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      say: "Nf3 — develop with tempo. Critically, the Nc3 has been ATTACKING the d5-queen since Black's queen landed there last move. Black must move the queen, which is one more lost tempo on top of the two pawns he chased. White is rapidly equalising material through development pressure.",
    ...
    },
    {
      ...
      say: "Bg4 — Black pins the f3-knight to the queen on d1, trying to maintain his developmental edge. But the pin is just a tactical resource, not a winning advantage. White has the e-file, the d4-pawn lever still in his pocket (to be replaced by Bxf4 next), the bishop on f1 ready for c4 with attack on the queen again, and full piece coordination right around the corner. The two pawns Black grabbed cost him five tempi of forced reactions.",
...
const STEINITZ_GAMBIT: LessonScript = {
  ...
  beats: [
    ...
    },
    {
      ...
      highlights: [H('f4', KEY)],
      say: "Bxf4! White recaptures the gambit pawn, getting his bishop into the attack on a square that eyes h6 (Black's kingside) AND attacks the d6-pawn. White has now caught up in pieces developed, recovered one of the sacrificed pawns, and his king on e2 is annoyingly still safer than Black's queen on h4. This is what Steinitz meant — opening rules don't apply when the centre is full of pieces and the opponent's queen is misplaced.",
