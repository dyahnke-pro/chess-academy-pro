...
const AUSTRIAN: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7',
      ...
      say: "The Pirc against the most aggressive try — the Austrian Attack with f4, grabbing a huge e4-d4-f4 pawn wall. You calmly fianchetto with …Bg7, aiming down the long diagonal. Let White have the space; the bigger that centre gets, the harder it falls when you hit it.",
    ...
    b({ id: 'c5', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 c5 Bb5+ Nc6',
      ...
      say: "You strike — …c5! straight at the base of the centre, the d4-pawn. This is the modern, critical answer to the Austrian: don't sit and get squashed, hit back instantly. White throws in Bb5-check; you block with …Nc6, developing AND adding a second attacker to d4.",
    ...
    b({ id: 'mg-e5', moves: 'e4 d6 d4 Nf6 Nc3 g6 f4 Bg7 Nf3 c5 Bb5+ Nc6 e5 Nd7',
      ...
      say: "White lunges e5; you slide the knight to d7, where it attacks the e5-pawn and eyes c5 and b6. Here's the middlegame: White's pawns look huge but they're overextended, and you're swarming them. The plan is …cxd4 and …dxe5, prying the centre apart so your g7-bishop roars down the long diagonal. The engine calls it dead level — give White the centre, then dismantle it.",
...
const CLASSICAL: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O',
      ...
      say: "Against the calm Classical setup — Nf3 and Be2 instead of the f4 storm — the Pirc is comfortable. You fianchetto, castle, and get a sound King's-Indian-style position. White has a space edge; you have the flexible structure and the thematic …e5 break in your pocket.",
    ...
    b({ id: 'nc6', moves: 'e4 d6 d4 Nf6 Nc3 g6 Nf3 Bg7 Be2 O-O O-O Nc6',
      ...
      say: "You develop …Nc6, pressuring d4 and e4 and preparing your central break. This is the active Pirc treatment: rather than sit passively, you put a question to White's centre and get ready to open the game for your fianchettoed bishop.",
...
const ATTACK_150: LessonScript = {
  ...
  beats: [
    b({ id: 'open', moves: 'e4 d6 d4 Nf6 Nc3 g6 Be3 c6',
      ...
      say: "The 150 Attack — White sets up Be3 and f3, planning Qd2 and Bh6 to trade your fianchetto bishop, then castle long and storm with h4-h5. You know the antidote: …c6, preparing a queenside pawn avalanche of your own. If it's a race, you want to be running too.",
