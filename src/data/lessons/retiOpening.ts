...
export const RETI_OPENING_LESSON: LessonScript = {
  ...
  orientation: "white",
  beats: [
    b({ id: "open", moves: "Nf3 d5 c4 e6 g3", say: "The Réti — Nf3 and c4 with a kingside fianchetto, the hypermodern opening named for Richard Réti, who used it to hand Capablanca his first loss in eight years. White does NOT rush to occupy the centre with pawns; instead they control it from afar with the fianchettoed bishop and pressures d5 from the flank, inviting Black to overextend.", sayShort: "g3 — the hypermodern Réti fianchetto.", highlights: [H("g3", KEY), H("d5", SOFT)] }),
