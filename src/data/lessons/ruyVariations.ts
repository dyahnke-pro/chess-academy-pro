...
const MARSHALL: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'm7', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5 exd5 Nxd5 Nxe5 Nxe5 Rxe5 c6 d4 Bd6 Re1 Qh4 g3 Qh3 Be3 Bg4 Qd3 Rae8',
      say: "Here is the honest verdict the engines deliver: with flawless play White survives and keeps the pawn — but a human at the board, meeting this storm cold, almost never finds every only-move. That practical terror is why the Marshall has scored for Black for a century, and why so many White players sidestep it entirely with the Anti-Marshall. Set it beside the main line: there White attacks slowly over forty moves; here Black attacks on move eight. This is championship theory on both sides of the duel — not a curiosity to skim.",
      sayShort: "Engines hold for White; humans crack. Know both sides — it's championship theory.",
      highlights: [H('g2', SOFT)] }),
  ],
};
...
const BREYER: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'r4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Nb8 d4 Nbd7 Nbd2 Bb7 Bc2 Re8 Nf1 Bf8 Ng3 g6 a4 c5 d5 c4 Bg5',
      say: "Finally the structure resolves: White clamps the centre with d5 and turns to the wings — a4 against the queenside, Bg5 and the f5-knight toward the king. The Breyer is the closed Ruy at its richest: a slow, two-winged maneuvering battle decided by who improves their pieces best.",
...
const ZAITSEV: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'z2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Bb7 d4 Re8 Nbd2 Bf8',
      say: "Black answers d4 with Re8 and Bf8 — keeping the centre tense and reinforcing e5 to the maximum. The threat is real: capture on d4 followed by Nb4, hitting the c2-bishop. This razor-sharp move-order precision is why the Zaitsev produced the famous repetition dramas of the Kasparov-Karpov matches.",
