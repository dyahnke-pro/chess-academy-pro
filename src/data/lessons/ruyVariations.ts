...
const BERLIN: LessonScript = {
  ...
  beats: [
    b({ id: 'b1', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6',
      ...
      sayShort: "…Nf6 — the Berlin: ignore a6, hit e4.",
      arrows: [A('f6', 'e4', ATK)], highlights: [H('e4', KEY)] }),
    b({ id: 'b2', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8',
      say: "And here is what makes the Berlin unique: the queens come straight off, and Black's king is dragged to d8, losing the right to castle. In return Black gets the two bishops and doubled c6 and c7 pawns — a structure that simply will not crack. This queenless middlegame is the whole point.",
      sayShort: "Queens off, Kd8 — bishops vs doubled pawns.",
    ...
    b({ id: 'b3', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8 h3 Ke8 Nc3 h5',
      ...
      sayShort: "White's kingside majority vs Black's bishop pair.",
    ...
    b({ id: 'b4', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8 h3 Ke8 Nc3 h5 Bf4 Be7 Rad1 Be6',
      say: "White develops to pester the awkward king — knight to c3, bishop to f4, rooks to the center. Black calmly unbundles: the bishop comes to e6, the king walks to safety, and the two bishops on e6 and e7 start eyeing the long diagonals — one slicing all the way down to a2, the other down to a3.",
      sayShort: "White probes; Black untangles and activates the bishops.",
      arrows: [A('e6', 'a2', VIS), A('e7', 'a3', VIS)],
      highlights: [H('e6', SOFT), H('e7', SOFT)] }),
    b({ id: 'b5', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8 h3 Ke8 Nc3 h5 Bf4 Be7 Rad1 Be6 Ng5 Bxg5 Bxg5',
      ...
      sayShort: "The technical endgame — majority vs bishops, usually drawn." }),
    b({ id: 'b6', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8 h3 Ke8 Nc3 h5 Bf4 Be7 Rad1 Be6 Ng5 Bxg5 Bxg5',
      say: "So how does White actually try to win? There is only one path: nurse that clean kingside majority — e5, f2, g2, h3 against f7, g7, h5 — until it births a passed pawn, while the rook stares from d1 down the open d-file at d8 and the bishop on g5 stops Black's king from coordinating. Black's whole defence rests on the blockading knight on f5, the bishop on e6, and walking the king to safety. This endgame is decided square by square, not by force.",
      sayShort: "White's try: push the majority; Black blockades f5.",
    ...
    b({ id: 'b7', moves: 'e4 e5 Nf3 Nc6 Bb5 Nf6 O-O Nxe4 d4 Nd6 Bxc6 dxc6 dxe5 Nf5 Qxd8+ Kxd8 h3 Ke8 Nc3 h5 Bf4 Be7 Rad1 Be6 Ng5 Bxg5 Bxg5',
      ...
      sayShort: "The Berlin — championship theory; it dethroned Kasparov." }),
  ],
};
...
const OPEN: LessonScript = {
  ...
  beats: [
    b({ id: 'o1', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4',
      ...
      sayShort: "The Open Ruy — …Nxe4 for fast, active play.",
      highlights: [H('e4', KEY)] }),
    b({ id: 'o2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4 d4 b5 Bb3 d5 dxe5 Be6',
      say: "White strikes back in the center with d4, Black props the knight with b5 and d5, and a sharp pawn chain forms. Black's solid d5-pawn, screened by the e6-bishop, anchors the active knight — and White's wedge sits on e5 — the structure that defines the Open Ruy.",
      sayShort: "…d5, …Be6 anchor the knight; e5 wedge.",
    ...
    b({ id: 'o3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4 d4 b5 Bb3 d5 dxe5 Be6 Nbd2 Nc5 c3 d4',
      ...
      sayShort: "White leans on Bb3 and the light squares.",
    ...
    b({ id: 'o4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4 d4 b5 Bb3 d5 dxe5 Be6 Nbd2 Nc5 c3 d4 Ng5 dxc3 Nxe6 fxe6',
      say: "White's knight jumps to g5 and trades itself for the prized e6-bishop, opening the f-file in front of Black's uncastled king. White's e5 wedge still cramps. The whole opening, opposite in temperament to the slow main line, comes down to this: Black's activity against White's targets on the light squares.",
      sayShort: "Ng5 — trades Be6, opens the f-file; e5 cramps.",
    ...
    b({ id: 'o5', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4 d4 b5 Bb3 d5 dxe5 Be6 Nbd2 Nc5 c3 d4 Ng5 dxc3 Nxe6 fxe6',
      say: "Here is the Open Ruy's whole bargain in one frame. Black has handed over the e6-bishop and their king sits on a freshly opened f-file — but in exchange they own the advanced c3-pawn and two knights biting deep into White's camp. White's plan writes itself: round up that c3-pawn and lean on the light squares the missing bishop left behind, above all the weakened e6-pawn and the long diagonal the b3-bishop already rakes.",
      sayShort: "White hunts c3 and the holes; Black hurries.",
    ...
    b({ id: 'o6', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Nxe4 d4 b5 Bb3 d5 dxe5 Be6 Nbd2 Nc5 c3 d4 Ng5 dxc3 Nxe6 fxe6',
      say: "This is the Ruy turned inside out, and it matters because it changes the very question of the opening. The main line is patience — Black reroutes and waits for the slow squeeze. The Open Variation flatly refuses: from move five Black trades the e5-pawn for piece activity and turns the game into a race. It was Korchnoi's lifelong weapon against the Spanish and remains the answer of every player who finds the Closed Ruy too quiet. Same three opening moves, completely different music.",
      sayShort: "Korchnoi's antidote — trade e5 for a race.",
...
const MARSHALL: LessonScript = {
  ...
  beats: [
    b({ id: 'm1', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3',
      ...
      sayShort: "A normal closed Ruy — but a bombshell waits." }),
    b({ id: 'm2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5',
      ...
      sayShort: "d5! — the Marshall gambit, ripping the centre open.",
    ...
    b({ id: 'm3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5 exd5 Nxd5 Nxe5 Nxe5 Rxe5 c6',
      ...
      sayShort: "A pawn up — but Black's pieces all attack." }),
    b({ id: 'm4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5 exd5 Nxd5 Nxe5 Nxe5 Rxe5 c6 d4 Bd6 Re1 Qh4 g3 Qh3',
      say: "Here comes the storm. The bishop swings to d6 — firing straight down the diagonal at g3 — the queen leaps to h4, White's g3 push tries to chase her away but she defies it and lands on h3, glued to White's king. Black threatens mating ideas against g2 and down the h-file; White must defend with absolute precision.",
      sayShort: "…Bd6, …Qh4 — the attack crashes onto g2.",
    ...
    b({ id: 'm5', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5 exd5 Nxd5 Nxe5 Nxe5 Rxe5 c6 d4 Bd6 Re1 Qh4 g3 Qh3 Be3 Bg4 Qd3 Rae8',
      say: "White returns the extra pawn for shelter — Be3, Qd3 — while Black keeps pouring fuel on the fire: Bg4 pins down the d1-back-rank diagonal, Rae8 swings the rook into the attack. This is the Marshall's bargain: a pawn for a permanent initiative, and a single inaccuracy by White can be fatal. The opposite of the patient main line — here, Black attacks from move eight.",
      sayShort: "…Bg4, …Rae8 — a pawn for lasting initiative.",
    ...
    b({ id: 'm6', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5 exd5 Nxd5 Nxe5 Nxe5 Rxe5 c6 d4 Bd6 Re1 Qh4 g3 Qh3 Be3 Bg4 Qd3 Rae8',
      say: "Count the attackers, because that is the entire evaluation. The queen on h3 is glued to g2; the bishop on g4 rakes the d1-back-rank; the bishop on d6 and both rooks pour down at the white king. White is a clean pawn up and stands worse — every defensive move from here is an only-move. That is the Marshall's promise: a permanent initiative is worth more than the pawn it cost.",
      sayShort: "Five pieces swarm for one pawn — only-moves needed.",
    ...
    b({ id: 'm7', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5 exd5 Nxd5 Nxe5 Nxe5 Rxe5 c6 d4 Bd6 Re1 Qh4 g3 Qh3 Be3 Bg4 Qd3 Rae8 Nd2',
      ...
      sayShort: "Nd2 — the only move, shielding the king.",
    ...
    b({ id: 'm8', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5 exd5 Nxd5 Nxe5 Nxe5 Rxe5 c6 d4 Bd6 Re1 Qh4 g3 Qh3 Be3 Bg4 Qd3 Rae8 Nd2 Re6 a4',
      say: "Black swings the rook to e6 for the final wave — and now White's whole defensive philosophy in one move: a4! Do not cower; counterattack the OTHER wing. White strikes the b5-pawn, and suddenly Black has problems of their own to solve before any mate arrives. The attack has no forced breakthrough, so White makes threats instead of only parrying them.",
      sayShort: "a4! — counterattack b5 instead of cowering.",
    ...
    b({ id: 'm9', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O c3 d5 exd5 Nxd5 Nxe5 Nxe5 Rxe5 c6 d4 Bd6 Re1 Qh4 g3 Qh3 Be3 Bg4 Qd3 Rae8 Nd2 Re6 a4 Qh5',
      say: "The queen drops to h5 — the storm spends itself, the mating threats against g2 finally fade, and White stands a clean pawn up with the king intact. This is the Spassky main line, and the honest verdict: with these exact only-moves White survives, but a human meeting the storm cold rarely finds every one. That practical terror is why the Marshall has scored for Black for a century, and why many White players sidestep it with the Anti-Marshall. Now you know the moves that hold.",
      sayShort: "Qh5 — the g2 threats fade; White's pawn holds.",
...
const EXCHANGE: LessonScript = {
  ...
  beats: [
    b({ id: 'x1', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Bxc6 dxc6',
      say: "The Exchange Variation, Bobby Fischer's favourite way to play the Ruy. Instead of retreating, White simply takes on c6 — and Black's d-pawn recaptures, stacking up on top of the c7-pawn. White gives up the bishop pair on purpose — to hand Black a permanent structural flaw.",
      sayShort: "Bxc6 dxc6 — Fischer's Exchange, doubling the c-pawns.",
      highlights: [H('c6', KEY), H('c7', KEY)] }),
    b({ id: 'x2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Bxc6 dxc6 O-O f6 d4 exd4 Nxd4',
      say: "Here is the whole idea in one picture. White has a healthy four-against-three majority on the kingside — that can make a passed pawn in an endgame. Black's queenside majority is crippled by the doubled c6 + c7 pawns and can never produce one. White wants to trade pieces and grind that difference home.",
      sayShort: "White's kingside majority vs Black's doubled c-pawns.",
      highlights: [H('c6', SOFT), H('c7', SOFT)] }),
    b({ id: 'x3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Bxc6 dxc6 O-O f6 d4 exd4 Nxd4 c5 Nb3 Qxd1 Rxd1 Bg4',
      say: "So White steers toward the endgame, even inviting the queens off the d1-square. Black's compensation is real — the two bishops and a big pawn centre give active play in the middlegame. The fight is a race: can Black's bishops do damage before White's pure structure decides a long ending?",
      sayShort: "Queens off; Black's bishops race White's structure.",
      arrows: [A('g4', 'd1', VIS)] }),
...
const BREYER: LessonScript = {
  ...
  beats: [
    b({ id: 'r1', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Nb8',
      say: "The Breyer is the deepest expression of the closed Ruy — and it features the strangest move in the whole opening: the knight retreats all the way home to b8, eyes already on d7. It looks like a beginner's blunder; it is one of the most respected ideas in chess.",
      sayShort: "…Nb8 — the Breyer, rerouting via d7.",
    ...
    b({ id: 'r2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Nb8 d4 Nbd7 Nbd2 Bb7',
      say: "The point: the knight reroutes to d7, where it braces e5 and clears the way for the bishop to reach the long diagonal on b7. Capablanca prized exactly this bishop for the great pressure it exerts down the long diagonal at e4 and the white centre.",
      sayShort: "…Nbd7, …Bb7 at e4 — Capablanca's harmony.",
      arrows: [A('b7', 'e4', ATK)] }),
    b({ id: 'r3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Nb8 d4 Nbd7 Nbd2 Bb7 Bc2 Re8 Nf1 Bf8 Ng3 g6',
      ...
      sayShort: "White's knight heads g3-f5; Black coils behind …Bg7.",
    ...
    b({ id: 'r4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Nb8 d4 Nbd7 Nbd2 Bb7 Bc2 Re8 Nf1 Bf8 Ng3 g6 a4 c5 d5 c4 Bg5',
      say: "Finally the structure resolves: White clamps the centre with d5, Black drives a queenside wedge with the c4-pawn, and White turns to the wings — a4 against the queenside, Bg5 and the knight, bound for the f5 outpost, toward the king. The Breyer is the closed Ruy at its richest: a slow, two-winged maneuvering battle decided by who improves their pieces best.",
      sayShort: "d5 locks it, c4 wedges — a two-winged battle.",
    ...
    b({ id: 'r5', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Nb8 d4 Nbd7 Nbd2 Bb7 Bc2 Re8 Nf1 Bf8 Ng3 g6 a4 c5 d5 c4 Bg5',
      ...
      sayShort: "Opposite wings — White Ng3-f5, Black the c4 wedge.",
    ...
    b({ id: 'r6', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Nb8 d4 Nbd7 Nbd2 Bb7 Bc2 Re8 Nf1 Bf8 Ng3 g6 a4 c5 d5 c4 Bg5',
      ...
      sayShort: "The deepest Closed Ruy — Spassky, Karpov, Kasparov.",
...
const CHIGORIN: LessonScript = {
  ...
  beats: [
    b({ id: 'c1', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Na5',
      say: "Where the Breyer reroutes the knight backward, the Chigorin sends it forward to the edge — Na5, straight at White's prized b3-bishop. Black's plan is concrete: trade or chase that bishop, then expand in the centre with c5.",
      sayShort: "…Na5 — the Chigorin, hitting Bb3, then …c5.",
    ...
    b({ id: 'c2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Na5 Bc2 c5',
      ...
      sayShort: "Bc2 keeps the diagonal; Black grabs c5 space.",
    ...
    b({ id: 'c3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Na5 Bc2 c5 d4 Qc7 Nbd2 Nc6 d5 Nd8 Nf1',
      ...
      sayShort: "d5 locks it — opposite wings, White kingside.",
    ...
    b({ id: 'c4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Na5 Bc2 c5 d4 Qc7 Nbd2 Nc6 d5 Nd8 Nf1',
      ...
      sayShort: "…c5 expands; White clamps d5 and aims h7.",
    ...
    b({ id: 'c5', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Na5 Bc2 c5 d4 Qc7 Nbd2 Nc6 d5 Nd8 Nf1',
      say: "For decades the Chigorin WAS the main line of the Ruy Lopez — the tabiya through which world titles were fought. So treat it as bedrock, not a branch. Where the Breyer reroutes the knight backward to d7, the Chigorin sends it forward to a5 to settle accounts with the b3-bishop immediately. Same Closed Ruy spine, a different answer to the same eternal question: what do you do about that annoying Spanish bishop?",
      sayShort: "…Na5 — for decades the Ruy's main line.",
...
const ZAITSEV: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'z3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Bb7 d4 Re8 Nbd2 Bf8 a4 h6 Bc2 exd4 cxd4 Nb4 Bb1 c5 d5 Nd7 Ra3',
      say: "The play turns concrete fast: Black releases the tension, jumps the knight to b4 to harass the bishop, and strikes with c5. White clamps with d5 and unveils the signature Zaitsev idea — the rook lift Ra3, swinging across the third rank toward Ng3 and the kingside. A tense, theory-heavy battle where a single tempo decides the evaluation.",
      sayShort: "The Ra3-g3 lift swings at the king — theory-heavy.",
    ...
    b({ id: 'z4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Bb7 d4 Re8 Nbd2 Bf8 a4 h6 Bc2 exd4 cxd4 Nb4 Bb1 c5 d5 Nd7 Ra3',
      say: "The position bristles with concrete threats. Black's knight has leapt to b4 to harass the bishop and now presses against the d5-clamp; White's signature resource is the rook lift — the rook already on a3, ready to swing along the third rank via g3 toward the black king the instant the f3-knight steps aside. A single tempo flips the evaluation here, which is exactly why entire World Championship games dissolved into the move-repetition draws neither Karpov nor Kasparov dared avoid.",
      sayShort: "…Nb4 hits d5; Ra3-g3 waits — one tempo decides.",
    ...
    b({ id: 'z5', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 d6 c3 O-O h3 Bb7 d4 Re8 Nbd2 Bf8 a4 h6 Bc2 exd4 cxd4 Nb4 Bb1 c5 d5 Nd7 Ra3',
      say: "The Zaitsev was Karpov's lifelong main weapon, fed to him by the very trainer it is named for, and it carried the highest-stakes matches in history. So this is not a line to dabble in — it is a line to know cold. It is the sharpest, most theory-soaked branch of the Closed Ruy: the same d6, O-O setup as the Breyer and Chigorin, but with the bishop committed early to b7 raking at e4, and the centre held at maximum tension. Where the Breyer is patience and the Chigorin is queenside space, the Zaitsev is precision under fire.",
      sayShort: "Karpov's weapon — …Bb7 on e4, know it cold.",
...
const ANTI_MARSHALL: LessonScript = {
  ...
  beats: [
    b({ id: 'am1', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O a4',
      ...
      sayShort: "a4 — the Anti-Marshall, hitting b5 first.",
      highlights: [H('b5', KEY)] }),
    b({ id: 'am2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O a4 b4 d3 d6 Nbd2 Na5 Ba2',
      say: "Edward Lasker noted this exact idea: the a4 advance is strong because it can pressure or weaken Black's queenside pawns, and the b-pawn can become an endgame target. Black closes with b4 and plays for the centre; White settles for the quiet d3 and the slow Spanish maneuvering they wanted all along.",
      sayShort: "Lasker's a4 — pressure the queenside, slow game.",
    ...
    b({ id: 'am3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O a4 b4 d3 d6 Nbd2 Na5 Ba2 c5 c3 Rb8 Nf1 Bd7',
      ...
      sayShort: "A quiet strategic battle — the Anti-Marshall's aim.",
    ...
    b({ id: 'am4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O a4 b4 d3 d6 Nbd2 Na5 Ba2 c5 c3 Rb8 Nf1 Bd7',
      say: "Having dodged the gambit, White settles into exactly the squeeze they wanted. The knight reroutes Nf1-g3 toward the f5 outpost, the bishop on a2 rakes the long light diagonal straight at f7, and the slow Spanish maneuvering begins. Black has closed the queenside with b4 and plays for c5 and central space. No fireworks here — just the patient accumulation that is the Ruy Lopez's truest nature, the game White was always angling for.",
      sayShort: "Slow squeeze — Nf1-g3 to f5, Ba2 on f7.",
    ...
    b({ id: 'am5', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O Be7 Re1 b5 Bb3 O-O a4 b4 d3 d6 Nbd2 Na5 Ba2 c5 c3 Rb8 Nf1 Bd7',
      say: "Do not read the Anti-Marshall as fear. It is the modern elite's preferred answer — Carlsen, Caruana and Nepomniachtchi all play a4 against b5 here rather than wade into the Marshall's forced waterfall of memorized moves. The lesson generalizes far beyond this opening: when your opponent owns a beautiful piece of preparation, the strongest reply is often to deny him the position altogether and keep the game in your own slow waters. That is a champion's pragmatism, not timidity.",
      sayShort: "a4 attacks b5 — denying Black the Marshall.",
...
const ARKHANGELSK: LessonScript = {
  ...
  beats: [
    b({ id: 'k1', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O b5 Bb3 Bb7',
      say: "Black's most aggressive legitimate try in the a6 complex. Instead of the modest Be7, Black fianchettoes fast — b5 and Bb7 — aiming the bishop down the long diagonal toward e4. Black doesn't want to sit and reroute; they point everything forward.",
      sayShort: "The Arkhangelsk — fast …b5, …Bb7 at e4.",
      highlights: [H('e4', KEY)] }),
    b({ id: 'k2', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O b5 Bb3 Bb7 d3 Be7 Nc3 O-O',
      ...
      sayShort: "…Bb7 pressure forces White's solid d3, Nc3.",
      highlights: [H('e4', SOFT)] }),
    b({ id: 'k3', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O b5 Bb3 Bb7 d3 Be7 Nc3 O-O a3 d6 Ba2',
      ...
      sayShort: "Ba2 keeps the f7 diagonal; active Black pieces.",
    ...
    b({ id: 'k4', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O b5 Bb3 Bb7 d3 Be7 Nc3 O-O a3 d6 Ba2',
      ...
      sayShort: "…Bb7/e7 vs Ba2 and the Nd5 reroute.",
    ...
    b({ id: 'k5', moves: 'e4 e5 Nf3 Nc6 Bb5 a6 Ba4 Nf6 O-O b5 Bb3 Bb7 d3 Be7 Nc3 O-O a3 d6 Ba2 Qd7 Re1 Rfe8',
      ...
      sayShort: "…Bb7 rakes e4 early — Black's aggressive answer.",
      highlights: [H('e4', SOFT)] }),
  ],
};
