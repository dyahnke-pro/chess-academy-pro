...
const C3_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'col-c3-2', moves: 'd4 d5 Nf3 Nf6 e3 c5 c3 e6 Bd3 Nc6 Nbd2 Bd6',
      say: "You develop with purpose — …Nc6 and …e6 — and then the critical …Bd6, planting your bishop on the very b8-h2 diagonal White covets, staring back at their attacking bishop on d3. This is the whole point: mirror White's setup and their 'attack' has nothing left to bite on.",
...
const B3_LESSON: LessonScript = {
  ...
  beats: [
    b({ id: 'col-b3-1', moves: 'd4 d5 Nf3 Nf6 e3 c5 b3 Nc6',
      say: "The Colle-Zukertort: White fianchettoes the queen's bishop with b3, planning Bb2 and a slow kingside build-up. You meet it head-on with a broad centre — …d5 and …c5 — and rapid, natural development. Active, classical play denies White the quiet squeeze they are angling for.",
    ...
    b({ id: 'col-b3-3', moves: 'd4 d5 Nf3 Nf6 e3 c5 b3 Nc6 dxc5 Bg4 Be2 e6 Ba3 Ne4 O-O Bxc5 Bxc5 Nxc5',
      say: "You regain the pawn cleanly — …Bxc5 and …Nxc5 — landing a beautifully centralized knight with full equality. White's queenside adventure has left them nothing but loose squares, while your pieces sit on the best posts on the board. If anyone is pressing here, it's you.",
    ...
    b({ id: 'col-b3-4', moves: 'd4 d5 Nf3 Nf6 e3 c5 b3 Nc6 dxc5 Bg4 Be2 e6 Ba3 Ne4 O-O Bxc5 Bxc5 Nxc5 Nbd2 O-O c4 dxc4 bxc4',
      say: "White tries to free themselves with c4, but after …dxc4 and bxc4 they are left with an isolated, weak c4-pawn to nurse. You are fully equal — better, in fact: two active knights, a clear target on c4, and no weaknesses of your own. The Colle-Zukertort has been comprehensively out-played.",
