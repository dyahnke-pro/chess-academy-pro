...
const NC3_QUEEN_TEMPO: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "After the …d5 simplification, Black recaptures with the queen on d5. The queen is centralised and looks active — but she's the only developed piece, and your knight on b1 is about to make her uncomfortable.",
    ...
    b({
      ...
      say: "Black plays …e6 preparing development. Solid, but it doesn't address the queen's vulnerability. You develop the queen's knight next — and her position becomes the problem.",
    ...
    b({
      ...
      say: "Nc3 — and the queen has to move. This is the difference between your Alapin and a regular open Sicilian: c3 is a knight square now, and Nc3 develops AND attacks at the same time. Black has no good queen square that doesn't lose another tempo.",
...
const BC4_GAMBIT_EXF7: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Inside the …Nf6 spine, Black plays …d6 attacking the e5-pawn. Most beginners would play dxe5 here and transpose to safer territory. You don't — you develop Bc4 instead, eyeing f7 and offering the pawn as a gambit.",
    ...
    b({
      ...
      say: "e6! — the pawn marches forward. You're not protecting it, you're using it as a wedge. The pawn touches f7 and Black has to react before you crack open the king. This is the signature move that 62 of his opponents — including Hans Niemann at 3161 — walked into.",
    ...
    b({
      ...
      say: "Black grabs the bishop with …Nxc4 — and you play Qa4+! The check forces Black to interpose with …Nc6 (the only piece that can block). Then exf7+ Kxf7 — the king walks out to f7 and now sits exposed in the centre, with no kingside shelter and no castling rights.",
    ...
    b({
      ...
      say: "Qxc4+ recovers the bishop. Material is even, but Black's king is permanently on f7, the kingside is a wreck, and you get to castle for free while Black has to find precise defence with no king shelter. This is a forced sequence and Black's rating bucket almost never finds the right defence.",
...
const D5_OPEN_NB5: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "In the d5 Open, you play Na3 — a strange-looking knight move whose whole point is the trip to b5. Be3 supports d4 and waits for Black to commit. Black has to deal with the centre eventually, and the most natural move walks into the trap.",
    ...
    b({
      ...
      say: "Nb5! — the trip pays off. The knight forks d4 AND the c7/d6 outpost squares. Black's queen on d5 has to move or risk getting trapped, and the d4-pawn is hanging. Either way you win the tempo battle.",
    ...
    b({
      ...
      say: "Black retreats …Qd8, you recapture Nbxd4, Black tries to centralise with …Nd5, and you trade Nxc6 bxc6 — Black ends up with doubled c-pawns AND you keep the bishop pair. The structural edge converts smoothly in the R+min+P endgame.",
...
const BXF7_WALK_IN: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "Black plays …d6 and you throw in Bb5+ before retreating to c4 — gaining a tempo on the bishop's path to its prize square. Nb6 chases your bishop, but now Bxf7+ is set up: the bishop on c4 and the e5-pawn coordinate against f7.",
    ...
    b({
      ...
      say: "exd7 grabs the bishop back — you've recovered the material AND removed Black's most coordinated piece AND wrecked Black's king position. Black recaptures Qxd7, you castle, and play d4 opening the centre while every White piece swarms in. The opening is over and you're already winning.",
...
const BG4_PIN_REFLEX: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "In the Nc6 line, after Black recaptures …Qxd5, you play Nf3 — natural development. But here Black often reaches reflexively for …Bg4 hoping to pin the knight against your queen.",
    ...
    b({
      ...
      say: "…Bg4 — the pin reflex. Black thinks this restricts your development, but the queen on d5 is the real victim of this position, not the knight on f3. You ignore the pin entirely and play the move that exposes Black's queen.",
    ...
    b({
      ...
      highlights: [H('c3'), H('d5', ATK)],
      say: "Nc3! — same tempo-on-the-queen trick as the main Nc6 weapon, except now Black has TWO awkward problems: the queen has no good square AND the bishop on g4 is committed to the wrong diagonal. The pin doesn't matter because you won't ever play Be2 to break it.",
    ...
    b({
      ...
      highlights: [H('d4')],
      say: "Black commits to the trade with …Bxf3 gxf3, then grabs your d4-pawn with the queen, and you exchange queens. The position simplifies into an endgame where you have doubled f-pawns but the bishop pair. The pair compensates for the doubled pawn in every R+min+P endgame — and that's the endgame Black is now stuck with.",
      sayShort: 'Bishop pair vs doubled pawn — you\'re better.',
    }),
  ],
};
...
const PREMATURE_D4: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say: "Black plays …cxd4 cxd4 …d5! exd5 …Qxd5 — Black's queen comes out with tempo and reaches a Scandinavian-style position with full equality. Your 73.8% main spine score is dead because Black struck FIRST with d5 before you could set up the c3-d4 cramp.",
...
const BC2_RETREAT: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "After your central trade and short castle, Black plays …Be6 offering the bishop trade. The bishop on e6 is Black's best piece — the light-squared bishop is the coordination anchor for the whole position. Black wants the trade because keeping the bishop pair is worth a tempo.",
    ...
    b({
      ...
      say: "Black castles long — …O-O-O — and the picture is grim. Black keeps the bishop pair, gets the rook on the half-open d-file, and has active piece play across the board. Your 73.8% conversion plan (the queenside a4-a5-a6 crawl) is DEAD because the bishop on c2 isn't aiming at anything.",
...
const BE2_RETREAT_BG4: LessonScript = {
  ...
  beats: [
    b({
      ...
      highlights: [H('g4'), H('f3', SOFT), H('d1', SOFT)],
      say: "In the d5 Open, Black plays …Bg4 pinning your Nf3 against the queen. The pin LOOKS scary — moving the knight loses the queen. The panic move is Be2 to defuse the pin.",
    ...
    b({
      ...
      say: "Black trades …Bxf3 Bxf3, retreats …Qd6 to safety, develops calmly with …e6 Be7 O-O, and has fully equalised. Your light-squared bishop never reaches its real diagonal, and the Nb5-outpost / Bc4-Bb3 plan that wins the d5 Open is dead. The whole variation collapses.",
...
const NBXD4_OUTPOST: LessonScript = {
  ...
  beats: [
    b({
      ...
      say: "You've reached the d5 Open Nb5-outpost position. Black has retreated …Qd7 saving the queen. Your knight on b5 sits in front of c7 / d6 — the outpost squares you want. The question is which knight recaptures on d4.",
    ...
    b({
      ...
      say: "Black trades …Nxd4, you recapture …Qxd4, and Black plays …a6 cementing the queenside. Without the Nb5 outpost you have no structural advantage — the position is symmetric and Black equalises completely. The 33.7% R+min+P endgame conversion the d5 Open promises is gone.",
    ...
    b({
      ...
      say: "The fix: Nfxd4! Recapture with the f3-knight instead, keeping the Nb5 outpost alive. The knight on b5 keeps eyeing c7 and d6, the structural pressure stays, and you win the resulting middlegame on the queenside crawl. The right knight makes the recapture matter.",
