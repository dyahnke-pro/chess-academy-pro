...
export const PRO_GOTHAMCHESS_PIRC_DEFENSE_LESSON: LessonScript = {
  ...
  beats: [
    b({
      ...
      say:
        "The Pirc — e4 d6 and …Nf6, …g6. This is hypermodern chess: you INVITE White to build a giant pawn centre, because a big centre is also a big target. You fianchetto the bishop to g7, aim it down the long diagonal, and prepare to chip the whole thing down.",
    ...
    b({
      ...
      say:
        "White goes all in with f4 — the Austrian Attack, the most aggressive try, grabbing a huge e4-d4-f4 pawn wall. You calmly complete the fianchetto with Bg7. Let White have the space; the bigger that centre gets, the harder it falls when you hit it.",
    ...
    b({
      ...
      say:
        "White develops Nf3; you strike — c5! Straight at the base of the centre, the d4-pawn. This is the modern, critical answer to the Austrian: don't sit and get squashed, hit back instantly. The big wall is suddenly under real pressure.",
    ...
    b({
      ...
      say:
        "White throws in Bb5-check to disrupt you; you block naturally with Nc6, developing a piece AND adding a second attacker to d4. The check looks annoying but it just helps you bring a knight to a great square. You're developing with threats.",
