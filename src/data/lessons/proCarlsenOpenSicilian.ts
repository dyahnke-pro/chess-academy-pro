...
export const PRO_CARLSEN_OPEN_SICILIAN_LESSON: LessonScript = {
  ...
  title: "This repertoire's Open Sicilian — the Najdorf English Attack",
  minutes: 12,
  orientation: 'white',
  kind: 'variation',
  sources: SRC,
  beats: [
    b({ id: 'open', moves: 'e4 c5 Nf3 d6 d4', highlights: [H('d4')], say: "The Sicilian is the most combative answer to e4, and this repertoire meets it head-on with the Open — the principled d4 break. No sidesteps: they open the centre, takes the d4-square for a piece, and plays for the full board. This is their single most-played White weapon, scoring nearly seventy-seven percent across more than a thousand games.", sayShort: 'd4 — open it, play for everything.' }),
    b({ id: 'najdorf', moves: 'e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 a6', arrows: [A('c3', 'd5')], highlights: [H('d5'), H('a6')], say: "You reach the Najdorf, the deepest battleground in all of chess. Black's a6 is the famous prophylactic move — it stops anything landing on b5 and prepares queenside expansion. Notice the d5-square: that hole is the heart of the fight. Whoever controls it controls the game.", sayShort: 'Najdorf — a6, and the d5 fight.' }),
    b({ id: 'be3', moves: 'e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 a6 Be3', highlights: [H('e3')], say: "Be3 — the English Attack. The bishop eyes the queenside dark squares and the whole setup says one thing: castle long and hurl the kingside pawns forward. This is the line this repertoire trusts most, because it lets him attack and keep a sound structure at the same time.", sayShort: 'Be3 — the English Attack.' }),
