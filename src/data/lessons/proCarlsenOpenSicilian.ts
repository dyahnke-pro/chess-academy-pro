...
export const PRO_CARLSEN_OPEN_SICILIAN_LESSON: LessonScript = {
  ...
  sources: SRC,
  beats: [
    b({ id: 'open', moves: 'e4 c5 Nf3 d6 d4', highlights: [H('d4')], say: "The Sicilian is the most combative answer to e4, and this repertoire meets it head-on with the Open — the principled d4 break. No sidesteps: he opens the centre, takes the d4-square for a piece, and plays for the full board. This is his single most-played White weapon, scoring nearly seventy-seven percent across more than a thousand games.", sayShort: 'd4 — open it, play for everything.' }),
