...
export const SCHLIEMANN_DEFENCE_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'qg5', moves: 'e4 e5 Nf3 Nc6 Bb5 f5 Nc3 fxe4 Nxe4 d5 Nxe5 dxe4 Nxc6 Qg5', say: "Nxc6 wins a piece for the moment — but …Qg5! is the point: the queen springs out, threatening …Qxg2 to grab the loose g2-pawn and the rook behind it, while …bxc6 next rounds up the knight. Black regains the material with a powerful initiative. There is the Classical Schliemann tabiya: a sharp, double-edged fight where Black's active queen and open lines fully answer White's extra structure. The other tabs show the Schönemann 4.d4, the Jänisch-Accepted 4.exf5, and the solid Dyckhoff 4.d3.", sayShort: '…Qg5 — threaten …Qxg2, regain material.', arrows: [A('g5', 'g2')], highlights: [H('g5'), H('g2')] }),
  ],
};
