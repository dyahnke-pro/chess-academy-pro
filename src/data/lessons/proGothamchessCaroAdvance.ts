...
export const PRO_GOTHAMCHESS_CARO_ADVANCE_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({
      ...
      say:
        "d4 grabs the centre with both pawns; Black hits back with d5. Now the tension. You don't trade and you don't defend — you advance.",
    ...
    b({
      ...
      say:
        "e5 — the Advance. The pawn locks the centre and stakes out a wedge that cramps Black for the whole game. Unlike the French, Black's light-squared bishop is still free to come out — and your entire plan is built around making that bishop's life miserable.",
    ...
    b({
      ...
      say:
        "Black develops the bishop outside the chain to f5 — the move that justifies the whole Caro. That bishop is Black's pride. So you're going to hunt it.",
    ...
    b({
      ...
      say:
        "h4 — This repertoire's signature. You grab kingside space and threaten h5, which would slam the door on the f5-bishop's retreat squares. It's the move that gives the modern Advance its bite.",
    ...
    b({
      ...
      say:
        "Black stops the pawn with h5. But look what it costs him: the h5-pawn is now a fixed target, and the g5-square is permanently weak. That square is about to become yours.",
    ...
    b({
      ...
      say:
        "Black swings the queen to b6, the standard Caro counter-pressure — eyeing the b2-pawn and leaning on d4. You're not worried. You finish developing and let the space tell.",
    ...
    b({
      ...
      say:
        "Bd3 — and there's the hunt. The bishop challenges Black's prized light-squared bishop head-on. Black almost always trades, which is exactly what you want: it opens lines for your queen and leaves Black a passive piece short.",
    ...
    b({
      ...
      say:
        "Black takes, you recapture with the queen. Now the queen sits on d3 — centralised, eyeing the h7-square on one diagonal and the queenside on the other. Black's best bishop is gone, and you still have yours on g5.",
    ...
    b({
      ...
      say:
        "Both sides finish the opening: Black props the centre with e6 and brings the knight to e7; you develop the queen's knight to d2, heading for f3 or e2. The structure is set — and it favours you. Bigger space, the e5-wedge, the easier game.",
    ...
    b({
      ...
      say:
        "Black posts the knight on f5, eyeing d4; you answer Ne2 — the quiet reroute. The knight reinforces d4 and heads for g3 or f4 to prop up the e5-wedge. Patience: the space does the work.",
