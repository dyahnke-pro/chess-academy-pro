...
export const ITALIAN_GAME_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  beats: [
    ...
    b({ id: "t6", moves: "e4 e5 Nf3 Nc6 Bc4 Nf6 d4 exd4 O-O Nxe4 Re1 d5 Bxd5 Qxd5 Nc3 Qa5 Nxe4 Be6 Neg5 O-O-O Nxe6 fxe6 Rxe6 Bd6", say: "O-O-O Nxe6 fxe6 Rxe6 Bd6 — the dust finally settles. Black castles long out of the pin, the knights are traded on e6, and White's rook grabs the e6-pawn, landing actively in the heart of Black's position. The verdict: material is level, but White's better pawn structure and their active rook give a small, lasting pull. Know this forcing line cold — it's how you punish Nxe4 — but understand that with accurate play it leads to a balanced, playable middlegame, not a knockout.", sayShort: "Nxe6 fxe6 Rxe6 — level, but White presses.", arrows: [A("e6", "d6", VIS)], highlights: [H("e6", KEY), H("d6", SOFT)] }),
  ],
},
  ...
  beats: [
    ...
    b({ id: "e2", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 b4 Bxb4 c3 Bc5", say: "Bxb4 c3 — Black accepts, and White plays the point of the gambit: c3, gaining a tempo by attacking the b4-bishop while preparing the d4 break. The bishop retreats to c5 with Bc5, returning to the diagonal it came from. White has surrendered a pawn but gained exactly what they wanted — the time to seize the centre.", sayShort: "Bxb4 c3 — kick the bishop, prepare d4.", highlights: [H("c3", KEY), H("d4", SOFT)] }),
    b({ id: "e3", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 b4 Bxb4 c3 Bc5 d4 exd4 O-O d6 cxd4", say: "d4 exd4 O-O d6 cxd4 — and there it is: the broad pawn centre, pawns on d4 and e4, exactly the structure the gambit paid for. White is down a pawn but their centre is huge, their king is castled, and their pieces are ready to pour out. Black has slowed White with the solid d6, but now White claims the space they bought.", sayShort: "d4 O-O cxd4 — the bought centre stands tall.", highlights: [H("d4", KEY), H("e4", KEY)] }),
  ...
  orientation: "white",
  beats: [
    b({ id: "o1", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Nc3", say: "The Møller Attack is the most spectacular line in the entire Italian — a willing sacrifice of a full rook for a raging attack. You branch from the main line at the check: after Bb4+ White plays not the calm Bd2, but the fighting Nc3, defending the check with a piece and keeping the broad d4-e4 centre completely intact. White is offering Black the chance to win material — and inviting them to regret it.", sayShort: "Nc3 — keep the centre, dare Black to grab.", highlights: [H("c3", KEY), H("d4", SOFT)] }),
    b({ id: "o2", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Nc3 Nxe4 O-O Nxc3 bxc3 Bxc3", say: "Nxe4 O-O — Black snatches the e4-pawn and White just castles, ignoring it. After Nxc3 bxc3 Bxc3 Black has greedily munched two centre pawns and is now eyeing the rook in the corner. Every Black move has been a capture; not one has developed a new piece or helped their king. White, meanwhile, is fully castled with both bishops loaded. The trap is set.", sayShort: "Nxe4 O-O Bxc3 — Black feasts; White just develops.", highlights: [H("e4", KEY), H("c3", KEY)] }),
    b({ id: "o3", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Nc3 Nxe4 O-O Nxc3 bxc3 Bxc3 Qb3", say: "Qb3!! — the move that makes the Møller immortal. The queen leaps out with a double purpose: it attacks the c3-bishop and, far more dangerously, it joins the c4-bishop in a battery firing straight at f7. Two pieces now bear down on the one square the king alone defends. Black's c3-bishop is hanging, but if they stop to save it, the storm on f7 breaks. They are being asked to choose between their pieces and their king.", sayShort: "Qb3!! — queen and bishop double on f7.", arrows: [A("c4", "f7", ATK)], highlights: [H("f7", KEY), H("c3", SOFT)] }),
    b({ id: "o4", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Nc3 Nxe4 O-O Nxc3 bxc3 Bxc3 Qb3 Bxa1 Bxf7+ Kf8", say: "Bxa1 — Black takes the rook, winning the exchange and seemingly the game. Bxf7+! White ignores their lost rook and smashes the bishop into f7 with check. The king cannot take — after Kxf7 the queen check on b3 collects everything — so it shuffles to f8 with Kf8, and now Black's king is stranded in the centre, their queenside asleep, and their trophy bishop marooned in the corner on a1.", sayShort: "Bxa1 Bxf7+! — ignore the rook, crack the king.", highlights: [H("f7", KEY), H("f8", SOFT)] }),
    b({ id: "o5", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Nc3 Nxe4 O-O Nxc3 bxc3 Bxc3 Qb3 Bxa1 Bxf7+ Kf8 Bg5 Ne7 Ne5", say: "Bg5! Ne7 Ne5 — White brings the reserves with gain of time. The g5-bishop pins and harasses, Black props up with the knight on e7, and Ne5 plants the knight in the centre, supporting the f7-bishop and threatening to leap into d7 or g6 with devastating effect. White is down a whole rook and entirely winning — because every single one of their pieces is attacking and Black's are spectators.", sayShort: "Bg5 Ne7 Ne5 — down a rook, still winning.", arrows: [A("g5", "e7", ATK), A("e5", "f7", VIS)], highlights: [H("e7", KEY), H("e5", KEY)] }),
  ...
  beats: [
    ...
    b({ id: "gn3", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Nc3 Nxe4 O-O Bxc3 bxc3 d5 Bd3", say: "Nxe4 O-O Bxc3 bxc3 d5 Bd3 — Black grabs the pawn and hits the c4-bishop with …d5; White retreats that bishop to d3 with tempo, training it on the knight sitting on e4 and the h7-square beyond. Note the precise order: the greedy Ba3 here would leave the c4-bishop hanging to …dxc4, so White saves the bishop first. White keeps both bishops, the half-open b-file and a lead in development as compensation for the pawn.", sayShort: "Bd3 — retreat with tempo on e4.", arrows: [A("d3", "e4", ATK)], highlights: [H("d3", KEY), H("d5", SOFT)] }),
    b({ id: "gn4", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Nc3 Nxe4 O-O Bxc3 bxc3 d5 Bd3 O-O", say: "…O-O — Black castles to g8 and, with precise defence, stands a slender pawn to the good. But White's bishop on d3 and its dark-squared partner, plus a clear lead in development, supply real, lasting pressure for the pawn; at club level this scores well for White. A principled main line where activity, not material, is the currency.", sayShort: "O-O — a slim Black edge; White keeps pressing.", highlights: [H("g8", KEY), H("d3", SOFT)] }),
  ],
},
  ...
  beats: [
    ...
    b({ id: "gc2", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Bd2 Bxd2+ Nbxd2 d5 exd5 Nxd5 Qb3", say: "Bxd2+ Nbxd2 d5 exd5 Nxd5 Qb3! — the dark bishops come off, Black frees themselves with the …d5 break, and after the trade White springs Qb3, hitting the knight on d5 and, down the b-file, the b7-pawn at the same time. One developing move, two targets — the tempo-gaining idea at the heart of White's set-up.", sayShort: "Qb3! — hits d5 and b7.", highlights: [H("b3", KEY), H("d5", SOFT)] }),
    b({ id: "gc3", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Bd2 Bxd2+ Nbxd2 d5 exd5 Nxd5 Qb3 Na5 Qa4+ Nc6 Qb3 Nce7 O-O O-O", say: "Na5 Qa4+ Nc6 Qb3 Nce7 O-O O-O — Black scrambles their knights to neutralise the queen's pressure and both sides castle. White emerges with the freer position, the famous isolated d-pawn giving them active, dynamic piece play rather than a weakness.", sayShort: "O-O — White castles with the freer game.", highlights: [H("e7", KEY)] }),
  ...
  "italian-game::Giuoco Pianissimo: Closed Italian with a4/Ba2": {
    openingId: "italian-game", title: "Italian — the closed a4 system (quiet, not harmless)", minutes: 8, orientation: "white",
    sources: ["concept:pos-development", "concept:pos-space", "https://en.wikipedia.org/wiki/Italian_Game"],
    beats: [
      { id: "ci1", moves: ["e4", "e5", "Nf3", "Nc6", "Bc4", "Bc5", "d3", "Nf6", "O-O", "d6", "c3", "O-O"], say: "The modern Italian: d3 and c3 instead of forcing theory. White builds a small, flexible centre, castles early, and keeps every plan in reserve — the d4 break, the knight tour to g3, the queenside clamp. Slow does not mean soft.", sayShort: "c3 — small centre, every plan in reserve.", highlights: [{ square: "d4", color: "rgba(80,140,255,0.32)" }, { square: "c3", color: "rgba(255,214,0,0.88)" }] },
      { id: "ci2", moves: ["e4", "e5", "Nf3", "Nc6", "Bc4", "Bc5", "d3", "Nf6", "O-O", "d6", "c3", "O-O", "Re1", "a6", "a4", "Ba7"], say: "…a6 makes a retreat hole for the bishop and a4 answers, grabbing queenside yardage and denying …b5 forever. Black tucks the bishop on a7, where it keeps its diagonal down toward f2 — both bishops now point at the enemy king from a distance.", sayShort: "a4 — deny b5, keep the yard.", highlights: [{ square: "a4", color: "rgba(255,214,0,0.88)" }, { square: "a7", color: "rgba(80,140,255,0.32)" }] },
      { id: "ci3", moves: ["e4", "e5", "Nf3", "Nc6", "Bc4", "Bc5", "d3", "Nf6", "O-O", "d6", "c3", "O-O", "Re1", "a6", "a4", "Ba7", "Nbd2", "Ng4", "Re2"], say: "Nbd2 begins the classic Italian knight tour — and Black lunges: …Ng4, teaming up with the a7-bishop against f2. Count the attackers: two on f2, and the rook answers with the little sidestep Re2, holding the point laterally. Unglamorous, airtight.", sayShort: "Re2 — hold f2, refuse the panic.", arrows: [{ from: "g4", to: "f2", color: "rgba(40,185,95,0.92)" }, { from: "a7", to: "f2", color: "rgba(40,185,95,0.92)" }], highlights: [{ square: "f2", color: "rgba(255,214,0,0.88)" }] },
      { id: "ci4", moves: ["e4", "e5", "Nf3", "Nc6", "Bc4", "Bc5", "d3", "Nf6", "O-O", "d6", "c3", "O-O", "Re1", "a6", "a4", "Ba7", "Nbd2", "Ng4", "Re2", "Kh8", "h3", "Nh6"], say: "h3 puts the question and the knight backs off to h6 with nothing to show for the trip. The engine calls the position dead level — but look whose plans remain: the d4 break, the d2-knight's route to f1 and g3, the a4-a5 squeeze. Pianissimo means quiet. It has never meant equal chances of winning.", sayShort: "h3 — question asked, attack over.", highlights: [{ square: "h6", color: "rgba(80,140,255,0.32)" }, { square: "d4", color: "rgba(255,214,0,0.88)" }] },
    ],
  },
};
