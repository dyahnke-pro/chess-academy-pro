...
export const ITALIAN_GAME_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  beats: [
    ...
    b({ id: "gc2", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Bd2 Bxd2+ Nbxd2 d5 exd5 Nxd5 Qb3", say: "Bxd2+ Nbxd2 d5 exd5 Nxd5 Qb3! — the dark bishops come off, Black frees himself with the …d5 break, and after the trade White springs Qb3, hitting the knight on d5 and, down the b-file, the b7-pawn at the same time. One developing move, two targets — the tempo-gaining idea at the heart of White's set-up.", sayShort: "Qb3! — hits d5 and b7.", highlights: [H("b3", KEY), H("d5", SOFT)] }),
