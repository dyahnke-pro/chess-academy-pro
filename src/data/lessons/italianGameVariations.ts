...
export const ITALIAN_GAME_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  beats: [
    ...
    b({ id: "gn3", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d4 exd4 cxd4 Bb4+ Nc3 Nxe4 O-O Bxc3 bxc3 d5 Bd3", say: "Nxe4 O-O Bxc3 bxc3 d5 Bd3 — Black grabs the pawn and hits the bishop with …d5; White retreats it to d3 with tempo, training it on the knight sitting on e4 and the h7-square beyond. Note the precise order: the greedy Ba3 here would leave the c4-bishop hanging to …dxc4, so White saves the bishop first. White keeps both bishops, the half-open b-file and a lead in development as compensation for the pawn.", sayShort: "Bd3 — retreat with tempo on e4.", arrows: [A("d3", "e4", ATK)], highlights: [H("d3", KEY), H("d5", SOFT)] }),
