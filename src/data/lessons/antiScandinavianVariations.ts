...
const VALENCIAN_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'sva-2', moves: 'e4 d5 exd5 Qxd5 Nc3 Qd8 d4 Nf6 Nf3 Bg4 h3 Bxf3 Qxf3',
      say: "You build the classical centre with d4 and develop Nf3; Black pins it with Bg4, but after h3 they must part with the piece — Bxf3, and you recapture with the queen. Now you have the two bishops and a queen actively posted on f3, while Black has surrendered their good light-squared bishop for nothing concrete.",
    ...
    b({ id: 'sva-4', moves: 'e4 d5 exd5 Qxd5 Nc3 Qd8 d4 Nf6 Nf3 Bg4 h3 Bxf3 Qxf3 c6 Be3 e6 a3 Nd5 Nxd5 Qxd5 Qg3',
      say: "Black tries to free themselves with the central Nd5, but you trade it off and, after Qxd5, swing the queen to g3 — eyeing g7 and the kingside while Black stays tied down. You are clearly better: the bishop pair, more space, and the sounder structure. The passive Scandinavian hands White exactly the pull you signed up for.",
