...
export const FOUR_KNIGHTS_GAME_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  beats: [
    ...
    b({ id: "ru5", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 Bb5 Nd4 Be2 Nxf3+ Bxf3 Bc5 O-O O-O d3 d6 Na4 Bb6 Nxb6 axb6 c3", say: "Nxb6 axb6 c3 and you reach the Rubinstein tabiya. White has the bishop pair and a flexible centre; the little c3-pawn prepares the thematic d4-break to open lines for those bishops. Black got rid of nothing he wanted to keep. That is the verdict on the Rubinstein at club level — meet Nd4 with the quiet Be2, refuse every trap, and grind the two bishops home. Carlsen did exactly that against Gelfand.", sayShort: "c3 — prepare d4, unleash the bishops.", highlights: [H("c3", KEY), H("d4", SOFT)] }),
  ],
},
};
