...
export const FOUR_KNIGHTS_GAME_VARIATION_LESSONS: Record<string, LessonScript> = {
  ...
  "four-knights-game::Belgrade Gambit: 4.d4 exd4 5.Nd5": {
    ...
    beats: [
      b({ id: "bg1", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 d4 exd4 Nd5", say: "The Belgrade Gambit — out of a quiet Four Knights, White springs Nd5!?, offering the d4-pawn. The knight hits the f6-knight and lunges at the c7-square, and in return for the pawn White gets fast development and immediate attacking chances. A sharp surprise that drags Black out of comfortable theory.", sayShort: "Nd5!? — offer the pawn, attack fast.", highlights: [H("d5", KEY)] }),
  ...
  beats: [
    ...
    b({ id: "gl2", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 Bc5 Bg2", say: "Bc5 develops actively and Bg2 completes the fianchetto. The bishop on g2 is the soul of the system: for now its own knight on f3 stands in the way, but the moment that knight reroutes, the bishop will glare down the long diagonal at Black's queenside and centre. White's structure is solid and their plans are flexible.", sayShort: "Bg2 — the fianchettoed bishop's home.", highlights: [H("g2", KEY), H("f3", SOFT)] }),
    b({ id: "gl3", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 g3 Bc5 Bg2 d6 d3 a6 O-O O-O", say: "d6 d3 a6 O-O O-O — both sides build calmly and castle. You reach the Glek tabiya: a closed, manoeuvring centre at e4 and e5, with White's king snug behind the fianchetto. There is no immediate contact, no forcing line — this is a positional system where White slowly improves their pieces and waits for the right moment to expand.", sayShort: "O-O — the calm Glek tabiya.", highlights: [H("e4", KEY), H("e5", SOFT)] }),
  ...
  beats: [
    ...
    b({ id: "it5", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 Bc4 Nxe4 Nxe4 d5 Bd3 dxe4 Bxe4 Bd6 O-O O-O Re1 Re8 d3 h6 c3", say: "Re8 d3 h6 c3 — the Italian Four Knights tabiya. The position is nearly symmetrical and objectively balanced; this line is White's choice when they want a safe, sound game with a tiny enduring edge rather than fireworks. The d3-pawn and the c3-square give White a small, flexible centre, and from here it is pure technique — outplay Black slowly from a structurally healthy position.", sayShort: "c3 — a small, flexible, sound centre.", highlights: [H("d3", KEY), H("c3", SOFT)] }),
  ],
},
  ...
  beats: [
    ...
    b({ id: "ru5", moves: "e4 e5 Nf3 Nc6 Nc3 Nf6 Bb5 Nd4 Be2 Nxf3+ Bxf3 Bc5 O-O O-O d3 d6 Na4 Bb6 Nxb6 axb6 c3", say: "Nxb6 axb6 c3 and you reach the Rubinstein tabiya. White has the bishop pair and a flexible centre; the little c3-pawn prepares the thematic d4-break to open lines for those bishops. Black got rid of nothing they wanted to keep. That is the verdict on the Rubinstein at club level — meet Nd4 with the quiet Be2, refuse every trap, and grind the two bishops home. Carlsen did exactly that against Gelfand.", sayShort: "c3 — prepare d4, unleash the bishops.", highlights: [H("c3", KEY), H("d4", SOFT)] }),
  ],
},
};
