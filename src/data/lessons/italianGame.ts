...
export const ITALIAN_GAME_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: "bc5", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5", say: "Bc5 — the Giuoco Piano, the \"quiet game.\" Black mirrors, aiming their own bishop at f2 exactly as White aims at f7. The position is symmetrical, both sides pointed at the other's weak f-pawn. Symmetry is an invitation: whoever breaks it first in their own favour takes the initiative.", sayShort: "…Bc5 — the Giuoco mirror; c5 eyes f2.", arrows: [A("c5", "f2", ATK)], highlights: [H("f2", KEY), H("f7", SOFT)] }),
    ...
    b({ id: "d6", moves: "e4 e5 Nf3 Nc6 Bc4 Bc5 c3 Nf6 d3 d6", say: "Black mirrors with d6, bracing their own e5-pawn. The structures are symmetrical and closed; this is a battle of plans and tempo, not tactics — for now.", sayShort: "…d6 — Black mirrors, braces e5.", highlights: [H("e5", SOFT)] }),
