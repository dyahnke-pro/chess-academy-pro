...
const VS_DECLINED: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'oo', moves: 'e4 e5 f4 Nc6 Nf3 d6 Bc4 Bg4 O-O Nf6 Nc3 Be7 d3',
      ...
      say: "You castle, develop Nc3 and brace with d3. The tension on f4 and e5 is yours to release; White stands ready to open the f-file at the perfect moment.",
...
const VS_FALKBEER: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'd4', moves: 'e4 e5 f4 d5 exd5 exf4 Nf3 Nf6 d4 Nxd5 Bc4',
      ...
      say: "You develop Nf3, build the centre with d4, and hit the knight with Bc4. Black's pieces get bounced around while White finishes development with tempo and the better structure.",
