...
const TARRASCH: LessonScript = {
  ...
  beats: [
    b({ id: 'tt1', moves: TARRASCH_BASE,
      ...
      sayShort: "Open Ruy — the e4-knight loose, Re1 loaded.",
    ...
    b({ id: 'tt3', moves: `${TARRASCH_BASE} O-O Nd4 Qd7 Nxe6 fxe6 Rxe4`,
      ...
      sayShort: "Nd4, Nxe6, Rxe4 — White wins a clean piece.",
      highlights: [H('e4', KEY)] }),
  ],
};
...
const NOAH: LessonScript = {
  ...
  beats: [
    b({ id: 'na1', moves: NOAH_BASE,
      ...
      sayShort: "A tempting d4-pawn — and a vulnerable Bb3.",
    ...
    b({ id: 'na2', moves: `${NOAH_BASE} Qxd4 c5 Qd5 Be6 Qc6+ Bd7 Qd5 c4`,
      ...
      sayShort: "Qxd4 c5! — the queen hounded, c4 entombs Bb3.",
    ...
    b({ id: 'na3', moves: `${NOAH_BASE} Bd5`,
      ...
      sayShort: "Rewind: Bd5 keeps the bishop uncaged.",
...
const MORTIMER: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'mt2', moves: `${MORT_BASE} Nxe5 c6 Nc4 d6 Ba4 b5`,
      ...
      sayShort: "Nxe5?? c6 — …b5 forks; White loses a piece.",
    ...
    b({ id: 'mt3', moves: `${MORT_BASE} Nc3`,
      ...
      sayShort: 'Rewind: decline it — Nc3 develops, Black\'s Ne7 passive.',
      highlights: [H('c3', KEY)] }),
  ],
};
...
const FISHING_POLE: LessonScript = {
  ...
  beats: [
    b({ id: 'fp1', moves: FISH_BASE,
      ...
      sayShort: "The Fishing Pole — …Ng4 dares h3.",
      highlights: [H('g4', KEY)] }),
    b({ id: 'fp2', moves: `${FISH_BASE} h3 h5 hxg4 hxg4 Ne1 Qh4 f3 g3 Rf2 Qh1#`,
      say: "h3 attacks the knight — but h5! is the hook. Take it and hxg4 hxg4 rips the h-file open. The queen lands on h4, and even Ne1, f3, Rf2 can't plug the file — g3 and Qh1 is mate. The 'free' knight was a fishing line straight to your king on g1.",
      sayShort: "h3 h5! — the h-file opens; Qh1 mate.",
    ...
    b({ id: 'fp3', moves: `${FISH_BASE} d4`,
      ...
      sayShort: "Rewind: ignore it, play d4 — the hook snaps.",
      highlights: [H('d4', KEY)] }),
  ],
};
...
const MARSHALL_WARNING: LessonScript = {
  ...
  beats: [
    b({ id: 'mw1', moves: MARSH_BASE,
      ...
      sayShort: "The Marshall storm: …Qh4. One move holds.",
    ...
    b({ id: 'mw2', moves: `${MARSH_BASE} h3`,
      ...
      sayShort: "h3?? — natural and losing; it ignores f2/g2.",
      highlights: [H('h3', ATK)] }),
    b({ id: 'mw3', moves: `${MARSH_BASE} g3`,
      say: "Rewind. The only-move: g3. It blocks the queen's diagonal AT h4 and forces her to the worse h3-square, buying the tempo to consolidate. One square — g3, not h3 — is the whole difference between holding a pawn up and getting mated.",
      sayShort: "The only move: g3 — blocks the h4 diagonal.",
