...
const FISHING_POLE: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'fp2', moves: `${FISH_BASE} h3 h5 hxg4 hxg4 Ne1 Qh4 f3 g3 Rf2 Qh1#`,
      ...
      sayShort: "h3 h5! — grab the knight and the h-file opens; it ends in Qh1 mate on the g1-king.",
...
const MARSHALL_WARNING: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'mw3', moves: `${MARSH_BASE} g3`,
      ...
      sayShort: 'The only-move: g3 — blocks the h4 diagonal, forces the queen back. Not h3.',
