...
const CZECH_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'ben-cz-2', moves: 'd4 Nf6 c4 c5 d5 e5 Nc3 d6 e4 Be7 Nf3 Na6',
      say: "The structure sets: your pawns on c4-d5-e4 grip the whole centre while Black shuffles pieces behind their wall — Be7, and the knight to a6 heading for c7. You have all the space and every plan: a kingside storm with f4 or g4, or queenside expansion with b4. Black can only wait and watch.",
    ...
    b({ id: 'ben-cz-4', moves: 'd4 Nf6 c4 c5 d5 e5 Nc3 d6 e4 Be7 Nf3 Na6 h3 O-O Bd3 Nc7 Bd2 Kh8 Qe2 g6 Bh6 Re8',
      say: "Black weakens with g6 and you pounce — Bh6, planting the bishop on the newly-weakened dark squares right beside their king. You are clearly better by a wide margin: a huge space bind, pieces raking Black's cramped position, and a kingside attack brewing. The Czech Benoni's passivity is fully punished.",
