...
const VS_NF3: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'develop', moves: 'd4 Nf6 c4 e5 dxe5 Ng4 Nf3 Bc5 e3 Nc6 Nc3 Ngxe5',
      ...
      say: "You develop …Nc6 to add pressure and then regain the pawn with …Ngxe5, trading into a position where your knight sits proudly on e5 and the c5-bishop rakes the a7-g1 diagonal. Active equality with the easier game to play.",
...
const VS_NC3: LessonScript = {
  ...
  beats: [
    b({ id: 'nc3', moves: 'd4 Nf6 c4 e5 Nc3 exd4 Qxd4 Nc6',
      ...
      say: "If White declines the gambit with Nc3, you simply take on d4 and, after Qxd4, hit the queen with …Nc6 — gaining a tempo and quick development. Declining the Budapest just hands Black an easy, equal game.",
    ...
    b({ id: 'bb4', moves: 'd4 Nf6 c4 e5 Nc3 exd4 Qxd4 Nc6 Qd1 Bb4',
      ...
      say: "The queen retreats and you pin the c3-knight with …Bb4 — the same active, pressuring idea that runs through this repertoire's whole repertoire. Black develops with threats while White is still sorting out the queen.",
