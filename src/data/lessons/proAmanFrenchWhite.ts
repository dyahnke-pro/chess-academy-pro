...
export const PRO_AMAN_FRENCH_WHITE_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: 'ne7', moves: 'e4 e6 d4 d5 Nc3 Bb4 e5 c5 a3 Bxc3+ bxc3 Ne7 h4', highlights: [H('h4')],
    ...
    b({ id: 'middlegame', moves: 'e4 e6 d4 d5 Nc3 Bb4 e5 c5 a3 Bxc3+ bxc3 Ne7 h4 Qc7 Nf3 b6', highlights: [H('b6'), H('c5')],
