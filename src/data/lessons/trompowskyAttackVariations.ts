  ...
  'trompowsky-attack::2...d5 3.Bxf6 Doubled Pawns': {
    ...
    beats: [
      ...
      },
      {
        ...
        say: "Both sides develop naturally. White builds the modest e3/Bd3 set-up; Black places the bishop on d6 and rooks the e-file. White is in no hurry — with the bishop pair they simply want the position to stay open, keep both bishops breathing, and slowly aim at the half-open lines around Black's doubled pawns.",
  ...
  'trompowsky-attack::2...e6 French-Type Structure': {
    ...
    beats: [
      ...
      },
      {
        ...
        say: "Black questions the bishop with h6; White takes Bxf6 and Black recaptures with the queen. White is happy — they have the bishop pair and a big centre, and the queen on f6 will soon have to move again. Nc3 reinforces e4, Black plays d6 to keep things solid, and now White reveals their plan: this is going to be an opposite-wings attack.",
    ...
    beats: [
      {
        ...
        say: "Black challenges the centre with c5; White doesn't take — they ram the pawn home with d5, planting a space-grabbing wedge. Black pounces on the loose b2-pawn with Qb6, daring White to defend it. This is the Raptor: White is about to GIVE UP the b-pawn on purpose, betting that a lead in development and the cramping d5-wedge are worth more than a pawn.",
      ...
      },
      {
        ...
        say: "White just keeps developing with threats — f4 to seize the centre, Bc4 raking at f7, and the d5-pawn cramping everything. Black scrambles to untangle with a6 and Be7, but they are permanently a tempo behind and their king is stuck in the middle. White's pieces are all out, all aimed at the enemy king, and the gambit pawn is a distant memory. The Raptor's lesson: a pawn is nothing next to a roaring initiative.",
    ...
    beats: [
      {
        ...
        say: "Black heads for a King's-Indian-style fianchetto with g6 — but White strikes FIRST: Bxf6, taking the knight before Black can tuck a bishop on g7 to guard the dark squares. After exf6 Black is left with doubled f-pawns and a permanently weakened dark-square complex, exactly the squares their fianchetto bishop was meant to cover. White has spoiled the King's Indian before it began.",
    ...
    beats: [
      {
        ...
        highlights: [{ square: 'd5', color: KEY }, { square: 'b2', color: SOFT }],
        say: "After Ne4 Bf4, Black lashes out with c5; White answers d5, gaining space, and Black again grabs at the b2-pawn with Qb6. The Vaganian Gambit is White's bold reply: they will offer b2, retreat their bishop, and build a huge centre with f3 and e4 — a pawn for raw central power and the initiative.",
    ...
    beats: [
      {
        ...
        say: "When Black recaptures with the g-pawn instead — gxf6 — they keep the centre fluid and opens the g-file for their rook, but at a steep price: their kingside is shattered, with broken pawns on f6, f7 and h7 and no shelter for the king. White's plan writes itself: open the position, trade into an endgame, and grind the weak pawns.",
      ...
      },
      {
        ...
        say: "White regains the pawn with Bxc4, the bishop raking toward Black's weak f7, and develops smoothly — Nf3, Nc3, O-O — while Black shuffles their king to e7 to connect the rooks. White has reached the ideal Trompowsky endgame: better pawns, more active pieces, a target on f7, and no risk. From here it is pure technique. The lesson: when Black wrecks their own kingside, don't attack it with pieces — trade queens and win the structure.",
