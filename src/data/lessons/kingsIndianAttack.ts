...
export const KINGS_INDIAN_ATTACK_LESSON: LessonScript = {
  ...
  beats: [
    ...
    b({ id: "wedge", moves: "e4 e6 d3 d5 Nd2 Nf6 Ngf3 c5 g3 Nc6 Bg2 Be7 O-O O-O Re1 b5 e5 Nd7 Nf1", say: "b5 e5! Nd7 Nf1 — there it is, the e5-wedge. The pawn cramps Black and shuts the door on their pieces, and the knight begins its signature journey: Nf1-h2-g4, the famous KIA attacking reroute heading for the kingside. Black plays on the queenside; the game becomes a race.", sayShort: "e5! Nf1 — the wedge; knight reroutes to g4.", highlights: [H("e5", KEY), H("g4", SOFT)] }),
