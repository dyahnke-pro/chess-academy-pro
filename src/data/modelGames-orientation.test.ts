...
describe('model-games orientation — never showcase the student losing', () => {
  ...
  const PROTECTED = ['vienna-game', 'caro-kann', 'ruy-lopez', 'italian-game', 'scotch-game', 'kings-gambit', 'sicilian-dragon', 'french-defence', 'scandinavian-defence', 'alekhine-defence', 'benko-gambit', 'dutch-defence'];
