...
export const VIENNA_GAME: WalkthroughTree = {
  ...
  studentSide: 'white',
  intro:
    "The Vienna Game. It's the King's Pawn opening's quieter, sharper cousin — quieter because you develop a knight before the bishop, sharper because you keep the f-pawn free for an attack. Most beginners learn the Italian or the Spanish; the Vienna is what you play when you want the same classical pressure but with a tactical engine humming under the hood. Let me walk you through it.",
  shortIntro: "In the Vienna Game, develop the knight before the bishop, keeping the f-pawn free for tactical attacks.",
  outro:
  ...
  leafOutros: {
    ...
    'e4 e5 Nc3 Nf6 f4 exf4 e5 Ng8 Nf3':
      "And there it is — the Vienna Gambit accepted, the truth of the line. Black's knight is buried back on g8, having spent two tempi for nothing. You have a huge lead in development, the open f-file (the f-pawn you gave up clears the file for your rook on f1), and the f4-pawn (Black's prize) is just a target waiting to be picked off. From here White's plan: Bc4 eyeing f7, castle, take f4 with the c1-bishop, then attack down the f-file. Black is just worse — at master level the gambit accepted is considered theoretically bad for Black, which is why most strong Black players play the Falkbeer (3...d5) instead. Now you know why.",
    ...
    'e4 e5 Nc3 Nc6 Bc4 Nf6 d3 Bc5 Be3 Bxe3 fxe3 d6 Nf3 O-O O-O Bg4 h3':
      "And there it is — the Vienna middlegame in its purest form. Both kings castled, dark-square bishops traded off (which suits you — you have the open f-file as compensation for the doubled e-pawns), the c4-bishop still pointing at f7. From here Black has to decide whether to trade on f3 (giving you the queen on f3 hitting f7 and ready to swing) or retreat to h5 (and you play g4 to chase it further). Either way, your middlegame plan is set: double the rooks on the f-file, push d4 to break the center when ready, swing the queen to h5 or g3. This is the position to know cold. Want to play it out from here as a real game?",
  },
  ...
  concepts: [
    {
      ...
      choices: [
        ...
        },
        {
          ...
          correct: true,
          explanation:
            "Right — Nc3 supports e4 in case Black tries ...Nf6 attacking it. You have a defender ready.",
        },
        {
      ...
      choices: [
        {
          ...
          correct: true,
          explanation:
            "Exactly. You sacrifice the f-pawn to open the f-file (after exf4 captures away your f-pawn), free the dark-squared bishop, and create attacking chances along the f-file and the d1-h5 diagonal. Material for activity.",
        },
        {
        ...
        },
        {
          ...
          correct: false,
          explanation:
            "You're not playing for material — you're SACRIFICING the f-pawn. Winning e5 isn't the point; activity is.",
        },
      ],
    },
    {
      ...
      choices: [
        {
          ...
          correct: true,
          explanation:
            "Right. After 4.d3, the e4-pawn has TWO defenders (the c3-knight AND the d3-pawn), so 4...Nxe4 just loses a piece. With 4.Nf3, e4 has only one defender, and Black's Nxe4 → d5 fork costs you the bishop pair.",
        },
        {
          text: "To prepare a quick queenside castle.",
          correct: false,
          explanation:
            "You castle short in the Vienna, not long. d3 isn't related to castling preparation.",
        },
        {
          text: "Because Nf3 blocks the f-pawn.",
          correct: false,
          explanation:
            "True statement, but not why you play d3 here. You CAN play Nf3 in many Vienna lines (the 2...Bc5 branch, for example). The d3 specifically defends e4.",
        },
        {
          text: "To threaten d4 next move.",
          correct: false,
          explanation:
            "You're not really threatening d4 — d3 is a one-move-at-a-time defensive move. The threat is the absence of the fork trick.",
        },
      ],
    },
    {
      ...
      choices: [
        {
          text: "After you trade off Black's c5-bishop (e.g. with Be3 Bxe3 fxe3).",
          correct: true,
          explanation:
            "Exactly. Pushing f4 with a Black bishop on c5 alive is a blunder — it opens the long a7-g1 diagonal and your knight on g1 hangs to ...Bxg1. So you trade the bishop FIRST. Be3 challenges it head-on; if Black trades, you recapture with the f-pawn opening the f-file as a bonus.",
        },
        {
        ...
        },
        {
          ...
          correct: false,
          explanation:
            "Black's castling doesn't change the c5-bishop's diagonal attack. The bishop has to move or trade BEFORE you push f4.",
        },
        {
          text: "Never — the Vienna can't push f4 against ...Bc5.",
          correct: false,
          explanation:
            "Too pessimistic — you CAN push f4 once the c5-bishop is gone. You just have to trade it first.",
        },
      ],
    },
  ],
  ...
  findMove: [
      ...
      candidates: [
        {
          ...
          correct: true,
          explanation:
            "Correct! Push e5 BEFORE developing. The knight on f6 has to move, and every square except Ng8 hangs material to your queen along the open d1-h5 diagonal. This is the foundational Vienna Gambit move-order lesson.",
        },
        {
          san: 'Nf3',
          ...
          correct: false,
          explanation:
            "The right idea (you do need to neutralize Qh4+) but the wrong move ORDER. Push e5 first to kick the knight; THEN play Nf3 once Black's knight has moved. Playing Nf3 first lets Black develop normally while you've gained nothing on tempo.",
        },
        {
          san: 'd4',
    ...
    },
    {
      ...
      prompt:
        "Black just played Qxd5. Their queen attacks your e4-knight! What's White's only good move?",
      candidates: [
        {
          san: 'd3',
          ...
          correct: true,
          explanation:
            "Right — the d3-pawn supports the knight. Black can't take Nxe4 because you'd recapture with the pawn. You keep the piece and continue developing.",
        },
        {
          san: 'Nc3',
          ...
          correct: false,
          explanation:
            "Looks safe but actually loses material! Once the knight retreats, the d5-queen has a clean diagonal all the way to g2. Qxg2 wins your pawn AND attacks the rook on h1. The defend-in-place move (d3) is the only safe one.",
        },
        {
          san: 'Nf3',
    ...
    },
    {
      ...
      prompt:
        "Black just played Bc5. Now you want to push f4 eventually — what should White play first?",
      candidates: [
        {
          san: 'Be3',
          ...
          correct: true,
          explanation:
            "Right. Pushing f4 directly with Bc5 alive opens the long a7-g1 diagonal and your knight on g1 hangs to Bxg1. So you trade the bishop first. After Bxe3 fxe3, the f-pawn already moved (recapture), the bishop is gone, AND you have the open f-file for free.",
        },
        {
          san: 'f4',
          ...
          correct: false,
          explanation:
            "Loses material! After f4, the f2-square clears and Black plays Bxg1 winning your knight. ALWAYS check the long diagonals before pushing pawns that open them.",
        },
        {
          san: 'Nf3',
          ...
          correct: false,
          explanation:
            "Solid but it locks the f-pawn behind the knight forever. You've just turned your Vienna into an Italian. The whole reason you played Nc3 was to keep f4 available.",
        },
        {
          san: 'h3',
          ...
          correct: false,
          explanation:
            "Premature — h3 is useful later (preventing ...Bg4 once Black develops the bishop) but right now you have a more pressing concern: the c5-bishop's diagonal threatens your king position.",
        },
      ],
    },
  ],
  ...
  punish: [
    {
      ...
      shortWhyBad: "Black's knight on g4 hangs because the queen's diagonal to g4 is open and undefended.",
      punishment: 'Qxg4',
      whyPunish:
        "Queen takes knight, end of discussion. Black has no recapture — no Black piece attacks g4 right now. You go from down a pawn (the gambit) to up a clean knight. The recurring chess principle: ALWAYS look for captures first when it's your move. Tactics live ahead of strategy. The lesson Black needs to learn from this game is the diagonal-counting habit.",
      shortWhyPunish: "Queen takes knight on g4, no recapture, converting gambit pawn deficit into a clean knight advantage.",
      distractors: [
        {
          san: 'Nf3',
          label: 'Nf3 — develop and shut Qh4+',
          explanation:
            "Misses the free piece. Right idea on the SECOND-best move (Nf3 IS what you'd play if Black retreated to Ng8), but here you have a tactic. Always look for captures first.",
        },
        {
          san: 'd4',
      ...
      followup: [
        {
          ...
          shortIdea: "Black's desperate ...d5 opens lines, but you're a piece up.",
        },
        {
          san: 'd3',
          idea:
    ...
    },
    {
      ...
      shortWhyBad: "Black's Nh5 hangs to Bxh5 because the d1-queen's diagonal runs through four empty squares to h5.",
      punishment: 'Qxh5',
      whyPunish:
      ...
      shortWhyPunish: "In the Vienna Gambit, a queen on d1 wins any knight that lands on g4 or h5.",
      distractors: [
        {
          san: 'g4',
          label: 'g4 — kick before taking',
          explanation:
            "g4 attacks the knight, but you can just take it directly with the queen. Don't waste a tempo on a kick when capture is available.",
        },
        {
          san: 'Nf3',
          label: 'Nf3 — develop',
      ...
      followup: [
        {
          ...
          shortIdea: "Black is up a piece, so development doesn't matter.",
        },
        {
          san: 'Nf3',
          idea:
    ...
    },
    {
      ...
      shortWhyPunish: "Knight takes knight on d5, Black cannot recapture because the d7-pawn blocks, leaving White up a piece.",
      distractors: [
        {
          san: 'Nf3',
          label: 'Nf3 — develop',
      ...
      followup: [
        {
          ...
          shortIdea: "Black's Qe7 aims to trade pieces, but you're up a knight.",
        },
        {
          san: 'Nf3',
          idea:
    ...
    },
    {
      ...
      inaccuracy: 'Ne4',
      whyBad:
        "Black moves the knight to e4 hoping to attack your c3-knight. But Black missed: their knight on e4 is itself attacked by your c3-knight, and Black has zero defenders for it. So Black is offering a knight trade where THEY lose the piece, not you. This is the fourth variation of the same lesson: every Black knight square except Ng8 in this position hangs to White's superior piece coordination.",
      shortWhyBad: "Black's knight to e4 hangs to White's c3-knight with no defenders.",
      punishment: 'Nxe4',
      whyPunish:
        "Knight takes knight, end of story. Black has no recapture (no piece attacks e4). You've now seen four flavors of the same principle in this exact position: Ng4 hangs to the queen, Nh5 hangs to the queen, Nd5 hangs to the c3-knight, Ne4 hangs to the c3-knight. Black's ONLY non-losing move was Ng8 — pure passive retreat. That's why the Vienna Gambit accepted is theoretically refuted at master level.",
      shortWhyPunish: "Knight takes knight on e4, Black has no recapture, so Vienna Gambit accepted is refuted.",
      distractors: [
        {
          san: 'd3',
    ...
    },
    {
      ...
      shortWhyBad: "Black's knight takes e4, but e4 has two defenders to one attacker, so the pawn is poison and Black loses a piece.",
      punishment: 'Nxe4',
      whyPunish:
      ...
      shortWhyPunish: "Knight takes knight leaves Black down a piece for a pawn, a catastrophic trade.",
      distractors: [
        {
          san: 'dxe4',
          label: 'Pawn takes (dxe4)',
          explanation:
            "Also wins the knight, but it removes your d3-pawn from the position. Knight recapture is cleaner: it keeps your pawn structure intact and your knight stays in the center. Always prefer the cleaner recapture.",
        },
        {
          san: 'Bxf7+',
      ...
      followup: [
        {
          ...
          shortIdea: "Up a piece, Black's development attempt doesn't change the material advantage.",
        },
        {
          san: 'Nf3',
          idea:
        ...
        },
        {
          ...
          shortIdea: "Black castles, exchanges pieces, and simplifies to a winning endgame a piece up.",
        },
      ],
    },
  ],
    ...
    children: [
      {
        node: {
          ...
          shortIdea: "1.e4 claims the center and opens lines for the bishop and queen.",
          children: [
            {
              node: {
                san: 'e5',
                ...
                shortIdea: "Black mirrors with 1...e5, contesting the center directly as the most principled response.",
                children: [
                  {
                    node: {
                      san: 'Nc3',
                      movedBy: 'white',
                      idea:
                        "2.Nc3 — and here's where the Vienna actually starts. The natural move at this point is Nf3 (the Italian and the Spanish both go there), but you play Nc3 instead. Why? Three reasons. One: it develops a piece. Two: it defends e4 in case Black later threatens it. Three — and this is the big one — it leaves the f-pawn FREE. In the Italian, after Nf3, the f-pawn is locked behind the knight forever; you can never push f4 without first moving the knight. In the Vienna, f4 is on the table from move three onward. That's the whole opening: a kingside pawn storm waiting to happen.",
                      shortIdea: "Nc3 leaves the f-pawn free for an immediate kingside pawn storm with f4.",
                      narration: [
                        {
                          ...
                          shortText: "2.Nc3 starts the Vienna, not Nf3 like the Italian or Spanish.",
                          arrows: [{ from: 'g1', to: 'f3', color: 'red' }],
                        },
                        {
                          text: "But you play Nc3 instead. Why? Three reasons. One — it develops a piece.",
                          shortText: "Nc3 develops a piece.",
                          arrows: [{ from: 'b1', to: 'c3', color: 'green' }],
                        },
                        {
                          text: "Two — it defends e4 in case Black later threatens it.",
                          shortText: "The knight defends e4 against future threats.",
                        ...
                        },
                        {
                          ...
                          shortText: "In the Italian, Nf3 locks the f-pawn, so f4 requires moving the knight first.",
                        ...
                        },
                        {
                          ...
                          shortText: "f4 from move three signals a kingside pawn storm in the Vienna.",
                      ...
                      children: [
                        // ─── FORK 1: Black's response to 2.Nc3 ───
                        {
                          ...
                          node: {
                            ...
                            movedBy: 'black',
                            idea:
                              "2...Nf6 — Black develops a knight AND attacks your e4 pawn at the same time. This is the most theoretically critical response. Black is daring you to either defend e4 or play the gambit. Both choices are real, and they lead to very different games. Pick your appetite.",
                            shortIdea: "Black's 2...Nf6 attacks e4, forcing a choice between defending or a gambit.",
                            children: [
                              // ─── FORK 2: White's third move ───
                              {
                                ...
                                node: {
                                  ...
                                  narration: [
                                    {
                                      text: "3.f4 — the Vienna Gambit. Right out of the gate, you're offering the f-pawn.",
                                      shortText: "White offers the f-pawn with 3.f4, the Vienna Gambit.",
                                      arrows: [{ from: 'f2', to: 'f4', color: 'green' }],
                                    },
                                    {
                                      text: "The point — if Black takes with exf4, the f-file opens up for your rook.",
                                      shortText: "If Black takes with exf4, the f-file opens for the rook.",
                                      arrows: [
                                    ...
                                    },
                                    {
                                      ...
                                      shortText: "Queen can swing to e2 or h5.",
                                      arrows: [
                                    ...
                                    },
                                    {
                                      ...
                                      shortText: "Dark-squared bishop activates on the long diagonal.",
                                  ...
                                  children: [
                                    // ─── FORK 3: Black accepts or declines ───
                                    {
                                      ...
                                      node: {
                                        ...
                                        shortIdea: "Black counters in the center with 3...d5, attacking your e4 pawn twice while it's defended only once.",
                                        children: [
                                          {
                                            node: {
                                              san: 'fxe5',
                                              ...
                                              children: [
                                                {
                                                  node: {
                                                    ...
                                                    movedBy: 'black',
                                                    idea:
                                                      "4...Nxe4 — Black grabs my e4 pawn with the knight. This is the only move; anything else loses material. You're now in the main line of the Vienna Gambit Falkbeer Variation, and theory has been worked out for over a century.",
                                                    shortIdea: "Black's knight captures on e4, the only move to avoid losing material, entering the Vienna Gambit Falkbeer main line.",
                                                    children: [
                                                      {
                                                        node: {
                                                          san: 'Qf3',
                                                          ...
                                                          shortIdea: "Qf3 attacks the undefended e4-knight, forcing Black into Nxc3, f5, or Nc5.",
                                                          narration: [
                                                            {
                                                            ...
                                                            },
                                                            {
                                                              ...
                                                              shortText: "Queen to f3 directly attacks the e4-knight.",
                                                            ...
                                                            },
                                                            {
                                                              ...
                                                              shortText: "Black's knight hangs; Nxc3 trades, f5 weakens the king, or Nc5 loses tempo.",
                                                            },
                                                            {
                                      ...
                                      node: {
                                        ...
                                        narration: [
                                          ...
                                          },
                                          {
                                            ...
                                            shortText: "Missing f-pawn opens the e1-h4 diagonal, and Black's Qh4+ check will split the king from castling rights.",
                                            ...
                                            node: {
                                              ...
                                              narration: [
                                                ...
                                                },
                                                {
                                                  ...
                                                  shortText: "Ng4 is the active try, eyeing f2 and supporting Qh4+.",
                                                  arrows: [{ from: 'f6', to: 'g4', color: 'yellow' }],
                                                },
                                                {
                                                  text: 'Important: Qh4+ is still threatened on the next move because the e1-h4 diagonal is still open. That is your problem to solve next.',
                                                  arrows: [{ from: 'd8', to: 'h4', color: 'red' }],
                                                },
                                              ],
                                              children: [
                                                {
                                                  node: {
                                                    ...
                                                    movedBy: 'black',
                                                    idea:
                                                      "4...Ng8 — Black retreats all the way back to the starting square. This is the cleanest move at amateur level — and Stockfish actually agrees it's the best survival move for Black. Why? Every other knight move loses material to a queen capture along the open diagonal: Ng4 hangs to Qxg4, Nh5 hangs to Qxh5 (along d1-h5), Nd5 hangs to Nxd5 (your knight takes), Ne4 hangs to Nxe4. The d1-queen has a clear shot at the kingside now that the f-pawn is gone. So Black retreats with two tempi spent (Nf6 then Ng8) and you have a huge lead in development. The gambit accepted is honestly bad for Black — this is part of why it's not played at master level.",
                                                    shortIdea: "Black retreats Ng8, the only move avoiding queen captures along the open diagonal, giving White a huge development lead.",
                                                    narration: [
                                                      {
                              ...
                              },
                              {
                                ...
                                node: {
                                  ...
                                  shortIdea: "Bc4 eyes f7, the weakest square, setting a famous trap.",
                                  narration: [
                                    {
                                      text: "3.Bc4 — Italian-style development.",
                                      shortText: "Bc4 develops the bishop to attack f7, a classic Italian setup.",
                                      arrows: [{ from: 'f1', to: 'c4', color: 'green' }],
                                    },
                                    {
                                      text: "The bishop eyes f7, the weakest square in Black's camp.",
                                      shortText: "The bishop targets f7, Black's weakest square.",
                                    ...
                                    },
                                    {
                                      ...
                                      shortText: "In the Vienna, Black's next move springs a famous trap.",
                                    },
                                  ],
                                  children: [
                                    {
                                                          ...
                                                          children: [
                                                            {
                                                              node: {
                                                                ...
                                                                shortIdea: "5...Qxd5 recaptures, giving Black the bishop pair as a small long-term plus.",
                                                                narration: [
                                                                  {
                                                                  ...
                                                                  },
                                                                  {
                                                                    ...
                                                                    shortText: "Early queen development is safe here because it can't be easily attacked.",
                                                                    highlights: [{ square: 'd5', color: 'yellow' }],
                                                                  },
                                                                  {
                                                                    text: "Both sides develop from here. Let me show you the typical middlegame.",
                                                                    shortText: "White's knight forks queen and rook on f7, winning material.",
                                                                  },
                                                                ],
                                                                children: [
                                                                  {
                                                                      ...
                                                                      children: [
                                                                        {
                                                                          node: {
                                                                            ...
                                                                            movedBy: 'black',
                                                                            idea:
                                                                              "6...Nc6 — Black develops and defends e5. Knight to c6 supports the e5-pawn (which your pieces will eventually pressure) and prepares queenside castling.",
                                                                            shortIdea: "Black's knight develops to c6, defending e5 and preparing queenside castling.",
                                                                            narration: [
                                                                              {
                                                                            ...
                                                                            children: [
                                                                              {
                                                                                node: {
                                                                                  ...
                                                                                  shortIdea: "7.Nf3 develops the knight, defends e4, and prepares to castle.",
                                                                                  narration: [
                                                                                    {
                                                                                  ...
                                                                                  children: [
                                                                                    {
                                                                                      node: {
                                                                                        ...
                                                                                        movedBy: 'black',
                                                                                        idea:
                                                                                          "7...Bf5 — Black develops and pins. Bishop from c8 to f5 attacks your e4-knight along the b1-h7 diagonal. The knight is now attacked by both the bishop AND the queen — defended only by your d3-pawn. You can't move the knight without losing material to Bxe4 or Qxe4. The right move: get out of the way with castling, then deal with the pressure later.",
                                                                                        shortIdea: "Castle to relieve the pin on the e4-knight, attacked by bishop and queen.",
                                                                                        narration: [
                                                                                          {
                                                                                          ...
                                                                                          {
                                                                                            text: 'Bishop to f5 attacks your e4-knight along the b1-h7 diagonal.',
                                                                                            arrows: [{ from: 'f5', to: 'e4', color: 'red' }],
                                                                                            highlights: [{ square: 'e4', color: 'red' }],
                                                                                          },
                                                                                          {
                                                                                            text: 'The knight is attacked twice but defended once — by d3. You castle and figure it out.',
                                                                                          },
                                                                                        ],
                                                                                        children: [
                                                                                          {
                                                                                            node: {
                                                                                              ...
                                                                                              movedBy: 'white',
                                                                                              idea:
                                                                                                "8.O-O — castle. King to g1, rook to f1. You've reached the typical center fork trick middlegame. Material is even, both sides developed, the e4-knight situation is tense but stable. From here white can play Re1 to add another defender, or Nh4 to kick the f5-bishop, or just continue developing with c3 and Bc1-d2. Black has the bishop pair (a small long-term plus) but White has piece coordination.",
                                                                                              shortIdea: "White castles kingside, material even, e4-knight tense but stable, Black holds bishop pair.",
                                                                                              narration: [
                                                                                                {
                                                                                                  text: '8.O-O — castle.',
                                                                                                ...
                                                                                                {
                                                                                                  text: "You've reached the typical center fork trick middlegame. Material even, both sides developed, the e4-knight tense but stable.",
                                                                                                  shortText: "The e4-knight forks the queen and rook on f6 if the pawn on d5 advances.",
                                                                                                  highlights: [
                                                                                              ...
                                                                                              children: [
                                                                                                {
                                                                                                  node: {
                                                                                                    ...
                                                                                                    shortIdea: "Black castles queenside, king to c8, rook to d8, setting up opposite-side attacks.",
                                                                                                    narration: [
                                                                                                      {
                                                                                                    ...
                                                                                                    children: [
                                                                                                      {
                                                                                                        node: {
                                                                                                          ...
                                                                                                          movedBy: 'white',
                                                                                                          idea:
                                                                                                            "9.d4 — challenge the center. Pawn from d3 to d4 (you played d3 on move 6 to defend the knight; now it advances) hits Black's e5-pawn directly. Black has to decide: trade with exd4 (opening the position for the bishop pair, slightly favoring Black), defend with Bd6, or let you take with dxe5. This is the typical middlegame moment in the center fork trick line — open position, bishop pair vs piece coordination, opposite-side castled kings, both sides have plans. From here it's real chess.",
                                                                                                          shortIdea: "9.d4 challenges the center, hitting e5, forcing Black to choose between exd4, Bd6, or dxe5.",
                                                                                                          narration: [
                                                                                                            {
                                                                                                            ...
                                                                                                            {
                                                                                                              text: 'Black has to decide — trade with exd4 to open lines for the bishop pair, defend, or let you take with dxe5.',
                                                                                                            },
                                                                                                            {
                                                                                                              text: 'This is the typical middlegame moment — opposite-side castled kings, open position, bishop pair versus your piece coordination. From here it is real chess.',
                                                                                                            },
                                                                                                          ],
                                                                                                          children: [],
                                                                                                        },
                        ...
                        },
                        {
                          ...
                          node: {
                            ...
                            movedBy: 'black',
                            idea:
                              "2...Nc6 — the most common move you'll face at amateur level. Black develops naturally and defends e5. The position is calmer than after 2...Nf6 — there's no immediate threat, no gambit on offer. You'll set up Italian-style and choose between a slow positional game or push f4 later.",
                            shortIdea: "2...Nc6 develops and defends e5, setting up a calm Italian-style game with options for slow play or f4 later.",
                            children: [
                              {
                                node: {
                                  san: 'Bc4',
                                  movedBy: 'white',
                                  idea:
                                    "3.Bc4 — Italian setup. The bishop slides to its best diagonal, eyeing f7. You're playing a Vienna-Italian hybrid — same bishop placement as the Italian, but with the knight on c3 (not f3) so f4 is still on the table. You're keeping your options open.",
                                  shortIdea: "Bishop to c4 eyes f7, knight on c3 keeps f4 available in a Vienna-Italian hybrid.",
                                  children: [
                                    {
                                      node: {
                                        san: 'Nf6',
                                        movedBy: 'black',
                                        idea:
                                          "3...Nf6 — Black develops the second knight and threatens your e4 pawn. Now you hit the critical Vienna decision against the 2...Nc6 line: do you play 4.d3 (kill the center fork trick before it starts) or 4.Nf3 (allow the trick and accept equality)? Strong players play d3.",
                                        shortIdea: "Play 4.d3 to kill the center fork trick, or 4.Nf3 allows equality.",
                                        children: [
                                          {
                                            node: {
                                              san: 'd3',
                                              movedBy: 'white',
                                              idea:
                                                "4.d3 — the move. Defends e4 with a pawn, kills the center fork trick (no Nxe4 because the pawn has it covered), and prepares to push f4 in a few moves once you've castled. The position is quiet but White is comfortable. From here it's classical Italian-style chess — get the king safe, play f4 when the timing's right, point everything at the kingside.",
                                              shortIdea: "d3 defends e4, prevents Nxe4, and prepares f4 after castling for a kingside attack.",
                                              narration: [
                                                {
                                                ...
                                                {
                                                  text: 'And it prepares to push f4 once you have castled.',
                                                ...
                                                },
                                                {
                                                  ...
                                                  shortText: "White castles, prepares f4, and aims for a kingside attack in a comfortable Italian position.",
                                                  arrows: [
                                                    { from: 'e1', to: 'g1', color: 'blue' },
                                              ...
                                              children: [
                                                {
                                                  node: {
                                                    ...
                                                    narration: [
                                                      {
                                                        text: '4...Bc5 — Black mirrors your Italian setup.',
                                                        arrows: [{ from: 'f8', to: 'c5', color: 'green' }],
                                                      },
                                                      {
                                                        text: 'Bishop to c5 hits f2 — the same target your bishop on c4 has on f7.',
                                                        arrows: [
                                                      ...
                                                      {
                                                        text: "But here's the trap. The bishop is on the long a7-g1 diagonal. If you ever push f4 — clearing f2 — that diagonal opens up to your knight on g1, and Black plays Bxg1 winning the piece.",
                                                        shortText: "Pushing f4 opens the a7-g1 diagonal, allowing Bxg1 to win the knight.",
                                                        arrows: [
                                                      ...
                                                      {
                                                        text: 'So you trade this bishop FIRST. Be3 challenges it head-on — if Black trades, you recapture with the f-pawn, opening the f-file as a bonus.',
                                                    ...
                                                    children: [
                                                      {
                                                        node: {
                                                          ...
                                                          movedBy: 'white',
                                                          idea:
                                                            "5.Be3 — challenge the bishop. Bishop from c1 to e3, offering the trade and getting the dangerous c5-bishop off the long diagonal. Black's choice: trade with Bxe3 (most common — keeps it simple) or retreat with Bb6 (keeping the bishop, but losing tempo). Either way your plan is the same — recapture with the f-pawn if there's a trade, or push f4 safely later if the bishop moves.",
                                                          shortIdea: "5.Be3 offers a trade or forces Black's bishop to retreat, then recapture with the f-pawn or push f4 safely.",
                                                          narration: [
                                                            {
                                                            ...
                                                            {
                                                              text: "Bishop from c1 to e3, offering the trade and getting Black's c5-bishop off the long diagonal where it threatens your knight.",
                                                              shortText: "Bishop to e3 offers a trade, removing Black's c5-bishop from the long diagonal threatening the knight.",
                                                              arrows: [{ from: 'e3', to: 'c5', color: 'red' }],
                                                            },
                                                            {
                                                              text: "Black's choice — trade with Bxe3, the most common reply, or retreat with Bb6 keeping the bishop but losing a tempo. Either way your plan is the same.",
                                                              shortText: "Black trades with Bxe3 or retreats Bb6 losing a tempo; either way, White's plan continues.",
                                                            },
                                                          ],
                                                          children: [
                                                            {
                                                                ...
                                                                children: [
                                                                  {
                                                                    node: {
                                                                      ...
                                                                      movedBy: 'white',
                                                                      idea:
                                                                        "6.fxe3 — and there's the move. F-pawn captures back on e3. You've doubled your e-pawns and that's slightly ugly, BUT — and this is the whole point of the recapture — the f-file is now wide open. Your rook on h1 can swing to f1; your queen can use the file; the king will castle short and live behind a still-intact pawn shield on g2-h2. The doubled e-pawns are a minor structural concession; the open f-file is a major attacking asset.",
                                                                      shortIdea: "fxe3 recaptures, doubling e-pawns but opening the f-file for rook and queen attacks.",
                                                                      narration: [
                                                                        {
                                                                        ...
                                                                        {
                                                                          text: "You have doubled your e-pawns and that's slightly ugly. But the f-file is now wide open.",
                                                                          shortText: "Doubled e-pawns are ugly, but the open f-file offers compensation.",
                                                                          highlights: [
                                                                      ...
                                                                      children: [
                                                                        {
                                                                          node: {
                                                                            ...
                                                                            movedBy: 'black',
                                                                            idea:
                                                                              "6...d6 — Black plays it safe. Pawn to d6 supports e5, opens the c8-bishop's diagonal, and waits to see what you commit to. The center is locked: your pawn on e4 against theirs on e5. From here you develop normally — knight to f3, castle short, prepare the f-file pressure.",
                                                                            shortIdea: "Black's d6 supports e5, opens the c8-bishop, and waits for White's commitment.",
                                                                            narration: [
                                                                              {
                                                                            ...
                                                                            children: [
                                                                              {
                                                                                node: {
                                                                                  ...
                                                                                  movedBy: 'white',
                                                                                  idea:
                                                                                    "7.Nf3 — bring the second knight out. Knight from g1 to f3, where it pressures e5 (third attacker on the pawn) and supports a future castle. With both knights, both bishops, and the kingside cleared, you're one move from castling.",
                                                                                  shortIdea: "Knight to f3 pressures e5 with a third attacker and clears the kingside for castling.",
                                                                                  narration: [
                                                                                    {
                                                                                      text: '7.Nf3 — bring the second knight out.',
                                                                                      arrows: [{ from: 'g1', to: 'f3', color: 'green' }],
                                                                                    ...
                                                                                    {
                                                                                      text: "You're one move from castling.",
                                                                                      shortText: "White's king is stuck in the center one move from castling.",
                                                                                      arrows: [{ from: 'e1', to: 'g1', color: 'blue' }],
                                                                                    },
                                                                                  ],
                                                                                  children: [
                                                                                    {
                                                                                      node: {
                                                                                        ...
                                                                                        movedBy: 'black',
                                                                                        idea:
                                                                                          "7...O-O — Black castles first. King to g8, rook to f8. Standard procedure; nothing special about it. Your turn to do the same.",
                                                                                        shortIdea: "Castling kingside, Black secures his king and connects rooks.",
                                                                                        narration: [
                                                                                          {
                                                                                          ...
                                                                                          {
                                                                                            text: 'King to g8, rook to f8. Your turn.',
                                                                                          },
                                                                                        ],
                                                                                        children: [
                                                                                          {
                                                                                            node: {
                                                                                              ...
                                                                                              movedBy: 'white',
                                                                                              idea:
                                                                                                "8.O-O — and you follow. King to g1, rook to f1. The rook lands directly on the open f-file — every move of this opening has been pointing toward this exact configuration. You're now in the middlegame with a textbook Vienna setup: open f-file, knights on c3 and f3, bishop on c4 eyeing f7, kings safely castled, doubled e-pawns the only structural blemish. Black's only critical decision left is whether to challenge your bishop with Bg4.",
                                                                                              shortIdea: "O-O castles king and rook onto the open f-file, creating a textbook Vienna setup with knights on c3 and f3, bishop on c4 eyeing f7, and doubled e-pawns.",
                                                                                              narration: [
                                                                                                {
                                                                                                  text: '8.O-O — and you follow. King to g1,',
                                                                                                  arrows: [{ from: 'e1', to: 'g1', color: 'green' }],
                                                                                                },
                                                                                                {
                                                                                                ...
                                                                                                {
                                                                                                  text: "You're now in the middlegame. Open f-file, knights on c3 and f3, bishop on c4 eyeing f7, both kings castled. Doubled e-pawns the only structural blemish — and worth it.",
                                                                                                  shortText: "Open f-file, knights on c3 and f3, bishop on c4 eyeing f7, doubled e-pawns worth the structural blemish.",
                                                                                                  highlights: [
                                                                                                    { square: 'g1', color: 'green' },
                                                                                              ...
                                                                                              children: [
                                                                                                {
                                                                                                  node: {
                                                                                                    ...
                                                                                                    movedBy: 'black',
                                                                                                    idea:
                                                                                                      "8...Bg4 — Black pins your knight. Bishop from c8 to g4, pinning Nf3 against your queen on d1. The threat is to play Nxe4 next — since the knight on f3 is pinned, it can't recapture. Your answer is h3 — kick the bishop, force the trade or the retreat.",
                                                                                                    shortIdea: "h3 kicks the pinned bishop, forcing it to trade or retreat before Black plays Nxe4.",
                                                                                                    narration: [
                                                                                                      {
                                                                                                        text: '8...Bg4 — Black pins your knight.',
                                                                                                        arrows: [{ from: 'c8', to: 'g4', color: 'green' }],
                                                                                                      },
                                                                                                      {
                                                                                                        text: 'Bishop to g4, pinning the f3-knight against your queen on d1.',
                                                                                                      ...
                                                                                                      {
                                                                                                        text: 'The threat is Nxe4 — since the f3-knight is pinned, it cannot recapture. You answer with h3.',
                                                                                                    ...
                                                                                                    children: [
                                                                                                      {
                                                                                                        node: {
                                                                                                          ...
                                                                                                          movedBy: 'white',
                                                                                                          idea:
                                                                                                            "9.h3 — kick the bishop. Pawn to h3 forces Bxf3 (the trade) or Bh5 (retreat, then you play g4 next to chase it further). If they trade, you recapture with the queen — Qxf3 — and your queen lands on a powerful kingside square pointing at f7 and ready to swing. The middlegame plan from here: queen and rook on the f-file, knight to d5 if Black ever lets you, push the d-pawn or the e-pawn for a central break. This is where opening theory ends and real chess begins.",
                                                                                                          shortIdea: "9.h3 forces Bxf3 or Bh5; Qxf3 recaptures, aiming at f7 with queen and rook on the f-file.",
                                                                                                          narration: [
                                                                                                            {
                                                                                                            ...
                                                                                                            {
                                                                                                              text: 'If they trade, you recapture with the queen — Qxf3 — and the queen lands on a powerful kingside square pointing at f7.',
                                                                                                              arrows: [
                                                                                                            ...
                                                                                                            {
                                                                                                              text: 'Middlegame plan from here. Queen and rook on the f-file. Knight to d5 if Black lets you. Push the d-pawn or the e-pawn for a central break. This is where opening theory ends and real chess begins.',
                                                                                                              arrows: [
                        ...
                        },
                        {
                          ...
                          node: {
                            ...
                            movedBy: 'black',
                            idea:
                              "2...Bc5 — Black plays Italian-style as Black, developing the bishop to its most active square and aiming at the f2 pawn. This is rarer than the knight moves but solid. You respond with normal development and look for f4 later, same as the other lines.",
                            shortIdea: "Bc5 develops the bishop to its most active square, targeting f2.",
                            children: [
                              {
                                node: {
                                  san: 'Nf3',
                                  movedBy: 'white',
                                  idea:
                                    "3.Nf3 — develop the second knight. Yes, this commits the f-pawn behind the knight for now, but after 2...Bc5 the gambit f4 doesn't work anyway: pushing f4 with Black's bishop on c5 opens the long a7-g1 diagonal and the knight on g1 hangs to ...Bxg1. With the bishop already pointed at your king, you develop calmly instead and aim for a normal Italian-style middlegame.",
                                  shortIdea: "Develop the knight to f3, avoiding the f4 push that hangs the knight to ...Bxg1 with Black's bishop on c5.",
                                  narration: [
                                    {
                                    ...
                                    {
                                      text: "Pushing f4 with Black's bishop on c5 doesn't work — clearing f2 opens the long a7-g1 diagonal, and your knight on g1 hangs to Bxg1.",
                                      shortText: "f4 fails because it opens the a7-g1 diagonal, hanging the knight on g1 to Bxg1.",
                                      arrows: [{ from: 'c5', to: 'g1', color: 'red' }],
                                      highlights: [{ square: 'g1', color: 'red' }],
                                    },
                                    {
                                      text: 'So you develop calmly instead — Italian-style, knight to f3, normal pieces out, aim for a normal middlegame.',
                                    },
                                  ],
                                  children: [
                                    {
                                      node: {
                                        ...
                                        movedBy: 'black',
                                        idea:
                                          "3...Nf6 — Black develops symmetrically. Knight from g8 to f6, attacking your e4 pawn. Standard reply.",
                                        shortIdea: "Black's knight from g8 to f6 attacks the e4 pawn, developing symmetrically.",
                                        narration: [
                                          {
                                          ...
                                          {
                                            text: 'Knight to f6, attacking your e4 pawn.',
                                        ...
                                        children: [
                                          {
                                            node: {
                                              ...
                                              movedBy: 'white',
                                              idea:
                                                "4.Be2 — modest bishop development, and crucially this AVOIDS the center fork trick. If you played Bc4 here instead, Black would play Nxe4! — and after you recapture with your c3-knight, Black plays d5 forking your bishop on c4 and the knight on e4. Same trick as against the 2...Nc6 line. By playing Be2 first, no target on c4. You'll defend e4 with d3 next move so any Nxe4 grab loses material outright.",
                                              shortIdea: "Be2 avoids the center fork trick; Nxe4 is met by d3, winning material.",
                                              narration: [
                                                {
                                                ...
                                                {
                                                  text: 'Critically — this AVOIDS the center fork trick. If you played Bc4 here, Black would play Nxe4 then d5 forking the bishop and your recaptured knight.',
                                                  arrows: [
                                                ...
                                                {
                                                  text: 'By playing Be2 first, no target on c4. You defend e4 with d3 next move so any Nxe4 grab just loses material.',
                                              ...
                                              children: [
                                                {
                                                  node: {
                                                    ...
                                                    shortIdea: "Black develops the knight to c6, defending e5.",
                                                    narration: [
                                                      {
                                                        text: "4...Nc6 — Black develops the queen's knight.",
                                                        shortText: "Black develops the knight to c6.",
                                                        arrows: [{ from: 'b8', to: 'c6', color: 'green' }],
                                                      },
                                                      {
                                                    ...
                                                    children: [
                                                      {
                                                        node: {
                                                          ...
                                                          movedBy: 'white',
                                                          idea:
                                                            "5.d3 — defend e4 with the pawn. Now the e4-pawn has TWO defenders (the c3-knight AND this d3-pawn) so any Nxe4 ideas are off the table for good. You can also push d4 later if conditions allow. The position is set up for a calm Italian-Vienna middlegame.",
                                                          shortIdea: "d3 defends e4 with a pawn, killing Nxe4 threats and setting up a calm Italian-Vienna middlegame.",
                                                          narration: [
                                                            {
                                                            ...
                                                            },
                                                            {
                                                              ...
                                                              shortText: "Nxe4 hangs the knight to a recapture.",
                                                            },
                                                          ],
                                                          children: [
                                                            {
                                                              node: {
                                                                ...
                                                                shortIdea: "5...d6 supports e5 and opens the c8-bishop's diagonal, preparing to castle.",
                                                                narration: [
                                                                  {
                                                                  ...
                                                                  },
                                                                  {
                                                                    ...
                                                                    shortText: "The c8-bishop's diagonal is opened.",
                                                                ...
                                                                children: [
                                                                  {
                                                                    node: {
                                                                      ...
                                                                      movedBy: 'white',
                                                                      idea:
                                                                        "6.O-O — castle short. King to safety, rook to f1. The bishop on c5 still aims at the long diagonal but your f2-pawn blocks any pressure on g1. You're set up for a calm middlegame from here — what you have over a normal Italian is the knight already on c3, ready for Nd5 or supporting an eventual d4 break.",
                                                                      shortIdea: "Castle short to safety; knight on c3 preps Nd5 or d4 break in a calm Italian middlegame.",
                                                                      narration: [
                                                                        {
                                                                        ...
                                                                        {
                                                                          text: "The bishop on c5 aims at your king's destination but your f2-pawn blocks any pressure on g1.",
                                                                          shortText: "The bishop on c5 eyes the king's route, but the f2-pawn blocks pressure on g1.",
                                                                          highlights: [{ square: 'f2', color: 'green' }],
                                                                        },
                                                                        {
                                                                          text: 'What you have over a normal Italian is the knight already on c3, ready for Nd5 or supporting d4.',
                                                                      ...
                                                                      children: [
                                                                        {
                                                                          node: {
                                                                            ...
                                                                            narration: [
                                                                              ...
                                                                              {
                                                                                text: "Both kings safe — you've reached the calm Italian-Vienna middlegame.",
                                                                                shortText: "Both kings safe in a calm Italian-Vienna middlegame.",
                                                                                highlights: [
                                                                                  { square: 'g1', color: 'green' },
                                                                                  { square: 'g8', color: 'green' },
                                                                                ],
