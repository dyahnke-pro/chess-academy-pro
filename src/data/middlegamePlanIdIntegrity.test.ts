...
const BASELINE_MISSING = new Set<string>([
  ...
  'mp-petrovdefence-bd3',
  'mp-petrovdefence-italian',
  'mp-petrovdefence-threeknights',
  'mp-philidordefence-antoshin',
  'mp-philidordefence-countergambit',
  'mp-philidordefence-nimzowitsch',
  'mp-qga-janowski',
  'mp-qga-sadler',
  'mp-qgd-exchange',
  'mp-qgd-lasker',
  ...
  'mp-semislav-botvinnik',
  'mp-semislav-meran',
  'mp-semislav-moscow',
  'mp-semislav-stoltz',
  'mp-siciliannajdorf-6f3',
  'mp-slavdefence-schlechter',
