...
describe('PieceSoundPanel', () => {
  ...
  it('all sliders default to 50 when profile has no custom values', () => {
    render(<PieceSoundPanel />);
    expect(screen.getByTestId<HTMLInputElement>('piece-sound-pitch').value).toBe('50');
    expect(screen.getByTestId<HTMLInputElement>('piece-sound-tone').value).toBe('50');
    expect(screen.getByTestId<HTMLInputElement>('piece-sound-waveform').value).toBe('50');
    expect(screen.getByTestId<HTMLInputElement>('piece-sound-length').value).toBe('50');
  });
