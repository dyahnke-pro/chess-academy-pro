...
export function GamesPage(): JSX.Element {
  ...
  if (phase === 'challenge-modes') {
    return (
      <div className="flex-1 min-h-0 overflow-y-auto p-4 md:p-6 pb-[calc(6.5rem+env(safe-area-inset-bottom,0px))] md:pb-6" data-testid="challenge-modes">
  ...
  // ─── Main menu ──────────────────────────────────────────────────────────────
  return (
    <div className="flex-1 min-h-0 overflow-y-auto p-4 md:p-6 pb-[calc(6.5rem+env(safe-area-inset-bottom,0px))] md:pb-6" data-testid="games-page">
      <div className="max-w-lg mx-auto space-y-4">
        <div className="mb-4">
