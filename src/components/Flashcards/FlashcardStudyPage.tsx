...
export function FlashcardStudyPage(): JSX.Element {
  ...
  if (phase === 'modes') {
    return (
      <div className="flex flex-col gap-6 p-6 flex-1 min-h-0 overflow-y-auto pb-[calc(6.5rem+env(safe-area-inset-bottom,0px))] md:pb-6" data-testid="flashcard-modes">
  ...
  if (phase === 'complete') {
    ...
    return (
      <div className="flex flex-col gap-6 p-6 flex-1 min-h-0 overflow-y-auto pb-[calc(6.5rem+env(safe-area-inset-bottom,0px))] md:pb-6" data-testid="flashcard-complete">
        <button
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 p-6 flex-1 min-h-0 overflow-y-auto pb-[calc(6.5rem+env(safe-area-inset-bottom,0px))] md:pb-6" data-testid="flashcard-study">
