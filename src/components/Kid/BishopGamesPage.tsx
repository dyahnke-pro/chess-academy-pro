  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <button
          onClick={() => void navigate('/kid/bishop-games/puzzles')}
          className="rounded-xl p-5 border-2 flex items-center gap-4 hover:opacity-80 transition-opacity w-full text-left"
          style={{
            background: 'var(--color-surface)',
            borderColor: 'var(--color-accent)',
          ...
          data-testid="bishop-puzzles-card"
        >
          <span className="text-2xl">🧩</span>
          <div className="flex-1">
            <div className="font-bold text-lg">Bishop Puzzles</div>
            <div className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
              Find the bishop move that wins.
            </div>
          </div>
        </button>
        ...
        <button
          ...
          data-testid="bishop-maze-card"
        >
          <span className="text-2xl">🧭</span>
          <div className="flex-1">
            <div className="font-bold text-lg">Bishop Path</div>
            <div className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
              Guide the bishop to the target square.
            </div>
          </div>
        </button>
        ...
        <button
          ...
          data-testid="bishop-hunt-card"
        >
          <span className="text-2xl">⚔️</span>
          <div className="flex-1">
            <div className="font-bold text-lg">Bishop Hunt</div>
            <div className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
