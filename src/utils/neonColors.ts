...
const STYLE_COLORS: Record<string, NeonColor> = {
  ...
  entertaining: {
    ...
    shadow: '0 2px 6px rgba(250, 204, 21, 0.15)',
    shadowHover: '0 2px 12px rgba(250, 204, 21, 0.4)',
  ...
  balanced: {
    ...
    shadow: '0 2px 6px rgba(96, 165, 250, 0.15)',
    shadowHover: '0 2px 12px rgba(96, 165, 250, 0.4)',
