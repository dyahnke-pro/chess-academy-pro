 ...
 *     (Level 1 retry without Stockfish, then Level 2 retry without
 *     any data tools, then Level 3 deterministic fallback). Try /
 *     catch with Error.message string-matching is brittle; a typed
