// Download and install pre-generated voice packs from the server.
// Voice packs are binary files containing pre-generated MP3 audio clips.
// Format: [count(uint32)] then repeated [hashLen(uint16)][hash][audioLen(uint32)][mp3Data]

import { db } from '../db/schema';

const VOICE_PACK_BASE_URL = '/voices';
