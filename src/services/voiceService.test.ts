...
describe('voiceService', () => {
  beforeEach(async () => {
    ...
    vi.spyOn(speechService, 'speak').mockResolvedValue(undefined);
    vi.spyOn(speechService, 'stop').mockResolvedValue(undefined);
    vi.spyOn(speechService, 'setVoice').mockResolvedValue(undefined);
