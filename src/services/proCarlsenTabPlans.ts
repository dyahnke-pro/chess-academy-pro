...
const PLANS: Record<string, Record<string, string[]>> = {
  'pro-carlsen-open-sicilian': { main: ['mp-procarlsen-opensicilian-storm'], 'classical bc4': ['mp-carlsen-opensic-classical'] },
  ...
  'pro-carlsen-sicilian': { main: ['mp-procarlsen-sicilian-qstorm'], 'open vs ...nc6': ['mp-carlsen-sic-opennc6'] },
  ...
  'pro-carlsen-french': { main: ['mp-procarlsen-french-qbreak'], 'vs advance e5': ['mp-carlsen-french-advance'] },
