...
export type AuditKind =
  ...
  // Coach-turn resilience layer — three-tier fallback chain that
  // ensures the coach never hangs mid-game. (WO-COACH-RESILIENCE).
  ...
  // Level 2: Level 1 also timed out, retrying with NO data tools and
  // a system addendum telling the brain to play from its own chess
  // knowledge.
