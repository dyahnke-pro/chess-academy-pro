// Tab-plan resolver for the Eric Rosen Scandinavian pro-rep (STEP 12.5). No
...
export function getProEricRosenScandinavianTabPlanIds(openingId: string, _tabKey: string): string[] | null {
