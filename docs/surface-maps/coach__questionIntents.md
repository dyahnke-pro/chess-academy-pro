...
**3111 lines · 91 exports · 36 importers · 28 tests · 4 audits**

## Locked rules that govern this surface

- **The standard post-deploy ritual** (CLAUDE.md:5955) — names `questionIntents`
- **🔒🔒 THE EXHAUSTIVE COACH-QUESTION ROUTING AUDIT — run it THIS EXACT WAY, every session (David 2026-09-12, LOCKED: "make sure that every session does this audit in the same exact way as you").** (CLAUDE.md:6007) — names `questionIntents`
...
- `src/coach/coachService.ts:1526`
- `src/coach/coachService.ts:1663`
...
- `src/coach/coachService.ts:1438`
...
- `src/coach/coachService.ts:1449`
...
- `src/coach/coachService.ts:1471`
...
- `src/coach/coachService.ts:1658`
...
- `src/coach/coachService.ts:1745`
...
- `src/components/Coach/CoachTeachPage.tsx:4660`
