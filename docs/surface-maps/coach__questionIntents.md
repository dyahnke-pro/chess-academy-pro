...
- **The standard post-deploy ritual** (CLAUDE.md:5980) — names `questionIntents`
- **🔒🔒 THE EXHAUSTIVE COACH-QUESTION ROUTING AUDIT — run it THIS EXACT WAY, every session (David 2026-09-12, LOCKED: "make sure that every session does this audit in the same exact way as you").** (CLAUDE.md:6032) — names `questionIntents`
...
- `src/components/Coach/CoachTeachPage.tsx:3036`
