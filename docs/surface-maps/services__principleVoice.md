...
- `src/services/coachFeatureService.ts:4310`
...
- `src/services/coachFeatureService.ts:2202`
...
- `src/services/reviewFullData.ts:381`

### `renderPvEvidence` (function) — 3 call sites
- `src/services/coachFeatureService.ts:2213`
...
- `src/services/coachFeatureService.ts:4768`
