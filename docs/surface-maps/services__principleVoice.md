...
- `src/services/coachFeatureService.ts:4203`
...
- `src/services/coachFeatureService.ts:2156`
...
- `src/services/reviewFullData.ts:347`

### `renderPvEvidence` (function) — 3 call sites
- `src/services/coachFeatureService.ts:2167`
...
- `src/services/coachFeatureService.ts:4655`
