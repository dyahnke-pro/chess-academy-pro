...
- **🔒🔒 EVERY ALGO-BASED BUILD SHIPS WITH AN AUDIT TOOL — the decision must be observable, not just its prose (David 2026-09-20: "I want audit tools on all algo based builds").** (CLAUDE.md:3927) — names `factSelector`
...
- **The standard post-deploy ritual** (CLAUDE.md:5954) — names `factSelector`
