# Surface map — `src/components/Coach/TeachGameOverCard.tsx`
...
- `src/components/Coach/TeachGameOverCard.test.tsx`

## Exports and every call site

### `TeachGameResult` (type) — 0 call sites
- _no call sites outside this file — unused, or reached only through a re-export_

### `TeachGameOverCardProps` (interface) — 0 call sites
- _no call sites outside this file — unused, or reached only through a re-export_

### `TeachGameOverCard` (function) — 0 call sites
- _no call sites outside this file — unused, or reached only through a re-export_
