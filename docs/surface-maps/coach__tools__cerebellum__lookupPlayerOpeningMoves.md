# Surface map — `src/coach/tools/cerebellum/lookupPlayerOpeningMoves.ts`

> GENERATED by `node scripts/surface-map.mjs`. Do not hand-edit — ship-check
> regenerates this and fails the push if it differs, which is how the map is
> proven FRESH rather than merely present. Read it before you change the file.

**185 lines · 1 exports · 2 importers · 1 tests · 0 audits**
...
- `src/coach/tools/cerebellum/lookupPlayerOpeningMoves.test.ts`
- `src/coach/tools/registry.ts`

## Exports and every call site

### `lookupPlayerOpeningMovesTool` (const) — 0 call sites
