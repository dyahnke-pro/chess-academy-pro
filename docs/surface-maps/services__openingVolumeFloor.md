...
**98 lines · 8 exports · 3 importers · 1 tests · 0 audits**
...
### `HOME_OPENING_MIN_GAMES_BY_SHARE` (const) — 0 call sites
- _no call sites outside this file — unused, or reached only through a re-export_

### `clearsVolumeFloor` (function) — 5 call sites
- `src/services/groundedAnswer.ts:4812`
- `src/services/openingVolumeFloor.test.ts:21`
...
- `src/services/openingVolumeFloor.test.ts:30`
- `src/services/openingVolumeFloor.test.ts:36`
- `src/services/openingVolumeFloor.test.ts:40`
- `src/services/openingVolumeFloor.test.ts:47`
- `src/services/openingVolumeFloor.test.ts:53`

### `homeOpening` (function) — 2 call sites
- `src/services/openingVolumeFloor.test.ts:59`
- `src/services/openingVolumeFloor.test.ts:60`
