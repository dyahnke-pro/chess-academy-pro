...
- F3 (stockfish budget) — DONE. Engine-aware budget/depth in `usePhaseNarration`
  + `usePositionNarration` (asm.js iOS gets 3000ms/depth-8; desktop ≥700ms).
  Stockfish is the #1 call; determinism is the fallback (David 2026-07-03).
